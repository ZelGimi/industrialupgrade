...
public class ItemBotaniaDrill extends ItemDrill {
  ...
  public ItemBotaniaDrill() {
    ...
    ((ItemBotaniaDrill)BlocksItems.registerItem((Item)this, new ResourceLocation("super_solar_panels", "ItemBotaniaDrill"))).setUnlocalizedName("ItemBotaniaDrill");
  }
  
  @SideOnly(Side.CLIENT)
  public void registerModels(ItemName name) {
    ModelLoader.setCustomModelResourceLocation((Item)this, 0, new ModelResourceLocation("super_solar_panels:" + CaseFormat.LOWER_CAMEL.to(CaseFormat.LOWER_UNDERSCORE, "ItemBotaniaDrill"), null));
  }

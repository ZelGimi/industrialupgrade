...
public class BlockRubWood extends BlockBase {
    ...
    public BlockRubWood() {
        super("rubber_wood", Material.WOOD);
    ...
    public IBlockState getStateFromMeta(int meta) {
        return meta >= 0 && meta < BlockRubWood.RubberWoodState.values.length ? this.getDefaultState().withProperty(
                stateProperty,
                BlockRubWood.RubberWoodState.values[meta]

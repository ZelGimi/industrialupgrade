...
public class BlockAsteroidOre<T extends Enum<T> & ISubEnum> extends BlockCore<T> implements IBlockTag {

    public BlockAsteroidOre(T[] elements, T element, DataBlock<T, ? extends BlockCore<T>, ? extends ItemBlockCore<T>> dataBlock) {
    ...
    public enum Type implements ISubEnum {
        asteroid_adamantium_ore(0, DropType.SELF, 0),
        asteroid_aluminium_ore(1, DropType.RAW, 1),
        asteroid_apatite_ore(2, DropType.APATITE, 0),
        asteroid_arsenic_ore(3, DropType.RAW, 25),
        asteroid_ariel_draconium(4, DropType.SELF, 0),
        asteroid_beryllium_ore(5, DropType.SELF, 0),
        asteroid_bismuth_ore(6, DropType.RAW, 27),
        asteroid_bloodstone(7, DropType.SELF, 0),
        asteroid_boron_ore(8, DropType.SELF, 0),
        asteroid_calcium_ore(9, DropType.SELF, 0),
        asteroid_chromium_ore(10, DropType.RAW, 9),
        asteroid_cobalt_ore(11, DropType.RAW, 4),
        asteroid_copper_ore(12, DropType.RAW, 16),
        asteroid_diamond_ore(13, DropType.DIAMOND, 0),
        asteroid_emerald_ore(14, DropType.EMERALD, 0),
        asteroid_gadolinium_ore(15, DropType.RAW, 28);

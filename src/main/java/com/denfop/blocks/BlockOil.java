...
public class BlockOil<T extends Enum<T> & ISubEnum> extends BlockCore<T> implements IBlockTag {


    public BlockOil(T[] elements, T element, DataBlock<T, ? extends BlockCore<T>, ? extends ItemBlockCore<T>> dataBlock) {

...
public class BlockGas extends BlockCore implements IModelRegister {
    ...
    public BlockGas() {
        ...
        setUnlocalizedName("veingas");
        setCreativeTab(IUCore.OreTab);
        setHardness(1.0F);
        setSoundType(SoundType.STONE);
        setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, Type.gas));

...
public class BlockGas<T extends Enum<T> & ISubEnum> extends BlockCore<T> implements IBlockTag {


    public BlockGas(T[] elements, T element, DataBlock<T, ? extends BlockCore<T>, ? extends ItemBlockCore<T>> dataBlock) {

...
public class BlockSpaceStone1 extends BlockCore implements IModelRegister {

    public static final PropertyEnum<Type> VARIANT = PropertyEnum.create("type", Type.class);


    public BlockSpaceStone1() {
        super(Material.ROCK, Constants.MOD_ID);
        setUnlocalizedName("spacestone1");
        setCreativeTab(IUCore.RecourseTab);
        setHardness(1.0F);
        setResistance(5.0F);
        setSoundType(SoundType.STONE);
        setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, Type.mimas_stone));

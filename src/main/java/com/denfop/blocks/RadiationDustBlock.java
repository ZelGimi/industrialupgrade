...
public class RadiationDustBlock<T extends Enum<T> & SubEnum> extends AbstractLayerDustBlock<T> {
    ...
    protected void applyDustEffects(net.minecraft.world.level.block.state.BlockState state, Level level, net.minecraft.core.BlockPos pos, LivingEntity living, int layers) {
        ...
        living.addEffect(new MobEffectInstance(IUPotion.radiation, 120, 0));
    ...
    @Override
    public <E extends Enum<E> & SubEnum> void fillItemCategory(CreativeModeTab tab, NonNullList<ItemStack> items, E element) {

...
public class BlockMineral<T extends Enum<T> & ISubEnum> extends BlockCore<T> implements IBlockTag, IMineral {


    public BlockMineral(T[] elements, T element, DataBlock<T, ? extends BlockCore<T>, ? extends ItemBlockCore<T>> dataBlock) {

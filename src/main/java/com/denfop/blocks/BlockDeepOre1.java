...
public class BlockDeepOre1<T extends Enum<T> & ISubEnum> extends BlockCore<T> implements IBlockTag {

    public BlockDeepOre1(T[] elements, T element, DataBlock<T, ? extends BlockCore<T>, ? extends ItemBlockCore<T>> dataBlock) {
    ...
    public enum Type implements ISubEnum {
        deep_osmium_ore(0, DropType.RAW, 22),
        deep_tantalum_ore(1, DropType.RAW, 23),
        deep_cadmium_ore(2, DropType.RAW, 24),
        deep_calcium_ore(3, DropType.SELF, 0),
        deep_arsenic_ore(4, DropType.RAW, 25),
        deep_barium_ore(5, DropType.RAW, 26),
        deep_bismuth_ore(6, DropType.RAW, 27),
        deep_gadolinium_ore(7, DropType.RAW, 28),
        deep_gallium_ore(8, DropType.RAW, 29),
        deep_hafnium_ore(9, DropType.RAW, 30),
        deep_yttrium_ore(10, DropType.RAW, 31),
        deep_molybdenum_ore(11, DropType.RAW, 32),
        deep_neodymium_ore(12, DropType.RAW, 33),
        deep_niobium_ore(13, DropType.RAW, 34),
        deep_palladium_ore(14, DropType.RAW, 35),
        deep_polonium_ore(15, DropType.RAW, 36);

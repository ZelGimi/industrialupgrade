...
public class BlockAsteroidOre2<T extends Enum<T> & ISubEnum> extends BlockCore<T> implements IBlockTag {

    public BlockAsteroidOre2(T[] elements, T element, DataBlock<T, ? extends BlockCore<T>, ? extends ItemBlockCore<T>> dataBlock) {
    ...
    public enum Type implements ISubEnum {
        asteroid_niobium_ore(0, DropType.RAW, 34),
        asteroid_orichalcum_ore(1, DropType.SELF, 0),
        asteroid_osmium_ore(2, DropType.RAW, 22),
        asteroid_palladium_ore(3, DropType.RAW, 35),
        asteroid_platinum_ore(4, DropType.RAW, 7),
        asteroid_polonium_ore(5, DropType.RAW, 36),
        asteroid_quartz_ore(6, DropType.QUARTZ, 0),
        asteroid_redstone_ore(7, DropType.REDSTONE, 0),
        asteroid_silver_ore(8, DropType.RAW, 11),
        asteroid_spinel_ore(9, DropType.RAW, 10),
        asteroid_strontium_ore(10, DropType.RAW, 37),
        asteroid_sulfur_ore(11, DropType.SULFUR, 0),
        asteroid_thallium_ore(12, DropType.RAW, 38),
        asteroid_tin_ore(13, DropType.RAW, 20),
        asteroid_titanium_ore(14, DropType.RAW, 8),
        asteroid_tungsten_ore(15, DropType.RAW, 3);

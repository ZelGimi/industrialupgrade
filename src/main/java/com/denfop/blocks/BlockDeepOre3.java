...
public class BlockDeepOre3<T extends Enum<T> & ISubEnum> extends BlockCore<T> implements IBlockTag {

    public BlockDeepOre3(T[] elements, T element, DataBlock<T, ? extends BlockCore<T>, ? extends ItemBlockCore<T>> dataBlock) {
    ...
    public enum Type implements ISubEnum {
        deep_sodium_phosphate_ore(0, DropType.SELF, 0),
        deep_potassium_phosphate_ore(1, DropType.SELF, 0),
        deep_silver_stone_ore(2, DropType.SELF, 0);

...
public class BlockSwampRubWood extends BlockBase {
    ...
    public BlockSwampRubWood() {
        ...
        this.setDefaultState(this.blockState
                .getBaseState()
                .withProperty(stateProperty, BlockSwampRubWood.RubberWoodState.plain_y));
    }

    private static RubberWoodState getPlainAxisState(EnumFacing.Axis axis) {
        switch (axis) {
            case X:
                return BlockSwampRubWood.RubberWoodState.plain_x;
            case Y:
                return BlockSwampRubWood.RubberWoodState.plain_y;
            case Z:
                return BlockSwampRubWood.RubberWoodState.plain_z;
            default:
    ...
    public IBlockState getStateFromMeta(int meta) {
        return meta >= 0 && meta < BlockSwampRubWood.RubberWoodState.values.length ? this.getDefaultState().withProperty(
                stateProperty,
                BlockSwampRubWood.RubberWoodState.values[meta]
    ...
    public EnumPushReaction getMobilityFlag(IBlockState state) {
        ...
        return rstate != BlockSwampRubWood.RubberWoodState.plain_x && rstate != BlockSwampRubWood.RubberWoodState.plain_y && rstate != BlockSwampRubWood.RubberWoodState.plain_z

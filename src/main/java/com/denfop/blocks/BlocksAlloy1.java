...
public class BlocksAlloy1 extends BlockCore implements IModelRegister {
    ...
    public BlocksAlloy1() {
        ...
        setUnlocalizedName("baseblockalloy1");
        setCreativeTab(IUCore.RecourseTab);
        setHardness(1.0F);
        setResistance(5.0F);
        setSoundType(SoundType.METAL);
        setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, Type.stellite));
    ...
    public boolean preInit() {
        setRegistryName("baseblockalloy1");

...
public enum BlockPrimalWireInsulator implements IMultiTileBlock {

    primal_wire_insulator(TileEntityPrimalWireInsulator.class, 0),
    ;


    public static final ResourceLocation IDENTITY = IUCore.getIdentifier("primal_wire_insulator");

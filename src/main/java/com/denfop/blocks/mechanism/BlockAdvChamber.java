...
public enum BlockAdvChamber implements ITeBlock {

    adv_chamber(TileEntityAdvReactorChamberElectric.class, 0),
    ;


    public static final ResourceLocation IDENTITY = IUCore.getIdentifier("adv_chamber");
    ...
    BlockAdvChamber(final Class<? extends TileEntityBlock> teClass, final int itemMeta, final EnumRarity rarity) {
    ...
    public static void buildDummies() {
        ...
        for (final BlockAdvChamber block : values()) {

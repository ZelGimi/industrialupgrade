...
public enum IUStorage implements ITeBlock, IElectricBlock {
    ...
    IUStorage(final Class<? extends TileEntityBlock> teClass, final int itemMeta) {
        this(teClass, itemMeta, EnumRarity.UNCOMMON);

    }

    IUStorage(final Class<? extends TileEntityBlock> teClass, final int itemMeta, final EnumRarity rarity) {
    ...
    public static void buildDummies() {
        ...
        for (final IUStorage block : IUStorage.values()) {

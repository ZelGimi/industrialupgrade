...
public enum IUChargepadStorage implements ITeBlock, IElectricBlock {
    ...
    IUChargepadStorage(final Class<? extends TileEntityBlock> teClass, final int itemMeta) {
        this(teClass, itemMeta, EnumRarity.UNCOMMON);

    }

    IUChargepadStorage(final Class<? extends TileEntityBlock> teClass, final int itemMeta, final EnumRarity rarity) {
    ...
    public static void buildDummies() {
        ...
        for (final IUChargepadStorage block : IUChargepadStorage.values()) {
    ...
    public ResourceLocation getIdentifier() {
        return IUChargepadStorage.IDENTITY;
    }

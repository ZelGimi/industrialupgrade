...
public enum BlockWaterMill implements IMultiTileBlock {

    water_mill(TileEntityWaterMill.class, 0),
    ;


    public static final ResourceLocation IDENTITY = IUCore.getIdentifier("water_mill");
    ...
    BlockWaterMill(final Class<? extends TileEntityBlock> teClass, final int itemMeta, final EnumRarity rarity) {

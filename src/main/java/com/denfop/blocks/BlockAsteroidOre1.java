...
public class BlockAsteroidOre1<T extends Enum<T> & ISubEnum> extends BlockCore<T> implements IBlockTag {

    public BlockAsteroidOre1(T[] elements, T element, DataBlock<T, ? extends BlockCore<T>, ? extends ItemBlockCore<T>> dataBlock) {
    ...
    public enum Type implements ISubEnum {
        asteroid_gallium_ore(0, DropType.RAW, 29),
        asteroid_gold_ore(1, DropType.RAW_GOLD, 0),
        asteroid_hafnium_ore(2, DropType.RAW, 30),
        asteroid_iridium_ore(3, DropType.RAW, 14),
        asteroid_iron_ore(4, DropType.RAW_IRON, 0),
        asteroid_lapis_ore(5, DropType.LAPIS, 0),
        asteroid_lead_ore(6, DropType.RAW, 19),
        asteroid_lithium_ore(7, DropType.SELF, 0),
        asteroid_magnesium(8, DropType.RAW, 5),
        asteroid_magnesium_ore(9, DropType.RAW, 5),
        asteroid_manganese(10, DropType.RAW, 13),
        asteroid_mikhail_ore(11, DropType.RAW, 0),
        asteroid_mithril_ore(12, DropType.SELF, 0),
        asteroid_molybdenum_ore(13, DropType.RAW, 32),
        asteroid_neodymium_ore(14, DropType.RAW, 33),
        asteroid_nickel_ore(15, DropType.RAW, 6);

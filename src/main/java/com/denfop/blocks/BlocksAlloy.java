...
public class BlocksAlloy<T extends Enum<T> & ISubEnum> extends BlockCore<T> implements IBlockTag {


    public BlocksAlloy(T[] elements, T element, DataBlock<T, ? extends BlockCore<T>, ? extends ItemBlockCore<T>> dataBlock) {

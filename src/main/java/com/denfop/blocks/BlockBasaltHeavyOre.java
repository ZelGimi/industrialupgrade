...
public class BlockBasaltHeavyOre extends BlockCore implements IModelRegister {

    public static final PropertyEnum<Type> VARIANT = PropertyEnum.create("type", Type.class);


    public BlockBasaltHeavyOre() {
        super(Material.ROCK, Constants.MOD_ID);
        setUnlocalizedName("basaltheavyore");
    ...
    public boolean preInit() {
        setRegistryName("basaltheavyore");

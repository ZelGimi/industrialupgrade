...
public record CustomOreConfig(
    ...
    public static final Codec<CustomOreConfig> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ForgeRegistries.BLOCKS.getCodec().fieldOf("ore_block").forGetter(CustomOreConfig::oreBlock),
            ForgeRegistries.BLOCKS.getCodec().fieldOf("replace_block").forGetter(CustomOreConfig::replaceBlock),

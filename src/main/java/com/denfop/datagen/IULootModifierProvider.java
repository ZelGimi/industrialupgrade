...
public class IULootModifierProvider extends GlobalLootModifierProvider {
    ...
    public IULootModifierProvider(DataGenerator generator) {
    ...
    private void addChest(String name, ResourceLocation vanillaTable, ResourceLocation injectTable) {
        add(
                "inject_" + name,
                new AddFromLootTableModifier(
                        new LootItemCondition[]{
                                LootTableIdCondition.builder(vanillaTable).build()
                        },
                        injectTable
                )
        );

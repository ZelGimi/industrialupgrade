...
public enum EnumSound {
    ...
    CannerOp(TypePath.Machines, "CannerOp"),
    CannerReverseOp(TypePath.Machines, "CannerReverseOp"),
    centrifuge(TypePath.Machines, "centrifuge"),
    compressor(TypePath.Machines, "CompressorOp"),
    cooling(TypePath.Machines, "cooling"),
    cooling2(TypePath.Machines, "cooling2"),
    ...
    BatteryUse(TypePath.Tools, "BatteryUse"),
    bow(TypePath.Tools, "bow"),
    ChainsawIdle(TypePath.Tools, "ChainsawIdle"),
    ChainsawStop(TypePath.Tools, "ChainsawStop"),
    ChainsawUseOne(TypePath.Tools, "ChainsawUseOne"),
    ChainsawUseTwo(TypePath.Tools, "ChainsawUseTwo"),
    Crowbar(TypePath.Tools, "Crowbar"),
    JetpackFire(TypePath.Tools, "JetpackFire"),
    ...
    Painter(TypePath.Tools, "Painter"),

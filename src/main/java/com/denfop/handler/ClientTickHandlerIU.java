...
public class ClientTickHandlerIU {
    ...
    public static void onTickRender() {
        ...
        if (mc.world != null && mc.inGameHasFocus && !mc.gameSettings.showDebugInfo) {
            ...
            i1 = 0;
            if (!lst1.isEmpty())
                mc.ingameGUI.drawString(mc.fontRenderer, Localization.translate("description_item"), xPos1, yPos1 + 2 + 20 * size, ModUtils.convertRGBcolorToInt(44, 192, 224));
            ...
            if (!lst1.isEmpty())
                for (int i : lst1) {
                    ...
                    itemRender.renderItemAndEffectIntoGUI(new ItemStack(IUItem.upgrademodule, 1, i), xPos1, yPos1 + 10 + 20 * (i1 + size)
                    );
    ...
    public static String getDescription(ItemStack stack, Map<Integer, Integer> map) {
        ...
        switch (stack.getItemDamage()) {
            case 0:
                return TextFormatting.YELLOW + Localization.translate("genday") + TextFormatting.GREEN + ModUtils.getString(0.05 * map.get(stack.getItemDamage()) * 100) + "%";
            case 1:
                return TextFormatting.AQUA + Localization.translate("gennight") + TextFormatting.GREEN + ModUtils.getString(0.05 * map.get(stack.getItemDamage()) * 100) + "%";
            case 2:
                return TextFormatting.GOLD + Localization.translate("protect") + TextFormatting.GREEN + ModUtils.getString(0.2 * map.get(stack.getItemDamage()) * 100) + "%";
            case 3:
                return TextFormatting.LIGHT_PURPLE + Localization.translate("speed") + TextFormatting.GREEN + ModUtils.getString(0.2 * map.get(stack.getItemDamage()) * 100) + "%";
            case 4:
                return TextFormatting.RED + Localization.translate("bowenergy") + TextFormatting.GREEN + ModUtils.getString(0.1 * map.get(stack.getItemDamage()) * 100) + "%";
            case 5:
                return TextFormatting.RED + Localization.translate("saberenergy") + TextFormatting.GREEN + ModUtils.getString(0.15 * map.get(stack.getItemDamage()) * 100) + "%";
            case 6:
            ...
            case 11:
                return TextFormatting.DARK_GREEN + Localization.translate("bowdamage") + TextFormatting.GREEN + ModUtils.getString((0.25 * map.get(stack.getItemDamage())) * 100) + "%";
            case 12:
                return TextFormatting.DARK_AQUA + Localization.translate("saberdamage") + TextFormatting.GREEN + ModUtils.getString(0.15 * map.get(stack.getItemDamage()) * 100) + "%";
            case 13:
                return TextFormatting.BLUE + Localization.translate("aoe") + TextFormatting.GREEN + map.get(stack.getItemDamage());
            case 14:
                return TextFormatting.DARK_PURPLE + Localization.translate("speedfly") + TextFormatting.GREEN + ModUtils.getString((0.1 * map.get(stack.getItemDamage()) / 0.2) * 100) + "%";
            case 15:
                return TextFormatting.BLUE + Localization.translate("storage") + TextFormatting.GREEN + ModUtils.getString(0.05 * map.get(stack.getItemDamage()) * 100) + "%";
            case 16:
                return TextFormatting.RED + Localization.translate("energy_less_use") + TextFormatting.GREEN + ModUtils.getString(0.25 * map.get(stack.getItemDamage()) * 100) + "%";

            case 17:
                return TextFormatting.RED + Localization.translate("vampires") + TextFormatting.GREEN + ModUtils.getString(map.get(stack.getItemDamage()));
            case 18:
                return TextFormatting.GOLD + Localization.translate("resistance") + TextFormatting.GREEN + ModUtils.getString(map.get(stack.getItemDamage()));
            case 19:
            ...
            case 23:
                return TextFormatting.WHITE + Localization.translate("loot") + TextFormatting.GREEN + ModUtils.getString(map.get(stack.getItemDamage()));
            case 24:
                return TextFormatting.WHITE + Localization.translate("fire") + TextFormatting.GREEN + ModUtils.getString(map.get(stack.getItemDamage()));
            case 25:

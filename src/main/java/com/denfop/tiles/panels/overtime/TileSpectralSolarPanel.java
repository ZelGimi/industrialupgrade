...
public class TileSpectralSolarPanel extends TileSolarPanel {
    ...
    public TileSpectralSolarPanel(BlockPos pos, BlockState state) {
        super(EnumSolarPanels.SPECTRAL_SOLAR_PANEL, BlockSolarPanels.spectral_solar_panel, pos, state);
    }

    public IMultiTileBlock getTeBlock() {
        return BlockSolarPanels.spectral_solar_panel;
    }

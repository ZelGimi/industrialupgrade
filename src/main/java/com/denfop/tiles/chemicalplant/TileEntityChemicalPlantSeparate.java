...
public class TileEntityChemicalPlantSeparate extends TileEntityMultiBlockElement implements ISeparate {
    ...
    public TileEntityChemicalPlantSeparate() {
        this.fluids = this.addComponent(new Fluids(this));
        this.fluidTank = this.fluids.addTank("fluids", 10000);
        this.fluidTank.setAcceptedFluids(Fluids.fluidPredicate(FluidName.fluidHelium.getInstance()));
    }
    ...
    public GuiScreen getGui(final EntityPlayer var1, final boolean var2) {
        return new GuiChemicalSeparate(this.getGuiContainer(var1));
    }

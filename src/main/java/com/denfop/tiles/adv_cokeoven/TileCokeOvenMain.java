...
public class TileCokeOvenMain extends TileMultiBlockBase implements IMain,
    ...
    @Override
    public ContainerAdvCokeOven getGuiContainer(final EntityPlayer entityPlayer) {
    ...
    @Override
    @SideOnly(Side.CLIENT)
    public GuiAdvCokeOven getGui(final EntityPlayer entityPlayer, final boolean b) {

        return new GuiAdvCokeOven(this.getGuiContainer(entityPlayer));
    }

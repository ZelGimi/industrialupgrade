...
public class TileBioFuelGenerator extends TileEntityLiquidTankInventory implements
    ...
    public TileBioFuelGenerator() {
        super(12);
        this.coef = 1;
        this.fluidSlot = new InventoryFluidByList(this, 1, FluidName.fluidbiomass.getInstance());
    ...
    public IMultiTileBlock getTeBlock() {
        return BlockBaseMachine3.gen_bio;
    }

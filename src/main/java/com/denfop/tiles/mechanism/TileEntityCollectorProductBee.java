...
public class TileEntityCollectorProductBee extends TileEntityInventory implements IUpgradableBlock {
    ...
    public TileEntityCollectorProductBee() {
        ...
        this.fluidSlot = new InventoryFluidByList(this, 1, FluidName.fluidhoney.getInstance());
        this.fluidSlot.setTypeFluidSlot(InventoryFluid.TypeFluidSlot.OUTPUT);
        this.fluidSlot1 = new InventoryFluidByList(this, 1, FluidName.fluidroyaljelly.getInstance());

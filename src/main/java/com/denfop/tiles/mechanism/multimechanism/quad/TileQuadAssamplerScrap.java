...
public class TileQuadAssamplerScrap extends TileMultiMachine {
    ...
    public TileQuadAssamplerScrap(BlockPos pos, BlockState state) {
        super(
                EnumMultiMachine.QUAD_AssamplerScrap.usagePerTick,
                EnumMultiMachine.QUAD_AssamplerScrap.lenghtOperation, BlockMoreMachine3.quad_assamplerscrap, pos, state
        );

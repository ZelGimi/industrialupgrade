...
public class TileDoubleOreWashing extends TileMultiMachine {
    ...
    public TileDoubleOreWashing(BlockPos pos, BlockState state) {
        super(
                EnumMultiMachine.DOUBLE_OreWashing.usagePerTick,
                EnumMultiMachine.DOUBLE_OreWashing.lenghtOperation, BlockMoreMachine3.doubleorewashing, pos, state
        );

...
public class TileQuadElectricFurnace extends TileMultiMachine {
    ...
    public TileQuadElectricFurnace(BlockPos pos, BlockState state) {
        super(
                EnumMultiMachine.QUAD_ELECTRIC_FURNACE.usagePerTick,
                EnumMultiMachine.QUAD_ELECTRIC_FURNACE.lenghtOperation, BlockMoreMachine.quad_furnace, pos, state
        );

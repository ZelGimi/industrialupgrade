...
public class TileTripleRolling extends TileMultiMachine {
    ...
    public TileTripleRolling(BlockPos pos, BlockState state) {
        super(EnumMultiMachine.Rolling.usagePerTick, EnumMultiMachine.Rolling.lenghtOperation, BlockMoreMachine2.triple_rolling, pos, state);

...
public class TileTripleCombRecycler extends TileMultiMachine {
    ...
    public TileTripleCombRecycler(BlockPos pos, BlockState state) {
        super(
                EnumMultiMachine.TRIPLE_COMB_RRECYCLER.usagePerTick,
                EnumMultiMachine.TRIPLE_COMB_RRECYCLER.lenghtOperation, BlockMoreMachine1.triple_comb_recycler, pos, state
        );

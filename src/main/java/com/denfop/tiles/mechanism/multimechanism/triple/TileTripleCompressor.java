...
public class TileTripleCompressor extends TileMultiMachine {
    ...
    public TileTripleCompressor(BlockPos pos, BlockState state) {
        super(
                EnumMultiMachine.TRIPLE_COMPRESSER.usagePerTick,
                EnumMultiMachine.TRIPLE_COMPRESSER.lenghtOperation, BlockMoreMachine.triple_commpressor, pos, state
        );

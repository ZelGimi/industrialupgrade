...
public class TileExtruding extends TileMultiMachine {
    ...
    public TileExtruding(BlockPos pos, BlockState state) {
        super(EnumMultiMachine.Extruding.usagePerTick, EnumMultiMachine.Extruding.lenghtOperation, BlockMoreMachine2.extruder, pos, state);

...
public class TileAdvOilRefiner extends TileElectricMachine implements IManufacturerBlock, IUpgradableBlock, IHasRecipe {
    ...
    public TileAdvOilRefiner(BlockPos pos, BlockState state) {
        super(24000, 14, 2, BlockAdvRefiner.adv_refiner, pos, state);
    ...
    @Override
    public ContainerAdvOilRefiner getGuiContainer(Player entityPlayer) {
    ...
    public GuiCore<ContainerBase<? extends IAdvInventory>> getGui(Player entityPlayer, ContainerBase<? extends IAdvInventory> menu) {
        return new GuiAdvOilRefiner((ContainerAdvOilRefiner) menu);
    }

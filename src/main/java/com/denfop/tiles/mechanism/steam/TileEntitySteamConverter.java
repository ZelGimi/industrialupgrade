...
public class TileEntitySteamConverter extends TileElectricMachine implements IUpdatableTileEvent {
    ...
    public TileEntitySteamConverter() {
        super(0, 0, 1);
    ...
    public void updateEntityServer() {
        ...
        if (this.work) {
            if (this.getWorld().getWorldTime() % 1 == 0) {
    ...
    @Override
    public ContainerSteamConverter getGuiContainer(final EntityPlayer entityPlayer) {
    ...
    public GuiScreen getGui(final EntityPlayer entityPlayer, final boolean b) {
        return new GuiSteamConverter(getGuiContainer(entityPlayer), b);
    }

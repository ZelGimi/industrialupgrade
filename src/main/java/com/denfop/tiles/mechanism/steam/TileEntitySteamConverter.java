...
import com.denfop.container.ContainerSteamConverter;
import com.denfop.gui.GuiCore;
import com.denfop.gui.GuiSteamConverter;
...
public class TileEntitySteamConverter extends TileElectricMachine implements IUpdatableTileEvent {
    ...
    public TileEntitySteamConverter(BlockPos pos, BlockState state) {
        super(0, 0, 1,BlockBaseMachine3.steam_converter,pos,state);
    ...
    public IMultiTileBlock getTeBlock() {
        return BlockBaseMachine3.steam_converter;
    }
    ...
    public void updateEntityServer() {
        ...
        if (this.work) {
            if (this.getWorld().getGameTime() % 2 == 0) {
                if (!this.fluidTank.getFluid().isEmpty() && this.fluidTank.getFluid().getAmount() >= 1 && this.steam.getEnergy() + 2 <= this.steam.getCapacity()) {
    ...
    @Override
    public ContainerSteamConverter getGuiContainer(final Player entityPlayer) {
        return new ContainerSteamConverter(entityPlayer, this);
    }

    @Override
    @OnlyIn(Dist.CLIENT)
    public GuiCore<ContainerBase<? extends IAdvInventory>> getGui(Player var1, ContainerBase<? extends IAdvInventory> menu) {
        return new GuiSteamConverter((ContainerSteamConverter) menu);
    }

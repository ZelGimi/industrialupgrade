...
public class TileSteamExtruder extends TileSteamMultiMachine {

    private final SoilPollutionComponent pollutionSoil;
    private final AirPollutionComponent pollutionAir;

    public TileSteamExtruder(BlockPos pos, BlockState state) {
        super(
                EnumMultiMachine.Extruding.usagePerTick,
                EnumMultiMachine.Extruding.lenghtOperation,
                4, BlockBaseMachine3.steam_extruder, pos, state
        );
    ...
    public IMultiTileBlock getTeBlock() {
        return BlockBaseMachine3.steam_extruder;
    }

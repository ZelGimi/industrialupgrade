...
public class TileEntitySteamAmpereGenerator extends TileElectricMachine implements IUpdatableTileEvent {
    ...
    public TileEntitySteamAmpereGenerator(BlockPos pos, BlockState state) {
        ...
        this.fluidTank = this.fluids.addTank("fluidTank1", 4000, InvSlot.TypeItemSlot.NONE, Fluids.fluidPredicate(
    ...
    @Override
    public ContainerSteamAmpereGenerator getGuiContainer(final Player entityPlayer) {
    ...
    public GuiCore<ContainerBase<? extends IAdvInventory>> getGui(Player var1, ContainerBase<? extends IAdvInventory> menu) {
        return new GuiSteamAmpereGenerator((ContainerSteamAmpereGenerator) menu);
    }

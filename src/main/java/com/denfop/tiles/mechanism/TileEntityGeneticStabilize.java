...
import com.denfop.container.ContainerGeneticStabilizer;
import com.denfop.gui.GuiCore;
import com.denfop.gui.GuiGeneticStabilizer;
...
public class TileEntityGeneticStabilize extends TileElectricMachine implements
    ...
    public TileEntityGeneticStabilize(BlockPos pos, BlockState state) {
        super(200, 1, 1,BlockBaseMachine3.genetic_stabilizer,pos,state);
        ...
        this.inputSlotA = new InvSlotRecipes(this, "genetic_stabilizer", this, fluidTank1);


        this.fluid_handler = new FluidHandlerRecipe("genetic_stabilizer", fluids);
    ...
    public ContainerGeneticStabilizer getGuiContainer(final Player var1) {
        return new ContainerGeneticStabilizer(var1, this);
    ...
    public GuiCore<ContainerBase<? extends IAdvInventory>> getGui(Player var1, ContainerBase<? extends IAdvInventory> menu) {
        ...
        return new GuiGeneticStabilizer((ContainerGeneticStabilizer) menu);
    }

    @Override
    public void init() {
        addRecipe(
                new ItemStack(IUItem.crafting_elements.getStack(446), 1),
                new FluidStack(FluidName.fluidunstablemutagen.getInstance().get(), 500),
                new FluidStack(FluidName.fluidmutagen.getInstance().get()
                        , 500)
        );
    ...
    public IMultiTileBlock getTeBlock() {
        return BlockBaseMachine3.genetic_stabilizer;
    }

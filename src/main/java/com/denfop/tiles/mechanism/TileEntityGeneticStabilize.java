...
public class TileEntityGeneticStabilize extends TileElectricMachine implements
    ...
    public TileEntityGeneticStabilize() {
        super(200, 1, 1);
    ...
    public ContainerGeneticStabilizer getGuiContainer(final EntityPlayer var1) {
    ...
    public GuiScreen getGui(final EntityPlayer var1, final boolean var2) {
        ...
        return new GuiGeneticStabilizer(getGuiContainer(var1));
    }

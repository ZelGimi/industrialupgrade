...
public class TileEntityReverseTransriptor extends TileElectricMachine implements IUpgradableBlock, IHasRecipe {
    ...
    public IMultiTileBlock getTeBlock() {
        return BlockBaseMachine3.reverse_transcriptor;
    }

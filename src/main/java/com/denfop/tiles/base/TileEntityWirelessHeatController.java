...
public class TileEntityWirelessHeatController extends TileEntityInventory implements IUpdatableTileEvent {
    ...
    public TileEntityWirelessHeatController() {
    ...
    @Override
    public ContainerWirelessControllerHeatReactors getGuiContainer(final EntityPlayer var1) {
    ...
    public GuiScreen getGui(final EntityPlayer var1, final boolean var2) {
        return new GuiWirelessControllerHeatReactors(getGuiContainer(var1));
    }

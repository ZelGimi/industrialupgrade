...
public class TileEntityRefrigeratorFluids extends TileElectricMachine implements IUpgradableBlock, IHasRecipe {
    ...
    public IMultiTileBlock getTeBlock() {
        return BlockBaseMachine3.refrigerator_fluids;
    }

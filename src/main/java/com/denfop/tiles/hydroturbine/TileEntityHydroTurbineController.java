...
public class TileEntityHydroTurbineController extends TileMultiBlockBase implements IWindMechanism, IType,
    ...
    @Override
    public ContainerHydroTurbineController getGuiContainer(final EntityPlayer entityPlayer) {
    ...
    public GuiScreen getGui(final EntityPlayer entityPlayer, final boolean b) {
        return new GuiHydroTurbineController(getGuiContainer(entityPlayer));

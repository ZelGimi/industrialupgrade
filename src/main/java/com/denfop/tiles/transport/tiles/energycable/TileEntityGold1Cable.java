...
public class TileEntityGold1Cable extends TileEntityCable {
    public TileEntityGold1Cable(BlockPos pos, BlockState state) {
        super(CableType.gold1, BlockCable.gold1, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockCable.gold1;
    }

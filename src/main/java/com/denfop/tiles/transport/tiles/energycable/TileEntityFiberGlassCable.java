...
public class TileEntityFiberGlassCable extends TileEntityCable {
    public TileEntityFiberGlassCable(BlockPos pos, BlockState state) {
        super(CableType.glass_1, BlockCable.glass_1, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockCable.glass_1;
    }

...
public class TileEntityTransportPipe7 extends TileEntityItemPipes {
    public TileEntityTransportPipe7(BlockPos pos, BlockState state) {
        super(ItemType.itemcable7, BlockTransportPipe.itemcable7, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockTransportPipe.itemcable7;
    }

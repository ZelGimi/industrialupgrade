...
public class TileEntityTransportPipe24 extends TileEntityItemPipes {
    public TileEntityTransportPipe24(BlockPos pos, BlockState state) {
        super(ItemType.itemcable24, BlockTransportPipe.itemcable24, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockTransportPipe.itemcable24;
    }

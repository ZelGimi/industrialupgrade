...
public class TileEntityPipes3 extends TileEntityHeatPipes {
    public TileEntityPipes3(BlockPos pos, BlockState state) {
        super(HeatType.pipes3, BlockPipe.pipes3, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockPipe.pipes3;
    }

...
public class TileEntityGlassUniversalCable4 extends TileEntityUniversalCable {
    public TileEntityGlassUniversalCable4(BlockPos pos, BlockState state) {
        super(UniversalType.glass4, BlockUniversalCable.universal4, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockUniversalCable.universal4;
    }

...
public class TileEntityGlass4Cable extends TileEntityCable {
    public TileEntityGlass4Cable(BlockPos pos, BlockState state) {
        super(CableType.glass4, BlockCable.glass4, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockCable.glass4;
    }

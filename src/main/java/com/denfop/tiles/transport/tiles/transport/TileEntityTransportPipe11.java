...
public class TileEntityTransportPipe11 extends TileEntityItemPipes {
    public TileEntityTransportPipe11(BlockPos pos, BlockState state) {
        super(ItemType.itemcable11, BlockTransportPipe.itemcable11, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockTransportPipe.itemcable11;
    }

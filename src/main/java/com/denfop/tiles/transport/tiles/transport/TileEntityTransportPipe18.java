...
public class TileEntityTransportPipe18 extends TileEntityItemPipes {
    public TileEntityTransportPipe18(BlockPos pos, BlockState state) {
        super(ItemType.itemcable18, BlockTransportPipe.itemcable18, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockTransportPipe.itemcable18;
    }

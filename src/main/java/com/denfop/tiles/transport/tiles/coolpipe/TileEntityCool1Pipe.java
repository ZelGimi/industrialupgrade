...
public class TileEntityCool1Pipe extends TileEntityCoolPipes {
    public TileEntityCool1Pipe(BlockPos pos, BlockState state) {
        super(CoolType.cool1, BlockCoolPipe.cool1, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockCoolPipe.cool1;
    }

...
public class TileEntityTransportPipe17 extends TileEntityItemPipes {
    public TileEntityTransportPipe17(BlockPos pos, BlockState state) {
        super(ItemType.itemcable17, BlockTransportPipe.itemcable17, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockTransportPipe.itemcable17;
    }

...
public class TileEntityGlassUniversalCable8 extends TileEntityUniversalCable {
    public TileEntityGlassUniversalCable8(BlockPos pos, BlockState state) {
        super(UniversalType.glass8, BlockUniversalCable.universal8, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockUniversalCable.universal8;
    }

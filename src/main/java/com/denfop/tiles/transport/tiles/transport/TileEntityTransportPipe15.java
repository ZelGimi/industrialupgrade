...
public class TileEntityTransportPipe15 extends TileEntityItemPipes {
    public TileEntityTransportPipe15(BlockPos pos, BlockState state) {
        super(ItemType.itemcable15, BlockTransportPipe.itemcable15, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockTransportPipe.itemcable15;
    }

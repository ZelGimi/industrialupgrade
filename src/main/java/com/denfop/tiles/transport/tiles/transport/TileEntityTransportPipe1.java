...
public class TileEntityTransportPipe1 extends TileEntityItemPipes {
    public TileEntityTransportPipe1(BlockPos pos, BlockState state) {
        super(ItemType.itemcable1, BlockTransportPipe.itemcable1, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockTransportPipe.itemcable1;
    }

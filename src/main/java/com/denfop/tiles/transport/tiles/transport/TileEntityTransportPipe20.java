...
public class TileEntityTransportPipe20 extends TileEntityItemPipes {
    public TileEntityTransportPipe20(BlockPos pos, BlockState state) {
        super(ItemType.itemcable20, BlockTransportPipe.itemcable20, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockTransportPipe.itemcable20;
    }

...
public class TileEntityGlass6Cable extends TileEntityCable {
    public TileEntityGlass6Cable(BlockPos pos, BlockState state) {
        super(CableType.glass6, BlockCable.glass6, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockCable.glass6;
    }

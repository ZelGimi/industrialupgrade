...
public class TileEntityTransportPipe5 extends TileEntityItemPipes {
    public TileEntityTransportPipe5(BlockPos pos, BlockState state) {
        super(ItemType.itemcable5, BlockTransportPipe.itemcable5, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockTransportPipe.itemcable5;
    }

...
public class TileEntityGlassUniversalCable6 extends TileEntityUniversalCable {
    public TileEntityGlassUniversalCable6(BlockPos pos, BlockState state) {
        super(UniversalType.glass6, BlockUniversalCable.universal6, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockUniversalCable.universal6;
    }

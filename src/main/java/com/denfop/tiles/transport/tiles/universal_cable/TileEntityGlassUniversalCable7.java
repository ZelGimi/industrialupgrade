...
public class TileEntityGlassUniversalCable7 extends TileEntityUniversalCable {
    public TileEntityGlassUniversalCable7(BlockPos pos, BlockState state) {
        super(UniversalType.glass7, BlockUniversalCable.universal7, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockUniversalCable.universal7;
    }

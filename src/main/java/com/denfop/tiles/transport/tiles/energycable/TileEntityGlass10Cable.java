...
public class TileEntityGlass10Cable extends TileEntityCable {
    public TileEntityGlass10Cable(BlockPos pos, BlockState state) {
        super(CableType.glass10, BlockCable.glass10, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockCable.glass10;
    }

...
public class TileEntityCool4Pipe extends TileEntityCoolPipes {
    public TileEntityCool4Pipe(BlockPos pos, BlockState state) {
        super(CoolType.cool4, BlockCoolPipe.cool4, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockCoolPipe.cool4;
    }

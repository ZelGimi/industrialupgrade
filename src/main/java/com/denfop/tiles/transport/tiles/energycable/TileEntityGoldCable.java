...
public class TileEntityGoldCable extends TileEntityCable {
    public TileEntityGoldCable(BlockPos pos, BlockState state) {
        super(CableType.gold, BlockCable.gold, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockCable.gold;
    }

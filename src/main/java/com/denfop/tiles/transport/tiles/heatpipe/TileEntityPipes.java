...
public class TileEntityPipes extends TileEntityHeatPipes {
    public TileEntityPipes(BlockPos pos, BlockState state) {
        super(HeatType.pipes, BlockPipe.pipes, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockPipe.pipes;
    }

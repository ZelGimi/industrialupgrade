...
public class TileEntityBioPipe extends TileEntityMultiCable implements IConductor {
    ...
    public TileEntityBioPipe() {
        super(BioType.bpipe);
        this.cableType = BioType.bpipe;
        this.connectivity = 0;
        this.addedToEnergyNet = false;

    }

    public static TileEntityBioPipe delegate(BioType cableType) {
        return new TileEntityBioPipe(cableType);
    }

    public IMultiTileBlock getTeBlock() {
        return BlockBioPipes.bpipe;
    }

    public BlockTileEntity getBlock() {
        return IUItem.blockBioPipe;
    }
    ...
    public ItemStack getPickBlock(EntityPlayer player, RayTraceResult target) {
        return new ItemStack(IUItem.biopipes, 1, 0);
    }

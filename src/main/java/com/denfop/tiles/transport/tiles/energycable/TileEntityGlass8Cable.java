...
public class TileEntityGlass8Cable extends TileEntityCable {
    public TileEntityGlass8Cable(BlockPos pos, BlockState state) {
        super(CableType.glass8, BlockCable.glass8, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockCable.glass8;
    }

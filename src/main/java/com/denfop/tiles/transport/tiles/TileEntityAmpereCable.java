...
public class TileEntityAmpereCable extends TileEntityMultiCable implements IConductor {
    ...
    public TileEntityAmpereCable() {
        super(AmpereType.acable);
        this.cableType = AmpereType.acable;
        this.connectivity = 0;
    ...
    public IMultiTileBlock getTeBlock() {
        return BlockAmpereCable.acable;
    }

    public BlockTileEntity getBlock() {
        return IUItem.amperecableblock;
    }
    ...
    public void readFromNBT(NBTTagCompound nbt) {
        ...
        this.cableType = AmpereType.values[nbt.getByte("cableType") & 255];
    }
    ...
    public void readPacket(CustomPacketBuffer customPacketBuffer) {
        ...
        try {
            cableType = AmpereType.values[(int) DecoderHandler.decode(customPacketBuffer)];

...
public class TileEntityTransportPipe12 extends TileEntityItemPipes {
    public TileEntityTransportPipe12(BlockPos pos, BlockState state) {
        super(ItemType.itemcable12, BlockTransportPipe.itemcable12, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockTransportPipe.itemcable12;
    }

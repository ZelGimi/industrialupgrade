...
public class TileEntityTransportPipe19 extends TileEntityItemPipes {
    public TileEntityTransportPipe19(BlockPos pos, BlockState state) {
        super(ItemType.itemcable19, BlockTransportPipe.itemcable19, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockTransportPipe.itemcable19;
    }

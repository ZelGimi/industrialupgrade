...
public class TileEntityTransportPipe10 extends TileEntityItemPipes {
    public TileEntityTransportPipe10(BlockPos pos, BlockState state) {
        super(ItemType.itemcable10, BlockTransportPipe.itemcable10, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockTransportPipe.itemcable10;
    }

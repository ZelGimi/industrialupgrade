...
public class TileEntityTransportPipe8 extends TileEntityItemPipes {
    public TileEntityTransportPipe8(BlockPos pos, BlockState state) {
        super(ItemType.itemcable8, BlockTransportPipe.itemcable8, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockTransportPipe.itemcable8;
    }

...
public class TileEntityGlass9Cable extends TileEntityCable {
    public TileEntityGlass9Cable(BlockPos pos, BlockState state) {
        super(CableType.glass9, BlockCable.glass9, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockCable.glass9;
    }

...
public class TileEntityIronCable extends TileEntityCable {
    public TileEntityIronCable(BlockPos pos, BlockState state) {
        super(CableType.iron, BlockCable.iron, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockCable.iron;
    }

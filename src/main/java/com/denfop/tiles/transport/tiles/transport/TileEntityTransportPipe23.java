...
public class TileEntityTransportPipe23 extends TileEntityItemPipes {
    public TileEntityTransportPipe23(BlockPos pos, BlockState state) {
        super(ItemType.itemcable23, BlockTransportPipe.itemcable23, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockTransportPipe.itemcable23;
    }

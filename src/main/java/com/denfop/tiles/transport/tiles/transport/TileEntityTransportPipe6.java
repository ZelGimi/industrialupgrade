...
public class TileEntityTransportPipe6 extends TileEntityItemPipes {
    public TileEntityTransportPipe6(BlockPos pos, BlockState state) {
        super(ItemType.itemcable6, BlockTransportPipe.itemcable6, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockTransportPipe.itemcable6;
    }

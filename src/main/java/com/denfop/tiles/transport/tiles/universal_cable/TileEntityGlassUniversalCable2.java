...
public class TileEntityGlassUniversalCable2 extends TileEntityUniversalCable {
    public TileEntityGlassUniversalCable2(BlockPos pos, BlockState state) {
        super(UniversalType.glass2, BlockUniversalCable.universal2, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockUniversalCable.universal2;
    }

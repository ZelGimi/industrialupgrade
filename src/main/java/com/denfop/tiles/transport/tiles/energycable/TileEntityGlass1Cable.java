...
public class TileEntityGlass1Cable extends TileEntityCable {
    public TileEntityGlass1Cable(BlockPos pos, BlockState state) {
        super(CableType.glass1, BlockCable.glass1, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockCable.glass1;
    }

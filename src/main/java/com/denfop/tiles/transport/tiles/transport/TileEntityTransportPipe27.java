...
public class TileEntityTransportPipe27 extends TileEntityItemPipes {
    public TileEntityTransportPipe27(BlockPos pos, BlockState state) {
        super(ItemType.itemcable27, BlockTransportPipe.itemcable27, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockTransportPipe.itemcable27;
    }

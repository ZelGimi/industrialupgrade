...
public class TileEntityTransportPipe9 extends TileEntityItemPipes {
    public TileEntityTransportPipe9(BlockPos pos, BlockState state) {
        super(ItemType.itemcable9, BlockTransportPipe.itemcable9, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockTransportPipe.itemcable9;
    }

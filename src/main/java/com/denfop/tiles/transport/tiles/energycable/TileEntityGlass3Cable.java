...
public class TileEntityGlass3Cable extends TileEntityCable {
    public TileEntityGlass3Cable(BlockPos pos, BlockState state) {
        super(CableType.glass3, BlockCable.glass3, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockCable.glass3;
    }

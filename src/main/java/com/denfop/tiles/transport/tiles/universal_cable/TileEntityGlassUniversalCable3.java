...
public class TileEntityGlassUniversalCable3 extends TileEntityUniversalCable {
    public TileEntityGlassUniversalCable3(BlockPos pos, BlockState state) {
        super(UniversalType.glass3, BlockUniversalCable.universal3, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockUniversalCable.universal3;
    }

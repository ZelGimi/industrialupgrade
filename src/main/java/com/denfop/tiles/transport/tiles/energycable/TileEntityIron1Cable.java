...
public class TileEntityIron1Cable extends TileEntityCable {
    public TileEntityIron1Cable(BlockPos pos, BlockState state) {
        super(CableType.iron1, BlockCable.iron1, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockCable.iron1;
    }

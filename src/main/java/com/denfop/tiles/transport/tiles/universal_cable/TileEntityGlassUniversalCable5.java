...
public class TileEntityGlassUniversalCable5 extends TileEntityUniversalCable {
    public TileEntityGlassUniversalCable5(BlockPos pos, BlockState state) {
        super(UniversalType.glass5, BlockUniversalCable.universal5, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockUniversalCable.universal5;
    }

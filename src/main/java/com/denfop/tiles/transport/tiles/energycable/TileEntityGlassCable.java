...
public class TileEntityGlassCable extends TileEntityCable {
    public TileEntityGlassCable(BlockPos pos, BlockState state) {
        super(CableType.glass, BlockCable.glass, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockCable.glass;
    }

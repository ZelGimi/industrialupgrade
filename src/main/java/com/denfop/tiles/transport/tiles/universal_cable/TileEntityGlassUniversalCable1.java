...
public class TileEntityGlassUniversalCable1 extends TileEntityUniversalCable {
    public TileEntityGlassUniversalCable1(BlockPos pos, BlockState state) {
        super(UniversalType.glass1, BlockUniversalCable.universal1, pos, state);
    }

    @Override
    public IMultiTileBlock getTeBlock() {
        return BlockUniversalCable.universal1;
    }

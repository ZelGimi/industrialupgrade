...
public final class AbilityHudOverlay implements IGuiOverlay {
    ...
    public void render(
        ...
        poseStack.pushPose();
        poseStack.translate(baseX, baseY, 0.0F);
        poseStack.scale(scale, scale, 1.0F);

        drawPanelShadow(poseStack, 0, 0, PANEL_WIDTH, PANEL_HEIGHT);
        drawPanel(poseStack, 0, 0, PANEL_WIDTH, PANEL_HEIGHT, accentDark, accentSoft, accent, slowPulse);
        drawHeader(poseStack, 0, 0, PANEL_WIDTH, title, subtitle, statusText, statusColor);

        final int slotX = SLOT_X_OFFSET;
        final int slotY = SLOT_Y_OFFSET;
        drawSlot(poseStack, slotX, slotY, SLOT_SIZE, accent, type.getPanelColor(), pulse);
        ...
        drawInfoBlock(poseStack, INFO_X_OFFSET, INFO_Y_OFFSET, cooldownText, accent, lowFood, readyText);
    ...
    private static void renderGuiItem(final ItemStack stack, final int x, final int y) {
        final Minecraft mc = Minecraft.getInstance();
    ...
    private static void drawPanelShadow(final PoseStack poseStack, final int x, final int y, final int w, final int h) {
        fillRect(poseStack, x - 7, y - 7, x + w + 7, y + h + 7, 0x18000000);
        fillRect(poseStack, x - 4, y - 4, x + w + 4, y + h + 4, 0x26000000);
        fillRect(poseStack, x - 2, y - 2, x + w + 2, y + h + 2, 0x36000000);
    }
    ...
    private static void drawPanel(
        ...
        fillRect(poseStack, x, y, x + w, y + h, 0xEE0A0F15);
        fillRect(poseStack, x + 1, y + 1, x + w - 1, y + h - 1, 0xF0121922);
        fillRect(poseStack, x + 2, y + 2, x + w - 2, y + h - 2, 0xF017202B);

        fillRect(poseStack, x, y, x + w, y + 2, accentSoft);
        fillRect(poseStack, x, y, x + 2, y + h, accentDark);
        fillRect(poseStack, x + w - 2, y, x + w, y + h, 0xCC10161D);
        fillRect(poseStack, x, y + h - 2, x + w, y + h, 0xCC0A0F14);

        fillRect(poseStack, x + 8, y + 27, x + w - 8, y + 28, withScaledAlpha(accent, 0.25F + 0.08F * pulse));

        drawCorner(poseStack, x + 4, y + 4, accentSoft);
        drawCorner(poseStack, x + w - 9, y + 4, accentSoft);
        drawCorner(poseStack, x + 4, y + h - 9, accentDark);
        drawCorner(poseStack, x + w - 9, y + h - 9, accentDark);
    }
    ...
    private static void drawHeader(
        ...
        fillRect(poseStack, badgeX, badgeY, badgeX + badgeWidth, badgeY + badgeHeight, 0xCC0E151D);

        fillRect(poseStack, badgeX, badgeY, badgeX + badgeWidth, badgeY + 1, statusColor);
        fillRect(poseStack, badgeX, badgeY + badgeHeight - 1, badgeX + badgeWidth, badgeY + badgeHeight, statusColor);
        fillRect(poseStack, badgeX, badgeY, badgeX + 1, badgeY + badgeHeight, statusColor);
        fillRect(poseStack, badgeX + badgeWidth - 1, badgeY, badgeX + badgeWidth, badgeY + badgeHeight, statusColor);
        ...
        drawScaledCenteredText(poseStack, statusText, badgeX + 2, badgeY + 3, badgeWidth - 4, 0xFFF3F8FD);
        ...
        drawScaledLeftText(poseStack, title, titleX, titleY, maxTextWidth, 0xFFF1F6FB);
        drawScaledLeftText(poseStack, subtitle, titleX, subtitleY, maxTextWidth, 0xFF93A6B8);
    }
    ...
    private static void drawInfoBlock(
        ...
        drawScaledLeftText(poseStack, tr("iu.ability.label.cooldown"), x, y, 56, 0xFF97A5B7);
        drawScaledLeftText(poseStack, cooldownText, x + 58, y, 56, cooldownText.equals(readyText) ? accent : 0xFFF2D39A);

        drawScaledLeftText(poseStack, tr("iu.ability.label.food"), x, y + 14, 56, 0xFF97A5B7);
        drawScaledLeftText(poseStack, tr("iu.ability.label.food_range"), x + 58, y + 14, 56, lowFood ? 0xFFFF8B8B : 0xFFE9EEF5);

        drawScaledLeftText(poseStack, tr("iu.ability.label.key"), x, y + 28, 56, 0xFF97A5B7);
        drawScaledLeftText(poseStack, tr("iu.ability.label.activate_key"), x + 58, y + 28, 56, accent);
    }
    ...
    private static void drawSlot(
        ...
        fillRect(poseStack, x - 2, y - 2, x + size + 2, y + size + 2, 0xAA05080C);
        fillRect(poseStack, x - 1, y - 1, x + size + 1, y + size + 1, withScaledAlpha(accent, 0.35F));
        fillRect(poseStack, x, y, x + size, y + size, 0xE010151C);
        fillRect(poseStack, x + 2, y + 2, x + size - 2, y + size - 2, innerColor);
        fillRect(poseStack, x + 2, y + size - 4, x + size - 2, y + size - 2, 0x66060A10);
    }
    ...
    private static void drawBottomStatusStrip(
        ...
        fillRect(poseStack, x, y, x + width, y + height, fillColor);
        fillRect(poseStack, x, y, x + width, y + 1, borderColor);
        fillRect(poseStack, x, y + height - 1, x + width, y + height, borderColor);
        fillRect(poseStack, x, y, x + 1, y + height, borderColor);
        fillRect(poseStack, x + width - 1, y, x + width, y + height, borderColor);
        ...
        drawScaledLeftText(poseStack, text, x + 4, y + 3, width - 8, textColor);
    }
    ...
    private static void drawSegmentedBar(
        ...
        fillRect(poseStack, x - 1, y - 1, x + w + 1, y + h + 1, 0xAA04070B);
        fillRect(poseStack, x, y, x + w, y + h, 0xEE111922);
        ...
        for (int i = 0; i < segments; i++) {
            ...
            fillRect(poseStack, sx, y + 1, ex, y + h - 1, 0xCC091018);
            ...
            if (part > 0.0F) {
                ...
                fillRect(poseStack, sx, y + 1, sx + fillWidth, y + h - 1, fillColor);
                fillRect(poseStack, sx, y + 1, Math.min(ex, sx + fillWidth), y + 2, withScaledAlpha(0xFFFFFFFF, 0.18F));
            }
    ...
    private static void drawCooldownShade(
        ...
        buffer.vertex(matrix, centerX, centerY, 0.0F).color(r, g, b, a).endVertex();
        ...
        for (int i = 0; i <= segments; i++) {
            ...
            buffer.vertex(matrix, px, py, 0.0F).color(r, g, b, a).endVertex();
        }
    ...
    private static void drawRingArc(
        ...
        for (int i = 0; i <= segments; i++) {
            ...
            buffer.vertex(matrix, centerX + cos * outerRadius, centerY + sin * outerRadius, 0.0F).color(r, g, b, a).endVertex();
            buffer.vertex(matrix, centerX + cos * innerRadius, centerY + sin * innerRadius, 0.0F).color(r, g, b, a).endVertex();
        }
    ...
    private static void drawCorner(final PoseStack poseStack, final int x, final int y, final int color) {
        fillRect(poseStack, x, y, x + 4, y + 1, color);
        fillRect(poseStack, x, y, x + 1, y + 4, color);
    }
    ...
    private static void drawScaledLeftText(
        ...
        poseStack.scale(scale, scale, 1.0F);
        mc.font.draw(poseStack, text, 0, 0, color);
        poseStack.popPose();
    }
    ...
    private static void drawScaledCenteredText(
        ...
        if (textWidth <= maxWidth || textWidth <= 0) {
            ...
            mc.font.draw(poseStack, text, drawX, y, color);
            return;
        }
        ...
        poseStack.pushPose();
        poseStack.translate(drawX, y, 0.0F);
        poseStack.scale(scale, scale, 1.0F);
        mc.font.draw(poseStack, text, 0, 0, color);
        poseStack.popPose();
    }
    ...
    private static void fillRect(final PoseStack poseStack, final int x1, final int y1, final int x2, final int y2, final int color) {

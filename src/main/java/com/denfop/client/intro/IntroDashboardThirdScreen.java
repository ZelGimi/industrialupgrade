...
public class IntroDashboardThirdScreen extends Screen {
    ...
    public void render(PoseStack poseStack, int mouseX, int mouseY, float partialTick) {
        ...
        if (tooltip != null) renderComponentTooltip(poseStack, tooltip, mouseX, mouseY);
    }

    private void renderHeader(IntroGuiGraphics guiGraphics, Layout l) {
    ...
    private List<Component> renderPartnersPanel(IntroGuiGraphics guiGraphics, Rect panel, int mouseX, int mouseY) {
    ...
    private void renderPartnerBannerSlide(IntroGuiGraphics guiGraphics, IntroExternalBanner banner, Rect viewport, float alpha) {
    ...
    private List<Component> renderVersionPanel(IntroGuiGraphics guiGraphics, Rect panel, int mouseX, int mouseY) {
        IntroDrawUtil.drawPanel(guiGraphics, panel.x(), panel.y(), panel.w(), panel.h(), PANEL_FILL, PANEL_BORDER);
    ...
    private List<Component> renderSupportPanel(IntroGuiGraphics guiGraphics, Rect panel, int mouseX, int mouseY) {
        IntroDrawUtil.drawPanel(guiGraphics, panel.x(), panel.y(), panel.w(), panel.h(), PANEL_FILL, PANEL_BORDER);
    ...
    private List<Component> renderRecommendedModsPanel(IntroGuiGraphics guiGraphics, Rect panel, int mouseX, int mouseY) {
        IntroDrawUtil.drawPanel(guiGraphics, panel.x(), panel.y(), panel.w(), panel.h(), PANEL_FILL, PANEL_BORDER);
    ...
    private void renderSupportScrollbar(IntroGuiGraphics guiGraphics, Rect panel) {
    ...
    private void drawPartnerArrowButton(IntroGuiGraphics guiGraphics, Rect rect, String label, boolean hovered) {
    ...
    private void renderHorizontalScrollbar(IntroGuiGraphics guiGraphics, Rect panel, int scroll, int contentWidth) {
        int viewW = panel.w() - 12;
    ...
    private void drawStatusBadge(IntroGuiGraphics guiGraphics, int x, int y, int w, String label, int fillColor) {
        int h = 12;

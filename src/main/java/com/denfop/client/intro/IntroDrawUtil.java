...
public final class IntroDrawUtil {
    ...
    public static void drawPanel(IntroGuiGraphics guiGraphics, int x, int y, int width, int height, int fillColor, int borderColor) {
    ...
    public static void drawGeneratedBadge(IntroGuiGraphics guiGraphics, Font font, String label, int x, int y, int size) {

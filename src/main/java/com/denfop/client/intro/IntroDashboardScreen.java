...
public class IntroDashboardScreen extends Screen {
    ...
    public void render(PoseStack poseStack, int mouseX, int mouseY, float partialTick) {
        ...
        if (rightTooltip != null) {
            renderComponentTooltip(poseStack, rightTooltip, mouseX, mouseY);
        } else if (partnerTooltip != null) {
            renderComponentTooltip(poseStack, partnerTooltip, mouseX, mouseY);
        }
    }

    private void renderFrame(IntroGuiGraphics guiGraphics, Layout l) {
    ...
    private void drawNavButton(IntroGuiGraphics guiGraphics, int x, int y, int w, int h, String label, boolean active) {
    ...
    private void renderTopLeftLogo(IntroGuiGraphics guiGraphics, Layout l) {
        int iconSize = 48;
    ...
    private List<Component> renderPartners(IntroGuiGraphics guiGraphics, Layout l, int mouseX, int mouseY) {
    ...
    private void renderContentPanel(IntroGuiGraphics guiGraphics, Layout l, int mouseX, int mouseY, float partialTick) {
    ...
    private void renderMainContentScrollbar(IntroGuiGraphics guiGraphics, Layout l) {
    ...
    private List<Component> renderRightPanel(IntroGuiGraphics guiGraphics, Layout l, int mouseX, int mouseY) {
    ...
    private List<Component> renderTeamSection(IntroGuiGraphics guiGraphics, ScrollSection section, int mouseX, int mouseY) {
    ...
    private List<Component> renderAddonIconsSection(IntroGuiGraphics guiGraphics, ScrollSection section, int mouseX, int mouseY) {
        IntroDrawUtil.drawPanel(guiGraphics, section.panelX(), section.panelY(), section.panelW(), section.panelH(), 0xFF101923, 0xFF2E4158);
        int panelCenterX = section.panelX() + section.panelW() / 2;
    ...
    private void renderVersionChangelogSection(IntroGuiGraphics guiGraphics, ScrollSection section) {
        IntroDrawUtil.drawPanel(guiGraphics, section.panelX(), section.panelY(), section.panelW(), section.panelH(), 0xFF101923, 0xFF2E4158);
    ...
    private void renderSectionScrollbar(IntroGuiGraphics guiGraphics, ScrollSection section, int scroll, int contentHeight) {
    ...
    private void renderPartnerScrollbar(IntroGuiGraphics guiGraphics, int trackX, int trackY, int trackW, int trackH, int contentHeight) {
    ...
    private void drawLabelBadge(IntroGuiGraphics guiGraphics, int centerX, int badgeY, int maxWidth, String label, int fillColor, float textScale) {

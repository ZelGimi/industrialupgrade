...
public class BlockEntitySimpleController extends BlockEntityMainController {
    ...
    public BlockEntitySimpleController(BlockPos pos, BlockState state) {
        super(InitMultiBlockSystem.WaterReactorMultiBlock, EnumFluidReactors.S, BlockWaterReactorsEntity.water_controller, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockWaterReactorsEntity.water_controller;
    }

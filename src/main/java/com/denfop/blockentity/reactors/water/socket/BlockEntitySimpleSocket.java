...
public class BlockEntitySimpleSocket extends BlockEntityMainSocket {
    ...
    public BlockEntitySimpleSocket(BlockPos pos, BlockState state) {
        super(ModConfig.mechanismInt("liquid_reactor_socket_capacity", 10000), BlockWaterReactorsEntity.water_socket, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockWaterReactorsEntity.water_socket;
    }

...
public class BlockEntityPerController extends BlockEntityMainController {
    ...
    public BlockEntityPerController(BlockPos pos, BlockState state) {
        super(InitMultiBlockSystem.PerWaterReactorMultiBlock, EnumFluidReactors.P, BlockWaterReactorsEntity.water_per_controller, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockWaterReactorsEntity.water_per_controller;
    }

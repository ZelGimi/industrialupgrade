...
public class BlockEntitySimpleSecurity extends BlockEntityMultiBlockElement implements ISecurity {
    ...
    public BlockEntitySimpleSecurity(BlockPos pos, BlockState state) {
        super(BlockWaterReactorsEntity.water_security, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockWaterReactorsEntity.water_security;
    }

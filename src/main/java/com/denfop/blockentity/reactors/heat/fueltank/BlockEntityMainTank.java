...
import com.denfop.blockentity.reactors.heat.ITank;
import com.denfop.componets.Fluids;
import com.denfop.containermenu.ContainerMenuBase;
import com.denfop.containermenu.ContainerMenuHeatTank;
import com.denfop.screen.ScreenHeatMainTank;
...
public class BlockEntityMainTank extends BlockEntityMultiBlockElement implements ITank {
    ...
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player var1, ContainerMenuBase<? extends CustomWorldContainer> menu) {
        return new ScreenHeatMainTank((ContainerMenuHeatTank) menu);
    }

    @Override
    public ContainerMenuHeatTank getGuiContainer(final Player var1) {
        return new ContainerMenuHeatTank(this, var1);
    }

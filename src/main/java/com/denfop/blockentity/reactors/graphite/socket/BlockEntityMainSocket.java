...
import com.denfop.blockentity.reactors.graphite.ISocket;
import com.denfop.componets.Energy;
import com.denfop.containermenu.ContainerMenuBase;
import com.denfop.containermenu.ContainerMenuGraphiteSocket;
import com.denfop.screen.ScreenGraphiteSocket;
...
public class BlockEntityMainSocket extends BlockEntityMultiBlockElement implements ISocket {
    ...
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player var1, ContainerMenuBase<? extends CustomWorldContainer> menu) {
        ...
        return new ScreenGraphiteSocket((ContainerMenuGraphiteSocket) menu);
    }

    @Override
    public ContainerMenuGraphiteSocket getGuiContainer(final Player var1) {
        return new ContainerMenuGraphiteSocket(this, var1);
    }

...
public class BlockEntityEntityAerSolidMatter extends BlockEntityMatterGenerator {

    static final ItemStack itemstack = new ItemStack(IUItem.matter.getStack(7));

    public BlockEntityEntityAerSolidMatter(BlockPos pos, BlockState state) {
        super(itemstack, "GenAer_matter.name", BlockSolidMatterEntity.aer_solidmatter, pos, state);


    }

    public MultiBlockEntity getTeBlock() {
        return BlockSolidMatterEntity.aer_solidmatter;
    }

...
public class BlockEntityEntityEndSolidMatter extends BlockEntityMatterGenerator {

    static final ItemStack itemstack = new ItemStack(IUItem.matter.getStack(6));

    public BlockEntityEntityEndSolidMatter(BlockPos pos, BlockState state) {
        super(itemstack, "GenEnd_matter.name", BlockSolidMatterEntity.end_solidmatter, pos, state);


    }

    public MultiBlockEntity getTeBlock() {
        return BlockSolidMatterEntity.end_solidmatter;
    }

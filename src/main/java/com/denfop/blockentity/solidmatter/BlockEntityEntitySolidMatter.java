...
public class BlockEntityEntitySolidMatter extends BlockEntityMatterGenerator {

    static final ItemStack itemstack = new ItemStack(IUItem.matter.getStack(0));

    public BlockEntityEntitySolidMatter(BlockPos pos, BlockState state) {
        super(itemstack, "GenMatter_matter.name", BlockSolidMatterEntity.solidmatter, pos, state);


    }

    public MultiBlockEntity getTeBlock() {
        return BlockSolidMatterEntity.solidmatter;
    }

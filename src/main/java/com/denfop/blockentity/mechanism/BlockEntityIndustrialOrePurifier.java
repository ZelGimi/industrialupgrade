...
import com.denfop.screen.ScreenIndustrialOrePurifier;
...
public class BlockEntityIndustrialOrePurifier extends BlockEntityElectricMachine implements
    ...
    public ContainerMenuIndustrialOrePurifier getGuiContainer(final Player var1) {
        return new ContainerMenuIndustrialOrePurifier(var1, this);
    ...
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player var1, ContainerMenuBase<? extends CustomWorldContainer> menu) {
        ...
        return new ScreenIndustrialOrePurifier((ContainerMenuIndustrialOrePurifier) menu);
    }
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.industrial_ore_purifier;
    }

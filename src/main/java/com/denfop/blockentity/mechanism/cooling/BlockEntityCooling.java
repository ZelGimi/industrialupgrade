...
public class BlockEntityCooling extends BlockEntityElectricMachine implements IUpdatableTileEvent {
    ...
    @Override
    public ContainerMenuCoolMachine getGuiContainer(final Player entityPlayer) {

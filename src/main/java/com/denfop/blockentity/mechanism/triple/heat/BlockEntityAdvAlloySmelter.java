...
import com.denfop.screen.ScreenAdvAlloySmelter;
...
public class BlockEntityAdvAlloySmelter extends BlockEntityTripleElectricMachine implements IHasRecipe, IType {
        ...
        this.input_slot = new Inventory(this, Inventory.TypeItemSlot.INPUT, 1) {
            ...
            public ItemStack set(final int index, final ItemStack content) {
                ...
                if (this.get(0).isEmpty()) {
                    ((BlockEntityAdvAlloySmelter) this.base).inputSlotA.changeAccepts(ItemStack.EMPTY);
                } else {
                    ((BlockEntityAdvAlloySmelter) this.base).inputSlotA.changeAccepts(this.get(0));
                }
                return content;
            }
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine1Entity.adv_alloy_smelter;
    }
    ...
    public void init() {
        ...
        addAlloysmelter("forge:ingots/Aluminium",
                "forge:ingots/vanadium", "forge:ingots/Cobalt",
    ...
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player entityPlayer, ContainerMenuBase<? extends CustomWorldContainer> isAdmin) {
        return new ScreenAdvAlloySmelter((ContainerMenuTripleElectricMachine) isAdmin);
    }

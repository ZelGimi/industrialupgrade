...
import com.denfop.screen.ScreenGenStone;
...
public abstract class BlockEntityBaseGenStone extends BlockEntityElectricMachine implements
        BlockEntityUpgrade, IUpdateTick, IUpdatableTileEvent {
    ...
    public BlockEntityBaseGenStone(int energyPerTick, int length, int outputSlots, MultiBlockEntity multiTileBlock, BlockPos pos, BlockState state) {
    ...
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player entityPlayer, ContainerMenuBase<? extends CustomWorldContainer> menu) {
        return new ScreenGenStone((ContainerMenuGenStone) menu);
    }
    ...
    public ContainerMenuGenStone getGuiContainer(Player entityPlayer) {
        return new ContainerMenuGenStone(entityPlayer, this);
    }

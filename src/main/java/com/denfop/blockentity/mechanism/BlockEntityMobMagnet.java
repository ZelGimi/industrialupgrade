...
public class BlockEntityMobMagnet extends BlockEntityInventory {

    private final Energy energy;

    public BlockEntityMobMagnet(BlockPos pos, BlockState state) {
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.mob_magnet;
    }

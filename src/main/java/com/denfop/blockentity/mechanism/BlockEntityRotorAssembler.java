...
import com.denfop.screen.ScreenRotorAssembler;
...
public class BlockEntityRotorAssembler extends BlockEntityInventory implements IUpdateTick, IHasRecipe {
    ...
    public BlockEntityRotorAssembler(BlockPos pos, BlockState state) {
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.rotor_assembler;
    }
    ...
    @Override
    public ContainerMenuRotorAssembler getGuiContainer(final Player entityPlayer) {
        return new ContainerMenuRotorAssembler(this, entityPlayer);
    }
    ...
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player var1, ContainerMenuBase<? extends CustomWorldContainer> menu) {
        ...
        return new ScreenRotorAssembler((ContainerMenuRotorAssembler) menu);
    }

...
public class BlockEntityUpgradeMachineFactory extends BlockEntityElectricMachine implements
    ...
    @Override
    public ContainerMenuUpgradeMachineFactory getGuiContainer(final Player var1) {

...
import com.denfop.containermenu.ContainerMenuOilPurifier;
...
import com.denfop.screen.ScreenOilPurifier;
...
public class BlockEntityOilPurifier extends BlockEntityElectricMachine implements BlockEntityUpgrade, IHasRecipe {
    ...
    public BlockEntityOilPurifier(BlockPos pos, BlockState state) {
        ...
        this.fluid_handler = new FluidHandlerRecipe("oil_purifier", fluids);
    ...
    public void init() {
        Recipes.recipes.getRecipeFluid().addRecipe("oil_purifier", new BaseFluidMachineRecipe(new InputFluid(
                ...
                Collections.singletonList(new FluidStack(FluidName.fluidpetroleum.getInstance().get(), 225))
        ));
        Recipes.recipes.getRecipeFluid().addRecipe("oil_purifier", new BaseFluidMachineRecipe(new InputFluid(
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.oil_purifier;
    }
    ...
    public ContainerMenuOilPurifier getGuiContainer(Player entityPlayer) {
        return new ContainerMenuOilPurifier(entityPlayer, this);
    }

    @Override
    @OnlyIn(Dist.CLIENT)
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player var1, ContainerMenuBase<? extends CustomWorldContainer> menu) {
        return new ScreenOilPurifier((ContainerMenuOilPurifier) menu);
    }

...
public class BlockEntityRodManufacturer extends BlockEntityInventory implements BlockEntityUpgrade, IUpdateTick,
        IHasRecipe {
        ...
        this.input_slot = new Inventory(this, Inventory.TypeItemSlot.INPUT, 1) {
            ...
            public ItemStack set(final int index, final ItemStack content) {
                ...
                if (this.get(0).isEmpty()) {
                    ((BlockEntityRodManufacturer) this.base).inputSlotA.changeAccepts(ItemStack.EMPTY);
                } else {
    ...
    @Override
    public ContainerMenuRodManufacturer getGuiContainer(final Player entityPlayer) {

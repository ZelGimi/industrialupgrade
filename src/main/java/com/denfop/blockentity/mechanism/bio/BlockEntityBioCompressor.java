...
public class BlockEntityBioCompressor extends BlockEntityBioMultiMachine {


    public BlockEntityBioCompressor(BlockPos pos, BlockState state) {
        super(
                EnumMultiMachine.COMPRESSER.usagePerTick,
                EnumMultiMachine.COMPRESSER.lenghtOperation,
                4, BlockBaseMachine3Entity.bio_compressor, pos, state
        );
    }

    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.bio_compressor;
    }

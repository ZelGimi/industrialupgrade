...
public class BlockEntityBioCutting extends BlockEntityBioMultiMachine {


    public BlockEntityBioCutting(BlockPos pos, BlockState state) {
        super(
                EnumMultiMachine.Cutting.usagePerTick,
                EnumMultiMachine.Cutting.lenghtOperation,
                4, BlockBaseMachine3Entity.bio_cutting, pos, state
        );
    }

    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.bio_cutting;
    }

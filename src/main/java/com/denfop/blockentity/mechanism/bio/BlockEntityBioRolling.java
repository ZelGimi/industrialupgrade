...
public class BlockEntityBioRolling extends BlockEntityBioMultiMachine {


    public BlockEntityBioRolling(BlockPos pos, BlockState state) {
        super(
                EnumMultiMachine.Rolling.usagePerTick,
                EnumMultiMachine.Rolling.lenghtOperation,
                4, BlockBaseMachine3Entity.bio_rolling, pos, state
        );
    }

    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.bio_rolling;
    }

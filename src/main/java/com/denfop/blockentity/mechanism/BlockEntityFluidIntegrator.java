...
import com.denfop.screen.ScreenFluidIntegrator;
...
public class BlockEntityFluidIntegrator extends BlockEntityElectricMachine implements
    ...
    public ContainerMenuFluidIntegrator getGuiContainer(final Player var1) {
        return new ContainerMenuFluidIntegrator(var1, this);
    ...
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player var1, ContainerMenuBase<? extends CustomWorldContainer> menu) {
        ...
        return new ScreenFluidIntegrator((ContainerMenuFluidIntegrator) menu);
    }
    ...
    public void init() {
        ...
        addRecipe(new ItemStack(IUItem.heavyore.getItem(4), 4), new ItemStack(IUItem.smalldust.getStack(22), 10),
                new FluidStack(FluidName.fluidoxygen.getInstance().get(), 1100),
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.fluid_integrator;
    }

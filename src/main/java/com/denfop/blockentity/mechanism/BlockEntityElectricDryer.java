...
import com.denfop.screen.ScreenDryer;
...
public class BlockEntityElectricDryer extends BlockEntityElectricMachine implements BlockEntityUpgrade, IHasRecipe {
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.electric_dryer;
    }
    ...
    public ContainerMenuDryer getGuiContainer(Player entityPlayer) {
        return new ContainerMenuDryer(entityPlayer, this);
    }

    @Override
    @OnlyIn(Dist.CLIENT)
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player var1, ContainerMenuBase<? extends CustomWorldContainer> menu) {
        return new ScreenDryer((ContainerMenuDryer) menu);
    }

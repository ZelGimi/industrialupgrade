...
public class BlockEntityRoverAssembler extends BlockEntityElectricMachine implements
    ...
    public BlockEntityRoverAssembler(BlockPos pos, BlockState state) {
        super(ModConfig.mechanismDouble("rover_assembler_energy_storage", 800.0D), 1, 1, BlockBaseMachine3Entity.rover_assembler, pos, state);
        ...
        this.pollutionSoil = this.addComponent(new SoilPollutionComponent(this, ModConfig.mechanismDouble("rover_assembler_soil_pollution_amount", 0.1D)));
        this.pollutionAir = this.addComponent(new AirPollutionComponent(this, ModConfig.mechanismDouble("rover_assembler_air_pollution_amount", 0.1D)));
    }

...
import com.denfop.screen.ScreenTripleSolidMixer;
...
public class BlockEntityTripleSolidMixer extends BlockEntityElectricMachine implements
    ...
    public ContainerMenuTripleSolidMixer getGuiContainer(final Player var1) {
        return new ContainerMenuTripleSolidMixer(var1, this);
    ...
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player var1, ContainerMenuBase<? extends CustomWorldContainer> menu) {
        ...
        return new ScreenTripleSolidMixer((ContainerMenuTripleSolidMixer) menu);
    }
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.triple_solid_mixer;
    }

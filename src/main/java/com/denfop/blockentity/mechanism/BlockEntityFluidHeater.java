...
import com.denfop.containermenu.ContainerMenuHeatFluids;
...
import com.denfop.screen.ScreenFluidHeater;
...
public class BlockEntityFluidHeater extends BlockEntityElectricMachine implements BlockEntityUpgrade, IHasRecipe {
    ...
    public void updateEntityServer() {
        ...
        if (this.fluid_handler.output() != null && this.heat.getEnergy() > 500 && this.fluid_handler.canOperate() && this.fluid_handler.canFillFluid() && this.energy.canUseEnergy(
                energyConsume)) {
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.fluid_heater;
    }
    ...
    public ContainerMenuHeatFluids getGuiContainer(Player entityPlayer) {
        return new ContainerMenuHeatFluids(entityPlayer, this);
    }

    @Override
    @OnlyIn(Dist.CLIENT)
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player var1, ContainerMenuBase<? extends CustomWorldContainer> menu) {
        return new ScreenFluidHeater((ContainerMenuHeatFluids) menu);
    }

...
public class BlockEntityLaserPolisher extends BlockEntityElectricMachine implements
    ...
    public void init() {
        ...
        addRecipe("c:ores/emerald", new ItemStack(Items.EMERALD, 4));
        ...
        addRecipe("c:ores/ruby", new ItemStack(IUItem.preciousgem.getStack(0), 4));
        addRecipe("c:ores/sapphire", new ItemStack(IUItem.preciousgem.getStack(1), 4));
        addRecipe("c:ores/topaz", new ItemStack(IUItem.preciousgem.getStack(2), 4));

...
import com.denfop.containermenu.ContainerMenuOilRefiner;
...
import com.denfop.screen.ScreenOilRefiner;
...
public class BlockEntityOilRefiner extends BlockEntityElectricMachine implements IManufacturerBlock, BlockEntityUpgrade, IHasRecipe {
    ...
    public BlockEntityOilRefiner(BlockPos pos, BlockState state) {
        super(ModConfig.mechanismDouble("oil_refinery_energy_storage", 24000.0D), 14, 2, BlockRefinerEntity.refiner, pos, state);
        ...
        this.pollutionSoil = this.addComponent(new SoilPollutionComponent(this, ModConfig.mechanismDouble("oil_refiner_soil_pollution_amount", 0.075D)));
        this.pollutionAir = this.addComponent(new AirPollutionComponent(this, ModConfig.mechanismDouble("oil_refiner_air_pollution_amount", 0.25D)));
    ...
    public void init() {
        Recipes.recipes.getRecipeFluid().addRecipe("oil_refiner", new BaseFluidMachineRecipe(new InputFluid(
                new FluidStack(FluidName.fluidpetroleum.getInstance().get(), 10)), Arrays.asList(
                new FluidStack(
                        FluidName.fluidgasoline.getInstance().get(),
                        8
                ), new FluidStack(FluidName.fluiddiesel.getInstance().get(), 2))));
        Recipes.recipes.getRecipeFluid().addRecipe("oil_refiner", new BaseFluidMachineRecipe(new InputFluid(
                new FluidStack(FluidName.fluidsweet_heavy_oil.getInstance().get(), 10)), Arrays.asList(
                new FluidStack(
                        FluidName.fluiddiesel.getInstance().get(),
                        8
                ), new FluidStack(FluidName.fluidgasoline.getInstance().get(), 2))));
        Recipes.recipes.getRecipeFluid().addRecipe("oil_refiner", new BaseFluidMachineRecipe(new InputFluid(
                new FluidStack(FluidName.fluidsweet_medium_oil.getInstance().get(), 10)), Arrays.asList(
                new FluidStack(
                        FluidName.fluidgasoline.getInstance().get(),
                        6
                ), new FluidStack(FluidName.fluiddiesel.getInstance().get(), 4))));
        ...
        Recipes.recipes.getRecipeFluid().addRecipe("oil_refiner", new BaseFluidMachineRecipe(new InputFluid(
                ...
                new FluidStack(
                        FluidName.fluidgasoline.getInstance().get(),
                        5
                ), new FluidStack(FluidName.fluiddiesel.getInstance().get(), 1))));
        Recipes.recipes.getRecipeFluid().addRecipe("oil_refiner", new BaseFluidMachineRecipe(new InputFluid(
                new FluidStack(FluidName.fluidsour_heavy_oil.getInstance().get(), 10)), Arrays.asList(
                new FluidStack(
                        FluidName.fluiddiesel.getInstance().get(),
                        5
                ), new FluidStack(FluidName.fluidgasoline.getInstance().get(), 1))));
        Recipes.recipes.getRecipeFluid().addRecipe("oil_refiner", new BaseFluidMachineRecipe(new InputFluid(
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockRefinerEntity.refiner;
    }
    ...
    @Override
    public ContainerMenuOilRefiner getGuiContainer(Player entityPlayer) {
        return new ContainerMenuOilRefiner(entityPlayer, this);
    ...
    public ScreenIndustrialUpgrade<ContainerMenuBase<?>> getGui(Player entityPlayer, ContainerMenuBase<?> isAdmin) {
        return new ScreenOilRefiner((ContainerMenuOilRefiner) isAdmin);
    }
    ...
    public Set<EnumBlockEntityUpgrade> getUpgradableProperties() {
        return EnumSet.of(EnumBlockEntityUpgrade.Transformer,
                ...
                EnumBlockEntityUpgrade.FluidInput, EnumBlockEntityUpgrade.ItemExtract
        );
    }

...
public class BlockEntityNetherAssembler extends BlockEntityBaseWorldCollector {

    public BlockEntityNetherAssembler(BlockPos pos, BlockState state) {
        super(EnumTypeCollector.NETHER, BlockBaseMachine3Entity.nether_assembler, pos, state);
    }
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.nether_assembler;
    }

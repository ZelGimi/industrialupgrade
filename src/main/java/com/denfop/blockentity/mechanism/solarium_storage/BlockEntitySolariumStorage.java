...
import com.denfop.screen.ScreenSolariumStorage;
...
public class BlockEntitySolariumStorage extends BlockEntityInventory implements IType {

    public final ComponentBaseEnergy se;
    private final EnumTypeStyle enumTypeStyle;

    public BlockEntitySolariumStorage(double maxStorage1, EnumTypeStyle enumTypeStyle, MultiBlockEntity block, BlockPos pos, BlockState state) {
    ...
    @Override
    public ContainerMenuSolariumStorage getGuiContainer(final Player entityPlayer) {
        return new ContainerMenuSolariumStorage(entityPlayer, this);
    }
    ...
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(final Player entityPlayer, final ContainerMenuBase<? extends CustomWorldContainer> b) {
        return new ScreenSolariumStorage((ContainerMenuSolariumStorage) b);
    }

...
public class BlockEntitySimpleSolariumStorage extends BlockEntitySolariumStorage {
    ...
    public BlockEntitySimpleSolariumStorage(BlockPos pos, BlockState state) {
        super(ModConfig.mechanismDouble("background_radiation_is_low_energy_storage", 100000.0D), EnumTypeStyle.DEFAULT, BlockBaseMachine3Entity.solarium_storage, pos, state);
    }

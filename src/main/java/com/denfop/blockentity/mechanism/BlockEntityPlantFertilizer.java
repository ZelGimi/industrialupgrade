...
import com.denfop.screen.ScreenPlantFertilizer;
...
public class BlockEntityPlantFertilizer extends BlockEntityInventory implements BlockEntityUpgrade {
    ...
    public BlockEntityPlantFertilizer(BlockPos pos, BlockState state) {
        super(BlockBaseMachine3Entity.plant_fertilizer, pos, state);
        ...
        this.pollutionSoil = this.addComponent(new SoilPollutionComponent(this, ModConfig.mechanismDouble("plant_fertilizer_soil_pollution_amount", 0.1D)));
        this.pollutionAir = this.addComponent(new AirPollutionComponent(this, ModConfig.mechanismDouble("plant_fertilizer_air_pollution_amount", 0.1D)));
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.plant_fertilizer;
    }
    ...
    @Override
    public ContainerMenuPlantFertilizer getGuiContainer(final Player var1) {
        return new ContainerMenuPlantFertilizer(this, var1);
    }
    ...
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player var1, ContainerMenuBase<? extends CustomWorldContainer> menu) {
        ...
        return new ScreenPlantFertilizer((ContainerMenuPlantFertilizer) menu);
    }

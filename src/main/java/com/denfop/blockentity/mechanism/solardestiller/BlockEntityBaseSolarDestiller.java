...
public class BlockEntityBaseSolarDestiller extends BlockEntityInventory implements BlockEntityUpgrade, IType {
    ...
    public Set<EnumBlockEntityUpgrade> getUpgradableProperties() {
        return EnumSet.of(EnumBlockEntityUpgrade.FluidInput

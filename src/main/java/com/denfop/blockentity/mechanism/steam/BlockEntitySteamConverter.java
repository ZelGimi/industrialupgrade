...
import com.denfop.containermenu.ContainerMenuSteamConverter;
...
import com.denfop.screen.ScreenSteamConverter;
...
public class BlockEntitySteamConverter extends BlockEntityElectricMachine implements IUpdatableTileEvent {
    ...
    public BlockEntitySteamConverter(BlockPos pos, BlockState state) {
        super(ModConfig.mechanismDouble("steam_converter_energy_storage", 0.0D), 0, 1, BlockBaseMachine3Entity.steam_converter, pos, state);
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.steam_converter;
    }
    ...
    @Override
    public ContainerMenuSteamConverter getGuiContainer(final Player entityPlayer) {
        return new ContainerMenuSteamConverter(entityPlayer, this);
    }

    @Override
    @OnlyIn(Dist.CLIENT)
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player var1, ContainerMenuBase<? extends CustomWorldContainer> menu) {
        return new ScreenSteamConverter((ContainerMenuSteamConverter) menu);
    }

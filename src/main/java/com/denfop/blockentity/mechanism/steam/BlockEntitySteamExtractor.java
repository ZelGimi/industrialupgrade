...
public class BlockEntitySteamExtractor extends BlockEntitySteamMultiMachine {

    private final SoilPollutionComponent pollutionSoil;
    private final AirPollutionComponent pollutionAir;

    public BlockEntitySteamExtractor(BlockPos pos, BlockState state) {
        super(
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.steam_extractor;
    }

...
import com.denfop.screen.ScreenSteamBioGenerator;
...
public class BlockEntitySteamBioGenerator extends BlockEntityElectricMachine implements IHasRecipe, IUpdateTick {
    ...
    public void updateEntityServer() {
        ...
        if (this.output != null && this.fluid_handler.output() != null && pressure.getEnergy() >= 1 && this.fluid_handler.canFillFluid() && this.steam.canUseEnergy(
                energyConsume)) {
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.steam_bio_generator;
    }
    ...
    public ContainerMenuBioGenerator getGuiContainer(Player entityPlayer) {
        return new ContainerMenuBioGenerator(entityPlayer, this);
    }
    ...
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player var1, ContainerMenuBase<? extends CustomWorldContainer> menu) {
        ...
        return new ScreenSteamBioGenerator((ContainerMenuBioGenerator) menu);
    }

...
import com.denfop.screen.ScreenSteamWireInsulator;
...
public class BlockEntitySteamWireInsulator extends BlockEntityElectricMachine implements
    ...
    public BlockEntitySteamWireInsulator(BlockPos pos, BlockState state) {
        super(ModConfig.mechanismDouble("steam_cable_insulator_energy_storage", 0.0D), 1, 1, BlockBaseMachine3Entity.steam_wire_insulator, pos, state);
        Recipes.recipes.addInitRecipes(this);

        this.progress = 0;
        this.defaultEnergyConsume = this.energyConsume = ModConfig.mechanismInt("steam_cable_insulator_energy_use", 1);
    ...
    public ContainerMenuSteamWireInsulator getGuiContainer(final Player var1) {
        return new ContainerMenuSteamWireInsulator(var1, this);
    ...
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player var1, ContainerMenuBase<? extends CustomWorldContainer> menu) {
        ...
        return new ScreenSteamWireInsulator((ContainerMenuSteamWireInsulator) menu);
    }
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.steam_wire_insulator;
    }

...
import com.denfop.containermenu.ContainerMenuSteamAmpereGenerator;
...
import com.denfop.screen.ScreenSteamAmpereGenerator;
...
public class BlockEntitySteamAmpereGenerator extends BlockEntityElectricMachine implements IUpdatableTileEvent {
    ...
    public BlockEntitySteamAmpereGenerator(BlockPos pos, BlockState state) {
        super(ModConfig.mechanismDouble("steam_current_converter_energy_storage", 0.0D), 0, 1, BlockBaseMachine3Entity.steam_ampere_generator, pos, state);
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.steam_ampere_generator;
    }
    ...
    public void updateEntityServer() {
        ...
        if (this.work) {
            ...
            if (this.steam.getEnergy() >= 2 && this.pressure.getEnergy() + 1 <= this.pressure.getCapacity()) {
    ...
    @Override
    public ContainerMenuSteamAmpereGenerator getGuiContainer(final Player entityPlayer) {
        return new ContainerMenuSteamAmpereGenerator(entityPlayer, this);
    }

    @Override
    @OnlyIn(Dist.CLIENT)
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player var1, ContainerMenuBase<? extends CustomWorldContainer> menu) {
        return new ScreenSteamAmpereGenerator((ContainerMenuSteamAmpereGenerator) menu);
    }

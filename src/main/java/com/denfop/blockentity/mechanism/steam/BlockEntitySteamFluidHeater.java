...
import com.denfop.containermenu.ContainerMenuSteamFluidHeater;
...
import com.denfop.screen.ScreenSteamFluidHeater;
...
public class BlockEntitySteamFluidHeater extends BlockEntityElectricMachine implements IUpdatableTileEvent {
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.steam_fluid_heater;
    }
    ...
    @Override
    public ContainerMenuSteamFluidHeater getGuiContainer(final Player entityPlayer) {
        return new ContainerMenuSteamFluidHeater(entityPlayer, this);
    }
    ...
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player var1, ContainerMenuBase<? extends CustomWorldContainer> menu) {
        ...
        return new ScreenSteamFluidHeater((ContainerMenuSteamFluidHeater) menu);
    }

...
import com.denfop.containermenu.ContainerMenuSteamDryer;
import com.denfop.inventory.Inventory;
import com.denfop.network.DecoderHandler;
import com.denfop.network.EncoderHandler;
import com.denfop.network.packet.CustomPacketBuffer;
import com.denfop.screen.ScreenIndustrialUpgrade;
import com.denfop.screen.ScreenSteamDryer;
...
public class BlockEntitySteamDryer extends BlockEntityElectricMachine implements IHasRecipe {
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.steamdryer;
    }
    ...
    public ContainerMenuSteamDryer getGuiContainer(Player entityPlayer) {
        return new ContainerMenuSteamDryer(entityPlayer, this);
    }

    @Override
    @OnlyIn(Dist.CLIENT)
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player var1, ContainerMenuBase<? extends CustomWorldContainer> menu) {
        return new ScreenSteamDryer((ContainerMenuSteamDryer) menu);
    }

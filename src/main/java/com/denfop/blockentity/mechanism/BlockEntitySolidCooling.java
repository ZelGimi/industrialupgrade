...
import com.denfop.screen.ScreenSolidCoolMachine;
...
public class BlockEntitySolidCooling extends BlockEntityElectricMachine implements IUpdatableTileEvent {
    ...
    public BlockEntitySolidCooling(BlockPos pos, BlockState state) {
        super(ModConfig.mechanismDouble("solid_refrigerator_energy_storage", 0.0D), 0, 1, BlockBaseMachine3Entity.solid_cooling, pos, state);
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.solid_cooling;
    }
    ...
    @Override
    public ContainerMenuSolidCoolMachine getGuiContainer(final Player entityPlayer) {
        return new ContainerMenuSolidCoolMachine(entityPlayer, this);
    }

    @Override
    @OnlyIn(Dist.CLIENT)
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player var1, ContainerMenuBase<? extends CustomWorldContainer> menu) {
        return new ScreenSolidCoolMachine((ContainerMenuSolidCoolMachine) menu);
    }

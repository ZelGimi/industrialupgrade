package com.denfop.blockentity.mechanism.steamturbine.controller;
...
import com.denfop.screen.ScreenBaseSteamTurbineController;
...
public class BlockEntityBaseSteamTurbineController extends BlockEntityMultiBlockBase implements IController, IUpdatableTileEvent {
    ...
    public BlockEntityBaseSteamTurbineController(int blocLevel, MultiBlockEntity tileBlock, BlockPos pos, BlockState state) {
    ...
    @Override
    public ContainerMenuBaseSteamTurbineController getGuiContainer(final Player var1) {
        return new ContainerMenuBaseSteamTurbineController(this, var1);
    }
    ...
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player var1, ContainerMenuBase<? extends CustomWorldContainer> menu) {
        ...
        return new ScreenBaseSteamTurbineController((ContainerMenuBaseSteamTurbineController) menu);
    }
    ...
    @Override
    @OnlyIn(Dist.CLIENT)
    public void render(final BlockEntityMultiBlockBase tileEntityMultiBlockBase, RenderLevelStageEvent event) {
    ...
    @Override
    public List<com.denfop.blockentity.mechanism.steamturbine.IRod> getInfo() {
        return iRodListMap;
    }
    ...
    public void readUpdatePacket(CustomPacketBuffer packetBuffer) {
        ...
        if (isFull) {
            iRodListMap.clear();
            for (int i = 0; i < 9; i++) {
                BlockEntityMultiBlockElement multiBlockElement = (BlockEntityMultiBlockElement) this.getWorld().getBlockEntity(packetBuffer.readBlockPos());

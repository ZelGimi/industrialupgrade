...
public class BlockEntityPrimalElectronicsAssembler extends BlockEntityElectricMachine implements IUpdateTick, IHasRecipe,
        IUpdatableTileEvent {
    ...
    public ContainerMenuElectronicsAssembler getGuiContainer(Player entityPlayer) {
        return new ContainerMenuElectronicsAssembler(
                entityPlayer, this);
    }

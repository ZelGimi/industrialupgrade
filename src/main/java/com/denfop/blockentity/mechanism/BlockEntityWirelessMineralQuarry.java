...
import com.denfop.containermenu.ContainerMenuWirelessMineralQuarry;
...
import com.denfop.screen.ScreenWirelessMineralQuarry;
...
public class BlockEntityWirelessMineralQuarry extends BlockEntityInventory implements IManufacturerBlock {
    ...
    public BlockEntityWirelessMineralQuarry(BlockPos pos, BlockState state) {
        super(BlockBaseMachine3Entity.wireless_mineral_quarry, pos, state);
    ...
    @Override
    public ContainerMenuWirelessMineralQuarry getGuiContainer(final Player var1) {
        return new ContainerMenuWirelessMineralQuarry(this, var1);
    }

    @Override
    @OnlyIn(Dist.CLIENT)
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player var1, ContainerMenuBase<? extends CustomWorldContainer> menu) {
        return new ScreenWirelessMineralQuarry((ContainerMenuWirelessMineralQuarry) menu);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.wireless_mineral_quarry;
    }

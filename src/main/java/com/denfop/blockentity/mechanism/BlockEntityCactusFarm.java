...
public class BlockEntityCactusFarm extends BlockEntityInventory implements IUpgradableBlock {
    ...
    public BlockEntityCactusFarm(BlockPos pos, BlockState state) {
        ...
        this.pollutionSoil = this.addComponent(new SoilPollutionComponent(this, ModConfig.mechanismDouble("cactus_farm_soil_pollution_amount", 0.1D)));
        this.pollutionAir = this.addComponent(new AirPollutionComponent(this, ModConfig.mechanismDouble("cactus_farm_air_pollution_amount", 0.1D)));

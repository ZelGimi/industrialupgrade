...
public class BlockEntitySaplingGardener extends BlockEntityInventory implements IUpgradableBlock {
    ...
    public BlockEntitySaplingGardener(BlockPos pos, BlockState state) {
        ...
        this.pollutionSoil = this.addComponent(new SoilPollutionComponent(this, ModConfig.mechanismDouble("sapling_gardener_soil_pollution_amount", 0.1D)));
        this.pollutionAir = this.addComponent(new AirPollutionComponent(this, ModConfig.mechanismDouble("sapling_gardener_air_pollution_amount", 0.1D)));

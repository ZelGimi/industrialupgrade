            ...
            if (!this.rotor_slot.get(0).isEmpty()) {
                for (int i = 0; i < this.slot.size(); i++) {
                    ...
                    if (!this.slot.get(i).isEmpty()) {
                        ...
                        MinecraftForge.EVENT_BUS.post(new com.denfop.api.water.upgrade.event.EventRotorItemLoad(this.getWorld(), (com.denfop.api.water.upgrade.IRotorUpgradeItem) this

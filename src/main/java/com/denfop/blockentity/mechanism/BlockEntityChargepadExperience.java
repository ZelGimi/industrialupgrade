...
public class BlockEntityChargepadExperience extends BlockEntityInventory {

    private final ComponentBaseEnergy energy;
    private Player player;

    public BlockEntityChargepadExperience(BlockPos pos, BlockState state) {
        super(BlockBaseMachine3Entity.exp_chargepad, pos, state);
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.exp_chargepad;
    }

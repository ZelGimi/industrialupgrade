...
public class BlockEntityAlloySmelter extends BlockEntityDoubleElectricMachine implements IHasRecipe {
    ...
    public void init() {
        ...
        addAlloysmelter(
                input.getInput("c:ingots/iron", 2),
        ...
        addAlloysmelter(
                input.getInput("c:ingots/steel", 2),
                input.getInput("c:ingots/titanium", 3),
        ...
        addAlloysmelter(
                ...
                input.getInput("c:ingots/Invar", 3).getInputs().get(0), 5000
        );

...
public class BlockEntityUpgradeBlock extends BlockEntityDoubleElectricMachine implements IHasRecipe {
    ...
    public BlockEntityUpgradeBlock(BlockPos pos, BlockState state) {
        ...
        this.componentProgress = this.addComponent(new ComponentProgress(this, 1, (short) 300));
            ...
            public void operateWithMax(final MachineRecipe output) {
                ...
                if (this.updateTick.getRecipeOutput().getRecipe().output.metadata.getString("type").isEmpty()) {
                    ...
                    if (module.getItem() instanceof ItemUpgradeModule) {
                        ...
                        EnumInfoUpgradeModules type =
                                ItemUpgradeModule.getType(IUItem.upgrademodule.getMeta((ItemUpgradeModule) module.getItem()));
                        ...
                        com.denfop.datacomponent.UpgradeItem upgradeItem = getUpgradeData(stack);
                        List<UpgradeItemInform> upgradeItemInformList = new ArrayList<>(upgradeItem.upgradeItemInforms());
                        ...
                        upgradeItem.updateAmount(stack, upgradeItem.amount() + 1);
                    ...
                    } else if (module.getItem() instanceof ItemQuarryModule
                            && IUItem.module9.getMeta((ItemQuarryModule) module.getItem()) == 12) {
                        ...
                        upgradeItem.updateBlackList(stack, list);
    ...
    private static com.denfop.datacomponent.UpgradeItem getUpgradeData(ItemStack stack) {
        return stack.getOrDefault(DataComponentsInit.UPGRADE_ITEM, com.denfop.datacomponent.UpgradeItem.EMPTY);
    }

...
import com.denfop.screen.ScreenWelding;
...
public class BlockEntityWeldingMachine extends BlockEntityDoubleElectricMachine implements IHasRecipe {
        ...
        this.input_slot = new Inventory(this, Inventory.TypeItemSlot.INPUT, 1) {
            ...
            public ItemStack set(final int index, final ItemStack content) {
                ...
                if (this.get(0).isEmpty()) {
                    ((BlockEntityWeldingMachine) this.base).inputSlotA.changeAccepts(ItemStack.EMPTY);
                } else {
                    ((BlockEntityWeldingMachine) this.base).inputSlotA.changeAccepts(this.get(0));
                }
                return content;
            }
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.welding;
    }
    ...
    public void init() {
        ...
        addRecipe("forge:nuggets/vanadium", "forge:ingots/vanadium",
    ...
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player var1, ContainerMenuBase<? extends CustomWorldContainer> menu) {
        return new ScreenWelding((ContainerMenuDoubleElectricMachine) menu);
    }

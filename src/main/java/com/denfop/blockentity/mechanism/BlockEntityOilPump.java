...
public class BlockEntityOilPump extends BlockEntityElectricLiquidTankInventory implements BlockEntityUpgrade, IManufacturerBlock {
    ...
    public Set<EnumBlockEntityUpgrade> getUpgradableProperties() {
        return EnumSet.of(EnumBlockEntityUpgrade.Transformer, EnumBlockEntityUpgrade.FluidExtract
        );
    }

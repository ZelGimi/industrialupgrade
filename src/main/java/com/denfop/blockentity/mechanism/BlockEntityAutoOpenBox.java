...
public class BlockEntityAutoOpenBox extends BlockEntityInventory implements BlockEntityUpgrade {
    ...
    public BlockEntityAutoOpenBox(BlockPos pos, BlockState state) {
        ...
        this.pollutionSoil = this.addComponent(new SoilPollutionComponent(this, ModConfig.mechanismDouble("box_unpacker_soil_pollution_amount", 0.1D)));
        this.pollutionAir = this.addComponent(new AirPollutionComponent(this, ModConfig.mechanismDouble("box_unpacker_air_pollution_amount", 0.1D)));
    ...
    public Set<EnumBlockEntityUpgrade> getUpgradableProperties() {
        return EnumSet.of(EnumBlockEntityUpgrade.ItemExtract, EnumBlockEntityUpgrade.ItemInput, EnumBlockEntityUpgrade.EnergyStorage,

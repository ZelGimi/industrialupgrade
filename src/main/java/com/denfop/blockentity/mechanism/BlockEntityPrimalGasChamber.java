...
public class BlockEntityPrimalGasChamber extends BlockEntityElectricMachine implements BlockEntityUpgrade, IHasRecipe {
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockGasChamberEntity.primal_gas_chamber;
    }

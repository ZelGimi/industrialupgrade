...
public class BlockEntityRadioactiveOreHandler extends BlockEntityElectricMachine implements
    ...
    @Override
    public ContainerMenuRadioactiveOreHandler getGuiContainer(final Player var1) {

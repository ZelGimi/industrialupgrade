...
public class BlockEntityWaterRotorAssembler extends BlockEntityInventory implements IUpdateTick, IHasRecipe {
    ...
    public BlockEntityWaterRotorAssembler(BlockPos pos, BlockState state) {
        ...
        this.defaultEnergyConsume = this.energyConsume = ModConfig.mechanismInt("water_rotor_assembler_energy_use", 2);
        ...
        this.pollutionSoil = this.addComponent(new SoilPollutionComponent(this, ModConfig.mechanismDouble("water_rotor_assembler_soil_pollution_amount", 0.05D)));
        this.pollutionAir = this.addComponent(new AirPollutionComponent(this, ModConfig.mechanismDouble("water_rotor_assembler_air_pollution_amount", 0.05D)));
    }

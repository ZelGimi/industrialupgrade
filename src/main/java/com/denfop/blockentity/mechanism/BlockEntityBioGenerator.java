...
import com.denfop.containermenu.ContainerMenuElectricBioGenerator;
import com.denfop.inventory.Inventory;
import com.denfop.network.DecoderHandler;
import com.denfop.network.EncoderHandler;
import com.denfop.network.packet.CustomPacketBuffer;
import com.denfop.recipe.IInputHandler;
import com.denfop.screen.ScreenElectricBioGenerator;
...
public class BlockEntityBioGenerator extends BlockEntityElectricMachine implements IHasRecipe, IUpdateTick {
    ...
    public BlockEntityBioGenerator(BlockPos pos, BlockState state) {
        super(ModConfig.mechanismDouble("electric_bio_generator_energy_storage", 0.0D), 1, 0, BlockBaseMachine3Entity.bio_generator, pos, state);
        this.progress = 0;
        this.inputSlotA = new InventoryRecipes(this, "biomass", this);
        this.defaultEnergyConsume = this.energyConsume = ModConfig.mechanismInt("electric_bio_generator_energy_use", 1);
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.bio_generator;
    }
    ...
    public ContainerMenuElectricBioGenerator getGuiContainer(Player entityPlayer) {
        return new ContainerMenuElectricBioGenerator(entityPlayer, this);
    }
    ...
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player var1, ContainerMenuBase<? extends CustomWorldContainer> menu) {
        ...
        return new ScreenElectricBioGenerator((ContainerMenuElectricBioGenerator) menu);
    }

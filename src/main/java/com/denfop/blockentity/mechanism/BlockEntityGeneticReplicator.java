...
import com.denfop.containermenu.ContainerMenuGeneticReplicator;
...
import com.denfop.screen.ScreenGeneticReplicator;
...
public class BlockEntityGeneticReplicator extends BlockEntityElectricMachine implements BlockEntityUpgrade, IHasRecipe {
    ...
    public BlockEntityGeneticReplicator(BlockPos pos, BlockState state) {
        ...
        this.fluid_handler = new FluidHandlerRecipe("genetic_replicator", fluids);
    ...
    @Override
    public void init() {
        Recipes.recipes.getRecipeFluid().addRecipe("genetic_replicator", new BaseFluidMachineRecipe(new InputFluid(
                new FluidStack(FluidName.fluidmutagen.getInstance().get(), 1000), new FluidStack(
                FluidName.fluidbeedna.getInstance().get(),
                1000
        )), Collections.singletonList(new FluidStack(FluidName.fluidbeegenetic.getInstance().get(), 1000))));

        Recipes.recipes.getRecipeFluid().addRecipe("genetic_replicator", new BaseFluidMachineRecipe(new InputFluid(
                new FluidStack(FluidName.fluidmutagen.getInstance().get(), 1000), new FluidStack(
                FluidName.fluidcropdna.getInstance().get(),
                1000
        )), Collections.singletonList(new FluidStack(FluidName.fluidcropgenetic.getInstance().get(), 1000))));
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.genetic_replicator;
    }
    ...
    public ContainerMenuGeneticReplicator getGuiContainer(Player entityPlayer) {
        return new ContainerMenuGeneticReplicator(entityPlayer, this);
    }
    ...
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player var1, ContainerMenuBase<? extends CustomWorldContainer> menu) {
        ...
        return new ScreenGeneticReplicator((ContainerMenuGeneticReplicator) menu);
    }

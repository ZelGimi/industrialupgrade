...
public class BlockEntityQuadFermer extends BlockEntityMultiMachine implements IFarmer {
    ...
    public BlockEntityQuadFermer(BlockPos pos, BlockState state) {
        super(EnumMultiMachine.QUAD_Fermer.usagePerTick, EnumMultiMachine.QUAD_Fermer.lenghtOperation,
                BlockMoreMachine3Entity.quad_farmer, pos, state
        );
        ...
        this.pollutionSoil = this.addComponent(new SoilPollutionComponent(this, ModConfig.mechanismDouble("quad_fermer_soil_pollution_amount", 0.025D)));
        this.pollutionAir = this.addComponent(new AirPollutionComponent(this, ModConfig.mechanismDouble("quad_fermer_air_pollution_amount", 0.05D)));
    }
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockMoreMachine3Entity.quad_farmer;
    }

...
public class BlockEntityDoubleCompressor extends BlockEntityMultiMachine {
    ...
    public BlockEntityDoubleCompressor(BlockPos pos, BlockState state) {
        ...
        this.pollutionSoil = this.addComponent(new SoilPollutionComponent(this, ModConfig.mechanismDouble("double_compressor_soil_pollution_amount", 0.075D)));
        this.pollutionAir = this.addComponent(new AirPollutionComponent(this, ModConfig.mechanismDouble("double_compressor_air_pollution_amount", 0.1D)));
    }

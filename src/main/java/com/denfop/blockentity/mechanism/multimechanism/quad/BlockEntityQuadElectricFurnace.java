...
public class BlockEntityQuadElectricFurnace extends BlockEntityMultiMachine {
    ...
    public BlockEntityQuadElectricFurnace(BlockPos pos, BlockState state) {
        ...
        this.pollutionSoil = this.addComponent(new SoilPollutionComponent(this, ModConfig.mechanismDouble("quad_electric_furnace_soil_pollution_amount", 0.025D)));
        this.pollutionAir = this.addComponent(new AirPollutionComponent(this, ModConfig.mechanismDouble("quad_electric_furnace_air_pollution_amount", 0.05D)));
    }

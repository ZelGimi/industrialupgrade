...
public class BlockEntityDoubleFermer extends BlockEntityMultiMachine implements IFarmer {
    ...
    public BlockEntityDoubleFermer(BlockPos pos, BlockState state) {
        super(EnumMultiMachine.DOUBLE_Fermer.usagePerTick, EnumMultiMachine.DOUBLE_Fermer.lenghtOperation, BlockMoreMachine3Entity.double_farmer, pos, state
        ...
        this.pollutionSoil = this.addComponent(new SoilPollutionComponent(this, ModConfig.mechanismDouble("double_fermer_soil_pollution_amount", 0.075D)));
        this.pollutionAir = this.addComponent(new AirPollutionComponent(this, ModConfig.mechanismDouble("double_fermer_air_pollution_amount", 0.1D)));
    }
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockMoreMachine3Entity.double_farmer;
    }

...
public class BlockEntityDoubleRolling extends BlockEntityMultiMachine {
    ...
    public BlockEntityDoubleRolling(BlockPos pos, BlockState state) {
        ...
        this.pollutionSoil = this.addComponent(new SoilPollutionComponent(this, ModConfig.mechanismDouble("improved_rolling_machine_soil_pollution_amount", 0.075D)));
        this.pollutionAir = this.addComponent(new AirPollutionComponent(this, ModConfig.mechanismDouble("improved_rolling_machine_air_pollution_amount", 0.1D)));
    }

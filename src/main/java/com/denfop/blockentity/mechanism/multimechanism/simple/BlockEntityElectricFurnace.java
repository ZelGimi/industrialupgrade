...
public class BlockEntityElectricFurnace extends BlockEntityMultiMachine {
    ...
    public BlockEntityElectricFurnace(BlockPos pos, BlockState state) {
        ...
        this.pollutionSoil = this.addComponent(new SoilPollutionComponent(this, ModConfig.mechanismDouble("electric_furnace_soil_pollution_amount", 0.1D)));
        this.pollutionAir = this.addComponent(new AirPollutionComponent(this, ModConfig.mechanismDouble("electric_furnace_air_pollution_amount", 0.15D)));
    }

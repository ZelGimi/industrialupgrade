...
public class BlockEntityDoubleMacerator extends BlockEntityMultiMachine {
    ...
    public BlockEntityDoubleMacerator(BlockPos pos, BlockState state) {
        ...
        this.pollutionSoil = this.addComponent(new SoilPollutionComponent(this, ModConfig.mechanismDouble("improved_macerator_soil_pollution_amount", 0.075D)));
        this.pollutionAir = this.addComponent(new AirPollutionComponent(this, ModConfig.mechanismDouble("improved_macerator_air_pollution_amount", 0.1D)));
    }

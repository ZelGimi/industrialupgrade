...
public class BlockEntityDoubleRecycler extends BlockEntityMultiMachine {
    ...
    public BlockEntityDoubleRecycler(BlockPos pos, BlockState state) {
        ...
        this.pollutionSoil = this.addComponent(new SoilPollutionComponent(this, ModConfig.mechanismDouble("improved_recycler_soil_pollution_amount", 0.075D)));
        this.pollutionAir = this.addComponent(new AirPollutionComponent(this, ModConfig.mechanismDouble("improved_recycler_air_pollution_amount", 0.1D)));
    }

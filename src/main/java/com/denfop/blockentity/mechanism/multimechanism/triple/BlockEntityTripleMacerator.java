...
public class BlockEntityTripleMacerator extends BlockEntityMultiMachine {
    ...
    public BlockEntityTripleMacerator(BlockPos pos, BlockState state) {
        ...
        this.pollutionSoil = this.addComponent(new SoilPollutionComponent(this, ModConfig.mechanismDouble("advanced_macerator_soil_pollution_amount", 0.05D)));
        this.pollutionAir = this.addComponent(new AirPollutionComponent(this, ModConfig.mechanismDouble("advanced_macerator_air_pollution_amount", 0.075D)));
    }

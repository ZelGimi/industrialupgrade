...
public class BlockEntityDoubleExtruding extends BlockEntityMultiMachine {

    private final SoilPollutionComponent pollutionSoil;
    private final AirPollutionComponent pollutionAir;

    public BlockEntityDoubleExtruding(BlockPos pos, BlockState state) {
        super(
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockMoreMachine2Entity.double_extruder;
    }

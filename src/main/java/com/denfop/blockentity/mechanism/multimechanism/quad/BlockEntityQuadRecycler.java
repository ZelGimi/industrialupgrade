...
public class BlockEntityQuadRecycler extends BlockEntityMultiMachine {

    private final SoilPollutionComponent pollutionSoil;
    private final AirPollutionComponent pollutionAir;

    public BlockEntityQuadRecycler(BlockPos pos, BlockState state) {
        super(
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockMoreMachine1Entity.quad_recycler;
    }

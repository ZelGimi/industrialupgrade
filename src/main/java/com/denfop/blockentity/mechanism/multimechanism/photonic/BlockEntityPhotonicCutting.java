...
public class BlockEntityPhotonicCutting extends BlockEntityMultiMachine {

    public BlockEntityPhotonicCutting(BlockPos pos, BlockState state) {
        super(
                EnumMultiMachine.PHO_Cutting, BlocksPhotonicMachine.photonic_cutting, pos, state
        );

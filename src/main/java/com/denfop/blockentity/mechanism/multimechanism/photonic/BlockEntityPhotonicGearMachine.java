...
public class BlockEntityPhotonicGearMachine extends BlockEntityMultiMachine {

    public BlockEntityPhotonicGearMachine(BlockPos pos, BlockState state) {
        super(
                EnumMultiMachine.Pho_Gearing, BlocksPhotonicMachine.photonic_gearing, pos, state
        );

...
public class BlockEntityQuadMacerator extends BlockEntityMultiMachine {
    ...
    public BlockEntityQuadMacerator(BlockPos pos, BlockState state) {
        ...
        this.pollutionSoil = this.addComponent(new SoilPollutionComponent(this, ModConfig.mechanismDouble("perfect_macerator_soil_pollution_amount", 0.025D)));
        this.pollutionAir = this.addComponent(new AirPollutionComponent(this, ModConfig.mechanismDouble("perfect_macerator_air_pollution_amount", 0.05D)));
    }

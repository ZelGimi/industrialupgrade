...
public class BlockEntityRolling extends BlockEntityMultiMachine {
    ...
    public BlockEntityRolling(BlockPos pos, BlockState state) {
        ...
        this.pollutionSoil = this.addComponent(new SoilPollutionComponent(this, ModConfig.mechanismDouble("rolling_machine_soil_pollution_amount", 0.1D)));
        this.pollutionAir = this.addComponent(new AirPollutionComponent(this, ModConfig.mechanismDouble("rolling_machine_air_pollution_amount", 0.15D)));
    }

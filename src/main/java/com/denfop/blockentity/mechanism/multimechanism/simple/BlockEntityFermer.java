...
public class BlockEntityFermer extends BlockEntityMultiMachine implements IFarmer {
    ...
    public BlockEntityFermer(BlockPos pos, BlockState state) {
        ...
        this.pollutionSoil = this.addComponent(new SoilPollutionComponent(this, ModConfig.mechanismDouble("fermer_soil_pollution_amount", 0.1D)));
        this.pollutionAir = this.addComponent(new AirPollutionComponent(this, ModConfig.mechanismDouble("fermer_air_pollution_amount", 0.15D)));
    }

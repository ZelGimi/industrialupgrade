...
public class BlockEntityExtruding extends BlockEntityMultiMachine {
    ...
    public BlockEntityExtruding(BlockPos pos, BlockState state) {
        ...
        this.pollutionSoil = this.addComponent(new SoilPollutionComponent(this, ModConfig.mechanismDouble("extruding_soil_pollution_amount", 0.1D)));
        this.pollutionAir = this.addComponent(new AirPollutionComponent(this, ModConfig.mechanismDouble("extruding_air_pollution_amount", 0.15D)));
    }

...
public class BlockEntityCombQuadMacerator extends BlockEntityMultiMachine {
    ...
    public BlockEntityCombQuadMacerator(BlockPos pos, BlockState state) {
        ...
        this.pollutionSoil = this.addComponent(new SoilPollutionComponent(this, ModConfig.mechanismDouble("comb_quad_macerator_soil_pollution_amount", 0.025D)));
        this.pollutionAir = this.addComponent(new AirPollutionComponent(this, ModConfig.mechanismDouble("comb_quad_macerator_air_pollution_amount", 0.05D)));
    }

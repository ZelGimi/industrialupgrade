...
import com.denfop.screen.ScreenSatelliteAssembler;
...
public class BlockEntitySatelliteAssembler extends BlockEntityElectricMachine implements
    ...
    public BlockEntitySatelliteAssembler(BlockPos pos, BlockState state) {
        super(ModConfig.mechanismDouble("satellite_assembler_energy_storage", 800.0D), 1, 1, BlockBaseMachine3Entity.satellite_assembler, pos, state);
        ...
        this.pollutionSoil = this.addComponent(new SoilPollutionComponent(this, ModConfig.mechanismDouble("satellite_assembler_soil_pollution_amount", 0.1D)));
        this.pollutionAir = this.addComponent(new AirPollutionComponent(this, ModConfig.mechanismDouble("satellite_assembler_air_pollution_amount", 0.1D)));
    }
    ...
    @Override
    public ContainerMenuSatelliteAssembler getGuiContainer(final Player var1) {
        return new ContainerMenuSatelliteAssembler(this, var1);
    }
    ...
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player var1, ContainerMenuBase<? extends CustomWorldContainer> menu) {
        ...
        return new ScreenSatelliteAssembler((ContainerMenuSatelliteAssembler) menu);
    }
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.satellite_assembler;
    }

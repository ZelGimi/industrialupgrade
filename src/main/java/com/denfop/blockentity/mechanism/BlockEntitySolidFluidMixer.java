...
import com.denfop.containermenu.ContainerMenuSolidFluidMixer;
...
import com.denfop.screen.ScreenSolidFluidMixer;
...
public class BlockEntitySolidFluidMixer extends BlockEntityElectricMachine implements
    ...
    public BlockEntitySolidFluidMixer(BlockPos pos, BlockState state) {
        ...
        this.inputSlotA = new InventoryRecipes(this, "solid_fluid_mixer", this, this.fluidTank1);
    ...
    public ContainerMenuSolidFluidMixer getGuiContainer(final Player var1) {
        return new ContainerMenuSolidFluidMixer(var1, this);
    ...
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player var1, ContainerMenuBase<? extends CustomWorldContainer> menu) {
        ...
        return new ScreenSolidFluidMixer((ContainerMenuSolidFluidMixer) menu);
    }
    ...
    public void init() {
        addRecipe(Recipes.inputFactory.getInput("forge:dusts/coal"),
                ...
                new FluidStack(FluidName.fluidnitrogen.getInstance().get()
                        , 200), new FluidStack(FluidName.fluidcarbondioxide.getInstance().get()
                        , 100)
        );
        ...
        addRecipe(new ItemStack(IUItem.iudust.getStack(64), 1),
                ...
                new FluidStack(FluidName.fluidsodiumhydroxide.getInstance().get()
                        , 250), new FluidStack(FluidName.fluidhydrogen.getInstance().get()
                        , 250)
        );
        ...
        addRecipe(new ItemStack(IUItem.crafting_elements.getStack(295), 1),
                ...
                new FluidStack(FluidName.fluidsteam_oil.getInstance().get()
                        , 500), new FluidStack(FluidName.fluidoxygen.getInstance().get()
                        , 125)
        );
    }
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.solid_fluid_mixer;
    }

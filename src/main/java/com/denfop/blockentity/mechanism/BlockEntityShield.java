...
public class BlockEntityShield extends BlockEntityInventory implements IUpdatableTileEvent {
            ...
            public void update() {
                ...
                for (int i = 0; i < this.size(); i++) {
                    if (!this.get(i).isEmpty()) {
                        ...
                        LivingEntity entityLiving = (LivingEntity) captured.getEntity(((BlockEntityShield) base).getWorld(), true);
    ...
    @Override
    public ContainerMenuShield getGuiContainer(final Player var1) {

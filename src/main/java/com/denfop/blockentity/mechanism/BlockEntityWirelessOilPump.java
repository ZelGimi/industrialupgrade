...
import com.denfop.screen.ScreenWirelessOilPump;
...
public class BlockEntityWirelessOilPump extends BlockEntityInventory implements IManufacturerBlock {
    ...
    public BlockEntityWirelessOilPump(BlockPos pos, BlockState state) {
        super(BlockBaseMachine3Entity.wireless_oil_pump, pos, state);
        this.fluids = this.addComponent(new Fluids(this));
        this.fluidTank = fluids.addTank("tank", 256000, Fluids.fluidPredicate(FluidName.fluidpetroleum.getInstance().get(),
    ...
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player var1, ContainerMenuBase<? extends CustomWorldContainer> menu) {
        return new ScreenWirelessOilPump((ContainerMenuWirelessOilPump) menu);
    }

    @Override
    public ContainerMenuWirelessOilPump getGuiContainer(final Player var1) {
        return new ContainerMenuWirelessOilPump(this, var1);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.wireless_oil_pump;
    }

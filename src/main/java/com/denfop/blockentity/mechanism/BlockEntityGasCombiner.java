...
public class BlockEntityGasCombiner extends BlockEntityElectricMachine implements BlockEntityUpgrade, IHasRecipe {
    ...
    public void init() {
        ...
        Recipes.recipes.getRecipeFluid().addRecipe("gas_combiner", new BaseFluidMachineRecipe(new InputFluid(
                ...
                new FluidStack(FluidName.fluidhydrogen.getInstance().get(), 1000)
        ...
        Recipes.recipes.getRecipeFluid().addRecipe("gas_combiner", new BaseFluidMachineRecipe(new InputFluid(
                new FluidStack(FluidName.fluidnitrogen.getInstance().get(), 100), new FluidStack(
                FluidName.fluidhydrogen.getInstance().get(),
                300
        ...
        Recipes.recipes.getRecipeFluid().addRecipe("gas_combiner", new BaseFluidMachineRecipe(new InputFluid(new FluidStack(
                ...
                200
        ), new FluidStack(FluidName.fluidhydrogen.getInstance().get(), 200)), Collections.singletonList(new FluidStack(FluidName.fluidhydrogenchloride.getInstance().get(), 400))));

        Recipes.recipes.getRecipeFluid().addRecipe("gas_combiner", new BaseFluidMachineRecipe(new InputFluid(
                new FluidStack(FluidName.fluidgasoline.getInstance().get(), 500), new FluidStack(

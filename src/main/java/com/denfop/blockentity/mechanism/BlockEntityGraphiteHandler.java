...
import com.denfop.screen.ScreenGraphite;
...
public class BlockEntityGraphiteHandler extends BlockEntityElectricMachine implements
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.graphite_handler;
    }
    ...
    @Override
    public ContainerMenuGraphite getGuiContainer(final Player var1) {
        return new ContainerMenuGraphite(var1, this);
    }

    @Override
    @OnlyIn(Dist.CLIENT)
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player var1, ContainerMenuBase<? extends CustomWorldContainer> menu) {
        return new ScreenGraphite((ContainerMenuGraphite) menu);
    }

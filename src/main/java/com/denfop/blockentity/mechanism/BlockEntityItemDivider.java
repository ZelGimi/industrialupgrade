...
public class BlockEntityItemDivider extends BlockEntityElectricMachine implements
    ...
    public BlockEntityItemDivider(BlockPos pos, BlockState state) {
        super(ModConfig.mechanismDouble("item_divider_energy_storage", 200.0D), 1, 1, BlockBaseMachine3Entity.item_divider, pos, state);
        Recipes.recipes.addInitRecipes(this);

        this.progress = 0;
        this.defaultEnergyConsume = this.energyConsume = ModConfig.mechanismInt("item_divider_energy_use", 1);
        this.defaultOperationLength = this.operationLength = 100;
        this.defaultTier = 1;
        this.defaultEnergyStorage = 100;

        this.addComponent(new SoilPollutionComponent(this, ModConfig.mechanismDouble("item_divider_soil_pollution_amount", 0.1D)));
        this.addComponent(new AirPollutionComponent(this, ModConfig.mechanismDouble("item_divider_air_pollution_amount", 0.1D)));
    ...
    public ContainerMenuItemDivider getGuiContainer(final Player var1) {
    ...
    public void init() {
        addRecipe(new ItemStack(IUItem.crafting_elements.getStack(456)), new ItemStack(IUItem.iudust.getStack(37)),
                new FluidStack(FluidName.fluidnitrogen.getInstance().get(), 20), new FluidStack(FluidName.fluidoxygen.getInstance().get(), 10)
        );
        ...
        addRecipe(new ItemStack(Items.MAGMA_CREAM), new ItemStack(Items.BLAZE_POWDER),
                ...
                new FluidStack(FluidName.fluidoxygen.getInstance().get(), 15)
        );

...
import com.denfop.screen.ScreenImpOilRefiner;
...
public class BlockEntityImpOilRefiner extends BlockEntityElectricMachine implements IManufacturerBlock, BlockEntityUpgrade, IHasRecipe {
    ...
    public BlockEntityImpOilRefiner(BlockPos pos, BlockState state) {
        ...
        this.fluid_handler = new FluidHandlerRecipe("imp_oil_refiner", fluids);
    ...
    public void init() {
        ...
        Recipes.recipes.getRecipeFluid().addRecipe("imp_oil_refiner", new BaseFluidMachineRecipe(new InputFluid(
                ...
                new FluidStack(
                        FluidName.fluidpolyeth.getInstance().get(),
                        3
                ), new FluidStack(FluidName.fluidpolyprop.getInstance().get(), 3))));
        Recipes.recipes.getRecipeFluid().addRecipe("imp_oil_refiner", new BaseFluidMachineRecipe(new InputFluid(
                new FluidStack(FluidName.fluidsour_heavy_oil.getInstance().get(), 10)), Arrays.asList(
                new FluidStack(
                        FluidName.fluidpolyeth.getInstance().get(),
                        1
                ), new FluidStack(FluidName.fluidpolyprop.getInstance().get(), 2))));
        Recipes.recipes.getRecipeFluid().addRecipe("imp_oil_refiner", new BaseFluidMachineRecipe(new InputFluid(
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.imp_refiner;
    }
    ...
    @Override
    public ContainerMenuImpOilRefiner getGuiContainer(Player entityPlayer) {
        return new ContainerMenuImpOilRefiner(entityPlayer, this);
    ...
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player var1, ContainerMenuBase<? extends CustomWorldContainer> menu) {
        return new ScreenImpOilRefiner((ContainerMenuImpOilRefiner) menu);
    }

...
public class BlockEntityCombinedPump extends BlockEntityElectricLiquidTankInventory implements BlockEntityUpgrade, IType {
    ...
    @Override
    public ContainerMenuCombPump getGuiContainer(final Player var1) {
        return new ContainerMenuCombPump(var1, this);
    }

    @Override
    @OnlyIn(Dist.CLIENT)
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(final Player var1, final ContainerMenuBase<? extends CustomWorldContainer> var2) {

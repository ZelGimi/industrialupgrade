...
public class BlockEntityMagnetGenerator extends BlockEntityElectricMachine {
    ...
    @Override
    public ContainerMenuMagnetGenerator getGuiContainer(final Player entityPlayer) {
        return new ContainerMenuMagnetGenerator(entityPlayer, this);
    }

    @OnlyIn(Dist.CLIENT)
    @Override
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(final Player entityPlayer, ContainerMenuBase<? extends CustomWorldContainer> b) {

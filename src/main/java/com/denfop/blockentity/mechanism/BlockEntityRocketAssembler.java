...
import com.denfop.screen.ScreenRocketAssembler;
...
public class BlockEntityRocketAssembler extends BlockEntityElectricMachine implements
    ...
    public BlockEntityRocketAssembler(BlockPos pos, BlockState state) {
        ...
        this.inputSlotA = new InventoryRecipes(this, "rocketassembler", this) {
            @Override
    ...
    @Override
    public ContainerMenuRocketAssembler getGuiContainer(final Player var1) {
        return new ContainerMenuRocketAssembler(this, var1);
    }
    ...
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player var1, ContainerMenuBase<? extends CustomWorldContainer> menu) {
        ...
        return new ScreenRocketAssembler((ContainerMenuRocketAssembler) menu);
    }
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.rocket_assembler;
    }

...
import com.denfop.containermenu.ContainerMenuReverseTransriptor;
...
import com.denfop.screen.ScreenReverseTransriptor;
...
public class BlockEntityReverseTransriptor extends BlockEntityElectricMachine implements BlockEntityUpgrade, IHasRecipe {
    ...
    public BlockEntityReverseTransriptor(BlockPos pos, BlockState state) {
        ...
        this.fluid_handler = new FluidHandlerRecipe("reverse_transcriptor", fluids);
    ...
    public void updateEntityServer() {
        ...
        if (this.fluid_handler.output() != null && qe.getEnergy() >= 5 && rad.getEnergy() >= 2 &&
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.reverse_transcriptor;
    }
    ...
    public ContainerMenuReverseTransriptor getGuiContainer(Player entityPlayer) {
        return new ContainerMenuReverseTransriptor(entityPlayer, this);
    }

    @Override
    @OnlyIn(Dist.CLIENT)
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player var1, ContainerMenuBase<? extends CustomWorldContainer> menu) {
        return new ScreenReverseTransriptor((ContainerMenuReverseTransriptor) menu);
    }

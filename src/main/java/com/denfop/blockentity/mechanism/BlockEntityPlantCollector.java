...
import com.denfop.screen.ScreenPlantCollector;
...
public class BlockEntityPlantCollector extends BlockEntityInventory implements BlockEntityUpgrade {
    ...
    public BlockEntityPlantCollector(BlockPos pos, BlockState state) {
        super(BlockBaseMachine3Entity.plant_collector, pos, state);
        ...
        this.pollutionSoil = this.addComponent(new SoilPollutionComponent(this, ModConfig.mechanismDouble("plant_collector_soil_pollution_amount", 0.1D)));
        this.pollutionAir = this.addComponent(new AirPollutionComponent(this, ModConfig.mechanismDouble("plant_collector_air_pollution_amount", 0.2D)));
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.plant_collector;
    }
    ...
    @Override
    public ContainerMenuPlantCollector getGuiContainer(final Player var1) {
        return new ContainerMenuPlantCollector(this, var1);
    }
    ...
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player var1, ContainerMenuBase<? extends CustomWorldContainer> menu) {
        ...
        return new ScreenPlantCollector((ContainerMenuPlantCollector) menu);
    }

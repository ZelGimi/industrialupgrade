...
public abstract class BlockEntityBaseGenerator extends BlockEntityInventory {
    ...
    public BlockEntityBaseGenerator(double production, int tier, int maxStorage, MultiBlockEntity multiTileBlock, BlockPos pos, BlockState state) {
    ...
    public ContainerMenuBase<? extends BlockEntityBaseGenerator> getGuiContainer(Player player) {
        return null;
    }

    @OnlyIn(Dist.CLIENT)
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player player, ContainerMenuBase<? extends CustomWorldContainer> menu) {
        return null;
    }

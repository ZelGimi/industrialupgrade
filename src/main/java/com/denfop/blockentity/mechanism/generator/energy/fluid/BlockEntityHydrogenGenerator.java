...
import com.denfop.containermenu.ContainerMenuHydrogenGenerator;
...
import com.denfop.screen.ScreenHydrogenGenerator;
...
public class BlockEntityHydrogenGenerator extends BlockEntityLiquidTankInventory implements
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine2Entity.gen_hyd;
    }
    ...
    public ContainerMenuHydrogenGenerator getGuiContainer(Player entityPlayer) {
        return new ContainerMenuHydrogenGenerator(entityPlayer, this);
    }
    ...
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player entityPlayer, ContainerMenuBase<? extends CustomWorldContainer> isAdmin) {
        return new ScreenHydrogenGenerator((ContainerMenuHydrogenGenerator) isAdmin);
    }

...
public class BlockEntityCentrifuge extends BlockEntityElectricMachine implements
    ...
    public BlockEntityCentrifuge(BlockPos pos, BlockState state) {
        super(200, ModConfig.mechanismInt("bee_product_centrifuge_energy_use", 1), 1, BlockBaseMachine3Entity.centrifuge, pos, state);
        ...
        this.pollutionSoil = this.addComponent(new SoilPollutionComponent(this, ModConfig.mechanismDouble("bee_product_centrifuge_soil_pollution_amount", 0.1D)));
        this.pollutionAir = this.addComponent(new AirPollutionComponent(this, ModConfig.mechanismDouble("bee_product_centrifuge_air_pollution_amount", 0.1D)));

...
import com.denfop.containermenu.ContainerMenuIncubator;
...
import com.denfop.screen.ScreenIncubator;
...
public class BlockEntityIncubator extends BlockEntityElectricMachine implements
    ...
    public BlockEntityIncubator(BlockPos pos, BlockState state) {
        super(ModConfig.mechanismDouble("incubator_energy_storage", 200.0D), 1, 1, BlockBaseMachine3Entity.incubator, pos, state);
        Recipes.recipes.addInitRecipes(this);

        this.progress = 0;
        this.defaultEnergyConsume = this.energyConsume = ModConfig.mechanismInt("incubator_energy_use", 1);
        ...
        this.inputSlotA = new InventoryRecipes(this, "incubator", this, fluidTank1);


        this.fluid_handler = new FluidHandlerRecipe("incubator", fluids);
        ...
        this.pollutionSoil = this.addComponent(new SoilPollutionComponent(this, ModConfig.mechanismDouble("incubator_soil_pollution_amount", 0.1D)));
        this.pollutionAir = this.addComponent(new AirPollutionComponent(this, ModConfig.mechanismDouble("incubator_air_pollution_amount", 0.25D)));
    ...
    public ContainerMenuIncubator getGuiContainer(final Player var1) {
        return new ContainerMenuIncubator(var1, this);
    ...
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player var1, ContainerMenuBase<? extends CustomWorldContainer> menu) {
        ...
        return new ScreenIncubator((ContainerMenuIncubator) menu);
    }
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.incubator;
    }

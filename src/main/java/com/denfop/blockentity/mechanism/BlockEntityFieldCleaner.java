...
public class BlockEntityFieldCleaner extends BlockEntityInventory implements IUpgradableBlock {
    ...
    public BlockEntityFieldCleaner(BlockPos pos, BlockState state) {
        ...
        this.pollutionSoil = this.addComponent(new SoilPollutionComponent(this, ModConfig.mechanismDouble("field_cleaner_soil_pollution_amount", 0.1D)));
        this.pollutionAir = this.addComponent(new AirPollutionComponent(this, ModConfig.mechanismDouble("field_cleaner_air_pollution_amount", 0.1D)));

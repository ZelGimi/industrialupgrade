...
public class BlockEntitySolidStateElectrolyzer extends BlockEntityElectricMachine implements
    ...
    public ContainerMenuSolidStateElectrolyzer getGuiContainer(final Player var1) {
    ...
    public void init() {
        ...
        addRecipe(new ItemStack(Blocks.CLAY), new ItemStack(IUItem.smalldust.getStack(1)),
                new FluidStack(FluidName.fluidcarbondioxide.getInstance().get(), 10)
        );
        ...
        addRecipe(new ItemStack(IUItem.space_stone.getItem(14)), new ItemStack(IUItem.spaceItem.getStack(44), 3),
                new FluidStack(FluidName.fluidnitrogen.getInstance().get(), 100)
        );

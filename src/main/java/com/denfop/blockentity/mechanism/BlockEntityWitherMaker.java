...
import com.denfop.blockentity.base.BlockEntityBaseWitherMaker;
...
import com.denfop.screen.ScreenWitherMaker;
...
public class BlockEntityWitherMaker extends BlockEntityBaseWitherMaker implements IHasRecipe {
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine1Entity.gen_wither;
    }
    ...
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player entityPlayer, ContainerMenuBase<? extends CustomWorldContainer> isAdmin) {
        return new ScreenWitherMaker((ContainerMenuBaseWitherMaker) isAdmin);
    }

    public ContainerMenuBaseWitherMaker getGuiContainer(Player entityPlayer) {
        return new ContainerMenuBaseWitherMaker(
                entityPlayer, this);
    }

...
public class BlockEntitySawmill extends BlockEntityElectricMachine implements
    ...
    public BlockEntitySawmill(BlockPos pos, BlockState state) {
        super(ModConfig.mechanismDouble("sawmill_energy_storage", 200.0D), 1, 1, BlockBaseMachine3Entity.sawmill, pos, state);
        ...
        this.pollutionSoil = this.addComponent(new SoilPollutionComponent(this, ModConfig.mechanismDouble("sawmill_soil_pollution_amount", 0.1D)));
        this.pollutionAir = this.addComponent(new AirPollutionComponent(this, ModConfig.mechanismDouble("sawmill_air_pollution_amount", 0.1D)));

...
import com.denfop.screen.ScreenItemDividerFluids;
...
public class BlockEntityItemDividerFluids extends BlockEntityElectricMachine implements
    ...
    public ContainerMenuItemDividerFluids getGuiContainer(final Player var1) {
        return new ContainerMenuItemDividerFluids(var1, this);
    ...
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player var1, ContainerMenuBase<? extends CustomWorldContainer> menu) {
        ...
        return new ScreenItemDividerFluids((ContainerMenuItemDividerFluids) menu);
    }
    ...
    public void init() {
        ...
        addRecipe(
                ...
                new FluidStack(FluidName.fluidoxygen.getInstance().get(), 50)
        );
        addRecipe(
                IUItem.biochaff,
                new FluidStack(FluidName.fluidbiomass.getInstance().get(), 100),
                new FluidStack(FluidName.fluidoxygen.getInstance().get(), 20)
        );
        addRecipe(
                IUItem.plantBall,
                new FluidStack(FluidName.fluidbiomass.getInstance().get(), 50),
        ...
        addRecipe(
                ...
                new FluidStack(FluidName.fluidhydrogen.getInstance().get(), 100)
        );
        addRecipe(
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.item_divider_to_fluid;
    }

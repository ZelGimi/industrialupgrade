...
public class BlockEntityTransportPipe15 extends BlockEntityItemPipes {
    public BlockEntityTransportPipe15(BlockPos pos, BlockState state) {
        super(ItemType.itemcable15, BlockTransportPipeEntity.itemcable15, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockTransportPipeEntity.itemcable15;
    }

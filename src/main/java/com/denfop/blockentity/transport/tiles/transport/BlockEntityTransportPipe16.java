...
public class BlockEntityTransportPipe16 extends BlockEntityItemPipes {
    public BlockEntityTransportPipe16(BlockPos pos, BlockState state) {
        super(ItemType.itemcable16, BlockTransportPipeEntity.itemcable16, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockTransportPipeEntity.itemcable16;
    }

...
public class BlockEntityGold1Cable extends BlockEntityCable {
    public BlockEntityGold1Cable(BlockPos pos, BlockState state) {
        super(CableType.gold1, BlockCableEntity.gold1, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockCableEntity.gold1;
    }

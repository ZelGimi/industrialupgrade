...
public class BlockEntityTransportPipe14 extends BlockEntityItemPipes {
    public BlockEntityTransportPipe14(BlockPos pos, BlockState state) {
        super(ItemType.itemcable14, BlockTransportPipeEntity.itemcable14, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockTransportPipeEntity.itemcable14;
    }

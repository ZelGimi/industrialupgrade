...
public class BlockEntityHeatColdPipe4 extends BlockEntityHeatColdPipes {
    public BlockEntityHeatColdPipe4(BlockPos pos, BlockState state) {
        super(HeatColdType.heatcool4, BlockHeatColdPipeEntity.heatcool4, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockHeatColdPipeEntity.heatcool4;
    }

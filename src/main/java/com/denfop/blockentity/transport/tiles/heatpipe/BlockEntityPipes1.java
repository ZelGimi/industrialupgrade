...
public class BlockEntityPipes1 extends BlockEntityHeatPipes {
    public BlockEntityPipes1(BlockPos pos, BlockState state) {
        super(HeatType.pipes1, BlockPipeEntity.pipes1, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockPipeEntity.pipes1;
    }

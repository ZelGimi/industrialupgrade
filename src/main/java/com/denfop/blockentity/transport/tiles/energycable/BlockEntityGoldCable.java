...
public class BlockEntityGoldCable extends BlockEntityCable {
    public BlockEntityGoldCable(BlockPos pos, BlockState state) {
        super(CableType.gold, BlockCableEntity.gold, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockCableEntity.gold;
    }

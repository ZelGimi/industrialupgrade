...
public class BlockEntityGlass5Cable extends BlockEntityCable {
    public BlockEntityGlass5Cable(BlockPos pos, BlockState state) {
        super(CableType.glass5, BlockCableEntity.glass5, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockCableEntity.glass5;
    }

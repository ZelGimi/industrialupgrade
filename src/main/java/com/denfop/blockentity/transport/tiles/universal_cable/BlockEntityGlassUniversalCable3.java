...
public class BlockEntityGlassUniversalCable3 extends BlockEntityUniversalCable {
    public BlockEntityGlassUniversalCable3(BlockPos pos, BlockState state) {
        super(UniversalType.glass3, BlockUniversalCableEntity.universal3, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockUniversalCableEntity.universal3;
    }

...
public class BlockEntityTransportPipe8 extends BlockEntityItemPipes {
    public BlockEntityTransportPipe8(BlockPos pos, BlockState state) {
        super(ItemType.itemcable8, BlockTransportPipeEntity.itemcable8, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockTransportPipeEntity.itemcable8;
    }

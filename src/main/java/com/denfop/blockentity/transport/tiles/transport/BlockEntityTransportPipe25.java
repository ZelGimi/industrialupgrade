...
public class BlockEntityTransportPipe25 extends BlockEntityItemPipes {
    public BlockEntityTransportPipe25(BlockPos pos, BlockState state) {
        super(ItemType.itemcable25, BlockTransportPipeEntity.itemcable25, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockTransportPipeEntity.itemcable25;
    }

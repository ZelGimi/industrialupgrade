...
public class BlockEntityTransportPipe23 extends BlockEntityItemPipes {
    public BlockEntityTransportPipe23(BlockPos pos, BlockState state) {
        super(ItemType.itemcable23, BlockTransportPipeEntity.itemcable23, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockTransportPipeEntity.itemcable23;
    }

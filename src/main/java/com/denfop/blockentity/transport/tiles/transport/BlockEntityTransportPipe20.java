...
public class BlockEntityTransportPipe20 extends BlockEntityItemPipes {
    public BlockEntityTransportPipe20(BlockPos pos, BlockState state) {
        super(ItemType.itemcable20, BlockTransportPipeEntity.itemcable20, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockTransportPipeEntity.itemcable20;
    }

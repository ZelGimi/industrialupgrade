...
public class BlockEntityPipes2 extends BlockEntityHeatPipes {
    public BlockEntityPipes2(BlockPos pos, BlockState state) {
        super(HeatType.pipes2, BlockPipeEntity.pipes2, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockPipeEntity.pipes2;
    }

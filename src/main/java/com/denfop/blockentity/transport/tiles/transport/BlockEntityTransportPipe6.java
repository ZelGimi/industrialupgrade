...
public class BlockEntityTransportPipe6 extends BlockEntityItemPipes {
    public BlockEntityTransportPipe6(BlockPos pos, BlockState state) {
        super(ItemType.itemcable6, BlockTransportPipeEntity.itemcable6, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockTransportPipeEntity.itemcable6;
    }

...
public class BlockEntityTransportPipe27 extends BlockEntityItemPipes {
    public BlockEntityTransportPipe27(BlockPos pos, BlockState state) {
        super(ItemType.itemcable27, BlockTransportPipeEntity.itemcable27, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockTransportPipeEntity.itemcable27;
    }

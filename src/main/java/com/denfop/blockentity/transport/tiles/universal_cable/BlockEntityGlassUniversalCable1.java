...
public class BlockEntityGlassUniversalCable1 extends BlockEntityUniversalCable {
    public BlockEntityGlassUniversalCable1(BlockPos pos, BlockState state) {
        super(UniversalType.glass1, BlockUniversalCableEntity.universal1, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockUniversalCableEntity.universal1;
    }

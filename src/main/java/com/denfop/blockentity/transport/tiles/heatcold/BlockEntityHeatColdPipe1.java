...
public class BlockEntityHeatColdPipe1 extends BlockEntityHeatColdPipes {
    public BlockEntityHeatColdPipe1(BlockPos pos, BlockState state) {
        super(HeatColdType.heatcool1, BlockHeatColdPipeEntity.heatcool1, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockHeatColdPipeEntity.heatcool1;
    }

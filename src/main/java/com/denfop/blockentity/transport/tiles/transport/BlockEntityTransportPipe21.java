...
public class BlockEntityTransportPipe21 extends BlockEntityItemPipes {
    public BlockEntityTransportPipe21(BlockPos pos, BlockState state) {
        super(ItemType.itemcable21, BlockTransportPipeEntity.itemcable21, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockTransportPipeEntity.itemcable21;
    }

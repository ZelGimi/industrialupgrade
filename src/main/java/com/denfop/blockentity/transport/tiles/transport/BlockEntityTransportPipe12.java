...
public class BlockEntityTransportPipe12 extends BlockEntityItemPipes {
    public BlockEntityTransportPipe12(BlockPos pos, BlockState state) {
        super(ItemType.itemcable12, BlockTransportPipeEntity.itemcable12, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockTransportPipeEntity.itemcable12;
    }

...
public class BlockEntityTransportPipe28 extends BlockEntityItemPipes {
    public BlockEntityTransportPipe28(BlockPos pos, BlockState state) {
        super(ItemType.itemcable28, BlockTransportPipeEntity.itemcable28, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockTransportPipeEntity.itemcable28;
    }

...
public class BlockEntityTransportPipe19 extends BlockEntityItemPipes {
    public BlockEntityTransportPipe19(BlockPos pos, BlockState state) {
        super(ItemType.itemcable19, BlockTransportPipeEntity.itemcable19, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockTransportPipeEntity.itemcable19;
    }

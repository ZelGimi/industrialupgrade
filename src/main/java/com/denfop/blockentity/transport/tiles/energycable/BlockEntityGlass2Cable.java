...
public class BlockEntityGlass2Cable extends BlockEntityCable {
    public BlockEntityGlass2Cable(BlockPos pos, BlockState state) {
        super(CableType.glass2, BlockCableEntity.glass2, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockCableEntity.glass2;
    }

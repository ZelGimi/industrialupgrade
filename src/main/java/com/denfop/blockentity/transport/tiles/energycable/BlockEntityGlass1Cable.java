...
public class BlockEntityGlass1Cable extends BlockEntityCable {
    public BlockEntityGlass1Cable(BlockPos pos, BlockState state) {
        super(CableType.glass1, BlockCableEntity.glass1, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockCableEntity.glass1;
    }

...
public class BlockEntityGlass9Cable extends BlockEntityCable {
    public BlockEntityGlass9Cable(BlockPos pos, BlockState state) {
        super(CableType.glass9, BlockCableEntity.glass9, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockCableEntity.glass9;
    }

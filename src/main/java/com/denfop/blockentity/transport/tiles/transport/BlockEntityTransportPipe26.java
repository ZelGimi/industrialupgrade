...
public class BlockEntityTransportPipe26 extends BlockEntityItemPipes {
    public BlockEntityTransportPipe26(BlockPos pos, BlockState state) {
        super(ItemType.itemcable26, BlockTransportPipeEntity.itemcable26, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockTransportPipeEntity.itemcable26;
    }

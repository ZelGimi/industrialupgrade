...
public class BlockEntityGlassUniversalCable6 extends BlockEntityUniversalCable {
    public BlockEntityGlassUniversalCable6(BlockPos pos, BlockState state) {
        super(UniversalType.glass6, BlockUniversalCableEntity.universal6, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockUniversalCableEntity.universal6;
    }

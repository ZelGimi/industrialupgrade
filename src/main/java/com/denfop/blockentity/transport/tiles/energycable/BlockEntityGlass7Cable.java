...
public class BlockEntityGlass7Cable extends BlockEntityCable {
    public BlockEntityGlass7Cable(BlockPos pos, BlockState state) {
        super(CableType.glass7, BlockCableEntity.glass7, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockCableEntity.glass7;
    }

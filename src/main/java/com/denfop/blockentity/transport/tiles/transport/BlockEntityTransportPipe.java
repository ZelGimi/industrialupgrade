...
public class BlockEntityTransportPipe extends BlockEntityItemPipes {
    public BlockEntityTransportPipe(BlockPos pos, BlockState state) {
        super(ItemType.itemcable, BlockTransportPipeEntity.itemcable, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockTransportPipeEntity.itemcable;
    }

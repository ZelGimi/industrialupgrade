...
public class BlockEntityTransportPipe9 extends BlockEntityItemPipes {
    public BlockEntityTransportPipe9(BlockPos pos, BlockState state) {
        super(ItemType.itemcable9, BlockTransportPipeEntity.itemcable9, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockTransportPipeEntity.itemcable9;
    }

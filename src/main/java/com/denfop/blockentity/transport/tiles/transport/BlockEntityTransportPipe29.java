...
public class BlockEntityTransportPipe29 extends BlockEntityItemPipes {
    public BlockEntityTransportPipe29(BlockPos pos, BlockState state) {
        super(ItemType.itemcable29, BlockTransportPipeEntity.itemcable29, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockTransportPipeEntity.itemcable29;
    }

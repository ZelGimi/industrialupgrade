...
public class BlockEntityFiberGlassCable extends BlockEntityCable {
    public BlockEntityFiberGlassCable(BlockPos pos, BlockState state) {
        super(CableType.glass_1, BlockCableEntity.glass_1, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockCableEntity.glass_1;
    }

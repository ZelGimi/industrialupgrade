...
public class BlockEntityTransportPipe24 extends BlockEntityItemPipes {
    public BlockEntityTransportPipe24(BlockPos pos, BlockState state) {
        super(ItemType.itemcable24, BlockTransportPipeEntity.itemcable24, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockTransportPipeEntity.itemcable24;
    }

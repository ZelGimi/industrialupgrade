...
public class BlockEntityTinCable extends BlockEntityCable {
    public BlockEntityTinCable(BlockPos pos, BlockState state) {
        super(CableType.tin, BlockCableEntity.tin, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockCableEntity.tin;
    }

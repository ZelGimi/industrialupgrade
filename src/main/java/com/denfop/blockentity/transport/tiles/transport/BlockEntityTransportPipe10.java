...
public class BlockEntityTransportPipe10 extends BlockEntityItemPipes {
    public BlockEntityTransportPipe10(BlockPos pos, BlockState state) {
        super(ItemType.itemcable10, BlockTransportPipeEntity.itemcable10, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockTransportPipeEntity.itemcable10;
    }

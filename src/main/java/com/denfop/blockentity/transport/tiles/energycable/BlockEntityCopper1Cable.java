...
public class BlockEntityCopper1Cable extends BlockEntityCable {
    public BlockEntityCopper1Cable(BlockPos pos, BlockState state) {
        super(CableType.copper1, BlockCableEntity.copper1, pos, state);
    }

    @Override
    public MultiBlockEntity getTeBlock() {
        return BlockCableEntity.copper1;
    }

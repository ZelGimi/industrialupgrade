...
public class BlockEntityElectricMFE extends BlockEntityElectricBlock {

    public BlockEntityElectricMFE(BlockPos pos, BlockState state) {
        super(EnumElectricBlock.MFE, BlockEnergyStorageEntity.mfe_iu, pos, state);
    }

    public MultiBlockEntity getTeBlock() {
        return BlockEnergyStorageEntity.mfe_iu;
    }

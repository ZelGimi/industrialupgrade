...
public class BlockEntityElectricGraMFSU extends BlockEntityElectricBlock {

    public BlockEntityElectricGraMFSU(BlockPos pos, BlockState state) {
        super(EnumElectricBlock.GRA_MFSU, BlockEnergyStorageEntity.gra_mfsu, pos, state);
    }

    public MultiBlockEntity getTeBlock() {
        return BlockEnergyStorageEntity.gra_mfsu;
    }

...
public class BlockEntityChargepadMFE extends BlockEntityElectricBlock {

    public BlockEntityChargepadMFE(BlockPos pos, BlockState state) {
        super(EnumElectricBlock.MFE_CHARGEPAD, BlockChargepadStorageEntity.mfe_iu_chargepad, pos, state);
    }

    public MultiBlockEntity getTeBlock() {
        return BlockChargepadStorageEntity.mfe_iu_chargepad;
    }

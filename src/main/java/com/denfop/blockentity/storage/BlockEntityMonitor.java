...
public class BlockEntityMonitor extends BlockEntityInventory implements IMonitor {
    ...
    @Override
    public ContainerMonitor getGuiContainer(Player var1) {

        return new ContainerMonitor(this, var1);
    }
    ...
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player entityPlayer, ContainerMenuBase<? extends CustomWorldContainer> isAdmin) {
        return new ScreenMonitor((ContainerMonitor) isAdmin);
    }

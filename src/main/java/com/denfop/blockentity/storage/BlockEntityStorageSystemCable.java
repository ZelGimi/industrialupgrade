...
import com.denfop.blocks.mechanism.BlockStorageSystemCableEntity;
...
public class BlockEntityStorageSystemCable extends BlockEntityMultiCable implements IConductor {


    public boolean addedToEnergyNet;
    protected StorageSystemCableType cableType;
    ...
    public BlockEntityStorageSystemCable(BlockPos pos, BlockState state) {
        super(StorageSystemCableType.storagecable, BlockStorageSystemCableEntity.storage, pos, state);
        this.cableType = StorageSystemCableType.storagecable;
    }

    public MultiBlockEntity getTeBlock() {
        return BlockStorageSystemCableEntity.storage;
    }

    public BlockTileEntity getBlock() {
        return IUItem.storagepipes.getBlock(getTeBlock());
    }
    ...
    public void readFromNBT(CompoundTag nbt) {
        ...
        this.cableType = StorageSystemCableType.values[nbt.getByte("cableType") & 255];
    }
    ...
    public void updateTileServer(final Player var1, final double var2) {
        ...
        MinecraftForge.EVENT_BUS.post(new EnergyEvent(this.getWorld(), EnumTypeEvent.UNLOAD, EnergyType.STORAGE, this));
    ...
    public void updateEntityServer() {
        ...
        if (this.needUpdate) {
            ...
            MinecraftForge.EVENT_BUS.post(new EnergyEvent(this.getWorld(), EnumTypeEvent.LOAD, EnergyType.STORAGE, this));
    ...
    public void readPacket(CustomPacketBuffer customPacketBuffer) {
        ...
        try {
            cableType = StorageSystemCableType.values[(int) DecoderHandler.decode(customPacketBuffer)];

...
public enum StorageSystemCableType implements ISubEnum, ICableItem {
    storagecable(0, 0, 0.25F, 0.02D, Integer.MAX_VALUE);

    public static final StorageSystemCableType[] values = values();
    private static final Map<String, StorageSystemCableType> nameMap = new HashMap<>();
    ...
    StorageSystemCableType(int maxInsulation, int minColoredInsulation, float thickness, double loss, double capacity) {

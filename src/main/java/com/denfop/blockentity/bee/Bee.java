...
public class Bee {
    ...
    public static final Codec<Bee> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            Codec.LONG.fieldOf("id").forGetter(com.denfop.blockentity.bee.Bee::getId),
            Codec.INT.fieldOf("maxLife").forGetter(com.denfop.blockentity.bee.Bee::getMaxLife),
            Codec.INT.fieldOf("birthTick").forGetter(com.denfop.blockentity.bee.Bee::getBirthTick),
            Codec.DOUBLE.fieldOf("jelly").forGetter(com.denfop.blockentity.bee.Bee::getJelly),
            Codec.DOUBLE.fieldOf("food").forGetter(com.denfop.blockentity.bee.Bee::getFood),
            Codec.BOOL.fieldOf("ill").forGetter(com.denfop.blockentity.bee.Bee::isIll),
            Codec.INT.fieldOf("tick").forGetter(com.denfop.blockentity.bee.Bee::getTick),
            Codec.STRING.xmap(EnumTypeBee::valueOf, Enum::name).fieldOf("typeBee").forGetter(com.denfop.blockentity.bee.Bee::getTypeBee),
            Codec.STRING.xmap(EnumTypeLife::valueOf, Enum::name).fieldOf("type").forGetter(com.denfop.blockentity.bee.Bee::getType),
            Codec.BOOL.fieldOf("isDead").forGetter(com.denfop.blockentity.bee.Bee::isDead),
            Codec.BOOL.fieldOf("wasBirth").forGetter(com.denfop.blockentity.bee.Bee::isWasBirth)
    ).apply(instance, com.denfop.blockentity.bee.Bee::new));
    ...
    public Bee(EnumTypeBee typeBee, com.denfop.api.bee.Bee bee, EnumTypeLife type, double food, final int tick) {

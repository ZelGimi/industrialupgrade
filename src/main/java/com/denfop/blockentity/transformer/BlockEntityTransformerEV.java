...
public class BlockEntityTransformerEV extends BlockEntityTransformer {

    public BlockEntityTransformerEV(BlockPos pos, BlockState state) {
        super(4, BlockTransformerEntity.ev, pos, state);
    }

    public MultiBlockEntity getTeBlock() {
        return BlockTransformerEntity.ev;
    }

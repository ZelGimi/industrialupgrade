...
public class BlockEntityTransformerMV extends BlockEntityTransformer {

    public BlockEntityTransformerMV(BlockPos pos, BlockState state) {
        super(2, BlockTransformerEntity.mv, pos, state);
    }

    public MultiBlockEntity getTeBlock() {
        return BlockTransformerEntity.mv;
    }

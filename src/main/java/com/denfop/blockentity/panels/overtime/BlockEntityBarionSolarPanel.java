...
public class BlockEntityBarionSolarPanel extends BlockEntitySolarPanel {

    public BlockEntityBarionSolarPanel(BlockPos pos, BlockState state) {
        super(EnumSolarPanels.BARION_SOLAR_PANEL, BlockSolarPanelsEntity.barion_solar_panel, pos, state);
    }

    public MultiBlockEntity getTeBlock() {
        return BlockSolarPanelsEntity.barion_solar_panel;
    }

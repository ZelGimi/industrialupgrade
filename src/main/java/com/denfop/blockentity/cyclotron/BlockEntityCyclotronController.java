...
public class BlockEntityCyclotronController extends BlockEntityMultiBlockBase implements IController, IHasRecipe {
    ...
    public void readContainerPacket(final CustomPacketBuffer customPacketBuffer) {
        ...
        try {
            ...
            bombardmentChamber
                    .getInputSlot()
                    .readFromNbt(customPacketBuffer.registryAccess(), ((Inventory) (DecoderHandler.decode(customPacketBuffer))).writeToNbt(customPacketBuffer.registryAccess(), new CompoundTag()));
            ...
            electrostaticDeflector.getOutputSlot().readFromNbt(customPacketBuffer.registryAccess(), ((Inventory) (DecoderHandler.decode(customPacketBuffer))).writeToNbt(customPacketBuffer.registryAccess(),
                    new CompoundTag()));

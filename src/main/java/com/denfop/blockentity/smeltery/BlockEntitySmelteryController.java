...
import com.denfop.screen.ScreenSmelteryController;
...
public class BlockEntitySmelteryController extends BlockEntityMultiBlockBase implements IController, IHasRecipe, IUpdatableTileEvent {
    ...
    public BlockEntitySmelteryController(BlockPos pos, BlockState state) {
        super(InitMultiBlockSystem.SmelterMultiBlock, BlockSmelteryEntity.smeltery_controller, pos, state);
    ...
    @Override
    public ContainerMenuSmelteryController getGuiContainer(final Player var1) {
        return new ContainerMenuSmelteryController(this, var1);
    }

    @Override
    @OnlyIn(Dist.CLIENT)
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player var1, ContainerMenuBase<? extends CustomWorldContainer> menu) {
        return new ScreenSmelteryController((ContainerMenuSmelteryController) menu);
    }
        ...
        if (this.isFull()) {
            ...
            if (this.casting != null && !casting.getInputSlotB().isEmpty()) {
                ...
                if ((casting.getFluid_handler().output() == null && this.getFirstTank() != null && this
                        .getFirstTank()
                        .getFluidAmount() >= 1) && (this.prevIndex.intValue() == this.list.get(0))) {
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockSmelteryEntity.smeltery_controller;
    }

...
public class BlockEntityElectricMachine extends BlockEntityInventory implements AudioFixer,
        IUpdatableTileEvent {
    ...
    public BlockEntityElectricMachine(double MaxEnergy, int tier, int count, MultiBlockEntity multiTileBlock, BlockPos pos, BlockState state) {
        super(multiTileBlock, pos, state);
        this.tier = tier;
        this.dischargeSlot = new InventoryDischarge(this, Inventory.TypeItemSlot.INPUT, tier, false);
        if (MaxEnergy != 0) {

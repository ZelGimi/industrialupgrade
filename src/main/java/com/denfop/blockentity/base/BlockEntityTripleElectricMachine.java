...
public abstract class BlockEntityTripleElectricMachine extends BlockEntityStandartMachine
    ...
    public BlockEntityTripleElectricMachine(
            int energyPerTick, int length, int outputSlots, String name,
            EnumTripleElectricMachine type, MultiBlockEntity block, BlockPos pos, BlockState state
    ) {
    ...
    public ContainerMenuTripleElectricMachine getGuiContainer(Player entityPlayer) {
        return new ContainerMenuTripleElectricMachine(entityPlayer, this, type);
    }

...
public class BlockEntityTeleporter extends BlockEntityElectricMachine {
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.teleporter_iu;
    }
    ...
    private boolean verifyTarget() {
        if (this.getWorld().getBlockEntity(this.target) instanceof BlockEntityTeleporter) {
            return true;
        } else {
            this.target = null;
            this.setActive(false);
    ...
    public void teleport(Entity user, double distance) {
        ...
        if (weight != 0) {
            ...
            if (energyCost <= this.getAvailableEnergy()) {
                ...
                if (be instanceof BlockEntityTeleporter teleporter) {

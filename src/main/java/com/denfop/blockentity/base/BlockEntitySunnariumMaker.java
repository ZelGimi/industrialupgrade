...
import com.denfop.blocks.mechanism.BlockSunnariumPanelMakerEntity;
import com.denfop.containermenu.ContainerMenuBase;
import com.denfop.containermenu.ContainerMenuSunnariumMaker;
import com.denfop.inventory.Inventory;
import com.denfop.recipe.IInputHandler;
import com.denfop.screen.ScreenIndustrialUpgrade;
import com.denfop.screen.ScreenSunnariumMaker;
...
public class BlockEntitySunnariumMaker extends BlockEntityBaseSunnariumMaker implements IUpdateTick, IHasRecipe {
        ...
        this.input_slot = new Inventory(this, Inventory.TypeItemSlot.INPUT, 1) {
            ...
            public ItemStack set(final int index, final ItemStack content) {
                ...
                if (this.get(0).isEmpty()) {
                    ((BlockEntitySunnariumMaker) this.base).inputSlotA.changeAccepts(ItemStack.EMPTY);
                } else {
                    ((BlockEntitySunnariumMaker) this.base).inputSlotA.changeAccepts(this.get(0));
                }
                return content;
            }
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockSunnariumPanelMakerEntity.gen_sunnarium;
    }
    ...
    public ScreenIndustrialUpgrade<ContainerMenuBase<?>> getGui(Player entityPlayer, ContainerMenuBase<?> isAdmin) {
        return new ScreenSunnariumMaker((ContainerMenuSunnariumMaker) isAdmin);
    }

    public ContainerMenuSunnariumMaker getGuiContainer(Player entityPlayer) {
        return new ContainerMenuSunnariumMaker(entityPlayer, this);
    }

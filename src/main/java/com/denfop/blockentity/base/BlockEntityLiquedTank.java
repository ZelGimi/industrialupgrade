...
public class BlockEntityLiquedTank extends BlockEntityInventory implements BlockEntityUpgrade {
    ...
    public Set<EnumBlockEntityUpgrade> getUpgradableProperties() {
        return EnumSet.of(EnumBlockEntityUpgrade.Transformer,
                EnumBlockEntityUpgrade.ItemExtract, EnumBlockEntityUpgrade.ItemInput, EnumBlockEntityUpgrade.FluidInput,

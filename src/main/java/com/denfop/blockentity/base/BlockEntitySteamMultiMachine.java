...
public abstract class BlockEntitySteamMultiMachine extends BlockEntityInventory implements
        AudioFixer, IUpdatableTileEvent, IHasRecipe, ISteamMechanism {
    ...
    public BlockEntitySteamMultiMachine(
            int aDefaultTier,
            int energyconsume,

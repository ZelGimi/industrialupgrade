...
public class DataOre {
    ...
    private List<VeinBase> veinsList;
    ...
    public DataOre(HolderLookup.Provider provider, CompoundTag tagCompound) {
        ...
        for (int i = 0; i < size1; i++) {
            ...
            VeinBase vein = VeinSystem.system.getVein(chunkPos);
    ...
    public DataOre(CustomPacketBuffer customPacketBuffer) {
        ...
        try {
            this.veinsList = (List<VeinBase>) DecoderHandler.decode(customPacketBuffer);
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    }

    public List<ItemStack> getRecipe_stack(BlockEntityAnalyzer tileAnalyzer, BlockPos pos) {
    ...
    public CompoundTag getTagCompound(HolderLookup.Provider provider) {
        ...
        for (int i = 0; i < veinsList.size(); i++) {
            ...
            VeinBase vein = this.veinsList.get(i);
    ...
    public void addVein(VeinBase vein) {
        this.veinsList.add(vein);
    }

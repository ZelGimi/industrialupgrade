...
import com.denfop.screen.ScreenQuantumTransformer;
...
public class BlockEntityQuantumMolecular extends BlockEntityElectricMachine implements
    ...
    public BlockEntityQuantumMolecular(BlockPos pos, BlockState state) {
        ...
        this.inputSlot = new InventoryRecipes(this, "quantummolecular", this) {
            ...
            public ItemStack set(final int index, final ItemStack content) {
                ...
                if (((BlockEntityQuantumMolecular) this.tile).getOutput() == null) {
                    if (!content.isEmpty()) {
                        ...
                        ((BlockEntityQuantumMolecular) this.tile).need_put_check = recipe1 != null;
                    } else {
                        if (!this.get(0).isEmpty() || !this.get(1).isEmpty()) {
                            ...
                            ((BlockEntityQuantumMolecular) this.tile).need_put_check = false;
                        }
                    }
                } else {
                    ((BlockEntityQuantumMolecular) this.tile).need_put_check = false;
    ...
    public MultiBlockEntity getTeBlock() {
        return BlockBaseMachine3Entity.quantum_transformer;
    }
    ...
    @Override
    public ContainerMenuQuantumMolecular getGuiContainer(Player entityPlayer) {
        return new ContainerMenuQuantumMolecular(entityPlayer, this);
    }
    ...
    public ScreenIndustrialUpgrade<ContainerMenuBase<? extends CustomWorldContainer>> getGui(Player var1, ContainerMenuBase<? extends CustomWorldContainer> menu) {
        ...
        return new ScreenQuantumTransformer((ContainerMenuQuantumMolecular) menu);
    }

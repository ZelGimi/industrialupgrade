...
public class GUIConverterSolidMatter extends GuiIC2<ContainerConverterSolidMatter> {
    ...
    protected void drawForegroundLayer(int par1, int par2) {
        this.fontRenderer.drawString(this.getName(), (this.xSize - this.fontRenderer.getStringWidth(this.getName())) / 2, 6, 4210752);

        new AdvArea(this,  119, 114, 157, 126).withTooltip("EU: " + ModUtils.getString((this.container.base).energy.getEnergy()) + "/" + ModUtils.getString((this.container.base).energy.getCapacity())).drawForeground(par1, par2);
       ...
       new AdvArea(this, 78,
               50, 111, 67).withTooltip(ModUtils.getString(this.container.base.getProgress() * 100) + "%").drawForeground(par1, par2);
        new AdvArea(this, 138, 50, 171, 67).withTooltip(ModUtils.getString(this.container.base.getProgress() * 100) + "%").drawForeground(par1, par2);
        new AdvArea(this, 116, 16, 133, 49).withTooltip(ModUtils.getString(this.container.base.getProgress() * 100) + "%").drawForeground(par1, par2);
        new AdvArea(this, 116, 68, 133, 101).withTooltip(ModUtils.getString(this.container.base.getProgress() * 100) + "%").drawForeground(par1, par2);
    ...
    private void handleUpgradeTooltip1(int mouseX, int mouseY) {
        ...
        if (mouseX >= 0 && mouseX <= 12 && mouseY >= 0 && mouseY <= 12) {
            ...
            this.drawTooltip(mouseX, mouseY, (List)text);
        }
    }

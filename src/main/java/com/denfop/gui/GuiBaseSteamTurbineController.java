...
public class GuiBaseSteamTurbineController<T extends ContainerBaseSteamTurbineController> extends GuiIU<ContainerBaseSteamTurbineController> {
    ...
    protected void drawForegroundLayer(GuiGraphics poseStack, final int par1, final int par2) {
        ...
        poseStack.drawString(Minecraft.getInstance().font, String.valueOf(this.container.base.stableenumSteamPhase.name()), 170, 80,
    ...
    protected void drawGuiContainerBackgroundLayer(GuiGraphics poseStack,final float partialTicks, final int mouseX, final int mouseY) {
      ...
      bindTexture(new ResourceLocation(Constants.MOD_ID, "textures/gui/guifluidreactor.png"));

        double bar = this.container.base.phase / 230D;
        bar = Math.min(1, bar);
        drawTexturedModalRect( poseStack,this.guiLeft + 70, (int) (this.guiTop + 6)
                , 202, 11, 13, 74);
        drawTexturedModalRect( poseStack,this.guiLeft + 72, (int) (this.guiTop + 73 + 6 - (bar * 71))

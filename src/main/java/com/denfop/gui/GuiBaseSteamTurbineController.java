...
public class GuiBaseSteamTurbineController<T extends ContainerBaseSteamTurbineController> extends GuiIU<ContainerBaseSteamTurbineController> {
    ...
    protected void drawForegroundLayer(GuiGraphics poseStack, final int par1, final int par2) {
        ...
        hoverWork = false;
        this.index = -1;
        new Area(this, 10, 51, 156, 14).withTooltip(() -> "Phase: " + String.valueOf(this.container.base.phase) + "\n" + "Stage: " + String.valueOf(
        ...
        for (int i = 0; i < 10; i++)
            if (par1 >= 10 + 15 * i && par2 >= 66 && par1 <= 22 + 15 * i && par2 <= 80) {
                index = i;
                new AdvArea(this, 10 + 15 * i, 66, 22 + 15 * i, 80).withTooltip(String.valueOf(EnumSteamPhase.values()[index].name())).drawForeground(poseStack, par1, par2);
            }
        ...
        if (par1 >= 62 && par2 >= 33 && par1 <= 114 && par2 <= 47) {
            ...
            String text = ModUtils.getString(Math.min(
                    ...
                    "EF";
            new AdvArea(this, 62, 33, 114, 47).withTooltip(text).drawForeground(poseStack, par1, par2);

        }
        if (hoverWork) {
            new AdvArea(this, 76, 6, 99, 30).withTooltip(this.container.base.work ? Localization.translate(
                    "turn_off") :
    ...
    protected ResourceLocation getTexture() {
        return ResourceLocation.tryBuild(Constants.MOD_ID, "textures/gui/guisteamturbine_main.png");
    }

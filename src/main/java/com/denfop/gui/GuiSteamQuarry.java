...
public class GuiSteamQuarry<T extends ContainerSteamQuarry> extends GuiIU<ContainerSteamQuarry> {

    public final ContainerSteamQuarry container;

    public GuiSteamQuarry(ContainerSteamQuarry container1) {

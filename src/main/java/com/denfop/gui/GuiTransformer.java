...
public class GuiTransformer<T extends ContainerTransformer> extends GuiIU<ContainerTransformer> {
    ...
    protected void drawForegroundLayer(PoseStack poseStack, int mouseX, int mouseY) {
        ...
        this.font.draw(poseStack, Localization.translate("Transformer.gui.Output"), 16, 20, 2157374);
        this.font.draw(poseStack, Localization.translate("Transformer.gui.Input"), 16, 35, 2157374);
        this.font.draw(poseStack, this.container.base.getoutputflow() + " " + Localization.translate(
                Constants.ABBREVIATION + ".generic.text.EUt"), 62, 20, 2157374);
        this.font.draw(poseStack, this.container.base.getinputflow() + " " + Localization.translate(

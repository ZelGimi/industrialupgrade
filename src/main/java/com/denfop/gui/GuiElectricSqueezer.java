...
public class GuiElectricSqueezer<T extends ContainerElectricSqueezer> extends GuiIU<ContainerElectricSqueezer> {

    public final ContainerElectricSqueezer container;

    public GuiElectricSqueezer(ContainerElectricSqueezer container1) {
        super(container1);
        ...
        this.addComponent(new GuiComponent(this, 75, 45, EnumTypeComponent.PROCESS,

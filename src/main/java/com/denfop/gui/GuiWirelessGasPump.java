...
public class GuiWirelessGasPump<T extends ContainerWirelessGasPump> extends GuiIU<ContainerWirelessGasPump> {

    private final ItemStack stack;

    public GuiWirelessGasPump(ContainerWirelessGasPump guiContainer) {
        super(guiContainer);
        this.stack = new ItemStack(IUItem.gasBlock.getItem());
        this.addElement(TankGauge.createNormal(this, this.imageWidth / 2 - 10, 20, (guiContainer.base).fluidTank));
        this.addComponent(new GuiComponent(this, 10, (this.imageWidth - 80) / 2,
    ...
    private void handleUpgradeTooltip(int mouseX, int mouseY) {
        if (mouseX >= 3 && mouseX <= 15 && mouseY >= 3 && mouseY <= 15) {
            ...
            text.add(Localization.translate("iu.wireless_gas_vein.info"));
            List<String> compatibleUpgrades = new ArrayList<>();
            for (int i = 1; i < 6; i++) {
                compatibleUpgrades.add(Localization.translate("iu.wireless_gas_vein.info" + i));
            }

...
public class GuiSteamConverter<T extends ContainerSteamConverter> extends GuiIU<ContainerSteamConverter> {

    public ContainerSteamConverter container;
    public String name;

    public GuiSteamConverter(ContainerSteamConverter guiContainer) {

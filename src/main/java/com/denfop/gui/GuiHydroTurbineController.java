...
public class GuiHydroTurbineController<T extends ContainerHydroTurbineController> extends GuiIU<ContainerHydroTurbineController> {

    private final ResourceLocation background;
    public boolean hoverChangeSide;
    public boolean hoverChangePower;

    public GuiHydroTurbineController(ContainerHydroTurbineController guiContainer) {
        super(guiContainer, guiContainer.base.getStyle());
        this.imageHeight = 247;
        this.imageWidth = 207;
        this.background = new ResourceLocation(Constants.MOD_ID, "textures/gui/guiwater_turbine.png");
    ...
    protected void drawForegroundLayer(PoseStack poseStack, final int mouseX, final int mouseY) {
        ...
        if (this.container.base.getRotor() != null) {
            ...
            for (String line : lines) {
                ...
                drawString(poseStack, line, 0, 0, ModUtils.convertRGBcolorToInt(13, 229, 34));
                poseStack1.popPose();
                y += 10;
            }
        }

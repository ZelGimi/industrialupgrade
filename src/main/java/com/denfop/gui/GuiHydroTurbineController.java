...
public class GuiHydroTurbineController<T extends ContainerHydroTurbineController> extends GuiIU<ContainerHydroTurbineController> implements GuiPageButtonList.GuiResponder,

...
public class GuiGeneticTransposer<T extends ContainerGeneticTransposer> extends GuiIU<ContainerGeneticTransposer> {

    public final ContainerGeneticTransposer container;

    public GuiGeneticTransposer(ContainerGeneticTransposer container1) {
        super(container1);
        ...
        this.addComponent(new GuiComponent(this, 58, 62, EnumTypeComponent.ENERGY, new Component<>(this.container.base.energy)));

...
public class GuiChemicalController<T extends ContainerChemicalController> extends GuiIU<ContainerChemicalController> {
        ...
        this.componentList.add(new GuiComponent(this, 70, 35, 24,
                ...
                new Component<>(new ComponentButton(this.container.base, 0, "") {
                    ...
                    public String getText() {
                        return ((TileEntityChemicalPlantController) this.getEntityBlock()).work ? Localization.translate(
                                "turn_off") :
                    ...
                    public boolean active() {
                        return !((TileEntityChemicalPlantController) this.getEntityBlock()).work;
                    }
                })
        ));

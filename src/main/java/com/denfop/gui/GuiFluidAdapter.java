...
public class GuiFluidAdapter<T extends ContainerFluidAdapter> extends GuiIU<ContainerFluidAdapter> {

    public final ContainerFluidAdapter container;

    public GuiFluidAdapter(ContainerFluidAdapter container1) {
        super(container1);

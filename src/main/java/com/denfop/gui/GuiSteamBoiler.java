...
public class GuiSteamBoiler<T extends ContainerSteamBoiler> extends GuiIU<ContainerSteamBoiler> {

    public ContainerSteamBoiler container;
    public String name;

    public GuiSteamBoiler(ContainerSteamBoiler guiContainer) {
    ...
    protected void drawForegroundLayer(PoseStack poseStack, int par1, int par2) {
        ...
        this.font.draw(poseStack,this.name, (this.imageWidth - this.getStringWidth(this.name)) / 2, 6, 4210752);

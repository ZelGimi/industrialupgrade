...
public class GUIEFReader<T extends ContainerEFReader> extends GuiIU<ContainerEFReader> {
    ...
    protected void drawForegroundLayer(PoseStack poseStack, int par1, int par2) {
        ...
        this.font.draw(poseStack, this.name, (this.imageWidth - this.getStringWidth(this.name)) / 2, 6, 0);
        this.font.draw(poseStack, Localization.translate("itemToolMEter.mode") + " Sink",
                (169 + this.getStringWidth(Localization.translate("itemToolMEter.mode") + " Sink")) / 2, 18,
                ModUtils.convertRGBcolorToInt(13, 229, 34)
        );
        this.font.draw(poseStack, Localization.translate("itemToolMEter.mode") + " Source",
                (169 + this.getStringWidth(Localization.translate("itemToolMEter.mode") + " Sink")) / 2, 78,
                ModUtils.convertRGBcolorToInt(13, 229, 34)
        );

        if (this.mode == 0) {
            this.font.draw(poseStack, Localization.translate("itemToolMEter.mode.EnergyIn") + ":",
                    12, 18,
                    ModUtils.convertRGBcolorToInt(13, 229, 34)
            );
            this.font.draw(poseStack, ModUtils.getString(this.energySink) + " EF/t",
                    12, 28,
                    ModUtils.convertRGBcolorToInt(13, 229, 34)
            );
            this.font.draw(poseStack, Localization.translate("itemToolMEter.avg") + " " + ModUtils.getString(this.average / tick) +
                            " " +
                            "EF/t",
                    8, 38,
                    ModUtils.convertRGBcolorToInt(13, 229, 34)
            );
            this.font.draw(poseStack, Localization.translate("itemToolMEter.max/min") + ": ",
                    12, 48,
                    ModUtils.convertRGBcolorToInt(13, 229, 34)
            );
            this.font.draw(poseStack, ModUtils.getString(this.max) + "/" + ModUtils.getString(this.min),
                    12, 58,
                    ModUtils.convertRGBcolorToInt(13, 229, 34)
            );
        }
        if (this.mode == 1) {
            ...
            this.font.draw(poseStack, Localization.translate("itemToolMEter.mode.EnergyOut") + ":",
                    12, 18,
                    ModUtils.convertRGBcolorToInt(13, 229, 34)
            );
            this.font.draw(poseStack, ModUtils.getString(this.energySource) + " EF/t",
                    12, 28,
                    ModUtils.convertRGBcolorToInt(13, 229, 34)
            );
            this.font.draw(poseStack, Localization.translate("itemToolMEter.avg") + " " + ModUtils.getString(this.average / tick) +
        ...
        this.font.draw(poseStack, Localization.translate("itemToolMEter.cycle", ModUtils.getString(this.tick / 40D)),
                12, 78,
                ModUtils.convertRGBcolorToInt(13, 229, 34)
        );
        this.font.draw(poseStack, Localization.translate("itemToolMEter.mode.reset"),
                38, 101,

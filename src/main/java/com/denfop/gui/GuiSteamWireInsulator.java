...
public class GuiSteamWireInsulator<T extends ContainerSteamWireInsulator> extends GuiIU<ContainerSteamWireInsulator> {

    public final ContainerSteamWireInsulator container;

    public GuiSteamWireInsulator(ContainerSteamWireInsulator container1) {

...
public class GuiPolymerizer<T extends ContainerPolymerizer> extends GuiIU<ContainerPolymerizer> {

    public final ContainerPolymerizer container;

    public GuiPolymerizer(ContainerPolymerizer container1) {
        super(container1);
        ...
        this.componentList.add(new GuiComponent(this, 70, 80, EnumTypeComponent.SOLARIUM_ENERGY_WEIGHT,

...
public class GuiOilPurifier<T extends ContainerOilPurifier> extends GuiIU<ContainerOilPurifier> {

    public final ContainerOilPurifier container;

    public GuiOilPurifier(ContainerOilPurifier container1) {
        super(container1);
        ...
        this.addComponent(new GuiComponent(this, 70, 40, EnumTypeComponent.PROCESS,

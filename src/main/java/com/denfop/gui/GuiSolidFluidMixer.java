...
public class GuiSolidFluidMixer<T extends ContainerSolidFluidMixer> extends GuiIU<ContainerSolidFluidMixer> {

    public final ContainerSolidFluidMixer container;

    public GuiSolidFluidMixer(ContainerSolidFluidMixer container1) {
        super(container1);

...
public class GuiMutatron<T extends ContainerMutatron> extends GuiIU<ContainerMutatron> {

    public final ContainerMutatron container;

    public GuiMutatron(ContainerMutatron container1) {
        super(container1);

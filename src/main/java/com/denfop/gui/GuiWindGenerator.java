...
public class GuiWindGenerator<T extends ContainerWindGenerator> extends GuiIU<ContainerWindGenerator> {
    ...
    public GuiWindGenerator(ContainerWindGenerator guiContainer) {
        ...
        this.imageWidth = 207;
        this.background = ResourceLocation.tryBuild(Constants.MOD_ID, "textures/gui/guiwind_generator.png");

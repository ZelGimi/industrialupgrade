...
public class GuiSteamBioGenerator<T extends ContainerBioGenerator> extends GuiIU<ContainerBioGenerator> {

    public final ContainerBioGenerator container;

    public GuiSteamBioGenerator(ContainerBioGenerator container1) {

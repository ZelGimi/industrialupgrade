...
public class GuiFluidIntegrator<T extends ContainerFluidIntegrator> extends GuiIU<ContainerFluidIntegrator> {

    public final ContainerFluidIntegrator container;

    public GuiFluidIntegrator(ContainerFluidIntegrator container1) {
        super(container1);

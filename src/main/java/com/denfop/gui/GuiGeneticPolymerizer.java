...
public class GuiGeneticPolymerizer extends GuiIU<ContainerGeneticPolymerizer> {

    public final ContainerGeneticPolymerizer container;

    public GuiGeneticPolymerizer(ContainerGeneticPolymerizer container1) {
        super(container1);
        ...
        this.addComponent(new GuiComponent(this, 95, 35, EnumTypeComponent.PROCESS,

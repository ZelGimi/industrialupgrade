...
public class GuiCreativeSteamTank<T extends ContainerCreativeSteamTank> extends GuiIU<ContainerCreativeSteamTank> {

    public final ContainerCreativeSteamTank container;

    public GuiCreativeSteamTank(ContainerCreativeSteamTank container1) {

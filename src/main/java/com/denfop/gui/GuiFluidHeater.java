...
public class GuiFluidHeater<T extends ContainerHeatFluids> extends GuiIU<ContainerHeatFluids> {

    public final ContainerHeatFluids container;

    public GuiFluidHeater(ContainerHeatFluids container1) {
        super(container1);
        ...
        this.componentList.add(new GuiComponent(this, 70, 80, EnumTypeComponent.HEAT,

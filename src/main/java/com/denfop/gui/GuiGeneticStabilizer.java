...
public class GuiGeneticStabilizer<T extends ContainerGeneticStabilizer> extends GuiIU<ContainerGeneticStabilizer> {

    public final ContainerGeneticStabilizer container;

    public GuiGeneticStabilizer(ContainerGeneticStabilizer container1) {
        super(container1);
        ...
        this.addComponent(new GuiComponent(this, 62, 70, EnumTypeComponent.SOLARIUM_ENERGY_WEIGHT,

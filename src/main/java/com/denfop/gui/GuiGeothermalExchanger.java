...
public class GuiGeothermalExchanger<T extends ContainerGeothermalExchanger> extends GuiIU<ContainerGeothermalExchanger> {

    public GuiGeothermalExchanger(ContainerGeothermalExchanger guiContainer) {
        super(guiContainer);
        this.componentList.clear();
        this.addElement((new FluidItem(this, this.imageWidth / 2 - 10, 20,
                ((TileEntityGeothermalExchanger) guiContainer.base).getFluidTank().getFluid()
        ) {
            @Override

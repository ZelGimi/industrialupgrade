...
public class GuiHeatGraphiteGraphiteController extends GuiIU<ContainerHeatGraphiteController> {
    ...
    protected void drawBackgroundAndTitle(final float partialTicks, final int mouseX, final int mouseY) {
        ...
        drawTexturedModalRect(this.guiLeft + 83  - 13, this.guiTop + 57 + 4
                , 0, 245, 11, 11);

        drawTexturedModalRect(this.guiLeft + 83 + 20, this.guiTop +57 + 4
                , 11, 245, 11, 11);

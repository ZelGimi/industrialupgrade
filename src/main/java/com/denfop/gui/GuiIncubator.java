...
public class GuiIncubator<T extends ContainerIncubator> extends GuiIU<ContainerIncubator> {

    public final ContainerIncubator container;

    public GuiIncubator(ContainerIncubator container1) {
        super(container1);

...
public class GuiGeneticReplicator<T extends ContainerGeneticReplicator> extends GuiIU<ContainerGeneticReplicator> {

    public final ContainerGeneticReplicator container;

    public GuiGeneticReplicator(ContainerGeneticReplicator container1) {
        super(container1);

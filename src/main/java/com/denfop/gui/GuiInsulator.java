...
public class GuiInsulator<T extends ContainerInsulator> extends GuiIU<ContainerInsulator> {

    public final ContainerInsulator container;

    public GuiInsulator(ContainerInsulator container1) {
        super(container1);
        ...
        this.addElement(TankGauge.createNormal(this, 45, 21, container.base.fluidTank1));
        this.addElement(TankGauge.createNormal(this, 65, 21, container.base.fluidTank2));
        this.addComponent(new GuiComponent(this, 7, 64, EnumTypeComponent.ENERGY,
                new Component<>(this.container.base.energy)
        ));

        this.addComponent(new GuiComponent(this, 90, 40, EnumTypeComponent.PROCESS,

...
public class GuiItemDivider<T extends ContainerItemDivider> extends GuiIU<ContainerItemDivider> {

    public final ContainerItemDivider container;

    public GuiItemDivider(ContainerItemDivider container1) {
        super(container1);

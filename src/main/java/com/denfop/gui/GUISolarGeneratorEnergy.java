...
public class GUISolarGeneratorEnergy extends GuiIC2<ContainerSolarGeneratorEnergy> {
    ...
    protected void drawForegroundLayer(final int mouseX, final int mouseY) {
        ...
        String tooltip = "SE: " + ModUtils.getString(this.container.base.sunenergy);
    ...
    protected void drawGuiContainerBackgroundLayer(float f, int x, int y) {
        ...
        if (this.container.base.sunenergy > 0.0D) {
            int i1 = (int) (24.0D * (this.container.base.sunenergy / this.container.base.maxSunEnergy));

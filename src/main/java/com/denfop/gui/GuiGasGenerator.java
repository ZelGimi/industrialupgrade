...
public class GuiGasGenerator<T extends ContainerGasGenerator> extends GuiIU<ContainerGasGenerator> {

    public ContainerGasGenerator container;
    public String name;

    public GuiGasGenerator(ContainerGasGenerator container1) {
        super(container1);

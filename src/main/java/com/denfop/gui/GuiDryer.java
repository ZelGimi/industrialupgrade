...
public class GuiDryer<T extends ContainerDryer> extends GuiIU<ContainerDryer> {

    public final ContainerDryer container;

    public GuiDryer(ContainerDryer container1) {
        super(container1);

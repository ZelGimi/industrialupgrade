...
public class GuiRNACollector<T extends ContainerRNACollector> extends GuiIU<ContainerRNACollector> {

    public final ContainerRNACollector container;

    public GuiRNACollector(ContainerRNACollector container1) {
        super(container1);
        ...
        this.addComponent(new GuiComponent(this, 62, 70, EnumTypeComponent.RAD,

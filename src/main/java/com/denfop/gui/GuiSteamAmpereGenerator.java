...
public class GuiSteamAmpereGenerator extends GuiIU<ContainerSteamAmpereGenerator> {

    public ContainerSteamAmpereGenerator container;
    public String name;

    public GuiSteamAmpereGenerator(ContainerSteamAmpereGenerator guiContainer, boolean b) {
        super(guiContainer, EnumTypeStyle.STEAM);
        this.container = guiContainer;
        this.name = Localization.translate(guiContainer.base.getName());

        this.componentList.add(new GuiComponent(this, 70, 41, EnumTypeComponent.STEAM_PROCESS,
                new Component<>(new ComponentEmpty())
        ));
        this.addElement(TankGauge.createNormal(this, 42, 22, (container.base).fluidTank));
        this.addComponent(new GuiComponent(this, 95, 39, EnumTypeComponent.STEAM_ENERGY_HEIGHT,

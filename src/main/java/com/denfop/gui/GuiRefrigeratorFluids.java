...
public class GuiRefrigeratorFluids<T extends ContainerRefrigeratorFluids> extends GuiIU<ContainerRefrigeratorFluids> {

    public final ContainerRefrigeratorFluids container;

    public GuiRefrigeratorFluids(ContainerRefrigeratorFluids container1) {
        super(container1);
        ...
        this.componentList.add(new GuiComponent(this, 70, 80, EnumTypeComponent.COOL_ENERGY_WEIGHT,

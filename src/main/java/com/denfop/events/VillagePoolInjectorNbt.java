...
public final class VillagePoolInjectorNbt {
    ...
    public static void onTagsUpdated(final TagsUpdatedEvent event) {
        ...
        addToPool(
                ...
                new ResourceLocation(Constants.MOD_ID, "village/plains/houses/engineer_house"),
                registryAccess,
                3
        );
        addToPool(
                new ResourceLocation("minecraft", "village/plains/houses"),
                new ResourceLocation(Constants.MOD_ID, "village/plains/houses/mechanic_house"),
                registryAccess,
                3
        );
        addToPool(
                new ResourceLocation("minecraft", "village/plains/houses"),
                new ResourceLocation(Constants.MOD_ID, "village/plains/houses/metallurg_house"),
                registryAccess,
                3
        );
        addToPool(
                new ResourceLocation("minecraft", "village/plains/houses"),
                new ResourceLocation(Constants.MOD_ID, "village/plains/houses/chemist_house"),
                registryAccess,
                3
        );
        addToPool(
                new ResourceLocation("minecraft", "village/plains/houses"),
                new ResourceLocation(Constants.MOD_ID, "village/plains/houses/botanist_house"),
                registryAccess,
                3
        );
        addToPool(
                new ResourceLocation("minecraft", "village/plains/houses"),
                new ResourceLocation(Constants.MOD_ID, "village/plains/houses/nuclear_house"),
                registryAccess,
                2
        );
        addToPool(
                new ResourceLocation("minecraft", "village/plains/houses"),
                new ResourceLocation(Constants.MOD_ID, "village/plains/houses/storage_house"),
                registryAccess,
                2
        );
    }
    ...
    private static void addToPool(ResourceLocation poolId, ResourceLocation toAdd, RegistryAccess regAccess, int weight) {
        Registry<StructureTemplatePool> registry = regAccess.registryOrThrow(BuiltinRegistries.TEMPLATE_POOL.key());
        Holder<StructureProcessorList> holder3 = ProcessorLists.MOSSIFY_10_PERCENT;

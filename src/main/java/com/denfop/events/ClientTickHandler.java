...
public class ClientTickHandler {
    public static void onTickRender1(GuiGraphics pose) {
        ...
        if (shouldDisplayRadiationInfo(player)) {
            ...
            ScreenIndustrialUpgrade.bindTexture(0, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_dosimeter.png"));
            ...
            ScreenIndustrialUpgrade.bindTexture(0, radiationTexture);
            pose.blit(ScreenIndustrialUpgrade.currentTexture, 0, 10, 0, 0, 256, 256, 256, 256);
            guiGraphics.popPose();
        }
    }

...
public class InventoryMatter extends Inventory implements ITypeSlot {
    ...
    public boolean canPlaceItem(final int index, ItemStack itemStack) {
        ...
        return (itemStack
                .getItem()
                instanceof ItemBlockTileEntity<?> && ((ItemBlockTileEntity<?>) itemStack.getItem()).getTeBlock(itemStack).getIDBlock() == BlockBaseMachineEntity.adv_matter.getIDBlock() && ((ItemBlockTileEntity<?>) itemStack.getItem()).getTeBlock(itemStack).getId() <= 3)
                || (itemStack
                .getItem()
                instanceof ItemBlockTileEntity<?> && ((ItemBlockTileEntity<?>) itemStack.getItem()).getTeBlock(itemStack).getIDBlock() == BlockSimpleMachineEntity.generator_matter.getIDBlock() && ((ItemBlockTileEntity<?>) itemStack.getItem()).getTeBlock(itemStack).getId() == 6)
                || (itemStack
                .getItem()
                instanceof ItemBlockTileEntity<?> && ((ItemBlockTileEntity<?>) itemStack.getItem()).getTeBlock(itemStack).getIDBlock() == BlockBaseMachineEntity.imp_matter.getIDBlock())
                || (itemStack
                .getItem()
                instanceof ItemBlockTileEntity<?> && ((ItemBlockTileEntity<?>) itemStack.getItem()).getTeBlock(itemStack).getIDBlock() == BlockBaseMachineEntity.per_matter.getIDBlock())
                || (itemStack
                .getItem()

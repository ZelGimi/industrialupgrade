...
public class InventoryWaterRotorBlades extends Inventory implements ITypeSlot {

    private final BlockEntityBaseWaterGenerator windGenerator;

    public InventoryWaterRotorBlades(BlockEntityBaseWaterGenerator windGenerator) {

...
import com.denfop.blockentity.mechanism.BlockEntitySheepFarm;
import com.denfop.containermenu.slot.SlotInvSlot;
import net.minecraft.world.entity.player.Player;

public class ContainerMenuSheepFarm extends ContainerMenuFullInv<BlockEntitySheepFarm> {

    public ContainerMenuSheepFarm(BlockEntitySheepFarm tileEntityChickenFarm, Player var1) {

...
public class ContainerMenuNeutronGenerator extends ContainerMenuFullInv<BlockEntityNeutronGenerator> {

    public ContainerMenuNeutronGenerator(Player entityPlayer, BlockEntityNeutronGenerator tileEntity1) {

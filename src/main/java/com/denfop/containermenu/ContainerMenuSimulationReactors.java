...
public class ContainerMenuSimulationReactors extends ContainerMenuFullInv<BlockEntitySimulatorReactor> {

    public ContainerMenuSimulationReactors(BlockEntitySimulatorReactor tileEntitySimulatorReactor, Player var1) {

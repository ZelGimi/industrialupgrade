...
public class ContainerMenuSolidMatter extends ContainerMenuFullInv<BlockEntityMatterGenerator> {

    public ContainerMenuSolidMatter(Player entityPlayer, BlockEntityMatterGenerator tileEntity1) {
        this(entityPlayer, tileEntity1, 167, 152, 8);
    }

    public ContainerMenuSolidMatter(
            Player entityPlayer,
            BlockEntityMatterGenerator tileEntity1,
            int height,
            int upgradeX,
            int upgradeY
    ) {

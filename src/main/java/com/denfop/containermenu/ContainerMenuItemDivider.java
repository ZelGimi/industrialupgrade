...
public class ContainerMenuItemDivider extends ContainerMenuFullInv<BlockEntityItemDivider> {

    public ContainerMenuItemDivider(Player var1, BlockEntityItemDivider tileEntity1) {

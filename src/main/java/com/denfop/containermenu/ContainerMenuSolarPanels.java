...
public class ContainerMenuSolarPanels extends ContainerMenuFullInv<BlockEntitySolarPanel> {

    public final BlockEntitySolarPanel tileentity;

    public ContainerMenuSolarPanels(Player player, BlockEntitySolarPanel tileEntity1) {

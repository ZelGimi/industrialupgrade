...
public class ContainerMenuElectricElectronicsAssembler
        extends ContainerMenuFullInv<BlockEntityElectronicsAssembler> {

    public ContainerMenuElectricElectronicsAssembler(Player entityPlayer, BlockEntityElectronicsAssembler tileEntity1) {
        this(entityPlayer, tileEntity1, 166, 152, 8);
    }

    public ContainerMenuElectricElectronicsAssembler(
            Player entityPlayer,
            BlockEntityElectronicsAssembler tileEntity1,
            int height,
            int upgradeX,
            int upgradeY
    ) {
        ...
        if ((tileEntity1).inputSlotA != null) {
            addSlotToContainer(new SlotInvSlot((tileEntity1).inputSlotA, 3, 43, 30));
        }
        if ((tileEntity1).outputSlot != null) {
            addSlotToContainer(new SlotInvSlot((tileEntity1).outputSlot, 0, 122, 19));
        }
        if ((tileEntity1).inputSlotA != null) {

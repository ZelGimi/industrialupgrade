...
import com.denfop.blockentity.base.BlockEntityQuantumMolecular;
import net.minecraft.world.entity.player.Player;
import net.minecraft.world.inventory.Slot;

public class ContainerMenuQuantumMolecular extends ContainerMenuBase<BlockEntityQuantumMolecular> {

    public ContainerMenuQuantumMolecular(Player entityPlayer, BlockEntityQuantumMolecular tileEntity1) {

...
public class ContainerMenuStamp extends ContainerMenuFullInv<BlockEntityStampMechanism> {

    public ContainerMenuStamp(BlockEntityStampMechanism tleEntityMatterFactory, Player var1) {

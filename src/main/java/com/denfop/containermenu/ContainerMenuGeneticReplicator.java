...
import com.denfop.blockentity.mechanism.BlockEntityGeneticReplicator;
import com.denfop.containermenu.slot.SlotInvSlot;
import net.minecraft.world.entity.player.Player;

public class ContainerMenuGeneticReplicator extends ContainerMenuFullInv<BlockEntityGeneticReplicator> {

    public ContainerMenuGeneticReplicator(Player entityPlayer, BlockEntityGeneticReplicator tileEntity1) {

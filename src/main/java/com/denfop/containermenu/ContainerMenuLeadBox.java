...
public class ContainerMenuLeadBox extends ContainerMenuHandHeldInventory<ItemStackLeadBox> {


    public final int inventorySize;
    private final int current;

    public ContainerMenuLeadBox(Player player, ItemStackLeadBox Toolbox1) {

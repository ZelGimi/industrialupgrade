...
public class ContainerMenuMultiCrop extends ContainerMenuFullInv<BlockEntityMultiCrop> {

    public ContainerMenuMultiCrop(BlockEntityMultiCrop tileEntityMultiCrop, Player var1) {

...
public class ContainerMenuUpgradeMachineFactory extends ContainerMenuFullInv<BlockEntityUpgradeMachineFactory> {

    public ContainerMenuUpgradeMachineFactory(BlockEntityUpgradeMachineFactory tileEntityBatteryFactory, Player var1) {

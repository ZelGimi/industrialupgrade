...
public class ContainerMenuWaterMainController extends ContainerMenuFullInv<BlockEntityMainController> {

    public ContainerMenuWaterMainController(BlockEntityMainController tileEntityMainController, Player entityPlayer) {

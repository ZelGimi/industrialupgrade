...
import com.denfop.blockentity.mechanism.BlockEntityChickenFarm;
import com.denfop.containermenu.slot.SlotInvSlot;
import net.minecraft.world.entity.player.Player;

public class ContainerMenuChickenFarm extends ContainerMenuFullInv<BlockEntityChickenFarm> {

    public ContainerMenuChickenFarm(BlockEntityChickenFarm tileEntityChickenFarm, Player var1) {

...
public class ContainerMenuUpgrade extends ContainerMenuHandHeldInventory<ItemStackUpgradeModules> {


    public ContainerMenuUpgrade(ItemStackUpgradeModules Toolbox1, Player player) {

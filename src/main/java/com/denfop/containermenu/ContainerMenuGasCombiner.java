...
public class ContainerMenuGasCombiner extends ContainerMenuFullInv<BlockEntityGasCombiner> {

    public ContainerMenuGasCombiner(Player entityPlayer, BlockEntityGasCombiner tileEntity1) {

...
public class ContainerMenuGasMainController extends ContainerMenuFullInv<BlockEntityMainController> {

    public ContainerMenuGasMainController(BlockEntityMainController tileEntityMainController, Player entityPlayer) {

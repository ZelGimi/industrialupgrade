...
public class ContainerMenuVeinSensor extends ContainerMenuHandHeldInventory<ItemStackVeinSensor> {


    private final int current;

    public ContainerMenuVeinSensor(Player player, ItemStackVeinSensor Toolbox1) {
        super(Toolbox1, null);

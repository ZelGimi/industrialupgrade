...
import com.denfop.blockentity.mechanism.BlockEntitySawmill;
import net.minecraft.world.entity.player.Player;

public class ContainerMenuSawmill extends ContainerMenuFullInv<BlockEntitySawmill> {

    public ContainerMenuSawmill(final Player player, final BlockEntitySawmill base) {
        super(player, base);

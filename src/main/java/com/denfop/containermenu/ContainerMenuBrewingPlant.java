...
import com.denfop.blockentity.mechanism.BlockEntityBrewingPlant;
import net.minecraft.world.entity.player.Player;

public class ContainerMenuBrewingPlant extends ContainerMenuFullInv<BlockEntityBrewingPlant> {

    public ContainerMenuBrewingPlant(final Player player, final BlockEntityBrewingPlant base) {
        super(player, base);

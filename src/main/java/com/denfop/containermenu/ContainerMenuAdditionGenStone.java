...
public class ContainerMenuAdditionGenStone extends ContainerMenuFullInv<BlockEntityBaseAdditionGenStone> {

    public ContainerMenuAdditionGenStone(Player entityPlayer, BlockEntityBaseAdditionGenStone tileEntity1) {
        this(entityPlayer, tileEntity1, 166, 56 - 48, 53, 152, 8);
    }

    public ContainerMenuAdditionGenStone(
            Player entityPlayer, BlockEntityBaseAdditionGenStone tileEntity1, int height, int dischargeX, int dischargeY,

...
public class ContainerMenuProbeAssembler extends ContainerMenuFullInv<BlockEntityProbeAssembler> {

    public ContainerMenuProbeAssembler(BlockEntityProbeAssembler tileEntityBatteryFactory, Player var1) {

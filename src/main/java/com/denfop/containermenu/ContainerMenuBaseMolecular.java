...
public class ContainerMenuBaseMolecular extends ContainerMenuBase<BlockEntityMolecularTransformer> {

    public ContainerMenuBaseMolecular(Player entityPlayer, BlockEntityMolecularTransformer tileEntity1) {

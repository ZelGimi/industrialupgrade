...
public class ContainerMenuWaterGenerator extends ContainerMenuFullInv<BlockEntityWaterGenerator> {

    public ContainerMenuWaterGenerator(Player entityPlayer, BlockEntityWaterGenerator tileEntity1) {

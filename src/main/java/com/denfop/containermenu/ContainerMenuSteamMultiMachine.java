...
public class ContainerMenuSteamMultiMachine extends ContainerMenuFullInv<BlockEntitySteamMultiMachine> {

    public ContainerMenuSteamMultiMachine(Player entityPlayer, BlockEntitySteamMultiMachine tileEntity1, int sizeWorkingSlot) {
    ...
    public ContainerMenuSteamMultiMachine(
            Player entityPlayer,
            BlockEntitySteamMultiMachine tileEntity1,
            int sizeWorkingSlot,
            boolean jei
    ) {
        super(entityPlayer, tileEntity1, 166);

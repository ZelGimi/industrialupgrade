...
public class ContainerMenuRefrigeratorFluids extends ContainerMenuFullInv<BlockEntityRefrigeratorFluids> {

    public ContainerMenuRefrigeratorFluids(Player entityPlayer, BlockEntityRefrigeratorFluids tileEntity1) {

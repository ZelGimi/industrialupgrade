...
public class ContainerMenuItemDividerFluids extends ContainerMenuFullInv<BlockEntityItemDividerFluids> {

    public ContainerMenuItemDividerFluids(Player var1, BlockEntityItemDividerFluids tileEntity1) {

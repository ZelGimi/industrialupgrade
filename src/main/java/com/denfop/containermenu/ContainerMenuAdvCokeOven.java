...
import com.denfop.blockentity.adv_cokeoven.BlockEntityCokeOvenMain;
import net.minecraft.world.entity.player.Player;

import javax.annotation.Nonnull;

public class ContainerMenuAdvCokeOven extends ContainerMenuFullInv<BlockEntityCokeOvenMain> {

    public ContainerMenuAdvCokeOven(Player entityPlayer, BlockEntityCokeOvenMain tileEntityBlastFurnaceMain) {

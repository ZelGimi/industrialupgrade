...
public class ContainerMenuGeneticStabilizer extends ContainerMenuFullInv<BlockEntityGeneticStabilize> {

    public ContainerMenuGeneticStabilizer(Player var1, BlockEntityGeneticStabilize tileEntity1) {

...
public class ContainerMenuGeneticPolymerizer extends ContainerMenuFullInv<BlockEntityGeneticPolymerizer> {

    public ContainerMenuGeneticPolymerizer(Player entityPlayer, BlockEntityGeneticPolymerizer tileEntity1) {
        this(entityPlayer, tileEntity1, 166, 56, 53, 56, 17, 116, 35, 152, 8);
    }

    public ContainerMenuGeneticPolymerizer(
            Player entityPlayer, BlockEntityGeneticPolymerizer tileEntity1, int height, int dischargeX,

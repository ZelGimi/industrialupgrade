...
import com.denfop.blockentity.mechanism.BlockEntityRNACollector;
import net.minecraft.world.entity.player.Player;

public class ContainerMenuRNACollector extends ContainerMenuFullInv<BlockEntityRNACollector> {

    public ContainerMenuRNACollector(Player var1, BlockEntityRNACollector tileEntity1) {

...
public class ContainerMenuBeeAnalyzer extends ContainerMenuHandHeldInventory<ItemStackBeeAnalyzer> {


    public final int inventorySize;
    private final int current;

    public ContainerMenuBeeAnalyzer(Player player, ItemStackBeeAnalyzer Toolbox1) {
        super(Toolbox1, null);
        this.player = player;

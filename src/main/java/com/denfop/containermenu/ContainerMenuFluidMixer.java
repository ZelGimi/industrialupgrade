...
import com.denfop.blockentity.mechanism.BlockEntityFluidMixer;
import net.minecraft.world.entity.player.Player;

public class ContainerMenuFluidMixer extends ContainerMenuFullInv<BlockEntityFluidMixer> {

    public ContainerMenuFluidMixer(Player entityPlayer, BlockEntityFluidMixer tileEntity1) {

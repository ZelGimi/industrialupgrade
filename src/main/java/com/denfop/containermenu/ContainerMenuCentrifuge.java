...
import com.denfop.blockentity.mechanism.BlockEntityCentrifuge;
import net.minecraft.world.entity.player.Player;

public class ContainerMenuCentrifuge extends ContainerMenuFullInv<BlockEntityCentrifuge> {

    public ContainerMenuCentrifuge(final Player player, final BlockEntityCentrifuge base) {
        super(player, base);

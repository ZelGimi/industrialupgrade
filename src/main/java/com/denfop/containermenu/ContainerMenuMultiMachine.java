...
public class ContainerMenuMultiMachine extends ContainerMenuFullInv<BlockEntityMultiMachine> {

    public ContainerMenuMultiMachine(Player entityPlayer, BlockEntityMultiMachine tileEntity1, int sizeWorkingSlot) {
    ...
    public ContainerMenuMultiMachine(Player entityPlayer, BlockEntityMultiMachine tileEntity1, int sizeWorkingSlot, boolean jei) {
        super(entityPlayer, tileEntity1, 166);
        for (int i = 0; i < sizeWorkingSlot; i++) {
            int xDisplayPosition1 = 80 + (32 - sizeWorkingSlot) * i - sizeWorkingSlot * 10;
            addSlotToContainer(new SlotInvSlot(tileEntity1.multi_process.inputSlots, i,

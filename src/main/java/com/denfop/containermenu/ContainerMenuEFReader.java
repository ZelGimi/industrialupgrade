...
public class ContainerMenuEFReader extends ContainerMenuHandHeldInventory<EFReaderInventory> {

    private final EnergyTile tile;
    private final int current;

    public ContainerMenuEFReader(EFReaderInventory efReaderInventory, final ItemStack itemStack1, Player player) {
        ...
        this.tile = EnergyNetGlobal.instance.getTile(efReaderInventory.player.getLevel(), pos);
    }
    ...
    public void broadcastChanges() {
        ...
        NodeStats nodeStats = EnergyNetGlobal.instance.getNodeStats(this.tile, player.level);

...
public class ContainerMenuOilRefiner extends ContainerMenuFullInv<BlockEntityOilRefiner> {

    public ContainerMenuOilRefiner(Player entityPlayer, BlockEntityOilRefiner tileEntity1) {

...
import com.denfop.blockentity.mechanism.BlockEntityReverseTransriptor;
import net.minecraft.world.entity.player.Player;

public class ContainerMenuReverseTransriptor extends ContainerMenuFullInv<BlockEntityReverseTransriptor> {

    public ContainerMenuReverseTransriptor(Player entityPlayer, BlockEntityReverseTransriptor tileEntity1) {

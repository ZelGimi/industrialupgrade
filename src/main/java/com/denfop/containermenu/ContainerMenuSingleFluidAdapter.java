...
public class ContainerMenuSingleFluidAdapter extends ContainerMenuFullInv<BlockEntitySingleFluidAdapter> {

    public ContainerMenuSingleFluidAdapter(Player var1, BlockEntitySingleFluidAdapter tileEntity1) {

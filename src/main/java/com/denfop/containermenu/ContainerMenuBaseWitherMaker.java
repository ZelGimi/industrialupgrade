...
public class ContainerMenuBaseWitherMaker
        extends ContainerMenuFullInv<BlockEntityBaseWitherMaker> {

    public ContainerMenuBaseWitherMaker(Player entityPlayer, BlockEntityBaseWitherMaker tileEntity1) {
        this(entityPlayer, tileEntity1, 166, 152, 8);
    }

    public ContainerMenuBaseWitherMaker(
            Player entityPlayer,
            BlockEntityBaseWitherMaker tileEntity1,
            int height,
            int upgradeX,
            int upgradeY
    ) {

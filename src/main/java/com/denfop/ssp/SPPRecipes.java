...
public final class SPPRecipes {
    ...
    static void addCraftingRecipes() {
        ...
        addShapedRecipe(
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.bluecomponent),
                "AAA",
                "BBB",
                "AAA",
                'A',
        ...
        addShapedRecipe(
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.solarsplitter),
                "ABC",
                "ABC",
                "ABC",
                'A',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.redcomponent),
                'B',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.greencomponent),
                'C',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.bluecomponent)
        );
        addShapedRecipe(
                ...
                "A  ",
                'A',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.IRRADIANT_GLASS_PANE)
        );
        ...
        addShapedRecipe(
                ...
                'I',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.IRIDIUM_IRON_PLATE)
        );
        addShapedRecipe(
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.IRRADIANT_REINFORCED_PLATE),
                "RSR",
                "LIL",
                "RDR",
                ...
                Items.REDSTONE,
                'S',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.SUNNARIUM_PART),
                'L',
                new ItemStack(Items.DYE, 1, 4),
                'I',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.REINFORCED_IRIDIUM_IRON_PLATE),
        ...
        addShapelessRecipe(
                StackUtil.setSize(SuperSolarPanels.machines.getItemStack(SSPBlock.hybrid_solar_panel), 4),
                SuperSolarPanels.machines
        ...
        addShapedRecipe(
                ...
                'S',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.ENRICHED_SUNNARIUM),
                'A',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.SUNNARIUM_ALLOY)
        );
        ...
        addShapedRecipe(
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.enderquantumcomponent),
                "ABA",
                "BCB",
                "ABA",
                'A',
        ...
        addShapedRecipe(
                ...
                " B ",
                'A',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.spectralcore),
                'B',
        ...
        addShapedRecipe(
                ...
                " B ",
                'A',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.singularcore),
                'B',
                SuperSolarPanels.machines.getItemStack(SSPBlock.proton_solar_panel)
        );
        addShapedRecipe(
        ...
        addShapedRecipe(
                ...
                SuperSolarPanels.machines.getItemStack(SSPBlock.admin_solar_panel),
                'A',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.quantcore1)
        );
        addShapedRecipe(
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.singularcore),
                "ABA",
        ...
        addCompressorRecipe(
                input.forStack(SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.photoniy), 9),
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.photoniy_ingot)
        );
        addShapedRecipe(
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.spectralcore),
                ...
                "CBC",
                'A',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.QUANTUM_CORE),
                'B',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.photoniy),
                'C',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.solarsplitter)
        );
        addShapedRecipe(
                new ItemStack(SSPItems.GRAVI_CHESTPLATE.getInstance()),
                "CBC",
                "CAC",
                " H ",
                'A',
                ...
                'B',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.quantumitems6),
                'C',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.QuantumItems3),
                'H',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.QuantumItems5)
        );
        addShapedRecipe(
                new ItemStack(SSPItems.QUANTUM_LEGGINGS.getInstance()),
                "CBC",
                "CAC",
                " H ",
                'A',
        ...
        addShapedRecipe(
                new ItemStack(SSPItems.QUANTUM_BOOSTS.getInstance()),
                "CBC",
                "CAC",
                " H ",
                'A',
        ...
        addShapedRecipe(
                ...
                IC2Items.getItem("crafting", "carbon_plate"),
                'B',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.nanobox),
                'C',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.QuantumItems4)
        );
        addShapedRecipe(
                new ItemStack(SSPItems.QUANTUM_HELMET.getInstance()),
                "CBC",
                "CAC",
                " H ",
                'A',
        ...
        //
        addShapedRecipe(
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.EnrichedSunnariumAlloy4),
                "ABA",
                'A',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.ENRICHED_SUNNARIUM_ALLOY),
                'B',
        ...
        addShapedRecipe(
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.EnrichedSunnariumAlloy3),
                "ABA",
                'A',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.EnrichedSunnariumAlloy4),
                'B',
        ...
        addShapedRecipe(
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.EnrichedSunnariumAlloy2),
                "ABA",
                'A',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.EnrichedSunnariumAlloy3),
                'B',
        ...
        addCompressorRecipe(
                input.forStack(SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.QuantumItems2), 9),
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.QuantumItems4)
        );
        addShapedRecipe(
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.quantumitems6),
        ...
        addCompressorRecipe(
                input.forStack(IC2Items.getItem("dust", "energium"), 9),
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.dust)
        );
        ...
        addExtrudingRecipe(
                input.forStack(IC2Items.getItem("crafting", "iridium")),
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.IRIDIUM_INGOT)
        );
        addCompressorRecipe(
                input.forStack(IC2Items.getItem("resource", "uranium_ore")),
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.URANIUM_INGOT)
        );
        addCompressorRecipe(
                input.forStack(IC2Items.getItem("crushed", "uranium")),
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.URANIUM_INGOT)
        );
        addCompressorRecipe(
                input.forStack(IC2Items.getItem("purified", "uranium")),
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.URANIUM_INGOT)
        );
        addCompressorRecipe(
                input.forStack(IC2Items.getItem("nuclear", "uranium")),
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.URANIUM_INGOT)
        );
//
        addCompressorRecipe(
                input.forStack(IC2Items.getItem("crafting", "carbon_plate"), 9),
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.compresscarbon)
        );
        addCompressorRecipe(
                input.forStack(IC2Items.getItem("crafting", "alloy"), 9),
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.compresscarbonultra)
        );
        addExtrudingRecipe(
                input.forStack(IC2Items.getItem("crafting", "coal_chunk"), 9),
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.coal_chunk)
        );
        addCompressorRecipe(
                input.forStack(IC2Items.getItem("nuclear", "plutonium")),
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.protonshard)
        );
        addCompressorRecipe(
                input.forStack(SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.protonshard), 18),
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.proton)
        );
        addShapedRecipe(
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.protoncore),
                " B ",
                "ACA",
                " B ",
                'A',
        ...
        if (fluidStack.getFluid() != null) {
            addCompressorRecipe(
                    input.forStack(FluidUtil.getFilledBucket(fluidStack)),
                    SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.neutronshard)
            );
        } else {
        ...
        addCompressorRecipe(
                input.forStack(SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.neutronshard), 9),
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.neutron)
        );
        addShapedRecipe(
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.neutroncore),
                " A ",
                "ABA",
                " A ",
                'A',
        ...
        addShapedRecipe(
                SuperSolarPanels.machines.getItemStack(SSPBlock.neutronium_solar_panel),
                " B ",
                "BAB",
                " B ",
                'A',
        ...
        addShapedRecipe(
                SuperSolarPanels.machines.getItemStack(SSPBlock.nutronfabricator),
                " A ",
                "BCB",
                " A ",
                'A',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.enderquantumcomponent),
                'C',
                IC2Items.getItem("te", "matter_generator"),
                'B',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.QuantumItems5)
        );
        addShapedRecipe(
                SuperSolarPanels.machines.getItemStack(SSPBlock.transformator),
                "BCB",
                'C',
                IC2Items.getItem("te", "ev_transformer"),
                'B',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.quantumitems6)
        );
        addShapedRecipe(
                SuperSolarPanels.machines.getItemStack(SSPBlock.transformator1),
                "BCB",
                'C',
                SuperSolarPanels.machines.getItemStack(SSPBlock.transformator),
                'B',
        ...
        addShapedRecipe(
                SuperSolarPanels.machines.getItemStack(SSPBlock.transformator2),
                "BCB",
                'C',
                SuperSolarPanels.machines.getItemStack(SSPBlock.transformator1),
                'B',
        ...
        addShapedRecipe(
                SuperSolarPanels.machines.getItemStack(SSPBlock.transformator3),
                "BCB",
                'C',
                SuperSolarPanels.machines.getItemStack(SSPBlock.transformator2),
                'B',
        ...
        addShapedRecipe(
                SuperSolarPanels.machines.getItemStack(SSPBlock.transformator4),
                "BCB",
                'C',
                SuperSolarPanels.machines.getItemStack(SSPBlock.transformator3),
                'B',
        ...
        addShapedRecipe(
                SuperSolarPanels.machines.getItemStack(SSPBlock.transformator5),
                "BCB",
                'C',
                SuperSolarPanels.machines.getItemStack(SSPBlock.transformator4),
                'B',
        ...
        //
        addShapedRecipe(
                SuperSolarPanels.machines.getItemStack(SSPBlock.ultimatemfsu),
                " B ",
                "BCB",
                " B ",
                'B',
                SuperSolarPanels.machines.getItemStack(SSPBlock.advancedmfsu),
                'C',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.quantumitems6)
        );
        addShapedRecipe(
                SuperSolarPanels.machines.getItemStack(SSPBlock.quantummfsu),
                " B ",
                "BCB",
                " B ",
                'B',
...
//
        ...
        //
        addShapedRecipe(
                SuperSolarPanels.machines.getItemStack(SSPBlock.spectral_solar_panelsun),
                "BA",
                'A',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.sunlinse),
                'B',
                SuperSolarPanels.machines.getItemStack(SSPBlock.spectral_solar_panel)
        );
        addShapedRecipe(
                SuperSolarPanels.machines.getItemStack(SSPBlock.singular_solar_panelsun),
                "BA",
                'A',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.sunlinse),
                'B',
        ...
        addShapedRecipe(
                SuperSolarPanels.machines.getItemStack(SSPBlock.admin_solar_panelsun),
                "BA",
                'A',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.sunlinse),
                'B',
        ...
        addShapedRecipe(
                SuperSolarPanels.machines.getItemStack(SSPBlock.photonic_solar_panelsun),
                "BA",
                'B',
                SuperSolarPanels.machines.getItemStack(SSPBlock.photonic_solar_panel),
                'A',
        ...
        addShapedRecipe(
                SuperSolarPanels.machines.getItemStack(SSPBlock.spectral_solar_panelrain),
                "BA",
                'A',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.rainlinse),
                'B',
                SuperSolarPanels.machines.getItemStack(SSPBlock.spectral_solar_panel)
        );
        addShapedRecipe(
                SuperSolarPanels.machines.getItemStack(SSPBlock.singular_solar_panelrain),
                "BA",
                'A',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.rainlinse),
                'B',
        ...
        addShapedRecipe(
                SuperSolarPanels.machines.getItemStack(SSPBlock.admin_solar_panelrain),
                "BA",
                'A',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.rainlinse),
                'B',
        ...
        addShapedRecipe(
                SuperSolarPanels.machines.getItemStack(SSPBlock.photonic_solar_panelrain),
                "BA",
                'B',
                SuperSolarPanels.machines.getItemStack(SSPBlock.photonic_solar_panel),
                'A',
        ...
        addShapedRecipe(
                SuperSolarPanels.machines.getItemStack(SSPBlock.proton_solar_panelsun),
                "BA",
                'A',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.sunlinse),
                'B',
        ...
        addShapedRecipe(
                SuperSolarPanels.machines.getItemStack(SSPBlock.neutronium_solar_panelsun),
                "BA",
                'A',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.sunlinse),
                'B',
        ...
        addShapedRecipe(
                SuperSolarPanels.machines.getItemStack(SSPBlock.proton_solar_panelrain),
                "BA",
                'A',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.rainlinse),
                'B',
        ...
        addShapedRecipe(
                SuperSolarPanels.machines.getItemStack(SSPBlock.neutronium_solar_panelrain),
                "BA",
                'A',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.rainlinse),
                'B',
        ...
        addShapedRecipe(
                SuperSolarPanels.machines.getItemStack(SSPBlock.advanced_solar_panelsun),
                "BA",
                'A',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.sunlinse),
                'B',
        ...
        addShapedRecipe(
                SuperSolarPanels.machines.getItemStack(SSPBlock.hybrid_solar_panelsun),
                "BA",
                'A',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.sunlinse),
                'B',
                SuperSolarPanels.machines.getItemStack(SSPBlock.hybrid_solar_panel)
        );
        addShapedRecipe(
                SuperSolarPanels.machines.getItemStack(SSPBlock.advanced_solar_panelrain),
                "BA",
                'A',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.rainlinse),
                'B',
        ...
        addShapedRecipe(
                SuperSolarPanels.machines.getItemStack(SSPBlock.hybrid_solar_panelrain),
                "BA",
                'A',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.rainlinse),
                'B',
        ...
        addShapedRecipe(
                SuperSolarPanels.machines.getItemStack(SSPBlock.ultimate_solar_panelsun),
                "BA",
                'A',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.sunlinse),
                'B',
                SuperSolarPanels.machines.getItemStack(SSPBlock.ultimate_solar_panel)
        );
        addShapedRecipe(
                SuperSolarPanels.machines.getItemStack(SSPBlock.quantum_solar_panelsun),
                "BA",
                'A',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.sunlinse),
                'B',
        ...
        addShapedRecipe(
                SuperSolarPanels.machines.getItemStack(SSPBlock.ultimate_solar_panelrain),
                "BA",
                'A',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.rainlinse),
                'B',
        ...
        addShapedRecipe(
                SuperSolarPanels.machines.getItemStack(SSPBlock.quantum_solar_panelrain),
                "BA",
                'A',
                SSPItems.CRAFTING.getItemStack(CraftingThings.CraftingTypes.rainlinse),
                'B',
    ...
    private static boolean decodeLine(int number, String[] parts) throws ParseException {
        ...
        if (output == null) {
            ...
            if (attempt.startsWith("OreDict:")) {
                ...
                if (!nonNullList.isEmpty()) {
                    ...
                    SuperSolarPanels.log.debug(
                            "Continued on line {} as the output ({}) could be resolved to {}",
                            number,
                            attempt,
                            output
                    );
        ...
        try {
            ...
            SuperSolarPanels.log.warn(
                    "Skipping line {} as the energy ({}) cannot be resolved to a number",
                    number,
                    parts[2].trim()
            );
            return false;

...
public enum SSPItems {
    ...
    MAX_HEAT_STORAGE,
    PROTON_FUEL_ROD,
    QUAD_PROTON_FUEL_ROD,
    EIT_PROTON_FUEL_ROD,
    DUAL_PROTON_FUEL_ROD,
    DRILL,
    IRIDIUM_ROTOR,
    COMPRESS_IRIDIUM_ROTOR,
    SPECTRAL;
    //battery_su
    ...
    public static void buildItems(Side side) {
        ...
        ADVANCED_CRYSTAL.setInstance(new ItemBattery(
                "spectral_battery",
                Configs.maxCharge8,
                Configs.transferLimit8,
                Configs.tier8
        ));
        QUANTUM_SABER.setInstance(new ItemNanoSaber(
                "quantumsaber",
                10,
                HarvestLevel.Diamond,
                ToolClass.Sword,
                Configs.maxCharge1,
                Configs.transferLimit1,
                Configs.tier1,
                Configs.damage1,
                Configs.damage2
        ));
        SPECTRAL_SABER.setInstance(new ItemNanoSaber(
                "spectralsaber",
                10,
                HarvestLevel.Diamond,
                ToolClass.Sword,
                Configs.maxCharge2,
                Configs.transferLimit2,
                Configs.tier2,
                Configs.damage3,
                Configs.damage4
        ));
        ...
        IRIDIUM_ROTOR.setInstance(new ItemWindRotor(
                "rotor_carbon1",
                Configs.iridiumRotorRadius,
                Configs.rotor_carbon1,
                Configs.coefficient,
                Configs.minWindStrength,
                Configs.maxWindStrength,
                SuperSolarPanels.getIdentifier("textures/items/carbon_rotor_model1.png")
        ));
        COMPRESS_IRIDIUM_ROTOR.setInstance(new ItemWindRotor(
                "rotor_carbon2",
                Configs.compressIridiumRotorRadius,
                Configs.rotor_carbon2,
                Configs.coefficient1,
                Configs.minWindStrength1,
                Configs.maxWindStrength1,
                SuperSolarPanels.getIdentifier("textures/items/carbon_rotor_model2.png")
        ));
        SPECTRAL.setInstance(new ItemWindRotor(
                "rotor_carbon3",
                Configs.spectralRotorRadius,
                Configs.rotor_carbon3,
                Configs.coefficient2,
                Configs.minWindStrength2,
                Configs.maxWindStrength2,
                SuperSolarPanels.getIdentifier("textures/items/carbon_rotor_model3.png")
        ));
        if (side == Side.CLIENT) {
            doModelGuf();
        }

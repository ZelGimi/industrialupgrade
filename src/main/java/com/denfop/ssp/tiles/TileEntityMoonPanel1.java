...
private final int nightPower1;
  ...
  public String getOutput() {
    switch (this.active) {
    case Nighty1:
        return String.format("%s %d %s", Localization.translate("super_solar_panels.gui.generating"), (int) (this.nightPower * 1.5), Localization.translate("ic2.generic.text.EUt"));

...
public class QuantumMFSU extends TileEntityInventory implements IEnergyStorage, IHasGui {
	...
	public ContainerBase<?> getGuiContainer(EntityPlayer player) {
		try {
			return DynamicContainer.create((IInventory) this, player, GuiParser.parse(new ResourceLocation(Constants.MOD_ID, "guidef/QuantumMFSU.xml"), this.teBlock.getTeClass()));
	...
	public GuiScreen getGui(EntityPlayer player, boolean b) {
		try {
			return DynamicGui.create((IInventory) this, player, GuiParser.parse(new ResourceLocation(Constants.MOD_ID, "guidef/QuantumMFSU.xml"), this.teBlock.getTeClass()));
		} catch (Exception exception) {
			return null;
		}
	}

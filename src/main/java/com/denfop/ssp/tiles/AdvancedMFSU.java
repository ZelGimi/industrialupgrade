...
public class AdvancedMFSU extends TileEntityInventory implements IEnergyStorage, IHasGui {
	...
	private final Energy energy = (Energy) addComponent((TileEntityComponent) (new Energy(this, Configs.advancedmfsu2, EnumSet.complementOf((EnumSet) EnumSet.of(EnumFacing.DOWN)),
	...
	public ContainerBase<?> getGuiContainer(EntityPlayer player) {
		try {
			return DynamicContainer.create((IInventory) this, player, GuiParser.parse(new ResourceLocation("super_solar_panels", "guidef/AdvancedMFSU.xml"), this.teBlock.getTeClass()));
	...
	public GuiScreen getGui(EntityPlayer player, boolean b) {
		try {
			return DynamicGui.create((IInventory) this, player, GuiParser.parse(new ResourceLocation("super_solar_panels", "guidef/AdvancedMFSU.xml"), this.teBlock.getTeClass()));
		} catch (Exception exception) {
			return null;
		}
	}

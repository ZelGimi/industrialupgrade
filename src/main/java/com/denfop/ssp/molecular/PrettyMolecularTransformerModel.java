...
public class PrettyMolecularTransformerModel extends ModelBase {
    ...
    final ModelRenderer coreWorkZone;

    final ModelRenderer coreTopElectr;

    final ModelRenderer coreTopPlate;

    final ModelRenderer firstElTop;

    final ModelRenderer firstElBottom;

    final ModelRenderer secondElTop;

    final ModelRenderer secondElBottom;

    final ModelRenderer thirdElTop;

    final ModelRenderer thirdElBottom;
    ...
    public PrettyMolecularTransformerModel() {
        ...
        setRotation(this.coreBottom, 0.0F);
        ...
        setRotation(this.coreWorkZone, 0.0F);
        ...
        setRotation(this.coreTopElectr, 0.0F);
        ...
        setRotation(this.coreTopPlate, 0.0F);
        ...
        setRotation(this.firstElTop, 0.0F);
        ...
        setRotation(this.firstElBottom, 0.0F);
        ...
        setRotation(this.secondElTop, -2.094395F);
        ...
        setRotation(this.secondElBottom, -2.094395F);
        ...
        setRotation(this.thirdElTop, 2.094395F);
        ...
        setRotation(this.thirdElBottom, 2.094395F);
    }

    private void setRotation(ModelRenderer model, float y) {

...
public class PrettyMolecularTransformerTESR extends TileEntitySpecialRenderer<TileEntityMolecularAssembler> {
    ...
    private static final ResourceLocation transfTextloc = SuperSolarPanels.getIdentifier(
            "textures/models/textureMolecularTransformer.png");
    ...
    public void render(
            @Nonnull TileEntityMolecularAssembler tileTransformer,
            double x,
            double y,
            double z,
            float partialTicks,
    ...
    public void renderCore(TileEntity te, double x, double y, double z) {
        ...
        buffer.pos(
                (posX - rotationX * scaleCore - rotationYZ * scaleCore),

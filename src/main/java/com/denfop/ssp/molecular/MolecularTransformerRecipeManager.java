...
public class MolecularTransformerRecipeManager extends
        MachineRecipeHelper<IMolecularTransformerRecipeManager.Input, ItemStack> implements IMolecularTransformerRecipeManager {
    ...
    public boolean addRecipe(
            IMolecularTransformerRecipeManager.Input input,
            ItemStack output,
        ...
        MachineRecipe<IMolecularTransformerRecipeManager.Input, ItemStack> recipe = new MachineRecipe<>(
                input,
                output.copy(),
                metadata
        );

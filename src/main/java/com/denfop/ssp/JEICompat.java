...
public final class JEICompat implements IModPlugin {
    ...
    private <T> void addMachineRecipes(IModRegistry registry, IORecipeCategory<T> category) {
        ...
        registry.addRecipes(
                ((IRecipeWrapperGenerator<T>) MolecularTransformerRecipeWrapper.RECIPE_WRAPPER).getRecipeList(category),
                category.getUid()
        );
    ...
    protected static class MolecularTransformerRecipeWrapper extends IORecipeWrapper {
        ...
        public static final IRecipeWrapperGenerator<IMolecularTransformerRecipeManager> RECIPE_WRAPPER = category -> {
            ...
            for (MachineRecipe<IMolecularTransformerRecipeManager.Input, ItemStack> container : IMolecularTransformerRecipeManager.RECIPES
                    .getRecipes()) {
        ...
        MolecularTransformerRecipeWrapper(
                MachineRecipe<IMolecularTransformerRecipeManager.Input, ItemStack> container,
                IORecipeCategory<?> category
        ) {

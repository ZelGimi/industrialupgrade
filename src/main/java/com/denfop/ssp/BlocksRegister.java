...
public class BlocksRegister {
	...
	public static final Block iridium_Block = new SSPB(Material.ROCK, "iridium_block", 8.0F, 15.0F, "pickaxe", 2, SoundType.STONE);
	public static final Block platiumOre = new SSPOre(Material.ROCK, "platium_ore", 5.0F, 8.0F, "pickaxe", 3, SoundType.STONE);

	public static final Block platium_Block = new SSPB(Material.ROCK, "platium_block", 8.0F, 15.0F, "pickaxe", 2, SoundType.STONE);
	...
	//
	public static final Block chromium_Block = new SSPB(Material.ROCK, "chromium_block", 8.0F, 15.0F, "pickaxe", 2, SoundType.STONE);
	public static final Block wolfram_Block = new SSPB(Material.ROCK, "wolfram_block", 8.0F, 15.0F, "pickaxe", 2, SoundType.STONE);

	public static final Block magnesium_Block = new SSPB(Material.ROCK, "magnesium_block", 8.0F, 15.0F, "pickaxe", 2, SoundType.STONE);
	public static final Block maltsev_Block = new SSPB(Material.ROCK, "maltsev_block", 8.0F, 15.0F, "pickaxe", 2, SoundType.STONE);

	public static final Block mikhail_Block = new SSPB(Material.ROCK, "mikhail_block", 8.0F, 15.0F, "pickaxe", 2, SoundType.STONE);

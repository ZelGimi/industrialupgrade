...
public final class Configs {
    ...
    private static void loadNormalConfig(final File configFile, final boolean client) {
        ...
        try {
            config.load();
            TileEntityNeutronSolar.settings = new TileEntitySolarPanel.SolarConfig(
                    config
                            .get("Neutron solar panels", "NeutronGenDay", 10485760)
                            .getInt(10485760),
                    config.get("Neutron solar panels", "NeutronGenNight", 10485760).getInt(10485760),
                    config.get("Neutron solar panels", "NeutronStorage", 800000000).getInt(800000000),
                    config.get("Neutron solar panels", "NeutronTier", 10).getInt(10)
            );
            TileEntityProtonSolar.settings = new TileEntitySolarPanel.SolarConfig(
                    config
                            .get("Proton solar panels", "ProtonGenDay", 32768)
                            .getInt(32768),
                    config.get("Proton solar panels", "ProtonGenNight", 20000).getInt(20000),
                    config.get("Proton solar panels", "ProtonStorage", 999999999).getInt(999999999),
                    config.get("Proton solar panels", "ProtonTier", 6).getInt(6)
            );
            TileEntityAdvancedSolar.settings = new TileEntitySolarPanel.SolarConfig(
                    config
                            .get("Advanced solar panels", "AdvancedSPGenDay", 4)
                            .getInt(4),
                    config.get("Advanced solar panels", "AdvancedSPGenNight", 4).getInt(4),
                    config.get("Advanced solar panels", "AdvancedSPStorage", 16000).getInt(16000),
                    config.get("Advanced solar panels", "AdvancedSPTier", 1).getInt(1)
            );
            TileEntityHybridSolar.settings = new TileEntitySolarPanel.SolarConfig(
                    config
                            .get("Hybrid solar panels", "HybrydSPGenDay", 32)
                            .getInt(32),
                    config.get("Hybrid solar panels", "HybrydSPGenNight", 8).getInt(8),
                    config.get("Hybrid solar panels", "HybrydSPStorage", 50000).getInt(50000),
                    config.get("Hybrid solar panels", "HybrydSPTier", 2).getInt(2)
            );
            TileEntityUltimateHybridSolar.settings = new TileEntitySolarPanel.SolarConfig(
                    config
                            .get("Ultimate solar panels", "UltimateHSPGenDay", 256)
                            .getInt(256),
                    config.get("Ultimate solar panels", "UltimateHSPGenNight", 64).getInt(64),
                    config.get("Ultimate solar panels", "UltimateHSPStorage", 500000).getInt(500000),
                    config.get("Ultimate solar panels", "UltimateHSPTier", 3).getInt(3)
            );
            TileEntityQuantumSolar.settings = new TileEntitySolarPanel.SolarConfig(
                    config
                            .get("Quantum solar panels", "QuantumSPGenDay", 2048)
                            .getInt(2048),
                    config.get("Quantum solar panels", "QuantumSPGenNight", 1024).getInt(1024),
                    config.get("Quantum solar panels", "QuantumSPStorage", 5000000).getInt(5000000),
                    config.get("Quantum solar panels", "QuantumSPTier", 4).getInt(4)
            );

            TileEntitySpectralSolar.settings = new TileEntitySolarPanel.SolarConfig(
                    config
                            .get("Spectral solar panels", "SpecrtalGenDay", 8192)
                            .getInt(8192),
                    config.get("Spectral solar panels", "SpecrtalGenNight", 5000).getInt(5000),
                    config.get("Spectral solar panels", "SpecrtalStorage", 10000000).getInt(10000000),
                    config.get("Spectral solar panels", "SpecrtalTier", 5).getInt(5)
            );
            TileEntitySingularSolar.settings = new TileEntitySolarPanel.SolarConfig(
                    config
                            .get("Singular solar panels", "SingularGenDay", 131072)
                            .getInt(131072),
                    config.get("Singular solar panels", "SingularGenNight", 104857).getInt(104857),
                    config.get("Singular solar panels", "SingularStorage", 50000000).getInt(50000000),
                    config.get("Singular solar panels", "SingularTier", 7).getInt(7)
            );
            TileEntityAdminSolar.settings = new TileEntitySolarPanel.SolarConfig(
                    config
                            .get("Light-Absord solar panels", "Light-AbsordGenDay", 554288)
                            .getInt(554288),
                    config.get("Light-Absord solar panels", "Light-AbsordGenNight", 554288).getInt(554288),
                    config.get("Light-Absord solar panels", "Light-AbsordStorage", 100000000).getInt(100000000),
                    config.get("Light-Absord solar panels", "Light-AbsordTier", 8).getInt(8)
            );
            TileEntityPhotonicSolar.settings = new TileEntitySolarPanel.SolarConfig(
                    config
                            .get("Photonic solar panels", "PhotonicGenDay", 2621440)
                            .getInt(2621440),
                    config.get("Photonic solar panels", "PhotonicGenNight", 2621440).getInt(2621440),
                    config.get("Photonic solar panels", "PhotonicStorage", 400000000).getInt(400000000),
                    config.get("Photonic solar panels", "PhotonicTier", 9).getInt(9)
            );


            TileEntityNeutronRain.settings = new TileEntityRainPanel.SolarConfig(
                    config
                            .get("Neutron Rain panels", "NeutronGenRain", 10485760)
                            .getInt(10485760),
                    config.get("Neutron Rain panels", "NeutronStorage", 800000000).getInt(800000000),
                    config.get("Neutron Rain panels", "NeutronTier", 10).getInt(10)
            );
            TileEntityProtonRain.settings = new TileEntityRainPanel.SolarConfig(
                    config
                            .get("Proton Rain panels", "ProtonGenRain", 20000)
                            .getInt(20000),
                    config.get("Proton solar Rain", "ProtonStorage", 999999999).getInt(999999999),
                    config.get("Proton Rain panels", "ProtonTier", 6).getInt(6)
            );
            TileEntityAdvancedSolarRain.settings = new TileEntityRainPanel.SolarConfig(
                    config
                            .get("Advanced Rain panels", "AdvancedSPGenRain", 4)
                            .getInt(4),
                    config.get("Advanced Rain panels", "AdvancedSPStorage", 16000).getInt(16000),
                    config.get("Advanced Rain panels", "AdvancedSPTier", 1).getInt(1)
            );
            TileEntityHybridSolarrain.settings = new TileEntityRainPanel.SolarConfig(
                    config
                            .get("Hybrid Rain panels", "HybrydSPGenRain", 8)
                            .getInt(8),
                    config.get("Hybrid Rain panels", "HybrydSPStorage", 50000).getInt(50000),
                    config.get("Hybrid Rain panels", "HybrydSPTier", 2).getInt(2)
            );
            TileEntityUltimateHybridSolarRain.settings = new TileEntityRainPanel.SolarConfig(
                    config
                            .get("Ultimate Rain panels", "UltimateHSPGenRain", 64)
                            .getInt(64),
                    config.get("Ultimate Rain panels", "UltimateHSPStorage", 500000).getInt(500000),
                    config.get("Ultimate Rain panels", "UltimateHSPTier", 3).getInt(3)
            );
            TileEntityQuantumSolarRain.settings = new TileEntityRainPanel.SolarConfig(
                    config
                            .get("Quantum Rain panels", "QuantumSPGenRain", 1024)
                            .getInt(1024),
                    config.get("Quantum Rain panels", "QuantumSPStorage", 5000000).getInt(5000000),
                    config.get("Quantum Rain panels", "QuantumSPTier", 4).getInt(4)
            );
            TileEntitySpectralRain.settings = new TileEntityRainPanel.SolarConfig(
                    config
                            .get("Spectral Rain panels", "SpecrtalGenRain", 5000)
                            .getInt(5000),
                    config.get("Spectral solar panels", "SpecrtalStorage", 10000000).getInt(10000000),
                    config.get("Spectral solar panels", "SpecrtalTier", 5).getInt(5)
            );
            TileEntitySingularrain.settings = new TileEntityRainPanel.SolarConfig(
                    config
                            .get("Singular Rain panels", "SingularGenRain", 104857)
                            .getInt(104857),
                    config.get("Singular solar panels", "SingularStorage", 50000000).getInt(50000000),
                    config.get("Singular solar panels", "SingularTier", 7).getInt(7)
            );
            TileEntityAdminRain.settings = new TileEntityRainPanel.SolarConfig(
                    config
                            .get("Light-Absord Rain panels", "Light-AbsordGenRain", 554288)
                            .getInt(554288),
                    config.get("Light-Absord solar panels", "Light-AbsordStorage", 100000000).getInt(100000000),
                    config.get("Light-Absord solar panels", "Light-AbsordTier", 8).getInt(8)
            );
            TileEntityPhotonicRain.settings = new TileEntityRainPanel.SolarConfig(
                    config
                            .get("Photonic Rain panels", "PhotonicGenRain", 2621440)
                            .getInt(2621440),
                    config.get("Photonic solar panels", "PhotonicStorage", 400000000).getInt(400000000),
                    config.get("Photonic solar panels", "PhotonicTier", 9).getInt(9)
            );
            ...
            TileEntityNeutronSun.settings = new TileEntitySunPanel.SolarConfig(
                    config
                            .get("Neutron Sun panels", "NeutronGenSun", 20971520)
                            .getInt(20971520),
                    config.get("Neutron Sun panels", "NeutronStorage", 800000000).getInt(800000000),
                    config.get("Neutron Sun panels", "NeutronTier", 10).getInt(10)
            );
            TileEntityProtonSun.settings = new TileEntitySunPanel.SolarConfig(
                    config
                            .get("Proton Sun panels", "ProtonGenSun", 65536)
                            .getInt(65536),
                    config.get("Proton Sun panels", "ProtonStorage", 999999999).getInt(999999999),
                    config.get("Proton Sun panels", "ProtonTier", 6).getInt(6)
            );
            TileEntityAdvancedSolarSun.settings = new TileEntitySunPanel.SolarConfig(
                    config
                            .get("Advanced Sun panels", "AdvancedSPGenSun", 8)
                            .getInt(8),
                    config.get("Advanced Sun panels", "AdvancedSPStorage", 16000).getInt(16000),
                    config.get("Advanced Sun panels", "AdvancedSPTier", 1).getInt(1)
            );
            TileEntityHybridSolarSun.settings = new TileEntitySunPanel.SolarConfig(
                    config
                            .get("Hybrid Sun panels", "HybrydSPGenSun", 64)
                            .getInt(64),
                    config.get("Hybrid Sun panels", "HybrydSPStorage", 50000).getInt(50000),
                    config.get("Hybrid Sun panels", "HybrydSPTier", 2).getInt(2)
            );
            TileEntityUltimateHybridSolarSun.settings = new TileEntitySunPanel.SolarConfig(
                    config
                            .get("Ultimate Sun panels", "UltimateHSPGenSun", 512)
                            .getInt(512),
                    config.get("Ultimate Sun panels", "UltimateHSPStorage", 500000).getInt(500000),
                    config.get("Ultimate Sun panels", "UltimateHSPTier", 3).getInt(3)
            );
            TileEntityQuantumSolarSun.settings = new TileEntitySunPanel.SolarConfig(
                    config
                            .get("Quantum Sun panels", "QuantumSPGenSun", 4096)
                            .getInt(4096),
                    config.get("Quantum Sun panels", "QuantumSPStorage", 5000000).getInt(5000000),
                    config.get("Quantum Sun panels", "QuantumSPTier", 4).getInt(4)
            );
            TileEntitySpectralSun.settings = new TileEntitySunPanel.SolarConfig(
                    config
                            .get("Spectral Sun panels", "SpecrtalGenSun", 16384)
                            .getInt(16384),
                    config.get("Spectral Sun panels", "SpecrtalStorage", 10000000).getInt(10000000),
                    config.get("Spectral Sun panels", "SpecrtalTier", 5).getInt(5)
            );
            TileEntitySingularSun.settings = new TileEntitySunPanel.SolarConfig(
                    config
                            .get("Singular Sun panels", "SingularGenSun", 262144)
                            .getInt(262144),
                    config.get("Singular Sun panels", "SingularStorage", 50000000).getInt(50000000),
                    config.get("Singular Sun panels", "SingularTier", 7).getInt(7)
            );
            TileEntityAdminSun.settings = new TileEntitySunPanel.SolarConfig(
                    config
                            .get("Light-Absord Sun panels", "Light-AbsordGenSun", 1108576)
                            .getInt(1108576),
                    config.get("Light-Absord Sun panels", "Light-AbsordStorage", 100000000).getInt(100000000),
                    config.get("Light-Absord Sun panels", "Light-AbsordTier", 8).getInt(8)
            );
            TileEntityPhotonicSun.settings = new TileEntitySunPanel.SolarConfig(
                    config
                            .get("Photonic Sun panels", "PhotonicGenSun", 5242880)
                            .getInt(5242880),
                    config.get("Photonic Sun panels", "PhotonicStorage", 400000000).getInt(400000000),
                    config.get("Photonic Sun panels", "PhotonicTier", 9).getInt(9)
            );
            ...
            canCraftDoubleSlabs = !config.get("settings Quantum chestplate", "Disable Effect FIRE RESISTANCE ", false).getBoolean(
                    false);
            canCraftMT = !config.get("settings Quantum Boosts", "Disable Effect WATER BREATHING ", false).getBoolean(false);
            ...
            //
            terrasteel_fuel_rod = config.get("Settings terrasteel fuel rods", "maxDamage(times, 1=1 seconds) ", 15000).getInt(
                    15000);
            ...
            rotor_carbon2 = config
                    .get("Settings Compress iridium rotor", " durability(times, 1=1 seconds)", 720000)
                    .getInt(720000);
...
//
    ...
    private static void loadMolecularTransformerConfig(File configFolder, String configFile) throws ParseException {
        ...
        File config = new File(
                configFolder,
                configFile.substring(0, fileExtensionMarker) + "_MTRecipes" + configFile.substring(fileExtensionMarker)
        );
        ...
        try (FileInputStream stream = new FileInputStream(config);
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (line.startsWith("version=")) {
                    ...
                    if (!"2.0".equals(version)) {
                        throw new ParseException(
                                "Advanced Solars expected a file version of 2.0, but the config is " + version,
                                line.indexOf('=') + 1
                        );
                    }
                    continue;
                ...
                SuperSolarPanels.log.warn(
                        "Skipping line {} as it is has the wrong format (expected length 3, found {})",
                        lineNumber,
                        recipe.parts.length
                );
            }

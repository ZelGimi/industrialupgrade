...
public final class Configs {
	...
	private static void loadNormalConfig(final File configFile, final boolean client) {
		...
		try {
			...
			TileEntityNeutronSun.settings = new TileEntitySolarPanelsun.SolarConfig(config.get("Neutron Sun panels", "NeutronGenSun", 20971520).getInt(20971520), config.get("Neutron Sun panels", "NeutronStorage", 800000000).getInt(800000000), config.get("Neutron Sun panels", "NeutronTier", 10).getInt(10));
			TileEntityProtonSun.settings = new TileEntitySolarPanelsun.SolarConfig(config.get("Proton Sun panels", "ProtonGenSun", 65536).getInt(65536), config.get("Proton Sun panels", "ProtonStorage", 999999999).getInt(999999999), config.get("Proton Sun panels", "ProtonTier", 6).getInt(6));
			TileEntityAdvancedSolarsun.settings = new TileEntitySolarPanelsun.SolarConfig(config.get("Advanced Sun panels", "AdvancedSPGenSun", 8).getInt(8), config.get("Advanced Sun panels", "AdvancedSPStorage", 16000).getInt(16000), config.get("Advanced Sun panels", "AdvancedSPTier", 1).getInt(1));
			TileEntityHybridSolarsun.settings = new TileEntitySolarPanelsun.SolarConfig(config.get("Hybrid Sun panels", "HybrydSPGenSun", 64).getInt(64), config.get("Hybrid Sun panels", "HybrydSPStorage", 50000).getInt(50000), config.get("Hybrid Sun panels", "HybrydSPTier", 2).getInt(2));
			TileEntityUltimateHybridSolarsun.settings = new TileEntitySolarPanelsun.SolarConfig(config.get("Ultimate Sun panels", "UltimateHSPGenSun", 512).getInt(512), config.get("Ultimate Sun panels", "UltimateHSPStorage", 500000).getInt(500000), config.get("Ultimate Sun panels", "UltimateHSPTier", 3).getInt(3));
			TileEntityQuantumSolarsun.settings = new TileEntitySolarPanelsun.SolarConfig(config.get("Quantum Sun panels", "QuantumSPGenSun", 4096).getInt(4096), config.get("Quantum Sun panels", "QuantumSPStorage", 5000000).getInt(5000000), config.get("Quantum Sun panels", "QuantumSPTier", 4).getInt(4));
			TileEntitySpectralsun.settings = new TileEntitySolarPanelsun.SolarConfig(config.get("Spectral Sun panels", "SpecrtalGenSun", 16384).getInt(16384), config.get("Spectral Sun panels", "SpecrtalStorage", 10000000).getInt(10000000), config.get("Spectral Sun panels", "SpecrtalTier", 5).getInt(5));
			TileEntitySingularsun.settings = new TileEntitySolarPanelsun.SolarConfig(config.get("Singular Sun panels", "SingularGenSun", 262144).getInt(262144), config.get("Singular Sun panels", "SingularStorage", 50000000).getInt(50000000), config.get("Singular Sun panels", "SingularTier", 7).getInt(7));
			TileEntityAdminsun.settings = new TileEntitySolarPanelsun.SolarConfig(config.get("Light-Absord Sun panels", "Light-AbsordGenSun", 1108576).getInt(1108576), config.get("Light-Absord Sun panels", "Light-AbsordStorage", 100000000).getInt(100000000), config.get("Light-Absord Sun panels", "Light-AbsordTier", 8).getInt(8));
			TileEntityPhotonicSun.settings = new TileEntitySolarPanelsun.SolarConfig(config.get("Photonic Sun panels", "PhotonicGenSun", 5242880).getInt(5242880), config.get("Photonic Sun panels", "PhotonicStorage", 400000000).getInt(400000000), config.get("Photonic Sun panels", "PhotonicTier", 9).getInt(9));

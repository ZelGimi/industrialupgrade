...
public class WorldBaseGen {
    public static final RegistryObject<Feature<NoneFeatureConfiguration>> RUB_TREE_GENERATOR = FEATURES.register("rub_tree",
            () -> new RubTreeFeature(NoneFeatureConfiguration.CODEC));
    public static final RegistryObject<ConfiguredFeature<?, ?>> RUB_TREE = CONFIGURED_FEATURES.register("rub_tree",
            () -> new ConfiguredFeature<>(RUB_TREE_GENERATOR.get(), NoneFeatureConfiguration.INSTANCE));
    public static final RegistryObject<PlacedFeature> RUB_TREE_PLACER = PLACED_FEATURES.register(
            "rub_tree_placed",
            () -> new PlacedFeature(
    ...
    public static final RegistryObject<Feature<NoneFeatureConfiguration>> VOLCANO_GENERATOR = FEATURES.register("volcano",
            () -> new WorldGenVolcano(NoneFeatureConfiguration.CODEC));
    public static final RegistryObject<Feature<NoneFeatureConfiguration>> OIL_GENERATOR = FEATURES.register("oil",
            () -> new WorldGenOil(NoneFeatureConfiguration.CODEC));
    public static final RegistryObject<ConfiguredFeature<?, ?>> VEIN = CONFIGURED_FEATURES.register("vein",
            () -> new ConfiguredFeature<>(VEIN_GENERATOR.get(), NoneFeatureConfiguration.INSTANCE));
    public static final RegistryObject<PlacedFeature> VEIN_PLACER = PLACED_FEATURES.register(
            "vein_placed",
            () -> new PlacedFeature(
    ...
    public static final RegistryObject<ConfiguredFeature<?, ?>> VOLCANO = CONFIGURED_FEATURES.register("volcano",
            () -> new ConfiguredFeature<>(VOLCANO_GENERATOR.get(), NoneFeatureConfiguration.INSTANCE));
    public static final RegistryObject<PlacedFeature> VOLCANO_PLACER = PLACED_FEATURES.register(
            "volcano_placed",
            () -> new PlacedFeature(
    ...
    public static final RegistryObject<ConfiguredFeature<?, ?>> OIL = CONFIGURED_FEATURES.register("oil",
            () -> new ConfiguredFeature<>(OIL_GENERATOR.get(), NoneFeatureConfiguration.INSTANCE));
    public static final RegistryObject<PlacedFeature> OIL_PLACER = PLACED_FEATURES.register(
            "oil_placed",
            () -> new PlacedFeature(
    ...
    public static final RegistryObject<PlacedFeature> SALTPETER_PLACER = PLACED_FEATURES.register(
            "saltpeter_placed",
            () -> new PlacedFeature(
    ...
    public static final RegistryObject<PlacedFeature> PEAT_PLACER = PLACED_FEATURES.register(
            "peat_placed",
            () -> new PlacedFeature(

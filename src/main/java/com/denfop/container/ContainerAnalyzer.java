...
public class ContainerAnalyzer extends ContainerFullInv<TileAnalyzer> {
    ...
    public ContainerAnalyzer(EntityPlayer entityPlayer, TileAnalyzer tileEntity1) {
        this(entityPlayer, tileEntity1, 214, 198 + 58);

    }

    public ContainerAnalyzer(EntityPlayer entityPlayer, TileAnalyzer tileEntity1, int width, int height) {

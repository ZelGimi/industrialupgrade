...
public class ContainerSingleFluidAdapter extends ContainerFullInv<TileEntitySingleFluidAdapter> {

    public ContainerSingleFluidAdapter(EntityPlayer var1, TileEntitySingleFluidAdapter tileEntity1) {

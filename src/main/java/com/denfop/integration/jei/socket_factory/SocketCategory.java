...
public class SocketCategory extends GuiIU implements IRecipeCategory<SocketRecipeWrapper> {
    ...
    public SocketCategory(
        ...
        super(((TileEntitySocketFactory) BlockBaseMachine3.socket_factory.getDummyTe()).getGuiContainer(Minecraft.getMinecraft().player));
    ...
    public String getUid() {
        return BlockBaseMachine3.socket_factory.getName();
    }

    @Nonnull
    @Override
    public String getTitle() {
        return Localization.translate(JEICompat.getBlockStack(BlockBaseMachine3.socket_factory).getUnlocalizedName());
    }
    ...
    public void setRecipe(
            ...
            final SocketRecipeWrapper recipes,

...
public class AlkalineEarthQuarryCategory extends GuiIU implements IRecipeCategory<AlkalineEarthQuarryWrapper> {
    ...
    public String getUid() {
        return BlockBaseMachine3.alkalineearthquarry.getName();
    }

    @Nonnull
    @Override
    public String getTitle() {
        return Localization.translate(JEICompat.getBlockStack(BlockBaseMachine3.alkalineearthquarry).getUnlocalizedName());
    }
    ...
    public void setRecipe(
            ...
            final AlkalineEarthQuarryWrapper recipes,
        ...
        isg.init(i + 1, true, slots1.get(0).getJeiX() + 15, slots1.get(0).getJeiY() + 15);
        isg.set(i + 1, recipes.getMesh());
    }

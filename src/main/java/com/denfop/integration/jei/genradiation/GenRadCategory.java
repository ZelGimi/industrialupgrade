...
public class GenRadCategory extends GuiIU implements IRecipeCategory<GenRadWrapper> {
    ...
    public GenRadCategory(
        ...
        super(((TileEntityNuclearWasteRecycler) BlockBaseMachine3.nuclear_waste_recycler.getDummyTe()).getGuiContainer(Minecraft.getMinecraft().player));
    ...
    public String getUid() {
        return BlockBaseMachine3.nuclear_waste_recycler.getName();
    }

    @Nonnull
    @Override
    public String getTitle() {
        return Localization.translate(JEICompat.getBlockStack(BlockBaseMachine3.nuclear_waste_recycler).getUnlocalizedName());
    }
    ...
    public void setRecipe(
        ...
        final List<ItemStack> inputs = Collections.singletonList(recipes.getInput2());
        int i = 0;
        for (; i < inputs.size(); i++) {

...
public class MoonSpooterCategory extends GuiIU implements IRecipeCategory<MoonSpooterRecipeWrapper> {
    ...
    public MoonSpooterCategory(
        ...
        super(((TileEntityMoonSpotter) BlockBaseMachine3.moon_spotter.getDummyTe()).getGuiContainer(Minecraft.getMinecraft().player));
    ...
    public String getUid() {
        return BlockBaseMachine3.moon_spotter.getName();
    }

    @Nonnull
    @Override
    public String getTitle() {
        return Localization.translate(JEICompat.getBlockStack(BlockBaseMachine3.moon_spotter).getUnlocalizedName());
    }
    ...
    public void setRecipe(
            ...
            final MoonSpooterRecipeWrapper recipes,

...
public class GenSECategory extends ScreenMain implements IRecipeCategory<GenSEHandler> {
    ...
    @Override
    public void draw(GenSEHandler recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {

...
public class ExtractorCategory extends GuiIU implements IRecipeCategory<ExtractorHandler> {
    ...
    @Override
    public void draw(ExtractorHandler recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
        progress++;
        if (this.energy < 100) {
            energy++;
        }

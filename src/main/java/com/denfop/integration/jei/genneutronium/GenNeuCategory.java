...
public class GenNeuCategory extends ScreenMain implements IRecipeCategory<GenNeuHandler> {
    ...
    @Override
    public RecipeType<GenNeuHandler> getRecipeType() {
    ...
    public String getTitles() {
        return Localization.translate(ItemStackHelper.fromData(IUItem.machines, 1, 5).getDescriptionId());
    }
    ...
    @Override
    public void draw(GenNeuHandler recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {

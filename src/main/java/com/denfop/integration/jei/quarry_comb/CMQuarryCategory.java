...
public class CMQuarryCategory extends Gui implements IRecipeCategory<CMQuarryWrapper> {
    ...
    public String getUid() {
        return BlockBaseMachine.quantum_quarry.getName() + "4";
    }
    ...
    public void setRecipe(
        ...
        isg.set(2, new ItemStack(IUItem.module9, 1, 15));
    }

...
public class BrewingCategory extends GuiIU implements IRecipeCategory<BrewingRecipeWrapper> {
    ...
    public String getUid() {
        return BlockBaseMachine3.electric_brewing.getName();
    }

    @Nonnull
    @Override
    public String getTitle() {
        return Localization.translate(JEICompat.getBlockStack(BlockBaseMachine3.electric_brewing).getUnlocalizedName());
    }
    ...
    public void setRecipe(
            ...
            final BrewingRecipeWrapper recipes,

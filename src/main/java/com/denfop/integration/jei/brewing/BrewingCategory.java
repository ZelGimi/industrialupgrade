...
public class BrewingCategory extends GuiIU implements IRecipeCategory<BrewingHandler> {
    ...
    public String getTitles() {
        return Localization.translate(JEICompat.getBlockStack(BlockBaseMachine3.electric_brewing).getDescriptionId());
    }

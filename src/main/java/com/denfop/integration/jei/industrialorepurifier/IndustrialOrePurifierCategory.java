...
public class IndustrialOrePurifierCategory extends ScreenMain implements IRecipeCategory<IndustrialOrePurifierHandler> {
    ...
    public String getTitles() {
        return Localization.translate(JEICompat.getBlockStack(BlockBaseMachine3Entity.industrial_ore_purifier).getDescriptionId());
    }
    ...
    @Override
    public void draw(IndustrialOrePurifierHandler recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
        int y = 58;
        int x = 80;
    ...
    @Override
    public RecipeType<IndustrialOrePurifierHandler> getRecipeType() {
        return jeiInform.recipeType;
    }

    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, IndustrialOrePurifierHandler recipe, IFocusGroup focuses) {

...
public class IndustrialOrePurifierCategory extends GuiIU implements IRecipeCategory<IndustrialOrePurifierRecipeWrapper> {
    ...
    public String getUid() {
        return BlockBaseMachine3.industrial_ore_purifier.getName();
    }

    @Nonnull
    @Override
    public String getTitle() {
        return Localization.translate(JEICompat.getBlockStack(BlockBaseMachine3.industrial_ore_purifier).getUnlocalizedName());
    }
    ...
    public void setRecipe(
            ...
            final IndustrialOrePurifierRecipeWrapper recipes,

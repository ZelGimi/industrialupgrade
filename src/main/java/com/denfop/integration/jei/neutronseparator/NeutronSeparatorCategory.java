...
public class NeutronSeparatorCategory extends GuiIU implements IRecipeCategory<NeutronSeparatorRecipeWrapper> {
    ...
    public String getUid() {
        return BlockBaseMachine3.neutronseparator.getName();
    }

    @Nonnull
    @Override
    public String getTitle() {
        return Localization.translate(JEICompat.getBlockStack(BlockBaseMachine3.neutronseparator).getUnlocalizedName());
    }
    ...
    public void setRecipe(
            ...
            final NeutronSeparatorRecipeWrapper recipes,

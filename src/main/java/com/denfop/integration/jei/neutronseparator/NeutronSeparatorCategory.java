...
public class NeutronSeparatorCategory extends GuiIU implements IRecipeCategory<NeutronSeparatorHandler> {
    ...
    public String getTitles() {
        return Localization.translate(JEICompat.getBlockStack(BlockBaseMachine3.neutronseparator).getDescriptionId());
    }
    ...
    @Override
    public void draw(NeutronSeparatorHandler recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
        progress++;
        if (this.energy < 100) {
            energy++;
        }

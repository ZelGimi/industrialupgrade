...
public class LaserCategory extends GuiIU implements IRecipeCategory<LaserHandler> {
    ...
    public String getTitles() {
        return Localization.translate(JEICompat.getBlockStack(BlockBaseMachine3.laser_polisher).getDescriptionId());
    }

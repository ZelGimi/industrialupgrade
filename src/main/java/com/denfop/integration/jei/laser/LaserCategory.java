...
public class LaserCategory extends ScreenMain implements IRecipeCategory<LaserHandler> {
    ...
    public String getTitles() {
        return Localization.translate(JEICompat.getBlockStack(BlockBaseMachine3Entity.laser_polisher).getDescriptionId());
    }
    ...
    @Override
    public void draw(LaserHandler recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
        progress++;
        if (this.energy < 100) {
            energy++;
        }
    ...
    @Override
    public RecipeType<LaserHandler> getRecipeType() {
        return jeiInform.recipeType;
    }

    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, LaserHandler recipes, IFocusGroup focuses) {

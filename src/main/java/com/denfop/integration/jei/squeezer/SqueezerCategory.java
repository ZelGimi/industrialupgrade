...
public class SqueezerCategory extends GuiIU implements IRecipeCategory<SqueezerHandler> {
    ...
    public String getTitles() {
        return Localization.translate(JEICompat.getBlockStack(BlockSqueezer.squeezer).getDescriptionId());
    }
    ...
    @Override
    public void draw(SqueezerHandler recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
        progress++;
        if (this.energy < 100) {
            energy++;
        }

...
public class SiliconCategory extends GuiIU implements IRecipeCategory<SiliconRecipeWrapper> {
    ...
    public SiliconCategory(
        ...
        super(((TileEntitySiliconCrystalHandler) BlockBaseMachine3.silicon_crystal_handler.getDummyTe()).getGuiContainer(Minecraft.getMinecraft().player));
    ...
    public String getUid() {
        return BlockBaseMachine3.silicon_crystal_handler.getName();
    }

    @Nonnull
    @Override
    public String getTitle() {
        return Localization.translate(JEICompat.getBlockStack(BlockBaseMachine3.silicon_crystal_handler).getUnlocalizedName());
    }
    ...
    public void setRecipe(
            ...
            final SiliconRecipeWrapper recipes,
        ...
        isg.set(i, new ItemStack(IUItem.iudust, 1, 21));
    }

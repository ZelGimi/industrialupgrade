...
public class GasCombinerCategory extends GuiIU implements IRecipeCategory<GasCombinerHandler> {
    ...
    public String getTitles() {
        return Localization.translate((JEICompat.getBlockStack(BlockBaseMachine3.gas_combiner)).getDescriptionId());
    }

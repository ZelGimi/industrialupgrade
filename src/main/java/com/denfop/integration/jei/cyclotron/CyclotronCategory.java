...
public class CyclotronCategory extends GuiIU implements IRecipeCategory<CyclotronHandler> {
    ...
    public String getTitles() {
        return Localization.translate(JEICompat.getBlockStack(BlockCyclotron.cyclotron_controller).getDescriptionId());
    }

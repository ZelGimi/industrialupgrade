...
public class CropCrossoverCategory extends GuiIU implements IRecipeCategory<CropCrossoverHandler> {
    ...
    @Override
    public void draw(CropCrossoverHandler recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
        Minecraft.getInstance().font.draw(stack, "+", 45, 48, 4210752);
        Minecraft.getInstance().font.draw(stack, "->", 65, 48, 4210752);

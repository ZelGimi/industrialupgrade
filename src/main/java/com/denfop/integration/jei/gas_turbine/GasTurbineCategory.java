...
public class GasTurbineCategory extends Gui implements IRecipeCategory<GasTurbineWrapper> {
    ...
    public String getUid() {
        return BlockGasTurbine.gas_turbine_controller.getName();
    }

    @Nonnull
    @Override
    public String getTitle() {
        return JEICompat.getBlockStack(BlockGasTurbine.gas_turbine_controller).getDisplayName();
    }
    ...
    public void setRecipe(
            ...
            final GasTurbineWrapper recipes,

...
public class WireInsulatorCategory extends GuiIU implements IRecipeCategory<WireInsulatorRecipeWrapper> {
    ...
    public String getUid() {
        return BlockBaseMachine3.electric_wire_insulator.getName();
    }

    @Nonnull
    @Override
    public String getTitle() {
        return Localization.translate(JEICompat.getBlockStack(BlockBaseMachine3.electric_wire_insulator).getUnlocalizedName());
    }
    ...
    public void setRecipe(
            ...
            final WireInsulatorRecipeWrapper recipes,

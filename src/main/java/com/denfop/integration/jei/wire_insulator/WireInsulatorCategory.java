...
public class WireInsulatorCategory extends GuiIU implements IRecipeCategory<WireInsulatorHandler> {
    ...
    public String getTitles() {
        return Localization.translate(JEICompat.getBlockStack(BlockBaseMachine3.electric_wire_insulator).getDescriptionId());
    }

...
public class GenWaterCategory extends ScreenMain implements IRecipeCategory<GenWaterHandler> {
    ...
    @Override
    public void draw(GenWaterHandler recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {

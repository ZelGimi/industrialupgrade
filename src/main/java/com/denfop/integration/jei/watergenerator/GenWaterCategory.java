...
public class GenWaterCategory extends Gui implements IRecipeCategory<GenWaterWrapper> {
    ...
    public String getUid() {
        return BlockBaseMachine3.watergenerator.getName();
    }

    @Nonnull
    @Override
    public String getTitle() {
        return Localization.translate(new ItemStack(IUItem.basemachine2, 1, 9).getUnlocalizedName());
    }

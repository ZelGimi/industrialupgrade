...
public class CentrifugeCategory extends GuiIU implements IRecipeCategory<CentrifugeRecipeWrapper> {
    ...
    public String getUid() {
        return BlockBaseMachine3.centrifuge.getName();
    }

    @Nonnull
    @Override
    public String getTitle() {
        return Localization.translate(JEICompat.getBlockStack(BlockBaseMachine3.centrifuge).getUnlocalizedName());
    }
    ...
    public void setRecipe(
            ...
            final CentrifugeRecipeWrapper recipes,

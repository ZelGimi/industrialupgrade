...
public class ElectrolyzerCategory extends ScreenMain implements IRecipeCategory<ElectrolyzerHandler> {
    ...
    @Override
    public void draw(ElectrolyzerHandler recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {

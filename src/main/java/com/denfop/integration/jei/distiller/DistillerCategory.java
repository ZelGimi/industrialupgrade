...
public class DistillerCategory extends GuiIU implements IRecipeCategory<DistillerHandler> {
    ...
    public String getTitles() {
        return Localization.translate(JEICompat.getBlockStack(BlockBaseMachine3.solardestiller).getDescriptionId());
    }

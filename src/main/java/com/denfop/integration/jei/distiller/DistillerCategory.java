...
public class DistillerCategory extends GuiIU implements IRecipeCategory<DistillerWrapper> {
    ...
    public String getUid() {
        return BlockBaseMachine3.solardestiller.getName();
    }

    @Nonnull
    @Override
    public String getTitle() {
        return Localization.translate(JEICompat.getBlockStack(BlockBaseMachine3.solardestiller).getUnlocalizedName());
    }
    ...
    public void setRecipe(
            ...
            final DistillerWrapper recipes,

...
public class QuantumMolecularCategory extends ScreenMain implements IRecipeCategory<QuantumMolecularHandler> {
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, QuantumMolecularHandler recipes, IFocusGroup focuses) {
        builder.addSlot(RecipeIngredientRole.INPUT, 8, 7).addItemStacks(JeiIngredientHelper.getInputVariants(recipes, 0, recipes.getInput()));
        builder.addSlot(RecipeIngredientRole.INPUT, 28, 7).addItemStacks(JeiIngredientHelper.getInputVariants(recipes, 1, recipes.getInput1()));

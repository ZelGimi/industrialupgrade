...
public class IncubatorCategory extends ScreenMain implements IRecipeCategory<IncubatorHandler> {
    ...
    public String getTitles() {
        return Localization.translate((JEICompat.getBlockStack(BlockBaseMachine3Entity.incubator)).getDescriptionId());
    }
    ...
    @Override
    public void draw(IncubatorHandler recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
        progress++;

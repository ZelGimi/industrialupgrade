...
public class GasChamberCategory extends GuiIU implements IRecipeCategory<GasChamberRecipeWrapper> {
    ...
    public String getUid() {
        return BlockGasChamber.primal_gas_chamber.getName();
    }

    @Nonnull
    @Override
    public String getTitle() {
        return Localization.translate((JEICompat.getBlockStack(BlockGasChamber.primal_gas_chamber)).getUnlocalizedName());
    }
    ...
    public void setRecipe(
            ...
            final GasChamberRecipeWrapper recipes,

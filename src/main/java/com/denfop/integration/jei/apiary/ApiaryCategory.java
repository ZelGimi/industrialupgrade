...
public class ApiaryCategory extends ScreenMain implements IRecipeCategory<ApiaryHandler> {
    ...
    public String getTitles() {
        return Localization.translate(JEICompat.getBlockStack(BlockApiaryEntity.apiary).getDescriptionId());
    }

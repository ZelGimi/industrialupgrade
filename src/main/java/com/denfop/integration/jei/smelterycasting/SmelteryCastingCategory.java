...
public class SmelteryCastingCategory extends ScreenMain implements IRecipeCategory<SmelteryCastingHandler> {
    ...
    public String getTitles() {
        return Localization.translate((JEICompat.getBlockStack(BlockSmelteryEntity.smeltery_casting)).getDescriptionId());
    }
    ...
    @Override
    public void draw(SmelteryCastingHandler recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
        progress++;

...
public class SharpenerCategory extends GuiIU implements IRecipeCategory<SharpenerRecipeWrapper> {
    ...
    public String getUid() {
        return BlockBaseMachine3.steam_sharpener.getName();
    }

    @Nonnull
    @Override
    public String getTitle() {
        return Localization.translate(JEICompat.getBlockStack(BlockBaseMachine3.steam_sharpener).getUnlocalizedName());
    }
    ...
    public void setRecipe(
            ...
            final SharpenerRecipeWrapper recipes,

...
public class EnchantCategory extends GuiIU implements IRecipeCategory<EnchantHandler> {
    ...
    public String getTitles() {
        return Localization.translate(JEICompat.getBlockStack(BlockBaseMachine3.enchanter_books).getDescriptionId());
    }
    ...
    @Override
    public void draw(EnchantHandler recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
        progress++;
        if (this.energy < 100) {
            energy++;
        }

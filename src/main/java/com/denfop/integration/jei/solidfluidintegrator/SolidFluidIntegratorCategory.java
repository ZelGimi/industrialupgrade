...
public class SolidFluidIntegratorCategory extends ScreenMain implements IRecipeCategory<SolidFluidIntegratorHandler> {

    private final IDrawableStatic bg;
    private final ContainerMenuSolidFluidIntegrator container1;
    ...
    public SolidFluidIntegratorCategory(
        ...
        this.container1 = (ContainerMenuSolidFluidIntegrator) this.getContainer();
        ...
        this.addWidget(TankWidget.createNormal(this, 35, 17, container1.base.fluidTank1));
    ...
    public String getTitles() {
        return Localization.translate((JEICompat.getBlockStack(BlockBaseMachine3Entity.solid_fluid_integrator)).getDescriptionId());
    }

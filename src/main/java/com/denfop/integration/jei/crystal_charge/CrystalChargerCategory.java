...
public class CrystalChargerCategory extends ScreenMain implements IRecipeCategory<CrystalChargerHandler> {
    ...
    @Override
    public RecipeType<CrystalChargerHandler> getRecipeType() {
    ...
    public String getTitles() {
        return Localization.translate(JEICompat.getBlockStack(BlockBaseMachine3Entity.crystal_charge).getDescriptionId());
    }
    ...
    @Override
    public void draw(CrystalChargerHandler recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
        progress++;
        if (this.energy < 100) {
            energy++;
        }
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, CrystalChargerHandler recipes, IFocusGroup focuses) {

...
public class CrystalChargerCategory extends GuiIU implements IRecipeCategory<CrystalChargerRecipeWrapper> {
    ...
    public String getUid() {
        return BlockBaseMachine3.crystal_charge.getName();
    }

    @Nonnull
    @Override
    public String getTitle() {
        return Localization.translate(JEICompat.getBlockStack(BlockBaseMachine3.crystal_charge).getUnlocalizedName());
    }
    ...
    public void setRecipe(
            ...
            final CrystalChargerRecipeWrapper recipes,

...
public class CrystalChargerCategory extends GuiIU implements IRecipeCategory<CrystalChargerHandler> {
    ...
    public String getTitles() {
        return Localization.translate(JEICompat.getBlockStack(BlockBaseMachine3.crystal_charge).getDescriptionId());
    }

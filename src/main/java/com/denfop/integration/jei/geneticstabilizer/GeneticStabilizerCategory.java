...
public class GeneticStabilizerCategory extends GuiIU implements IRecipeCategory<GeneticStabilizerRecipeWrapper> {
    ...
    public String getUid() {
        return BlockBaseMachine3.genetic_stabilizer.getName();
    }

    @Nonnull
    @Override
    public String getTitle() {
        return Localization.translate((JEICompat.getBlockStack(BlockBaseMachine3.genetic_stabilizer)).getUnlocalizedName());
    }
    ...
    public void setRecipe(
            ...
            final GeneticStabilizerRecipeWrapper recipes,

...
public class GeneticStabilizerCategory extends GuiIU implements IRecipeCategory<GeneticStabilizerHandler> {
    ...
    public String getTitles() {
        return Localization.translate((JEICompat.getBlockStack(BlockBaseMachine3.genetic_stabilizer)).getDescriptionId());
    }
    ...
    @Override
    public void draw(GeneticStabilizerHandler recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
        progress++;

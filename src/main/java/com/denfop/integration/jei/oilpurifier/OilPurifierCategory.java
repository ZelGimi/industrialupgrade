...
public class OilPurifierCategory extends GuiIU implements IRecipeCategory<OilPurifierRecipeWrapper> {
    ...
    public String getUid() {
        return BlockBaseMachine3.oil_purifier.getName();
    }

    @Nonnull
    @Override
    public String getTitle() {
        return Localization.translate((JEICompat.getBlockStack(BlockBaseMachine3.oil_purifier)).getUnlocalizedName());
    }
    ...
    public void setRecipe(
            ...
            final OilPurifierRecipeWrapper recipes,
        ...
        fff.init(0, true, 34, 21, 12, 47, 10000, true, null);

...
public class GasGeneratorCategory extends ScreenMain implements IRecipeCategory<GasGeneratorHandler> {
    ...
    public String getTitles() {
        return Localization.translate(JEICompat.getBlockStack(BlockBaseMachine3Entity.gas_generator).getDescriptionId());
    }
    ...
    @Override
    public void draw(GasGeneratorHandler recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {

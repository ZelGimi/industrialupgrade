...
public class DepositsCategory extends ScreenMain implements IRecipeCategory<DepositsHandler> {
    ...
    @Override
    public void draw(DepositsHandler recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {

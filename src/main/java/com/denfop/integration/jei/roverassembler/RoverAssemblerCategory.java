...
public class RoverAssemblerCategory extends GuiIU implements IRecipeCategory<RoverAssemblerRecipeWrapper> {
    ...
    public RoverAssemblerCategory(
        ...
        super(((TileEntityRoverAssembler) BlockBaseMachine3.rover_assembler.getDummyTe()).getGuiContainer(Minecraft.getMinecraft().player));
        ...
        this.container1 = (ContainerRoverAssembler) this.getContainer();
    ...
    public String getUid() {
        return BlockBaseMachine3.rover_assembler.getName();
    }

    @Nonnull
    @Override
    public String getTitle() {
        return Localization.translate(JEICompat.getBlockStack(BlockBaseMachine3.rover_assembler).getUnlocalizedName());
    }
    ...
    public void setRecipe(
            ...
            final RoverAssemblerRecipeWrapper recipes,

...
public class GenStarCategory extends ScreenMain implements IRecipeCategory<GenStarHandler> {
    ...
    @Override
    public void draw(GenStarHandler recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
        progress++;
    ...
    protected ResourceLocation getTexture() {
        return new ResourceLocation(Constants.MOD_ID, "textures/gui/GuiWitherMaker.png".toLowerCase());
    }

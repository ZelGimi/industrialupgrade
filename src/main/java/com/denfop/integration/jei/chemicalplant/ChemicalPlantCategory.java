...
public class ChemicalPlantCategory extends GuiIU implements IRecipeCategory<ChemicalPlantWrapper> {
    ...
    public String getUid() {
        return BlockChemicalPlant.chemical_plant_controller.getName();
    }

    @Nonnull
    @Override
    public String getTitle() {
        return Localization.translate(JEICompat.getBlockStack(BlockChemicalPlant.chemical_plant_controller).getUnlocalizedName());
    }
    ...
    public void setRecipe(
            ...
            final ChemicalPlantWrapper recipes,

...
public class InsulatorRecipeWrapper implements IRecipeWrapper {
    ...
    public InsulatorRecipeWrapper(InsulatorHandler container) {
    ...
    public void getIngredients(IIngredients ingredients) {
        ingredients.setInputs(VanillaTypes.FLUID, Arrays.asList(this.getInputFluid(), this.getOutputFluid()));

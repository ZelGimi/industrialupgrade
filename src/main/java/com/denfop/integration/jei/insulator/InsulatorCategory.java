...
public class InsulatorCategory extends GuiIU implements IRecipeCategory<InsulatorHandler> {
    ...
    public String getTitles() {
        return Localization.translate((JEICompat.getBlockStack(BlockBaseMachine3.insulator)).getDescriptionId());
    }
    ...
    @Override
    public void draw(InsulatorHandler recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
        progress++;

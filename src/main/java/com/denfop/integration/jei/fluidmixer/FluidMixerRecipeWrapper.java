...
public class FluidMixerRecipeWrapper implements IRecipeWrapper {
    ...
    private final FluidStack outputstack2;

    public FluidMixerRecipeWrapper(FluidMixerHandler container) {


        this.inputstack = container.getInput();
        this.outputstack1 = container.getOutput1();
        this.outputstack = container.getOutput();
        this.outputstack2 = container.getOutput2();

    }

    public FluidStack getOutputstack2() {
        return outputstack2;
    }

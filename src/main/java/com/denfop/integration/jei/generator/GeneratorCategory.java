...
public class GeneratorCategory extends GuiIU implements IRecipeCategory<GeneratorHandler> {
    ...
    public String getTitles() {
        return Localization.translate(JEICompat.getBlockStack(BlockBaseMachine3.geogenerator_iu).getDescriptionId());
    }
    ...
    @Override
    public void draw(GeneratorHandler recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {

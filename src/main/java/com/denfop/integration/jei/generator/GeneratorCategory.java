...
public class GeneratorCategory extends Gui implements IRecipeCategory<GeneratorWrapper> {
    ...
    public String getUid() {
        return BlockBaseMachine3.geogenerator_iu.getName();
    }

    @Nonnull
    @Override
    public String getTitle() {
        return Localization.translate(JEICompat.getBlockStack(BlockBaseMachine3.geogenerator_iu).getUnlocalizedName());
    }
    ...
    public void setRecipe(
            ...
            final GeneratorWrapper recipes,

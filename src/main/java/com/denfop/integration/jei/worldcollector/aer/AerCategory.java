...
public class AerCategory extends ScreenMain implements IRecipeCategory<AerHandler> {
    ...
    public AerCategory(
        ...
        bg = guiHelper.createDrawable(new ResourceLocation(Constants.MOD_ID, "textures/gui/guiaerassembler" +
                        ".png"), 5, 5, 140,
                75
        );
    }
    ...
    @Override
    public void draw(AerHandler recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
        progress++;
        energy++;
    ...
    protected ResourceLocation getTexture() {
        return new ResourceLocation(Constants.MOD_ID, "textures/gui/guiaerassembler.png");
    }

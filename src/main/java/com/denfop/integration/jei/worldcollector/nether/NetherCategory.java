...
public class NetherCategory extends ScreenMain implements IRecipeCategory<NetherHandler> {
    ...
    @Override
    public void draw(NetherHandler recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
        progress++;
        energy++;

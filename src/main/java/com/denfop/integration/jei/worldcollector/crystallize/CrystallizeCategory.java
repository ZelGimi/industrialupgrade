...
public class CrystallizeCategory extends ScreenMain implements IRecipeCategory<CrystallizeHandler> {
    ...
    public CrystallizeCategory(
        ...
        bg = guiHelper.createDrawable(ResourceLocation.tryBuild(Constants.MOD_ID, "textures/gui/guicrystallize" +
                        ".png"), 5, 5, 140,
                75
        );
    }
    ...
    @Override
    public void draw(CrystallizeHandler recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
        progress++;
        energy++;
    ...
    protected ResourceLocation getTexture() {
        return ResourceLocation.tryBuild(Constants.MOD_ID, "textures/gui/guicrystallize.png");
    }

...
public class EarthCategory extends ScreenMain implements IRecipeCategory<EarthHandler> {
    ...
    @Override
    public RecipeType<EarthHandler> getRecipeType() {
    ...
    @Override
    public void draw(EarthHandler recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
        progress++;
        energy++;

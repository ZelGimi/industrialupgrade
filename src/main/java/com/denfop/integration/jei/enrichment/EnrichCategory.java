...
public class EnrichCategory extends ScreenMain implements IRecipeCategory<EnrichHandler> {
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, EnrichHandler recipes, IFocusGroup focuses) {
        JeiIngredientHelper.addInputSlot(builder, RecipeIngredientRole.INPUT, 13, 33, recipes, 0, recipes.getInput());

        JeiIngredientHelper.addInputSlot(builder, RecipeIngredientRole.INPUT, 35, 33, recipes, 1, recipes.getInput1());

...
public class CentrifugeCategory extends Gui implements IRecipeCategory<CentrifugeWrapper> {
    ...
    public String getUid() {
        return BlockMoreMachine3.centrifuge_iu.getName();
    }

    @Nonnull
    @Override
    public String getTitle() {
        return Localization.translate(new ItemStack(IUItem.machines_base3, 1, 12).getUnlocalizedName());
    }
    ...
    public void drawExtras(@Nonnull final Minecraft mc) {
        ...
        drawTexturedModalRect(66 - 1, 12 + 19, 192 + 34 - 16, 14 + 24, 16, 24);
        drawTexturedModalRect(66 - 1, 12 + 19, 192 + 36, 14 + 24, 16, xScale + 1);
        drawTexturedModalRect(
    ...
    public void setRecipe(
            ...
            final CentrifugeWrapper recipes,

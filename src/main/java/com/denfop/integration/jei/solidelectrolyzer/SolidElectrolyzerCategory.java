...
public class SolidElectrolyzerCategory extends ScreenMain implements IRecipeCategory<SolidElectrolyzerHandler> {
    ...
    @Override
    public RecipeType<SolidElectrolyzerHandler> getRecipeType() {
    ...
    @Override
    public void draw(SolidElectrolyzerHandler recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
        progress++;
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, SolidElectrolyzerHandler recipe, IFocusGroup focuses) {
        ...
        builder.addSlot(RecipeIngredientRole.INPUT, 60 - 20, 44).addItemStacks(JeiIngredientHelper.getInputVariants(recipe, 0, recipe.getInput()));

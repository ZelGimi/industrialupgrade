...
public class SolidElectrolyzerCategory extends ScreenMain implements IRecipeCategory<SolidElectrolyzerHandler> {
    ...
    @Override
    public void draw(SolidElectrolyzerHandler recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
        progress++;
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, SolidElectrolyzerHandler recipe, IFocusGroup focuses) {
        ...
        JeiIngredientHelper.addInputSlot(builder, RecipeIngredientRole.INPUT, 60 - 20, 44, recipe, 0, recipe.getInput());

...
public class SawmillCategory extends GuiIU implements IRecipeCategory<SawmillHandler> {
    ...
    public String getTitles() {
        return Localization.translate(JEICompat.getBlockStack(BlockBaseMachine3.sawmill).getDescriptionId());
    }

...
public class SawmillCategory extends ScreenMain implements IRecipeCategory<SawmillHandler> {
    ...
    @Override
    public RecipeType<SawmillHandler> getRecipeType() {
    ...
    public String getTitles() {
        return Localization.translate(JEICompat.getBlockStack(BlockBaseMachine3Entity.sawmill).getDescriptionId());
    }
    ...
    @Override
    public void draw(SawmillHandler recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
        progress++;
        if (this.energy < 100) {
            energy++;
        }
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, SawmillHandler recipe, IFocusGroup focuses) {

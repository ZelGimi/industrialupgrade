...
public class SawmillCategory extends GuiIU implements IRecipeCategory<SawmillRecipeWrapper> {
    ...
    public String getUid() {
        return BlockBaseMachine3.sawmill.getName();
    }

    @Nonnull
    @Override
    public String getTitle() {
        return Localization.translate(JEICompat.getBlockStack(BlockBaseMachine3.sawmill).getUnlocalizedName());
    }
    ...
    public void setRecipe(
            ...
            final SawmillRecipeWrapper recipes,

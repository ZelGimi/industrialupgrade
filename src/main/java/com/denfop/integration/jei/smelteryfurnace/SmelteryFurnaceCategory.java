...
public class SmelteryFurnaceCategory extends ScreenMain implements IRecipeCategory<SmelteryFurnaceHandler> {
    ...
    public String getTitles() {
        return Localization.translate((JEICompat.getBlockStack(BlockSmelteryEntity.smeltery_furnace)).getDescriptionId());
    }
    ...
    @Override
    public void draw(SmelteryFurnaceHandler recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
        progress++;

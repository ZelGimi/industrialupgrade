...
public class ItemDividerCategory extends GuiIU implements IRecipeCategory<ItemDividerHandler> {
    ...
    public String getTitles() {
        return Localization.translate((JEICompat.getBlockStack(BlockBaseMachine3.item_divider)).getDescriptionId());
    }
    ...
    @Override
    public void draw(ItemDividerHandler recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
        progress++;

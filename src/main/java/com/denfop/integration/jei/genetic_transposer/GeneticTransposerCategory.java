...
public class GeneticTransposerCategory extends GuiIU implements IRecipeCategory<GeneticTransposerWrapper> {
    ...
    public GeneticTransposerCategory(
        ...
        super(((TileEntityGeneticTransposer) BlockBaseMachine3.genetic_transposer.getDummyTe()).getGuiContainer(Minecraft.getMinecraft().player));
    ...
    public String getUid() {
        return BlockBaseMachine3.genetic_transposer.getName();
    }
    ...
    public void setRecipe(
            ...
            final GeneticTransposerWrapper recipes,

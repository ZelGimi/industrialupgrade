...
public class PolymerizerCategory extends GuiIU implements IRecipeCategory<PolymerizerWrapper> {
    ...
    public String getUid() {
        return BlockBaseMachine3.polymerizer.getName();
    }

    @Nonnull
    @Override
    public String getTitle() {
        return Localization.translate(JEICompat.getBlockStack(BlockBaseMachine3.polymerizer).getUnlocalizedName());
    }
    ...
    public void setRecipe(
            ...
            final PolymerizerWrapper recipes,

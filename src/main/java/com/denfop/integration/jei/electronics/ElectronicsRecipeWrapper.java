...
public class ElectronicsRecipeWrapper implements IRecipeWrapper {
    ...
    public ElectronicsRecipeWrapper(ElectronicsHandler container) {
    ...
    public List<ItemStack> getInputs1() {
        return Arrays.asList(this.inputstack, this.inputstack1, this.inputstack2, this.inputstack3, this.inputstack4);
    }

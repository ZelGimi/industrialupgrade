...
public class ProbeAssemblerCategory extends GuiIU implements IRecipeCategory<ProbeAssemblerRecipeWrapper> {
    ...
    public ProbeAssemblerCategory(
        ...
        super(((TileEntityProbeAssembler) BlockBaseMachine3.probe_assembler.getDummyTe()).getGuiContainer(Minecraft.getMinecraft().player));
    ...
    public String getUid() {
        return BlockBaseMachine3.probe_assembler.getName();
    }

    @Nonnull
    @Override
    public String getTitle() {
        return Localization.translate(JEICompat.getBlockStack(BlockBaseMachine3.probe_assembler).getUnlocalizedName());
    }
    ...
    public void setRecipe(
            ...
            final ProbeAssemblerRecipeWrapper recipes,

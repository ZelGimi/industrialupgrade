...
public class TunerCategory extends ScreenMain implements IRecipeCategory<TunerHandler> {

    private final IDrawableStatic bg;
    private final ContainerMenuTunerWireless container1;
    JeiInform jeiInform;
    ...
    public TunerCategory(
        ...
        this.container1 = (ContainerMenuTunerWireless) this.getContainer();
    ...
    @Override
    public void draw(TunerHandler recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {

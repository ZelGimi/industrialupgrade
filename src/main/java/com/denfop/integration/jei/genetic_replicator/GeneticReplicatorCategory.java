...
public class GeneticReplicatorCategory extends ScreenMain implements IRecipeCategory<GeneticReplicatorHandler> {
    ...
    public String getTitles() {
        return Localization.translate((JEICompat.getBlockStack(BlockBaseMachine3Entity.genetic_replicator)).getDescriptionId());
    }
    ...
    @Override
    public void draw(GeneticReplicatorHandler recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {

...
public class GeneticReplicatorCategory extends GuiIU implements IRecipeCategory<GeneticReplicatorRecipeWrapper> {
    ...
    public String getUid() {
        return BlockBaseMachine3.genetic_replicator.getName();
    }

    @Nonnull
    @Override
    public String getTitle() {
        return Localization.translate((JEICompat.getBlockStack(BlockBaseMachine3.genetic_replicator)).getUnlocalizedName());
    }
    ...
    public void setRecipe(
            ...
            final GeneticReplicatorRecipeWrapper recipes,

...
public class MicrochipCategory extends ScreenMain implements IRecipeCategory<MicrochipHandler> {
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, MicrochipHandler recipe, IFocusGroup focuses) {
        builder.addSlot(RecipeIngredientRole.INPUT, 7, 6).addItemStacks(JeiIngredientHelper.getInputVariants(recipe, 0, recipe.getInput()));
        builder.addSlot(RecipeIngredientRole.INPUT, 7, 27).addItemStacks(JeiIngredientHelper.getInputVariants(recipe, 1, recipe.getInput1()));
        builder.addSlot(RecipeIngredientRole.INPUT, 40, 6).addItemStacks(JeiIngredientHelper.getInputVariants(recipe, 2, recipe.getInput2()));
        builder.addSlot(RecipeIngredientRole.INPUT, 40, 26).addItemStacks(JeiIngredientHelper.getInputVariants(recipe, 3, recipe.getInput3()));
        builder.addSlot(RecipeIngredientRole.INPUT, 68, 16).addItemStacks(JeiIngredientHelper.getInputVariants(recipe, 4, recipe.getInput4()));

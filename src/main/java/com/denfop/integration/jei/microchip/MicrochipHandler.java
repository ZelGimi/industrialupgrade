...
public class MicrochipHandler {
    private static List< MicrochipHandler> recipes = new ArrayList<>();
    ...
    public MicrochipHandler(ItemStack input, ItemStack input1,ItemStack input2,ItemStack input3,ItemStack input4,
    ...
    public static MicrochipHandler addRecipe(ItemStack input, ItemStack input1, ItemStack input2,ItemStack input3,

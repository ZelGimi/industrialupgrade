...
public class SingleFluidAdapterCategory extends GuiIU implements IRecipeCategory<SingleFluidAdapterHandler> {
    ...
    public String getTitles() {
        return Localization.translate((JEICompat.getBlockStack(BlockBaseMachine3.single_fluid_adapter)).getDescriptionId());
    }
    ...
    @Override
    public void draw(SingleFluidAdapterHandler recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
        progress++;

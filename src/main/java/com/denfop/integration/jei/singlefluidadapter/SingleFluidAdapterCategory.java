...
public class SingleFluidAdapterCategory extends GuiIU implements IRecipeCategory<SingleFluidAdapterRecipeWrapper> {
    ...
    public String getUid() {
        return BlockBaseMachine3.single_fluid_adapter.getName();
    }

    @Nonnull
    @Override
    public String getTitle() {
        return Localization.translate((JEICompat.getBlockStack(BlockBaseMachine3.single_fluid_adapter)).getUnlocalizedName());
    }
    ...
    public void setRecipe(
            ...
            final SingleFluidAdapterRecipeWrapper recipes,

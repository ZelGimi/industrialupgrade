...
public class RNACollectorHandler implements IJeiVariantRecipe {

    private static final List<RNACollectorHandler> recipes = new ArrayList<>();
...
private final ItemStack input;
    ...
    public static void initRecipes() {
        final List<BaseFluidMachineRecipe> list = Recipes.recipes.getRecipeFluid().getRecipeList(
                "rna_collector");
        final List<BaseMachineRecipe> list1 = Recipes.recipes.getRecipeList("rna_collector");

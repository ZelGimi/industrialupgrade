...
public class RNACollectorCategory extends GuiIU implements IRecipeCategory<RNACollectorRecipeWrapper> {
    ...
    public String getUid() {
        return BlockBaseMachine3.rna_collector.getName();
    }

    @Nonnull
    @Override
    public String getTitle() {
        return Localization.translate((JEICompat.getBlockStack(BlockBaseMachine3.rna_collector)).getUnlocalizedName());
    }
    ...
    public void setRecipe(
            ...
            final RNACollectorRecipeWrapper recipes,

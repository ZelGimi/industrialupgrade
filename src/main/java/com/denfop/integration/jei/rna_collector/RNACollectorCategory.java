...
public class RNACollectorCategory extends ScreenMain implements IRecipeCategory<RNACollectorHandler> {
    ...
    @Override
    public RecipeType<RNACollectorHandler> getRecipeType() {
    ...
    public String getTitles() {
        return Localization.translate((JEICompat.getBlockStack(BlockBaseMachine3Entity.rna_collector)).getDescriptionId());
    }
    ...
    @Override
    public void draw(RNACollectorHandler recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
        progress++;
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, RNACollectorHandler recipe, IFocusGroup focuses) {
        ...
        builder.addSlot(RecipeIngredientRole.INPUT, 60 - 5, 44 - 0).addItemStacks(JeiIngredientHelper.getInputVariants(recipe, 0, recipe.getInput()));
    }

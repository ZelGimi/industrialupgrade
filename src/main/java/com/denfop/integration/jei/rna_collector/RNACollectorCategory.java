...
public class RNACollectorCategory extends GuiIU implements IRecipeCategory<RNACollectorHandler> {
    ...
    public String getTitles() {
        return Localization.translate((JEICompat.getBlockStack(BlockBaseMachine3.rna_collector)).getDescriptionId());
    }

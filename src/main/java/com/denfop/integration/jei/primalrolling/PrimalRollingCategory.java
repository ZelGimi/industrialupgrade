...
public class PrimalRollingCategory extends Gui implements IRecipeCategory<PrimalRollingWrapper> {
    ...
    public String getUid() {
        return BlockBaseMachine3.rolling_machine.getName();
    }

    @Nonnull
    @Override
    public String getTitle() {
        return Localization.translate(JEICompat.getBlockStack(BlockBaseMachine3.rolling_machine).getUnlocalizedName());
    }
    ...
    public void setRecipe(
            ...
            final PrimalRollingWrapper recipes,
        ...
        isg.set(1, new ItemStack(IUItem.cutter));

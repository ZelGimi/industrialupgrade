...
public class FluidIntegratorCategory extends GuiIU implements IRecipeCategory<FluidIntegratorHandler> {
    ...
    public String getTitles() {
        return Localization.translate((JEICompat.getBlockStack(BlockBaseMachine3.fluid_integrator)).getDescriptionId());
    }

...
public class FluidIntegratorCategory extends ScreenMain implements IRecipeCategory<FluidIntegratorHandler> {
    ...
    public FluidIntegratorCategory(
    ...
    @Override
    public RecipeType<FluidIntegratorHandler> getRecipeType() {
    ...
    public String getTitles() {
        return Localization.translate((JEICompat.getBlockStack(BlockBaseMachine3Entity.fluid_integrator)).getDescriptionId());
    }
    ...
    @Override
    public void draw(FluidIntegratorHandler recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
        progress++;
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, FluidIntegratorHandler recipe, IFocusGroup focuses) {
        ...
        builder.addSlot(RecipeIngredientRole.INPUT, 60 - 20, 44 - 0).addItemStacks(JeiIngredientHelper.getInputVariants(recipe, 0, recipe.getInput()));

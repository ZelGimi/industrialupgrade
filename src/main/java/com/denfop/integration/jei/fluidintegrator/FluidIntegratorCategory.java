...
public class FluidIntegratorCategory extends GuiIU implements IRecipeCategory<FluidIntegratorRecipeWrapper> {
    ...
    public String getUid() {
        return BlockBaseMachine3.fluid_integrator.getName();
    }

    @Nonnull
    @Override
    public String getTitle() {
        return Localization.translate((JEICompat.getBlockStack(BlockBaseMachine3.fluid_integrator)).getUnlocalizedName());
    }
    ...
    public void setRecipe(
            ...
            final FluidIntegratorRecipeWrapper recipes,

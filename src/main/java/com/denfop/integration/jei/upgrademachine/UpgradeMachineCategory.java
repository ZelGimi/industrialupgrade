...
public class UpgradeMachineCategory extends GuiIU implements IRecipeCategory<UpgradeMachineRecipeWrapper> {
    ...
    public UpgradeMachineCategory(
        ...
        super(((TileEntityUpgradeMachineFactory) BlockBaseMachine3.upgrade_machine.getDummyTe()).getGuiContainer(Minecraft.getMinecraft().player));
    ...
    public String getUid() {
        return BlockBaseMachine3.upgrade_machine.getName();
    }

    @Nonnull
    @Override
    public String getTitle() {
        return Localization.translate(JEICompat.getBlockStack(BlockBaseMachine3.upgrade_machine).getUnlocalizedName());
    }
    ...
    public void setRecipe(
            ...
            final UpgradeMachineRecipeWrapper recipes,

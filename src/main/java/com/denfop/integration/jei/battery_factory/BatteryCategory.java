...
public class BatteryCategory extends GuiIU implements IRecipeCategory<BatteryRecipeWrapper> {
    ...
    public BatteryCategory(
        ...
        super(((TileEntityBatteryFactory) BlockBaseMachine3.battery_factory.getDummyTe()).getGuiContainer(Minecraft.getMinecraft().player));
    ...
    public String getUid() {
        return BlockBaseMachine3.battery_factory.getName();
    }

    @Nonnull
    @Override
    public String getTitle() {
        return Localization.translate(JEICompat.getBlockStack(BlockBaseMachine3.battery_factory).getUnlocalizedName());
    }
    ...
    public void setRecipe(
            ...
            final BatteryRecipeWrapper recipes,

...
public class PrimalLaserCategory extends ScreenMain implements IRecipeCategory<PrimalLaserHandler> {
    ...
    @Override
    public RecipeType<PrimalLaserHandler> getRecipeType() {
    ...
    public String getTitles() {
        return Localization.translate(JEICompat
                .getBlockStack(BlockPrimalLaserPolisherEntity.primal_laser_polisher)
                .getDescriptionId());
    }
    ...
    @Override
    public void draw(PrimalLaserHandler recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
        progress++;
        if (this.energy < 100) {
            energy++;
        }
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, PrimalLaserHandler recipe, IFocusGroup focuses) {

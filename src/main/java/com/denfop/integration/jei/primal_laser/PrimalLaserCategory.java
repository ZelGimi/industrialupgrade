...
public class PrimalLaserCategory extends GuiIU implements IRecipeCategory<PrimalLaserHandler> {
    ...
    public String getTitles() {
        return Localization.translate(JEICompat
                .getBlockStack(BlockPrimalLaserPolisher.primal_laser_polisher)
                .getDescriptionId());
    }

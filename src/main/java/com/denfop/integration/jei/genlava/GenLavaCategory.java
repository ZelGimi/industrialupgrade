...
public class GenLavaCategory extends GuiIU implements IRecipeCategory<GenLavaHandler> {
    ...
    @Override
    public RecipeType<GenLavaHandler> getRecipeType() {
        return jeiInform.recipeType;
    }

    @Override
    public void draw(GenLavaHandler recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {

...
public class PrimalFluidIntegratorCategory extends GuiIU implements IRecipeCategory<PrimalFluidIntegratorRecipeWrapper> {
    ...
    public String getUid() {
        return BlockPrimalFluidIntegrator.primal_fluid_integrator.getName();
    }

    @Nonnull
    @Override
    public String getTitle() {
        return Localization.translate((JEICompat.getBlockStack(BlockPrimalFluidIntegrator.primal_fluid_integrator)).getUnlocalizedName());
    }
    ...
    public void setRecipe(
            ...
            final PrimalFluidIntegratorRecipeWrapper recipes,

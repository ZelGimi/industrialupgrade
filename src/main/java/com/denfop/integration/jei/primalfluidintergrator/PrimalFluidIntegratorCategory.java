...
public class PrimalFluidIntegratorCategory extends ScreenMain implements IRecipeCategory<PrimalFluidIntegratorHandler> {
    ...
    public String getTitles() {
        return Localization.translate((JEICompat.getBlockStack(BlockPrimalFluidIntegratorEntity.primal_fluid_integrator)).getDescriptionId());
    }
    ...
    @Override
    public void draw(PrimalFluidIntegratorHandler recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
        progress++;

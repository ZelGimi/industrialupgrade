...
public class PrimalFluidIntegratorRecipeWrapper implements IRecipeWrapper {
    ...
    public PrimalFluidIntegratorRecipeWrapper(PrimalFluidIntegratorHandler container) {

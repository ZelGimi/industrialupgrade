...
public class RefractoryFurnaceCategory extends GuiIU implements IRecipeCategory<RefractoryFurnaceWrapper> {
    ...
    public String getUid() {
        return BlockRefractoryFurnace.refractory_furnace.getName();
    }

    @Nonnull
    @Override
    public String getTitle() {
        return Localization.translate(JEICompat.getBlockStack(BlockRefractoryFurnace.refractory_furnace).getUnlocalizedName());
    }

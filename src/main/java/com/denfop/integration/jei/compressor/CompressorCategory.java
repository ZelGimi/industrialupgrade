...
public class CompressorCategory extends Gui implements IRecipeCategory<CompressorWrapper> {
    ...
    public String getUid() {
        return BlockSimpleMachine.compressor_iu.getName();
    }

    @Nonnull
    @Override
    public String getTitle() {
        return Localization.translate(new ItemStack(IUItem.simplemachine, 1, 1).getUnlocalizedName());
    }
    ...
    public void drawExtras(@Nonnull final Minecraft mc) {
        ...
        drawTexturedModalRect(66 - 1, 12 + 19, 192 - 16, 14 + 24, 16, 24);
    ...
    public void setRecipe(
            ...
            final CompressorWrapper recipes,

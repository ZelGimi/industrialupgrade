...
public class SunnariumCategory extends ScreenMain implements IRecipeCategory<SunnariumHandler> {
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, SunnariumHandler recipe, IFocusGroup focuses) {
        builder.addSlot(RecipeIngredientRole.INPUT, 29, 18).addItemStacks(JeiIngredientHelper.getInputVariants(recipe, 0, recipe.getInput()));
        builder.addSlot(RecipeIngredientRole.INPUT, 65, 18).addItemStacks(JeiIngredientHelper.getInputVariants(recipe, 1, recipe.getInput1()));
        builder.addSlot(RecipeIngredientRole.INPUT, 29, 40).addItemStacks(JeiIngredientHelper.getInputVariants(recipe, 2, recipe.getInput2()));
        builder.addSlot(RecipeIngredientRole.INPUT, 65, 40).addItemStacks(JeiIngredientHelper.getInputVariants(recipe, 3, recipe.getInput3()));

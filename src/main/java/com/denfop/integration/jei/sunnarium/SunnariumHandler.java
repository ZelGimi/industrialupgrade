...
public class SunnariumHandler {
    private static List< SunnariumHandler> recipes = new ArrayList<>();
    ...
    public SunnariumHandler(ItemStack input, ItemStack input1,ItemStack input2,ItemStack input3,
                            ItemStack output) {
        this.input = input;
        this.input1 = input1;
        this.input2 = input2;
    ...
    public static SunnariumHandler addRecipe(ItemStack input, ItemStack input1, ItemStack input2,ItemStack input3,
                                            ItemStack output) {

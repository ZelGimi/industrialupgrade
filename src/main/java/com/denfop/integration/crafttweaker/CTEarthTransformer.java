...
@ZenClass("mods.industrialupgrade.EarthAssembler")
@ModOnly("industrialupgrade")
@ZenRegister
public class CTEarthTransformer {
    ...
    private static class RemoveAlloSmelterIngredientAction extends BaseAction {
        ...
        public void apply() {
            Recipes.recipes.removeRecipe("earthassembler", new RecipeOutput(null, getItemStack(this.output)));
        }

        public String describe() {
            return "removing earth transformer recipe " + this.output;
        }

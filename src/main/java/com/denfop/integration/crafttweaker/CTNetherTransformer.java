...
@ZenClass("mods.industrialupgrade.NetherAssembler")
@ModOnly("industrialupgrade")
@ZenRegister
public class CTNetherTransformer {
    ...
    private static class RemoveAlloSmelterIngredientAction extends BaseAction {
        ...
        public void apply() {
            Recipes.recipes.removeRecipe("netherassembler", new RecipeOutput(null, getItemStack(this.output)));
        }

        public String describe() {
            return "removing nether transformer recipe " + this.output;
        }

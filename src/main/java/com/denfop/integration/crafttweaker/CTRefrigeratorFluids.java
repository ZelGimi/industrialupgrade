...
@ZenClass("mods.industrialupgrade.refrigeratorfluids")
@ModOnly("industrialupgrade")
@ZenRegister
public class CTRefrigeratorFluids {
    ...
    private static class Remove extends BaseAction {
        ...
        public void apply() {
            Recipes.recipes.addFluidRemoveRecipe("refrigerator", new FluidRecipeInput(output).getInputs());

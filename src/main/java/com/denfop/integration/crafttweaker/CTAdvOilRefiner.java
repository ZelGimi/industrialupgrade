...
@ZenClass("mods.industrialupgrade.advoilrefiner")
@ModOnly("industrialupgrade")
@ZenRegister
public class CTAdvOilRefiner {
    ...
    private static class Remove extends BaseAction {
        ...
        public Remove(ILiquidStack output) {
            super("adv_oil_refiner");
            this.output = output;
        }


        public void apply() {
            Recipes.recipes.addFluidRemoveRecipe("adv_oil_refiner", new FluidRecipeInput(output).getInputs());

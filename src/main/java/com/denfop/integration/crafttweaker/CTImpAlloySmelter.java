...
@ZenClass("mods.industrialupgrade.impalloysmelter")
@ModOnly("industrialupgrade")
@ZenRegister
public class CTImpAlloySmelter {
    ...
    public static void addRecipe(
        ...
        CraftTweakerAPI.apply(new AddAlloSmelterIngredientAction(container, fill, fill1, fill2, output, temperature));
    }
    ...
    private static class Remove extends BaseAction {
        ...
        public void apply() {
            Recipes.recipes.addRemoveRecipe("impalloysmelter", getItemStack(this.output));
        }
    ...
    private static class AddAlloSmelterIngredientAction extends BaseAction {
        ...
        public void apply() {
            ...
            Recipes.recipes.addAdderRecipe("impalloysmelter", new BaseMachineRecipe(
                    new Input(

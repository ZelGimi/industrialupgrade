...
public enum BlockThaumSolarPanel implements IMultiTileBlock {
    ...
    BlockThaumSolarPanel(final Class<? extends TileEntityBlock> teClass, final int itemMeta, final EnumRarity rarity) {
    ...
    public static BlockThaumSolarPanel getFromID(final int ID) {
    ...
    public void buildDummies() {
        ...
        for (final BlockThaumSolarPanel block : values()) {

...
public class ItemGravelCrushed extends ItemSubTypes<ItemGravelCrushed.Types> implements IModelRegister {
    ...
    public void getSubItems(@Nonnull CreativeTabs tab, @Nonnull NonNullList<ItemStack> subItems) {
        if (this.isInCreativeTab(tab)) {
            ...
            for (final ItemGravelCrushed.Types type : this.typeProperty.getAllowedValues()) {

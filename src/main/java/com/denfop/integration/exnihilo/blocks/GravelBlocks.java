...
public class GravelBlocks extends BlockCore implements IModelRegister {
    ...
    public GravelBlocks() {
        ...
        setUnlocalizedName("gravelblocks_iu");
    ...
    public String getUnlocalizedName(ItemStack stack) {
        ...
        return Type.values()[meta].getName()+"_gravelcrushed" + ".name";
    }
    ...
    public boolean preInit() {
        setRegistryName("gravelblocks_iu");

...
@OnlyIn(Dist.CLIENT)
public class ScreenMolecularTransformer<T extends ContainerMenuBaseMolecular> extends ScreenIndustrialUpgrade<ContainerMenuBaseMolecular> {

    public final ContainerMenuBaseMolecular container;

    public ScreenMolecularTransformer(ContainerMenuBaseMolecular container1) {
    ...
    protected void drawForegroundLayer(PoseStack poseStack, final int mouseX, final int mouseY) {
        ...
        new AdvancedTooltipWidget(this, 152 + dopX, 25, 217 + dopX, 45)
        ...
        if (container.base.maxAmount == 1) {
            if (chargeLevel > 0 && !this.container.base.inputSlot[0].isEmpty() && this.container.base.inputSlot[0].continue_proccess(
                ...
                if (!this.container.base.queue) {
                    ...
                    this.font.draw(poseStack, input + com.denfop.utils.ModUtils.cleanComponentString(this.container.base.inputSlot[0].get(0).getDisplayName().getString()),
                    ...
                    this.font.draw(poseStack, energyPerOperation + ModUtils.getString(container.base.energySlots[0]) +
                                    " EF",
                    ...
                    if (this.container.base.outputSlot[0].get(0).isEmpty() || this.container.base.outputSlot[0]
                        ...
                        int coef =
                                (int) (this.container.base.maxEnergySlots[0] / this.container.base
                                        .getOutput(0)
                                        .getRecipe().output.metadata.getDouble("energy"));
                        this.font.draw(poseStack, input + this.container.base
                                        .getOutput(0)
                                        .getRecipe().input
                                        .getInputs()
                                        .get(0)
                        ...
                        this.font.draw(poseStack, energyPerOperation + ModUtils.getString(this.container.base.energySlots[0]) + " EF",
                                this.guiLeft + 60, this.guiTop + 75, ModUtils.convertRGBcolorToInt(255, 255, 255)
                        );
                        if (this.container.base.getProgress(0) * 100 <= 100) {
                            this.font.draw(poseStack,

...
public class ScreenSolidMixer<T extends ContainerMenuSolidMixer> extends ScreenMain<ContainerMenuSolidMixer> {

    public final ContainerMenuSolidMixer container;

    public ScreenSolidMixer(ContainerMenuSolidMixer container1) {
        super(container1);
        ...
        this.addComponent(new ScreenWidget(this, 76, 45, EnumTypeComponent.PROCESS,

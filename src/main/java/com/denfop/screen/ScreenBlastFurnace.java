...
@OnlyIn(Dist.CLIENT)
public class ScreenBlastFurnace<T extends ContainerMenuBlastFurnace> extends ScreenMain<ContainerMenuBlastFurnace> {

    public final ContainerMenuBlastFurnace container;
    public boolean highlightedMinus = false;
    public boolean highlightedPlus = false;

    public ScreenBlastFurnace(ContainerMenuBlastFurnace container1) {
        super(container1);
        ...
        this.addComponent(new ScreenWidget(this, 142, 74, EnumTypeComponent.SOUND_BUTTON,
                new WidgetDefault<>(new ComponentSoundButton(this.container.base, 10, this.container.base))
        ));
        this.addWidget(new AdvancedTooltipWidget(this, 137, 23, 150, 36).withTooltip("+1"));
        this.addWidget(new AdvancedTooltipWidget(this, 63, 23, 76, 36).withTooltip("-1"));
        this.addWidget(new AdvancedTooltipWidget(this, 79, 76, 134, 89) {
            @Override
        ...
        this.addWidget(new AdvancedTooltipWidget(this, 79, 25, 134, 34) {
            @Override
            protected List<String> getToolTip() {
                String temp =
        ...
        this.addWidget(new AdvancedTooltipWidget(this, 88, 46, 125, 57) {
                           @Override
                           protected List<String> getToolTip() {
    ...
    protected void drawGuiContainerBackgroundLayer(GuiGraphics poseStack, float f, int x, int y) {
        ...
        bindTexture(getTexture());
        if (highlightedMinus) {
            drawTexturedModalRect(poseStack, xoffset + 63, yoffset + 23, 192, 3, 14, 14);

        }
        if (highlightedPlus) {
            drawTexturedModalRect(poseStack, xoffset + 137, yoffset + 23, 177, 3, 14, 14);
        ...
        if (bar > 0) {
            drawTexturedModalRect(poseStack, this.guiLeft + 82, this.guiTop + 28, 181, 53, bar, 5);
        }
        if (container.base.heat != null) {
            progress = (int) (50.0F * container.base.heat.getFillRatio());
            drawTexturedModalRect(poseStack, this.guiLeft + 82, this.guiTop + 79, 180, 34, progress, 8);

...
public class ScreenReCirculationPump<T extends ContainerMenuReCirculationPump> extends ScreenMain<ContainerMenuReCirculationPump> {

    public ScreenReCirculationPump(ContainerMenuReCirculationPump guiContainer) {
        super(guiContainer);

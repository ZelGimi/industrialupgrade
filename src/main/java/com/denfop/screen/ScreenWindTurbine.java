...
public class ScreenWindTurbine<T extends ContainerMenuWindTurbine> extends ScreenMain<ContainerMenuWindTurbine> {

    private final ResourceLocation background;
    public boolean hoverChangeSide;
    public boolean hoverChangePower;

    public ScreenWindTurbine(ContainerMenuWindTurbine guiContainer) {

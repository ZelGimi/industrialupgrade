...
@OnlyIn(Dist.CLIENT)
public class ScreenOilRefiner<T extends ContainerMenuOilRefiner> extends ScreenMain<ContainerMenuOilRefiner> {
    ...
    public ContainerMenuOilRefiner container;

    public ScreenOilRefiner(ContainerMenuOilRefiner container1) {

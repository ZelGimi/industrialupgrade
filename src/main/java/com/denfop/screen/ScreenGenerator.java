...
@OnlyIn(Dist.CLIENT)
public class ScreenGenerator<T extends ContainerMenuGenerator> extends ScreenMain<ContainerMenuGenerator> {


    public ContainerMenuGenerator container;
    public String name;

    public ScreenGenerator(ContainerMenuGenerator container1) {

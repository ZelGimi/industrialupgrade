...
public class ScreenRNACollector<T extends ContainerMenuRNACollector> extends ScreenMain<ContainerMenuRNACollector> {

    public final ContainerMenuRNACollector container;

    public ScreenRNACollector(ContainerMenuRNACollector container1) {
        super(container1);
        ...
        this.addComponent(new ScreenWidget(this, 62, 70, EnumTypeComponent.RAD,

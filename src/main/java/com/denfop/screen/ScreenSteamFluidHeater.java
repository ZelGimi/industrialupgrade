...
public class ScreenSteamFluidHeater<T extends ContainerMenuSteamFluidHeater> extends ScreenMain<ContainerMenuSteamFluidHeater> {

    public ContainerMenuSteamFluidHeater container;
    public String name;

    public ScreenSteamFluidHeater(ContainerMenuSteamFluidHeater guiContainer) {
        ...
        this.addWidget(TankWidget.createNormal(this, 46, 22, (container.base).fluidTank1));

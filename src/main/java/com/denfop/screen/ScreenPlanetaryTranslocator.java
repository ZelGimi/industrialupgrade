...
public class ScreenPlanetaryTranslocator extends Screen {
    ...
    public void render(final PoseStack poseStack, final int mouseX, final int mouseY, final float partialTick) {
        final GuiGraphicsCompat graphics = new GuiGraphicsCompat(poseStack);
    ...
    private void drawFrame(final GuiGraphicsCompat graphics, final int x, final int y, final int w, final int h) {
    ...
    private void drawPanel(final GuiGraphicsCompat graphics, final int x, final int y, final int w, final int h) {
    ...
    private void renderStarField(final GuiGraphicsCompat graphics) {
    ...
    private void renderLeftList(final GuiGraphicsCompat graphics, final int mouseX, final int mouseY) {
        int left = guiLeft();
        int top = guiTop();
    ...
    private float renderSystemBlock(final GuiGraphicsCompat graphics, final SystemNode systemNode, final int x, final float y, final int width, final int mouseX, final int mouseY) {
        float startY = y;
    ...
    private float renderBodyBlockClipped(final GuiGraphicsCompat graphics, final BodyNode bodyNode, final int x, final float y, final int width, final int mouseX, final int mouseY, final float parentAlpha, final float visibleHeightBudget) {
    ...
    private void renderSystemRow(final GuiGraphicsCompat graphics, final SystemNode systemNode, final int x, final int y, final int width, final int mouseX, final int mouseY) {
    ...
    private void renderBodyRow(final GuiGraphicsCompat graphics, final BodyNode bodyNode, final int x, final int y, final int width, final int mouseX, final int mouseY, final float alphaMul) {
    ...
    private void renderRightInfo(final GuiGraphicsCompat graphics, final int mouseX, final int mouseY) {
        int left = guiLeft();
        int top = guiTop();
    ...
    public boolean mouseScrolled(final double mouseX, final double mouseY, final double delta) {
        ...
        if (mouseX >= vx && mouseX <= vx + LIST_VIEW_W && mouseY >= vy && mouseY <= vy + LIST_VIEW_H) {
            ...
            scrollY = Mth.clamp(scrollY - (float) delta * 18.0F, 0.0F, maxScroll);
            return true;
        }
    ...
    public boolean mouseClicked(final double mouseX, final double mouseY, final int button) {
        ...
        if (isMouseOver(mouseX, mouseY, left + TELEPORT_BTN_X, top + TELEPORT_BTN_Y, TELEPORT_BTN_W, TELEPORT_BTN_H)) {
            if (canTeleportSelected()) {
                new PacketPlanetaryTeleportRequest(selectedBodyNode.body.getName());
                onClose();
            }
            return true;
        }
        ...
        if (isMouseOver(mouseX, mouseY, left + RETURN_BTN_X, top + RETURN_BTN_Y, RETURN_BTN_W, RETURN_BTN_H)) {
            ...
            if (runtime.isActive() || data.sessionActive) {
                new PacketPlanetaryReturnRequest(true);
                onClose();
            }
            return true;
        }
    ...
    private void renderScrollbar(final GuiGraphicsCompat graphics, final int x, final int y, final int h, final float contentHeight) {
    ...
    private void drawTooltip(final GuiGraphicsCompat graphics, final int mouseX, final int mouseY, final String text) {
        renderComponentTooltip(graphics.pose(), List.of(Component.literal(text)), mouseX, mouseY);
    }

    private void drawExpandMarker(final GuiGraphicsCompat graphics, final int x, final int y, final float progress, final int color) {
        int midX = x + 4;
        int midY = y + 4;
    ...
    private void drawScrollingLine(final GuiGraphicsCompat graphics, final String text, final int x, final int y, final int maxWidth, final int color, final long seed) {
        if (text == null) {
            return;
        }
    ...
    private void renderBar(final GuiGraphicsCompat graphics, final int x, final int y, final int w, final int h, final float progress, final int fill, final int back) {
    ...
    private void renderGlowBehindIcon(final GuiGraphicsCompat graphics, final int cx, final int cy, final int radius, final int color) {
        int a = (color >> 24) & 255;
    ...
    private void renderStarPreview3D(final GuiGraphicsCompat graphics, final IStar star, final float x, final float y, final float radius, final float z) {
    ...
    private void renderBodyPreview3D(final GuiGraphicsCompat graphics, final IBody body, final float x, final float y, final float radius, final float z) {
        float gameTime = Minecraft.getInstance().level != null
                ? Minecraft.getInstance().level.getGameTime() + Minecraft.getInstance().getFrameTime()
                : 0.0F;
    ...
    private void renderTexturedCube(final GuiGraphicsCompat graphics, final ResourceLocation texture, final float x, final float y, final float radius, final float z, final float yaw, final float pitch, final float roll) {
    ...
    private void renderCube(final PoseStack poseStack, final float radius) {
        ...
        builder.vertex(matrix, -half, -half, -half).uv(0.0F, 0.0F).endVertex();
        builder.vertex(matrix, half, -half, -half).uv(1.0F, 0.0F).endVertex();
        builder.vertex(matrix, half, half, -half).uv(1.0F, 1.0F).endVertex();
        builder.vertex(matrix, -half, half, -half).uv(0.0F, 1.0F).endVertex();
    ...
    private final class GuiGraphicsCompat {
        ...
        private void fill(final int x1, final int y1, final int x2, final int y2, final int color) {
            ScreenPlanetaryTranslocator.fill(this.poseStack, x1, y1, x2, y2, color);
        }

        private void fillGradient(final int x1, final int y1, final int x2, final int y2, final int topColor, final int bottomColor) {
            ScreenPlanetaryTranslocator.this.fillGradient(this.poseStack, x1, y1, x2, y2, topColor, bottomColor);
        }

        private void drawString(final net.minecraft.client.gui.Font font, final String text, final int x, final int y, final int color, final boolean shadow) {
            if (shadow) {

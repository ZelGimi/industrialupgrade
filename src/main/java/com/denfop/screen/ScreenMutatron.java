...
public class ScreenMutatron<T extends ContainerMenuMutatron> extends ScreenMain<ContainerMenuMutatron> {

    public final ContainerMenuMutatron container;

    public ScreenMutatron(ContainerMenuMutatron container1) {
        super(container1);
        ...
        this.addWidget(TankWidget.createNormal(this, 43 - 8, 21, container.base.fluidTank1));
        this.addWidget(TankWidget.createNormal(this, 66 - 8, 21, container.base.fluidTank2));
        ...
        this.addComponent(new ScreenWidget(this, 77, 80, EnumTypeComponent.QUANTUM_ENERGY_WEIGHT,
                new WidgetDefault<>(this.container.base.qe)
        ));
        this.addComponent(new ScreenWidget(this, 92 - 3, 45, EnumTypeComponent.PROCESS,

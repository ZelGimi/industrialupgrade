...
public class ScreenGeneticStabilizer<T extends ContainerMenuGeneticStabilizer> extends ScreenMain<ContainerMenuGeneticStabilizer> {

    public final ContainerMenuGeneticStabilizer container;

    public ScreenGeneticStabilizer(ContainerMenuGeneticStabilizer container1) {
        super(container1);
        ...
        this.addComponent(new ScreenWidget(this, 62, 70, EnumTypeComponent.SOLARIUM_ENERGY_WEIGHT,

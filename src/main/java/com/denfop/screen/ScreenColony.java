...
public class ScreenColony extends ScreenDefaultResearchTable {
    ...
    public void drawForegroundLayer(PoseStack poseStack, int par1, int par2) {
        ...
        if (colony != null) {
            ...
            new TooltipWidget(tile, guiLeft + 33, guiTop + 40 + 15 + 15 + 15, (int) (76 * 0.75), (int) (12 * 0.75))
                    .withTooltip(Localization.translate("iu.space_colony_energy") + ModUtils.getString(colony.getEnergy()) + "/" + ModUtils.getString(
            ...
            new TooltipWidget(tile, guiLeft + 33, guiTop + 40 + 15 + 15 + 15 + 15, (int) (76 * 0.75), (int) (12 * 0.75))
                    .withTooltip(Localization.translate("iu.space_colony_food") + ModUtils.getString(colony.getFood()) +
            ...
            new TooltipWidget(tile, guiLeft + 33, guiTop + 40 + 15 + 15 + 15 + 15 + 15, (int) (76 * 0.75), (int) (12 * 0.75))
                    .withTooltip(Localization.translate("iu.space_colony_oxygen") + ModUtils.getString(colony.getOxygen()) + "/" + ModUtils.getString(
                            colony.getMaxOxygen())
            ...
            new TooltipWidget(tile, guiLeft + 33, guiTop + 40 + 15 + 15 + 15 + 15 + 15 + 15 + 30, (int) (76 * 0.75), (int) (12 * 0.75))
                    .withTooltip(Localization.translate("iu.space_colony_protection") + colony.getProtection()
            ...
            if (this.resourceList != null) {
                ...
                for (DataItem<?> baseResource : resourceList) {
                    if (baseResource.getElement() instanceof ItemStack) {
                        if (colony.getLevel() >= baseResource.getLevel()) {
                            amountResourceByLevelItem++;
                        }
                    }
                    if (baseResource.getElement() instanceof FluidStack) {
                        if (colony.getLevel() >= baseResource.getLevel()) {
            ...
            int storageTotalSize = storageStacksSize + storageFluids.size();
            ...
            for (int i = storageStart; i < storageEnd; i++) {
                Object baseResource;
                if (i < storageStacksSize) {
                    baseResource = storageStacks.get(i);
                } else {
                    baseResource = storageFluids.get(i - storageStacksSize);
                }
    ...
    public void drawGuiContainerBackgroundLayer(PoseStack poseStack, float partialTicks, int mouseX, int mouseY) {
        ...
        if (colony == null) {
            ...
            if (SpaceNet.instance.getColonieNet().canAddColony(planet, getTile().container.player)) {
                getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_other.png"), guiLeft + 37, guiTop + 25, 0, 0.75f, 0.75f, 0, 125, 103, 20);
            } else {
                getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_other.png"), guiLeft + 37, guiTop + 25, 0, 0.75f, 0.75f, 0, 145, 103, 20);
            }

            getTile().drawCenteredText(poseStack, Localization.translate("iu.space.createcolony"), (float) (guiLeft + width / 2), guiTop + 29, 20, 0.5f, ModUtils.convertRGBAcolorToInt(255, 255, 255));
            ...
            getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_icons.png"), guiLeft + 33, guiTop + 18, 0, 0.75f, 0.75f, 1, 44, 76, 12);
            getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_icons.png"), guiLeft + 33, guiTop + 18, 0, 0.75f, 0.75f, 78, 44, (int) (76 * (colony.getExperience() * 1D / colony.getMaxExperience())), 12);
            ...
            getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_icons.png"), guiLeft + 19, guiTop + 55, 0, 0.6f, 0.6f, 21, 57, 22, 22);
            ...
            getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_icons.png"), guiLeft + 21, guiTop + 72, 0, 0.5f, 0.5f, 160, 59, 20, 20);
            ...
            getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_icons.png"), guiLeft + 21, guiTop + 85, 0, 0.6f, 0.6f, 62, 83, 17, 18);
            getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_icons.png"), guiLeft + 33, guiTop + 85, 0, 0.75f, 0.75f, 1, 44, 76, 12);
            getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_icons.png"), guiLeft + 33, guiTop + 85, 0, 0.75f, 0.75f, 78, 44, (int) (76 * (colony.getEnergy() * 1D / Math.max(1, colony.getMaxEnergy()))), 12);

            getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_icons.png"), guiLeft + 21, guiTop + 100, 0, 0.6f, 0.6f, 118, 86, 18, 18);
            getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_icons.png"), guiLeft + 33, guiTop + 100, 0, 0.75f, 0.75f, 1, 44, 76, 12);

            int maxFood = Math.max(1, (colony.getFreeWorkers() + colony.getWorkers()) * 15);
            getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_icons.png"), guiLeft + 33, guiTop + 100, 0, 0.75f, 0.75f, 78, 44, (int) (76 * (colony.getFood() * 1D / maxFood)), 12);

            getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_icons.png"), guiLeft + 21, guiTop + 117, 0, 0.6f, 0.6f, 95, 81, 20, 22);
            getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_icons.png"), guiLeft + 33, guiTop + 115, 0, 0.75f, 0.75f, 1, 44, 76, 12);
            getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_icons.png"), guiLeft + 33, guiTop + 115, 0, 0.75f, 0.75f, 78, 44, (int) (76 * (colony.getOxygen() * 1D / Math.max(1, colony.getMaxoxygen()))), 12);

            getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_icons.png"), guiLeft + 21, guiTop + 130, 0, 0.5f, 0.5f, 33, 81, 24, 24);
            getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_icons.png"), guiLeft + 33, guiTop + 130, 0, 0.75f, 0.75f, 1, 44, 76, 12);
            getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_icons.png"), guiLeft + 33, guiTop + 130, 0, 0.75f, 0.75f, 78, 44, (int) (76 * Math.max(0, (colony.getPercentEntertainment() - 0.8) / 0.7)), 12);

            getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_icons.png"), guiLeft + 21, guiTop + 160, 0, 0.6f, 0.6f, 140, 84, 16, 18);
            getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_icons.png"), guiLeft + 33, guiTop + 160, 0, 0.75f, 0.75f, 1, 44, 76, 12);
            getTile().drawRect(
                    poseStack,
                    new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_icons.png"),
                    guiLeft + 33,
                    guiTop + 160,
                    0,
                    0.75f,
            ...
            getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_icons.png"), guiLeft + 21, guiTop + 145, 0, 0.6f, 0.6f, 45, 61, 20, 18);
            ...
            for (int i = 0; i < problems.size(); i++) {
                ...
                getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_icons.png"), guiLeft + 25 + 12 * i, guiTop + 178, 0, 0.6f, 0.6f, problem.getX(), problem.getY(), problem.getWidth(), problem.getHeight());
            }
            ...
            getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_slider.png"), guiLeft + 189, guiTop + 131, 0, 0.4f, 0.4f, 0, 0, 14, 124);
            getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_slider.png"), guiLeft + 189, guiTop + 175, 0, 0.4f, 0.4f, 0, 252, 14, 4);

            getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_slider.png"), guiLeft + 189, guiTop + 94, 0, 0.4f, 0.4f, 0, 0, 14, 94);
            getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_slider.png"), guiLeft + 189, guiTop + 127, 0, 0.4f, 0.4f, 0, 252, 14, 4);

            getTile().drawRect(
                    poseStack,
                    new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_slider.png"),
            ...
            getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_icons.png"), (float) (guiLeft + 108) + 76 / 2 - 4, guiTop + 24, 0, 0.5f, 0.5f, 6, 83, 17, 17);
            ...
            for (int i = resourceStart; i < resourceEnd; i++) {
                ...
                if (baseResource.getElement() instanceof ItemStack) {
                    ...
                    TextureAtlasSprite sprite = getSafeFluidSprite((FluidStack) baseResource.getElement());
            ...
            getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_other.png"), guiLeft + 108, guiTop + 38, 0, 0.75f, 0.75f, 152, 121, 103, 20);
            ...
            getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_other.png"), guiLeft + 107, guiTop + 55, 0, 0.75f, 0.75f, 0, 105, 103, 20);
            ...
            getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_other.png"), guiLeft + 107, guiTop + 75, 0, 0.75f, 0.75f, 0, 105, 103, 20);
    ...
    public boolean mouseClicked(int mouseX, int mouseY) {
        ...
        if (mouseX >= x + offsetX1 + (width / 2) - 40 && mouseX <= x + offsetX1 + (width / 2) + 80 && mouseY >= y + offsetY1 + 198 && mouseY <= y + offsetY1 + 198 + 15) {
        ...
        if (mouseX >= x + offsetX1 + 100 + 7 && mouseX <= x + offsetX1 + 100 + 7 + 103 * 0.75 && mouseY >= y + offsetY1 + 75 && mouseY <= y + offsetY1 + 75 + 20 * 0.75) {
            if (getTile().container.player.getUUID().equals(getTile().container.base.getPlayer())) {

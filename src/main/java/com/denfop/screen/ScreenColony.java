...
public class ScreenColony extends ScreenDefaultResearchTable {
    ...
    List<ItemStack> listBuildings = List.of(new ItemStack(IUItem.colonial_building.getStack(4), 3), new ItemStack(IUItem.colonial_building.getStack(19), 1), new ItemStack(IUItem.colonial_building.getStack(0), 1), new ItemStack(IUItem.colonial_building.getStack(16), 1), new ItemStack(IUItem.colonial_building.getStack(13), 2));
    ...
    public void drawForegroundLayer(GuiGraphics poseStack, int par1, int par2) {
        ...
        if (colony == null)
            for (int i = 0; i < listBuildings.size(); i++) {
                ...
                new ItemStackWidget(tile, this.x + offsetX1 + 33 + i * 18, this.y + offsetY1 + 40, () -> stack).drawForeground(poseStack, par1, par2);
            }
        if (colony != null) {
            int guiLeft = this.x + offsetX1;
            int guiTop = this.y + offsetY1;
            new TooltipWidget(tile, guiLeft + 33, guiTop + 40 + 15 + 15 + 15, (int) (76 * 0.75), (int) (12 * 0.75)).withTooltip(Localization.translate("iu.space_colony_energy") + ModUtils.getString(colony.getEnergy()) + "/" + ModUtils.getString(
            ...
            new TooltipWidget(tile, guiLeft + 33, guiTop + 40 + 15 + 15 + 15 + 15, (int) (76 * 0.75), (int) (12 * 0.75)).withTooltip(Localization.translate("iu.space_colony_food") + ModUtils.getString(colony.getFood()) +
            ...
            new TooltipWidget(tile, guiLeft + 33, guiTop + 40 + 15 + 15 + 15 + 15 + 15, (int) (76 * 0.75), (int) (12 * 0.75)).withTooltip(Localization.translate("iu.space_colony_oxygen") + ModUtils.getString(colony.getOxygen()) + "/" + ModUtils.getString(
                    colony.getMaxOxygen())
            ...
            new TooltipWidget(tile, guiLeft + 33, guiTop + 40 + 15 + 15 + 15 + 15 + 15 + 15, (int) (76 * 0.75), (int) (12 * 0.75)).withTooltip(Localization.translate("iu.space_colony_entertainment") + ModUtils.getString(colony.getPercentEntertainment() * 100) + "%").drawForeground(poseStack, par1, par2);
            new TooltipWidget(tile, guiLeft + 33, guiTop + 40 + 15 + 15 + 15 + 15 + 15 + 15 + 30, (int) (76 * 0.75), (int) (12 * 0.75)).withTooltip(Localization.translate("iu.space_colony_protection") + colony.getProtection()
            ...
            for (int i = (int) (8 * sliderPosition); i < Math.min(resourceList.size(), (sliderPosition * 8) + 8); i++) {
                ...
                if (baseResource.getElement() instanceof ItemStack) {
                    ...
                    new ItemStackTooltipWidget(tile, ((25 + 32 + 53 + (j % 4) * 18)) + guiLeft, (int) ((41 + 15 + 15 + 15 + 11 + 18 * (j / 4))) + guiTop, () -> stack, Localization.translate("iu.space.colony_level") + " " + baseResource.getLevel()).drawForeground(poseStack, par1, par2);
                    ...
                    new FluidDefaultWidget(tile, fluidX, fluidY, stack).withTooltip(() -> Localization.translate("iu.space.colony_level") + " " + baseResource.getLevel()).drawForeground(poseStack, par1, par2);
            ...
            for (int i = (int) (8 * sliderStoragePosition); i < Math.min(colony.getStacksFromStorage().size() + colony.getFluidsFromStorage().size(), (sliderStoragePosition * 8) + 8); i++) {
                ...
                if (baseResource instanceof ItemStack) {
                    ...
                    new ItemStackWidget(tile, ((25 + 32 + 53 + (j % 4) * 18)) + guiLeft, (int) ((41 + 15 + 15 + 15 + 11 + 18 * (j / 4))) + guiTop + 50, () -> stack).drawForeground(poseStack, par1, par2);
                    ...
                    new FluidDefaultWidget(tile, fluidX, fluidY, ((FluidStack) baseResource)).drawForeground(poseStack, par1, par2);
            ...
            if (getTile().container.player.containerMenu.getCarried().isEmpty())
                new TooltipWidget(getTile(), guiLeft + 108, guiTop + 21, 76, 14).withTooltip(Localization.translate("iu.space.colony_info_add")).drawForeground(poseStack, par1, par2);
            ...
            if (getTile().container.base.getSends() != null) {
                ...
                if (timers != null && !timers.isEmpty()) {
                    ...
                    new TooltipWidget(getTile(), guiLeft + 108, guiTop + 55 - 17, (int) (103 * 0.75), (int) (20 * 0.75)).withTooltip(timers.get(0).getDisplay()).drawForeground(poseStack, par1, par2);
                }
            }
        }
    }
    ...
    public void drawGuiContainerBackgroundLayer(GuiGraphics poseStack, float partialTicks, int mouseX, int mouseY) {
        ...
        if (colony == null) {
            ...
            RenderSystem.enableBlend();
            new SpaceMainRedInterfaceWidget(getTile(), 21, 40 + 15 + 15 + 15 + 15 + 15 + 15 + 15 + 15 + 15, 80, 17).drawBackground(poseStack, guiLeft, guiTop);
            RenderSystem.disableBlend();
            ...
            RenderSystem.enableBlend();
            new SpaceMainBlueInterfaceWidget(tile, 105, 40 + 15 + 15 + 15 + 15 + 15 + 15 + 10, 32 + 51, 52).drawBackground(poseStack, guiLeft, guiTop);
            RenderSystem.disableBlend();

            RenderSystem.enableBlend();
            new SpaceMainBlueInterfaceWidget(tile, 105, 40 + 15 + 15 + 15 + 8, 32 + 51, 40).drawBackground(poseStack, guiLeft, guiTop);
            RenderSystem.disableBlend();

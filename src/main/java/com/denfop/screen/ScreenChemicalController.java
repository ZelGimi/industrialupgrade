...
public class ScreenChemicalController<T extends ContainerMenuChemicalController> extends ScreenMain<ContainerMenuChemicalController> {

    private boolean visible;

    public ScreenChemicalController(ContainerMenuChemicalController guiContainer) {
        super(guiContainer);
        ...
        this.componentList.add(new ScreenWidget(this, 70, 35, 24,
                ...
                new WidgetDefault<>(new ComponentButton(this.container.base, 0, "") {
                    ...
                    public String getText() {
                        return ((BlockEntityChemicalPlantController) this.getEntityBlock()).work ? Localization.translate(
                                "turn_off") :
                    ...
                    public boolean active() {
                        return !((BlockEntityChemicalPlantController) this.getEntityBlock()).work;
                    }
                })
        ));
    ...
    private void handleUpgradeTooltip(int mouseX, int mouseY) {
        if (mouseX >= 0 && mouseX <= 12 && mouseY >= 0 && mouseY <= 12) {
            ...
            text.add(Localization.translate("guide.chemicalplant"));
            List<String> compatibleUpgrades = new ArrayList<>();
            for (int i = 1; i < 4; i++) {
                compatibleUpgrades.add(Localization.translate("guide.chemicalplant" + i));
            }

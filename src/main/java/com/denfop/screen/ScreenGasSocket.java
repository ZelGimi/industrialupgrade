...
public class ScreenGasSocket<T extends ContainerMenuGasSocket> extends ScreenMain<ContainerMenuGasSocket> {

    public ScreenGasSocket(ContainerMenuGasSocket guiContainer) {
        super(guiContainer);

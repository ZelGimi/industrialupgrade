...
public class ScreenItemDivider<T extends ContainerMenuItemDivider> extends ScreenMain<ContainerMenuItemDivider> {

    public final ContainerMenuItemDivider container;

    public ScreenItemDivider(ContainerMenuItemDivider container1) {
        super(container1);

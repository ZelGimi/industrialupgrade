...
public class ScreenSolidFluidIntegrator<T extends ContainerMenuSolidFluidIntegrator> extends ScreenMain<ContainerMenuSolidFluidIntegrator> {

    public final ContainerMenuSolidFluidIntegrator container;

    public ScreenSolidFluidIntegrator(ContainerMenuSolidFluidIntegrator container1) {
        super(container1);
        ...
        this.addWidget(TankWidget.createNormal(this, 58, 21, container.base.fluidTank3));

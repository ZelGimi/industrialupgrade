...
public class ScreenInsulator<T extends ContainerMenuInsulator> extends ScreenMain<ContainerMenuInsulator> {

    public final ContainerMenuInsulator container;

    public ScreenInsulator(ContainerMenuInsulator container1) {
        super(container1);
        ...
        this.addWidget(TankWidget.createNormal(this, 45, 21, container.base.fluidTank1));
        this.addWidget(TankWidget.createNormal(this, 65, 21, container.base.fluidTank2));
        this.addComponent(new ScreenWidget(this, 7, 64, EnumTypeComponent.ENERGY,
                new WidgetDefault<>(this.container.base.energy)
        ));

        this.addComponent(new ScreenWidget(this, 90, 40, EnumTypeComponent.PROCESS,

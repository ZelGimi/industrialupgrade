...
public class ScreenGraphiteController<T extends ContainerMenuGraphiteReactor> extends ScreenMain<ContainerMenuGraphiteReactor> {
    ...
    public ScreenGraphiteController(ContainerMenuGraphiteReactor guiContainer) {
        super(guiContainer);
        this.componentList.clear();
        this.imageWidth = 225;
        this.imageHeight = 254;
        this.componentList.add(new ScreenWidget(this, 160, 135, 186 - 160, 38 - 12,
        ...
        this.addComponent(new ScreenWidget(this, 172, 109, 182 - 163, 60 - 41,
        ...
        this.addComponent(new ScreenWidget(this, 20, 109, 182 - 163, 60 - 41,
    ...
    protected void drawForegroundLayer(GuiGraphics poseStack, final int par1, final int par2) {
        ...
        new AdvancedTooltipWidget(this, 94, 138, 122, 159).withTooltip(Localization.translate("iu.reactor_info.radiation") + ": " + ModUtils.getString(this.container.base
                .getRad()
                .getEnergy()) +
        ...
        new AdvancedTooltipWidget(this, 127, 134, 156, 162).withTooltip(Localization.translate("waterreactor.security." + name)).drawForeground(
                poseStack, par1,
                par2
        );
        new AdvancedTooltipWidget(this, 47, 106, 169, 129)

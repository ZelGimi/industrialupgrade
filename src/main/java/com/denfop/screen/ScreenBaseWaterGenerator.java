...
public class ScreenBaseWaterGenerator<T extends ContainerMenuBaseWaterGenerator> extends ScreenMain<ContainerMenuBaseWaterGenerator> {

    private final ResourceLocation background;
    public boolean hoverChangeSide;
    public boolean hoverChangePower;

    public ScreenBaseWaterGenerator(ContainerMenuBaseWaterGenerator guiContainer) {
        super(guiContainer, guiContainer.base.getStyle());
        this.imageHeight = 247;
        this.imageWidth = 207;
        this.background = ResourceLocation.tryBuild(Constants.MOD_ID, "textures/gui/guiwater_generator.png");

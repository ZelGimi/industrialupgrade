...
public class ScreenHeatController<T extends ContainerMenuHeatReactor> extends ScreenMain<ContainerMenuHeatReactor> {
    ...
    public ScreenHeatController(ContainerMenuHeatReactor guiContainer) {
        super(guiContainer);
        this.componentList.clear();
        this.imageWidth = 225;
        this.imageHeight = 254;
        this.componentList.add(new ScreenWidget(this, 160, 13, 186 - 160, 38 - 12,
    ...
    protected void drawForegroundLayer(GuiGraphics poseStack, final int par1, final int par2) {
        ...
        new AdvancedTooltipWidget(this, 158, 43, 188, 73).withTooltip(Localization.translate("waterreactor.security." + name)).drawForeground(
                poseStack, par1,
                par2
        );
        new AdvancedTooltipWidget(this, 21, 139, 148, 162)

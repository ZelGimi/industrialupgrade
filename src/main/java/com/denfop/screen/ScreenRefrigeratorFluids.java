...
public class ScreenRefrigeratorFluids<T extends ContainerMenuRefrigeratorFluids> extends ScreenMain<ContainerMenuRefrigeratorFluids> {

    public final ContainerMenuRefrigeratorFluids container;

    public ScreenRefrigeratorFluids(ContainerMenuRefrigeratorFluids container1) {
        super(container1);
        ...
        this.componentList.add(new ScreenWidget(this, 70, 80, EnumTypeComponent.COOL_ENERGY_WEIGHT,

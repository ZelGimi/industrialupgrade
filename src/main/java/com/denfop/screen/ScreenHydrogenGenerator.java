...
@OnlyIn(Dist.CLIENT)
public class ScreenHydrogenGenerator<T extends ContainerMenuHydrogenGenerator> extends ScreenMain<ContainerMenuHydrogenGenerator> {

    public ContainerMenuHydrogenGenerator container;
    public String name;

    public ScreenHydrogenGenerator(ContainerMenuHydrogenGenerator container1) {
        super(container1);

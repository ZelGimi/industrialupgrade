...
public class ScreenSolidFluidMixer<T extends ContainerMenuSolidFluidMixer> extends ScreenMain<ContainerMenuSolidFluidMixer> {

    public final ContainerMenuSolidFluidMixer container;

    public ScreenSolidFluidMixer(ContainerMenuSolidFluidMixer container1) {
        super(container1);
        ...
        this.addWidget(TankWidget.createNormal(this, 66 + 45, 21, container.base.fluidTank2));
        this.addWidget(TankWidget.createNormal(this, 66 + 75, 21, container.base.fluidTank3));
        this.addComponent(new ScreenWidget(this, 7, 64, EnumTypeComponent.ENERGY,
                new WidgetDefault<>(this.container.base.energy)
        ));
        this.addComponent(new ScreenWidget(this, 85, 45, EnumTypeComponent.PROCESS,

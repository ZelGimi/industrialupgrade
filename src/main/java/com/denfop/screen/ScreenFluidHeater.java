...
public class ScreenFluidHeater<T extends ContainerMenuHeatFluids> extends ScreenMain<ContainerMenuHeatFluids> {

    public final ContainerMenuHeatFluids container;

    public ScreenFluidHeater(ContainerMenuHeatFluids container1) {
        super(container1);
        ...
        this.componentList.add(new ScreenWidget(this, 70, 80, EnumTypeComponent.HEAT,

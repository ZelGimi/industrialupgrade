...
public class ScreenMiniPanel<T extends ContainerMenuMiniPanels> extends ScreenIndustrialUpgrade<ContainerMenuMiniPanels> {

    private final BlockEntityMiniPanels tileentity;

    public ScreenMiniPanel(ContainerMenuMiniPanels guiContainer) {
        super(guiContainer);
    ...
    protected void drawForegroundLayer(PoseStack poseStack, int mouseX, int mouseY) {
        ...
        this.font.draw(poseStack, Localization.translate(this.tileentity.getName()), nmPos, 6, 7718655);
        ...
        new AdvancedTooltipWidget(this, 168, 19, 183, 111).withTooltip(temptime).drawForeground(poseStack, mouseX, mouseY);
        new AdvancedTooltipWidget(this, 96, 135, 105, 143).withTooltip(tooltip2).drawForeground(poseStack, mouseX, mouseY);
        new AdvancedTooltipWidget(this, 80, 111, 122, 132).withTooltip(tooltip).drawForeground(poseStack, mouseX, mouseY);
        if (!this.tileentity.invSlotGlass.isEmpty()) {
            new AdvancedTooltipWidget(this, 18, 19, 32, 111).withTooltip(Localization.translate("iu.minipanel.stable_place") + Math.max(
                    0,
                    100 - (int) this.tileentity.load
            ) + " %").drawForeground(poseStack, mouseX, mouseY);
        }
        if (this.tileentity.component.getBonusCapacity() != 0) {
            new TooltipWidget(this, 184, 20, 16, 16)
        ...
        if (this.tileentity.component.getBonusProdution() != 0) {
            new TooltipWidget(this, 184, 40, 16, 16)
        ...
        if (this.tileentity.bonusGeneration != 0) {
            new TooltipWidget(this, 184, 60, 16, 16)
        ...
        if (this.tileentity.pollution.isActive()) {
            new ItemStackWidget(this, 184, 93, this.tileentity.pollution::getStack).drawForeground(poseStack, mouseX, mouseY);
        }

        for (int i = 0; i < this.tileentity.invSlotGlass.size(); i++) {
            final List<BlockEntityMiniPanels.EnumState> list = this.tileentity.listStable.get(i);
            if (list.size() == 0) {
                continue;
            }
            if (i == 0) {
                final BlockEntityMiniPanels.EnumState first = list.get(0);
                new TooltipWidget(this, 87, 34, 8, 8)
                        .withTooltip(Localization.translate("iu.minipanel." + first.name().toLowerCase()))
                        .drawForeground(
                                poseStack, mouseX,
                                mouseY
                        );
                final BlockEntityMiniPanels.EnumState second = list.get(1);
                new TooltipWidget(this, 74, 51, 9, 6)
            ...
            if (i == 1) {
                final BlockEntityMiniPanels.EnumState first = list.get(0);
                new TooltipWidget(this, 110, 38, 6, 9)
                        .withTooltip(Localization.translate("iu.minipanel." + first.name().toLowerCase()))
                        .drawForeground(
                                poseStack, mouseX,
                                mouseY
                ...
                final BlockEntityMiniPanels.EnumState second = list.get(1);
                new TooltipWidget(this, 97, 51, 9, 6)
                        .withTooltip(Localization.translate("iu.minipanel." + second.name().toLowerCase()))
                        .drawForeground(
                                poseStack, mouseX,
                                mouseY
            ...
            if (i == 2) {
                final BlockEntityMiniPanels.EnumState first = list.get(0);
                new TooltipWidget(this, 120, 51, 9, 6)
                        .withTooltip(Localization.translate("iu.minipanel." + first.name().toLowerCase()))
                        .drawForeground(
                                poseStack, mouseX,
                                mouseY
            ...
            if (i == 3) {
                final BlockEntityMiniPanels.EnumState first = list.get(0);
                new TooltipWidget(this, 87, 61, 6, 9)
                        .withTooltip(Localization.translate("iu.minipanel." + first.name().toLowerCase()))
                        .drawForeground(
                                poseStack, mouseX,
                                mouseY
                ...
                final BlockEntityMiniPanels.EnumState second = list.get(1);
                new TooltipWidget(this, 74, 74, 9, 6)
                        .withTooltip(Localization.translate("iu.minipanel." + second.name().toLowerCase()))
                        .drawForeground(
                                poseStack, mouseX,
                                mouseY
            ...
            if (i == 4) {
                final BlockEntityMiniPanels.EnumState first = list.get(0);
                new TooltipWidget(this, 110, 61, 6, 9)
                        .withTooltip(Localization.translate("iu.minipanel." + first.name().toLowerCase()))
                        .drawForeground(
                                poseStack, mouseX,
                                mouseY
                ...
                final BlockEntityMiniPanels.EnumState second = list.get(1);
                new TooltipWidget(this, 97, 74, 9, 6)
                        .withTooltip(Localization.translate("iu.minipanel." + second.name().toLowerCase()))
                        .drawForeground(
                                poseStack, mouseX,
                                mouseY
            ...
            if (i == 5) {
                final BlockEntityMiniPanels.EnumState first = list.get(0);
                new TooltipWidget(this, 120, 74, 9, 6)
                        .withTooltip(Localization.translate("iu.minipanel." + first.name().toLowerCase()))
                        .drawForeground(
                                poseStack, mouseX,
                                mouseY
            ...
            if (i == 6) {
                final BlockEntityMiniPanels.EnumState first = list.get(0);
                new TooltipWidget(this, 87, 84, 6, 9)
                        .withTooltip(Localization.translate("iu.minipanel." + first.name().toLowerCase()))
                        .drawForeground(
                                poseStack, mouseX,
                                mouseY
            ...
            if (i == 7) {
                final BlockEntityMiniPanels.EnumState first = list.get(0);
                new TooltipWidget(this, 110, 84, 6, 9)
                        .withTooltip(Localization.translate("iu.minipanel." + first.name().toLowerCase()))
                        .drawForeground(
                                poseStack, mouseX,
                                mouseY
    ...
    private void DrawModel(PoseStack poseStack, int h, int k) {
    ...
    protected void renderBg(PoseStack poseStack, float partialTicks, int mouseX, int mouseY) {
        ...
        for (int i = 0; i < this.tileentity.invSlotGlass.size(); i++) {
            ...
            if (i == 0) {
                final BlockEntityMiniPanels.EnumState first = list.get(1);
                if (first == BlockEntityMiniPanels.EnumState.STABLE) {

                    drawTexturedModalRect(poseStack, (h + 74), (k + 51), 220, 135, 9, 6);
                } else if (first == BlockEntityMiniPanels.EnumState.NORMAL) {

                    drawTexturedModalRect(poseStack, (h + 74), (k + 51), 220, 144, 9, 6);
                } else if (first == BlockEntityMiniPanels.EnumState.UNSTABLE) {

                    drawTexturedModalRect(poseStack, (h + 74), (k + 51), 220, 153, 9, 6);
                }
                final BlockEntityMiniPanels.EnumState second = list.get(0);
                if (second == BlockEntityMiniPanels.EnumState.STABLE) {

                    drawTexturedModalRect(poseStack, (h + 87), (k + 38), 213, 135, 6, 9);
                } else if (second == BlockEntityMiniPanels.EnumState.NORMAL) {

                    drawTexturedModalRect(poseStack, (h + 87), (k + 38), 213, 144, 6, 9);
                } else if (second == BlockEntityMiniPanels.EnumState.UNSTABLE) {
        ...
        if (this.tileentity.pollution.isActive()) {
            new ItemStackWidget(this, 184, 93, this.tileentity.pollution::getStack).drawBackground(poseStack, h, k);
        }
        ...
        if (tileentity.component.getBonusCapacity() > 0) {
            new ItemStackWidget(this, 184, 20, () -> this.tileentity.invSlotStorage.get(0)).drawBackground(poseStack, h, k);
            poseStack.pushPose();
            poseStack.scale(0.15F, 0.15F, 1F);
            bindTexture(getTexture());
        ...
        if (tileentity.component.getBonusProdution() > 0) {
            new ItemStackWidget(this, 184, 40, () -> this.tileentity.invSlotOutput.get(0)).drawBackground(poseStack, h, k);
            poseStack.pushPose();
            poseStack.scale(0.15F, 0.15F, 1F);
            bindTexture(getTexture());
            RenderSystem.disableDepthTest();
        ...
        if (tileentity.bonusGeneration > 0) {
            new ItemStackWidget(this, 184, 60, () -> this.tileentity.invSlotGlass.get(0)).drawBackground(poseStack, h, k);
            poseStack.pushPose();
            poseStack.scale(0.15F, 0.15F, 1F);
            bindTexture(getTexture());
            RenderSystem.disableDepthTest();

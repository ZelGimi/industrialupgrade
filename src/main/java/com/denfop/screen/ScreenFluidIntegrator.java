...
public class ScreenFluidIntegrator<T extends ContainerMenuFluidIntegrator> extends ScreenMain<ContainerMenuFluidIntegrator> {

    public final ContainerMenuFluidIntegrator container;

    public ScreenFluidIntegrator(ContainerMenuFluidIntegrator container1) {
        super(container1);

...
public class ScreenSteamTurbineTank<T extends ContainerMenuSteamTurbineTank> extends ScreenMain<ContainerMenuSteamTurbineTank> {

    public ScreenSteamTurbineTank(ContainerMenuSteamTurbineTank guiContainer) {
        super(guiContainer);

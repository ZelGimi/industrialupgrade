...
public class ScreenCable1<T extends ContainerMenuCable> extends ScreenMain<ContainerMenuCable> {
    ...
    public ScreenCable1(ContainerMenuCable guiContainer) {
        ...
        if (guiContainer.base instanceof BlockEntityItemPipes pipes && pipes.facingSide != null) {
            pipes.facingSide = null;
            new PacketUpdateServerTile(this.container.base, 150);
        }
    }

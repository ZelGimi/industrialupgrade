...
public class ScreenHeatMainTank<T extends ContainerMenuHeatTank> extends ScreenMain<ContainerMenuHeatTank> {

    public ScreenHeatMainTank(ContainerMenuHeatTank guiContainer) {
        super(guiContainer);

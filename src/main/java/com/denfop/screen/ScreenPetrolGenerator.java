...
@OnlyIn(Dist.CLIENT)
public class ScreenPetrolGenerator<T extends ContainerMenuPetrolGenerator> extends ScreenMain<ContainerMenuPetrolGenerator> {

    public ContainerMenuPetrolGenerator container;
    public String name;

    public ScreenPetrolGenerator(ContainerMenuPetrolGenerator container1) {
        super(container1);

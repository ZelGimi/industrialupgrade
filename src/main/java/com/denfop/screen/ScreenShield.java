...
public class ScreenShield<T extends ContainerMenuShield> extends ScreenMain<ContainerMenuShield> {
    ...
    protected void drawForegroundLayer(PoseStack poseStack, final int par1, final int par2) {
        ...
        this.font.draw(poseStack, Localization.translate("iu.shield" + (container.base.visibleShield ? ".visible" :
                        ".invisible")),
                10, 42, 0
        );
        this.font.draw(poseStack, Localization.translate("iu.laser" + (container.base.visibleLaser ? ".visible" :
                        ".invisible")),
                93, 42, 0
        );
    }

...
@OnlyIn(Dist.CLIENT)
public class ScreenDieselGenerator<T extends ContainerMenuDieselGenerator> extends ScreenMain<ContainerMenuDieselGenerator> {

    public ContainerMenuDieselGenerator container;
    public String name;

    public ScreenDieselGenerator(ContainerMenuDieselGenerator container1) {
        super(container1);

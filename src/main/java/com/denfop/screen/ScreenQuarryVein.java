...
public class ScreenQuarryVein<T extends ContainerMenuQuarryVein> extends ScreenMain<ContainerMenuQuarryVein> {
    ...
    protected void drawForegroundLayer(PoseStack poseStack, int par1, int par2) {
        ...
        this.font.draw(poseStack, name, nmPos, 4, 4210752);
        this.font.draw(poseStack, Localization.translate("iu.level"), 122, 23, 4210752);

        switch (this.container.base.levelMech) {
            case 2:
                this.font.draw(poseStack, ChatFormatting.GOLD + Localization.translate("iu.advanced"), 122, 31, 4210752);
                break;
            case 3:
                this.font.draw(poseStack, ChatFormatting.BLUE + Localization.translate("iu.improved"), 122, 31, 4210752);
                break;
            case 4:
                this.font.draw(poseStack, ChatFormatting.DARK_PURPLE + Localization.translate("iu.perfect"), 122, 31, 4210752);
                break;
            default:
                this.font.draw(poseStack, Localization.translate("iu.simply"), 122, 31, 4210752);
                break;
        }

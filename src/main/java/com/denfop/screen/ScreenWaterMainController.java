...
import com.denfop.containermenu.ContainerMenuWaterMainController;
...
public class ScreenWaterMainController<T extends ContainerMenuWaterMainController> extends ScreenMain<ContainerMenuWaterMainController> {
    ...
    public ScreenWaterMainController(ContainerMenuWaterMainController guiContainer) {
        super(guiContainer);
        this.componentList.clear();
        this.imageHeight = 254;
        this.imageWidth = 223;
        this.addComponent(new ScreenWidget(this, 149, 117, 170 - 149, 138 - 117,
        ...
        this.addComponent(new ScreenWidget(this, 172, 117, 170 - 149, 138 - 117,
        ...
        this.addComponent(new ScreenWidget(this, 163, 41, 182 - 163, 60 - 41,
                new WidgetDefault<>(new ComponentButton(this.container.base, -1) {
                    @Override
                    public String getText() {
        ...
        this.addComponent(new ScreenWidget(this, 163, 63, 182 - 163, 60 - 41,
                new WidgetDefault<>(new ComponentButton(this.container.base, -2) {
                    @Override
                    public String getText() {
        ...
        this.componentList.add(new ScreenWidget(this, 160, 12, 186 - 160, 38 - 12,
    ...
    protected void drawForegroundLayer(GuiGraphics poseStack, final int par1, final int par2) {
        ...
        if (this.container.base.typeWork == EnumTypeWork.LEVEL_INCREASE) {
            new TooltipWidget(this, 201, 10, 15, 76)
        ...
        new TooltipWidget(this, 26, 143, 120, 18)
        ...
        new AdvancedTooltipWidget(this, 158, 100, 185, 124)
    ...
    protected void drawGuiContainerBackgroundLayer(GuiGraphics poseStack, final float partialTicks, final int mouseX, final int mouseY) {
        ...
        bindTexture(ResourceLocation.tryBuild(Constants.MOD_ID, "textures/gui/gui_progressbars.png"));
    ...
    protected ResourceLocation getTexture() {
        switch (this.container.base.getMaxLevelReactor()) {
            case 1:
                return ResourceLocation.tryBuild(Constants.MOD_ID, "textures/gui/guifluidreactor.png");
            case 2:
                return ResourceLocation.tryBuild(Constants.MOD_ID, "textures/gui/guifluidreactor1.png");
            case 3:
                return ResourceLocation.tryBuild(Constants.MOD_ID, "textures/gui/guifluidreactor2.png");
            case 4:
                return ResourceLocation.tryBuild(Constants.MOD_ID, "textures/gui/guifluidreactor3.png");

        }
        return ResourceLocation.tryBuild(Constants.MOD_ID, "textures/gui/guiwaterreactor5.png");
    }

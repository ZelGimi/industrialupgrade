...
public abstract class ScreenIndustrialUpgrade<T extends ContainerMenuBase<? extends CustomWorldContainer>> extends AbstractContainerScreen<T> implements MenuAccess<T> {
    ...
    protected void drawForegroundLayer(@NotNull PoseStack graphics, int mouseX, int mouseY) {
        if (this.menu.base instanceof BlockEntityUpgrade) {
    ...
    public boolean mouseClicked(double d, double d2, int n) {
        ...
        for (ScreenWidget element : this.elements) {
            ScreenWidget guiElement = (ScreenWidget) element;
            if (guiElement.visible()) {

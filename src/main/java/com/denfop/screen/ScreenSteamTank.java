...
public class ScreenSteamTank<T extends ContainerMenuSteamTank> extends ScreenMain<ContainerMenuSteamTank> {

    public final ContainerMenuSteamTank container;

    public ScreenSteamTank(ContainerMenuSteamTank container1) {

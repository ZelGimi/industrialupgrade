...
public class ScreenFluidMixer<T extends ContainerMenuFluidMixer> extends ScreenMain<ContainerMenuFluidMixer> {

    public final ContainerMenuFluidMixer container;

    public ScreenFluidMixer(ContainerMenuFluidMixer container1) {
        super(container1);
        ...
        this.addWidget(TankWidget.createNormal(this, 23, 21, container.base.fluidTank1));
        this.addWidget(TankWidget.createNormal(this, 46, 21, container.base.fluidTank2));
        this.addWidget(TankWidget.createNormal(this, 97, 21, container.base.fluidTank3));
        this.addWidget(TankWidget.createNormal(this, 120, 21, container.base.fluidTank4));
        this.addComponent(new ScreenWidget(this, 7, 64, EnumTypeComponent.ENERGY,
                new WidgetDefault<>(this.container.base.energy)
        ));
        this.addComponent(new ScreenWidget(this, 72, 45, EnumTypeComponent.PROCESS,

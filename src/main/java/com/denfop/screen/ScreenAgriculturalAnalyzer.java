...
@OnlyIn(Dist.CLIENT)
public class ScreenAgriculturalAnalyzer<T extends ContainerMenuAgriculturalAnalyzer> extends ScreenMain<ContainerMenuAgriculturalAnalyzer> {
    ...
    public ScreenAgriculturalAnalyzer(ContainerMenuAgriculturalAnalyzer container, final ItemStack itemStack1) {
        super(container);

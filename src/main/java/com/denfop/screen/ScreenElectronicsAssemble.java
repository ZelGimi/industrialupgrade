...
@OnlyIn(Dist.CLIENT)
public class ScreenElectronicsAssemble<T extends ContainerMenuElectronicsAssembler> extends ScreenMain<ContainerMenuElectronicsAssembler> {

    public final ContainerMenuElectronicsAssembler container;
    int pointer;
    int prevPointer;
    ...
    public ScreenElectronicsAssemble(
            ContainerMenuElectronicsAssembler container1
    ) {
        super(container1);
    ...
    private void handleUpgradeTooltip(int mouseX, int mouseY) {
        if (mouseX >= 3 && mouseX <= 13 && mouseY >= 3 && mouseY <= 13) {
            ...
            for (int i = 1; i < 9; i++) {
                compatibleUpgrades.add(Localization.translate("electronics_assembler.info" + i));
            }

...
public class ScreenAutoSpawner<T extends ContainerMenuAutoSpawner> extends ScreenIndustrialUpgrade<ContainerMenuAutoSpawner> {

    public final ContainerMenuAutoSpawner container;

    public ScreenAutoSpawner(ContainerMenuAutoSpawner container1) {
    ...
    protected void drawForegroundLayer(PoseStack poseStack, int par1, int par2) {
        ...
        this.font.draw(poseStack, ModUtils.getString(ExperienceUtils.getLevelForExperience((int) this.container.base.exp.getEnergy())),

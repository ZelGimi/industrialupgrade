...
@OnlyIn(Dist.CLIENT)
public class ScreenAdvOilRefiner<T extends ContainerMenuAdvOilRefiner> extends ScreenMain<ContainerMenuAdvOilRefiner> {
    ...
    public ContainerMenuAdvOilRefiner container;

    public ScreenAdvOilRefiner(ContainerMenuAdvOilRefiner container1) {

...
public class ScreenSteamQuarry<T extends ContainerMenuSteamQuarry> extends ScreenMain<ContainerMenuSteamQuarry> {

    public final ContainerMenuSteamQuarry container;

    public ScreenSteamQuarry(ContainerMenuSteamQuarry container1) {

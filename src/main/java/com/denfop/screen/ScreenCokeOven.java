...
@OnlyIn(Dist.CLIENT)
public class ScreenCokeOven<T extends ContainerMenuCokeOven> extends ScreenMain<ContainerMenuCokeOven> {

    public final ContainerMenuCokeOven container;
    public boolean highlightedMinus = false;
    public boolean highlightedPlus = false;

    public ScreenCokeOven(ContainerMenuCokeOven container1) {
        super(container1);

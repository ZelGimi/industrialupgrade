...
public class ScreenRadiationStorage<T extends ContainerMenuRadiationStorage> extends ScreenMain<ContainerMenuRadiationStorage> {

    private final ContainerMenuRadiationStorage container;

    public ScreenRadiationStorage(ContainerMenuRadiationStorage container1) {
    ...
    protected void drawForegroundLayer(GuiGraphics poseStack, final int mouseX, final int mouseY) {
        ...
        new AdvancedTooltipWidget(this, 5, 31, 170, 55).withTooltip(ModUtils

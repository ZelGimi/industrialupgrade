...
public class ScreenFluidSeparator<T extends ContainerMenuFluidSeparator> extends ScreenMain<ContainerMenuFluidSeparator> {

    public final ContainerMenuFluidSeparator container;

    public ScreenFluidSeparator(ContainerMenuFluidSeparator container1) {
        super(container1);
        ...
        this.addWidget(TankWidget.createNormal(this, 48, 21, container.base.fluidTank1));
        this.addWidget(TankWidget.createNormal(this, 96, 21, container.base.fluidTank2));
        ...
        this.componentList.add(new ScreenWidget(this, 5, 90, EnumTypeComponent.SOLARIUM_ENERGY_WEIGHT,

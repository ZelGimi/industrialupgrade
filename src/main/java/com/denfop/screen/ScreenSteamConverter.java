...
public class ScreenSteamConverter<T extends ContainerMenuSteamConverter> extends ScreenMain<ContainerMenuSteamConverter> {

    public ContainerMenuSteamConverter container;
    public String name;

    public ScreenSteamConverter(ContainerMenuSteamConverter guiContainer) {

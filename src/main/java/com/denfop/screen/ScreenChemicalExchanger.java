...
import com.denfop.blockentity.chemicalplant.BlockEntityChemicalPlantExchanger;
...
public class ScreenChemicalExchanger<T extends ContainerMenuDefaultMultiElement> extends ScreenMain<ContainerMenuDefaultMultiElement> {

    public ScreenChemicalExchanger(ContainerMenuDefaultMultiElement guiContainer) {
        super(guiContainer);
        ...
        this.addWidget((new FluidDefaultWidget(
                ...
                20,
                ((BlockEntityChemicalPlantExchanger) guiContainer.base).getFluidTank().getFluid()
        ) {
            @Override
            public void drawBackground(GuiGraphics poseStack, final int mouseX, final int mouseY) {
                bindCommonTexture();
                FluidStack fs = ((BlockEntityChemicalPlantExchanger) guiContainer.base).getFluidTank().getFluid();

...
public class ScreenExpeditionTableSpace extends ScreenDefaultResearchTable {
    ...
    public void drawGuiContainerBackgroundLayer(GuiGraphics poseStack, float partialTicks, int mouseX, int mouseY) {
        ...
        if (fakeBody == null) {
            ...
            if (spaceOperation == null) {
                getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_other2.png"), (int) (guiLeft + width / 2 - (159 * 0.75) / 2), guiTop + 25, 20, 0.75f, 0.75f, 0, 34, 159, 16);
                ...
                switch (spaceOperation.getOperation()) {
                    case FAIL -> {
                        getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_other2.png"), (int) (guiLeft + width / 2 - (159 * 0.75) / 2), guiTop + 25, 20, 0.75f, 0.75f, 0, 17, 159, 16);
                    ...
                    case SUCCESS -> {
                        getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_other2.png"), (int) (guiLeft + width / 2 - (159 * 0.75) / 2), guiTop + 25, 20, 0.75f, 0.75f, 0, 0, 159, 16);
        ...
        if (fakeBody == null) {
            if (!hoverSend) {
                getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_other.png"), guiLeft + 30 + 7, guiTop + 55, 0, 0.75f, 0.75f, 0, 105, 103, 20);
            } else {
                getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_other.png"), guiLeft + 30 + 7, guiTop + 55, 0, 0.75f, 0.75f, 0, 125, 103, 20);
            ...
            if (!hoverAuto) {
                getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_other.png"), guiLeft + 30 + 7, guiTop + 55 + 35, 0, 0.75f, 0.75f, 0, 105, 103, 20);
            } else {
                getTile().drawRect(poseStack, new ResourceLocation(Constants.MOD_ID, "textures/gui/gui_space_other.png"), guiLeft + 30 + 7, guiTop + 55 + 35, 0, 0.75f, 0.75f, 0, 125, 103, 20);

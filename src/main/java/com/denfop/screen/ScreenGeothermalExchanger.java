...
public class ScreenGeothermalExchanger<T extends ContainerMenuGeothermalExchanger> extends ScreenMain<ContainerMenuGeothermalExchanger> {
    ...
    public ScreenGeothermalExchanger(ContainerMenuGeothermalExchanger guiContainer) {
        ...
        this.addWidget((new FluidDefaultWidget(this, this.imageWidth / 2 - 10, 20,
                ((BlockEntityGeothermalExchanger) guiContainer.base).getFluidTank().getFluid()
        ) {
            @Override
            public void drawBackground(GuiGraphics poseStack, final int mouseX, final int mouseY) {
                bindCommonTexture();
                FluidStack fs = ((BlockEntityGeothermalExchanger) guiContainer.base).getFluidTank().getFluid();

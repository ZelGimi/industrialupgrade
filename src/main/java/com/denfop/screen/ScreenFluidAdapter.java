...
public class ScreenFluidAdapter<T extends ContainerMenuFluidAdapter> extends ScreenMain<ContainerMenuFluidAdapter> {

    public final ContainerMenuFluidAdapter container;

    public ScreenFluidAdapter(ContainerMenuFluidAdapter container1) {
        super(container1);

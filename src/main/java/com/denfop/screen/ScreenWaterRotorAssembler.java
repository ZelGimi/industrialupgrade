...
public class ScreenWaterRotorAssembler<T extends ContainerMenuWaterRotorAssembler> extends ScreenMain<ContainerMenuWaterRotorAssembler> {
    ...
    public ScreenWaterRotorAssembler(ContainerMenuWaterRotorAssembler guiContainer) {
        super(guiContainer);
        this.imageWidth = 206;
        this.imageHeight = 256;
        this.inventory.setY(172);
        this.elements.add(new ImageInterfaceWidget(this, 0, 0, this.imageWidth, this.imageHeight));
        this.addComponent(new ScreenWidget(this, 137, 150, EnumTypeComponent.ENERGY_WEIGHT,

...
public class ScreenTripleSolidMixer<T extends ContainerMenuTripleSolidMixer> extends ScreenMain<ContainerMenuTripleSolidMixer> {

    public final ContainerMenuTripleSolidMixer container;

    public ScreenTripleSolidMixer(ContainerMenuTripleSolidMixer container1) {
        super(container1);
        this.container = container1;
        this.addComponent(new ScreenWidget(this, 5, 15, EnumTypeComponent.SOUND_BUTTON,

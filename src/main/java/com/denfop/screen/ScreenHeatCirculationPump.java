...
public class ScreenHeatCirculationPump<T extends ContainerMenuHeatCirculationPump> extends ScreenMain<ContainerMenuHeatCirculationPump> {

    public ScreenHeatCirculationPump(ContainerMenuHeatCirculationPump guiContainer) {
        super(guiContainer);

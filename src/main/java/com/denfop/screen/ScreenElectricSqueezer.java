...
public class ScreenElectricSqueezer<T extends ContainerMenuElectricSqueezer> extends ScreenMain<ContainerMenuElectricSqueezer> {

    public final ContainerMenuElectricSqueezer container;

    public ScreenElectricSqueezer(ContainerMenuElectricSqueezer container1) {
        super(container1);

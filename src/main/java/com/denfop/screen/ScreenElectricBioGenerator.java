...
public class ScreenElectricBioGenerator<T extends ContainerMenuElectricBioGenerator> extends ScreenMain<ContainerMenuElectricBioGenerator> {

    public final ContainerMenuElectricBioGenerator container;

    public ScreenElectricBioGenerator(ContainerMenuElectricBioGenerator container1) {
        super(container1);
        ...
        this.addComponent(new ScreenWidget(this, 70, 40, EnumTypeComponent.PROCESS2,

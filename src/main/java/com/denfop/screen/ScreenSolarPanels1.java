...
public class ScreenSolarPanels1<Y extends ContainerMenuSolarPanels1> extends ScreenMain<ContainerMenuSolarPanels1> implements ButtonListSliderWidget.WidgetResponder, SliderWidget.FormatHelper {

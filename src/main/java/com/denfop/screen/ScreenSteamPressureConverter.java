...
public class ScreenSteamPressureConverter<T extends ContainerMenuSteamPressureConverter> extends ScreenMain<ContainerMenuSteamPressureConverter> {

    public ContainerMenuSteamPressureConverter container;
    public String name;

    public ScreenSteamPressureConverter(ContainerMenuSteamPressureConverter guiContainer) {
        ...
        this.componentList.add(new ScreenWidget(this, 96, 24, EnumTypeComponent.PLUS_BUTTON,
        ...
        this.componentList.add(new ScreenWidget(this, 96, 56, EnumTypeComponent.MINUS_BUTTON,

...
public class ScreenBus<T extends ContainerBus> extends ScreenMain<ContainerBus> {
    ...
    @Override
    protected void drawForegroundLayer(PoseStack guiGraphics, final int mouseX, final int mouseY) {
    ...
    protected ResourceLocation getTexture() {
        if (container.base.isImport()) {
            return new ResourceLocation(Constants.MOD_ID, "textures/gui/guiimport.png");
        } else {
            return new ResourceLocation(Constants.MOD_ID, "textures/gui/guiexport.png");
        }
    }
}
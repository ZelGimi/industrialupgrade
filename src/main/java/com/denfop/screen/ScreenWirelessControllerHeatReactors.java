...
public class ScreenWirelessControllerHeatReactors<T extends ContainerMenuWirelessControllerHeatReactors> extends ScreenMain<ContainerMenuWirelessControllerHeatReactors> {


    public ScreenWirelessControllerHeatReactors(ContainerMenuWirelessControllerHeatReactors guiContainer) {
        super(guiContainer);

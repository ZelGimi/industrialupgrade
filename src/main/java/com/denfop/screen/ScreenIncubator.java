...
public class ScreenIncubator<T extends ContainerMenuIncubator> extends ScreenMain<ContainerMenuIncubator> {

    public final ContainerMenuIncubator container;

    public ScreenIncubator(ContainerMenuIncubator container1) {
        super(container1);

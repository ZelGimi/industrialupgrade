...
public class ScreenSteamDryer<T extends ContainerMenuSteamDryer> extends ScreenMain<ContainerMenuSteamDryer> {

    public final ContainerMenuSteamDryer container;

    public ScreenSteamDryer(ContainerMenuSteamDryer container1) {

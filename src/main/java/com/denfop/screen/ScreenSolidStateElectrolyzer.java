...
public class ScreenSolidStateElectrolyzer<T extends ContainerMenuSolidStateElectrolyzer> extends ScreenMain<ContainerMenuSolidStateElectrolyzer> {

    public final ContainerMenuSolidStateElectrolyzer container;

    public ScreenSolidStateElectrolyzer(ContainerMenuSolidStateElectrolyzer container1) {
        super(container1);
        ...
        this.addWidget(TankWidget.createNormal(this, 43 + 75, 21, container.base.fluidTank1));
        this.addComponent(new ScreenWidget(this, 7, 64, EnumTypeComponent.ENERGY,
                new WidgetDefault<>(this.container.base.energy)
        ));
        this.addComponent(new ScreenWidget(this, 62, 45, EnumTypeComponent.PROCESS,

...
public class ScreenCable<T extends ContainerMenuCable> extends ScreenMain<ContainerMenuCable> {
    ...
    private void drawHeader(PoseStack guiGraphics, EnumSet<Direction> displayBlacklist) {
    ...
    private void drawStatus(PoseStack guiGraphics, EnumSet<Direction> displayBlacklist) {
        int connected = 6 - displayBlacklist.size();
    ...
    private int drawWrappedTextBlock(PoseStack guiGraphics,
                                     Component text,
                                     int x,
                                     int y,
                                     int maxWidth,
    ...
    private void drawChip(PoseStack guiGraphics, int x, int y, int w, int h, int bgColor, Component text, int textColor) {
        fill(guiGraphics, x, y, x + w, y + h, 0xA0000000);
        fill(guiGraphics, x + 1, y + 1, x + w - 1, y + h - 1, bgColor);
        drawCenteredString(guiGraphics, this.font, text, x + (w / 2), y + (h - 8) / 2, textColor);
    }

...
public class ScreenTesseract<T extends ContainerMenuTesseract> extends ScreenMain<ContainerMenuTesseract> {
        ...
        switch (guiScreenID) {
            ...
            case 3:
                ...
                for (int i = 0; i < itemStackList.size(); i++) {
                    ...
                    this.drawItemStack(poseStack, 35 + (i % 6) * 20, 11 + (i / 6) * 22, itemStackList.get(i));
    ...
    protected ResourceLocation getTexture() {
        switch (guiScreenID) {
            default:
                return ResourceLocation.tryBuild(Constants.MOD_ID, "textures/gui/guitesseract.png");
            case 1:
                return ResourceLocation.tryBuild(Constants.MOD_ID, "textures/gui/guitesseract_create_channel.png");
            case 3:
                return ResourceLocation.tryBuild(Constants.MOD_ID, "textures/gui/guitesseract_inventory.png");
            case 2:
            case 4:
                return ResourceLocation.tryBuild(Constants.MOD_ID, "textures/gui/guitesseract_public_channels.png");

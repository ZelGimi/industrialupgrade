...
public class ScreenWireInsulator<T extends ContainerMenuWireInsulator> extends ScreenMain<ContainerMenuWireInsulator> {

    public ScreenWireInsulator(ContainerMenuWireInsulator guiContainer) {
        super(guiContainer);

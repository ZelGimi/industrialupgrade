...
public class ScreenItemDividerFluids<T extends ContainerMenuItemDividerFluids> extends ScreenMain<ContainerMenuItemDividerFluids> {

    public final ContainerMenuItemDividerFluids container;

    public ScreenItemDividerFluids(ContainerMenuItemDividerFluids container1) {
        super(container1);
        ...
        this.addComponent(new ScreenWidget(this, 75, 45, EnumTypeComponent.PROCESS,

...
public class ScreenOilPurifier<T extends ContainerMenuOilPurifier> extends ScreenMain<ContainerMenuOilPurifier> {

    public final ContainerMenuOilPurifier container;

    public ScreenOilPurifier(ContainerMenuOilPurifier container1) {
        super(container1);
        ...
        this.addComponent(new ScreenWidget(this, 70, 40, EnumTypeComponent.PROCESS,

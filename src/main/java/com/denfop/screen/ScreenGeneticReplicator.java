...
public class ScreenGeneticReplicator<T extends ContainerMenuGeneticReplicator> extends ScreenMain<ContainerMenuGeneticReplicator> {

    public final ContainerMenuGeneticReplicator container;

    public ScreenGeneticReplicator(ContainerMenuGeneticReplicator container1) {
        super(container1);

...
@OnlyIn(Dist.CLIENT)
public class ScreenPrimalProgrammingTable<T extends ContainerMenuPrimalProgrammingTable> extends ScreenMain<ContainerMenuPrimalProgrammingTable> {

    public final ContainerMenuPrimalProgrammingTable container;
    int pointer;
    int prevPointer;

    boolean hover;

    public ScreenPrimalProgrammingTable(
            ContainerMenuPrimalProgrammingTable container1
    ) {
        super(container1);
    ...
    public ResourceLocation getTexture() {
        return ResourceLocation.tryBuild(Constants.TEXTURES, "textures/gui/guiprogrammingtable.png");
    }

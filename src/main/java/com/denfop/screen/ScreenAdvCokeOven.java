...
@OnlyIn(Dist.CLIENT)
public class ScreenAdvCokeOven<T extends ContainerMenuAdvCokeOven> extends ScreenMain<ContainerMenuAdvCokeOven> {

    public final ContainerMenuAdvCokeOven container;
    public boolean highlightedMinus = false;
    public boolean highlightedPlus = false;

    public ScreenAdvCokeOven(ContainerMenuAdvCokeOven container1) {
        super(container1);
        ...
        this.addComponent(new ScreenWidget(this, 155, 44, EnumTypeComponent.SOUND_BUTTON,
                new WidgetDefault<>(new ComponentSoundButton(this.container.base, 10, this.container.base))
        ));
        this.addWidget(new AdvancedTooltipWidget(this, 108, 23, 150, 36).withTooltip("+1"));
        this.addWidget(new AdvancedTooltipWidget(this, 34, 23, 47, 36).withTooltip("-1"));
        this.addWidget(new AdvancedTooltipWidget(this, 63, 76, 118, 89) {
            @Override
        ...
        this.addWidget(new AdvancedTooltipWidget(this, 50, 25, 105, 34) {
            @Override
            protected List<String> getToolTip() {
                String temp =

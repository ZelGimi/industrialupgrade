...
public class ScreenReverseTransriptor<T extends ContainerMenuReverseTransriptor> extends ScreenMain<ContainerMenuReverseTransriptor> {

    public final ContainerMenuReverseTransriptor container;

    public ScreenReverseTransriptor(ContainerMenuReverseTransriptor container1) {
        super(container1);
        ...
        this.componentList.add(new ScreenWidget(this, 70, 80, EnumTypeComponent.QUANTUM_ENERGY_WEIGHT,
                new WidgetDefault<>(this.container.base.qe)
        ));
        this.componentList.add(new ScreenWidget(this, 70, 100, EnumTypeComponent.RAD,

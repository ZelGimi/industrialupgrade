...
public class ScreenWaterGenerator<T extends ContainerMenuWaterGenerator> extends ScreenMain<ContainerMenuWaterGenerator> {

    public final ContainerMenuWaterGenerator container;
    public final String progressLabel;
    public final String amplifierLabel;

    public ScreenWaterGenerator(ContainerMenuWaterGenerator container1) {
        super(container1);

...
public class ScreenDryer<T extends ContainerMenuDryer> extends ScreenMain<ContainerMenuDryer> {

    public final ContainerMenuDryer container;

    public ScreenDryer(ContainerMenuDryer container1) {
        super(container1);

...
public class ItemsPetrolQuarry extends ItemMulti<ItemsPetrolQuarry.Types> implements IModelRegister {

    protected static final String NAME = "petrol_quarry_item";

    public ItemsPetrolQuarry() {
    ...
    public EnumActionResult onItemUse(
        ...
        if (!StackUtil.isEmpty(stack) && player.canPlayerEdit(pos, side, stack) && world.mayPlace(
            ...
            TileEntityOilGetter te = new TileEntityOilGetter();

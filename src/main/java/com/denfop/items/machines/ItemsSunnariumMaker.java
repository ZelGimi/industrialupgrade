...
public class ItemsSunnariumMaker extends ItemMulti<ItemsSunnariumMaker.Types> implements IModelRegister {

    protected static final String NAME = "sunnarium_maker_item";

    public ItemsSunnariumMaker() {
    ...
    public EnumActionResult onItemUse(
        ...
        if (!StackUtil.isEmpty(stack) && player.canPlayerEdit(pos, side, stack) && world.mayPlace(
            ...
            TileSunnariumMaker te = new TileSunnariumMaker();

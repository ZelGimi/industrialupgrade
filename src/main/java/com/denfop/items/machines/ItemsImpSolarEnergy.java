...
public class ItemsImpSolarEnergy extends ItemMulti<ItemsImpSolarEnergy.Types> implements IModelRegister {

    protected static final String NAME = "imp_solar_energy";

    public ItemsImpSolarEnergy() {
    ...
    public EnumActionResult onItemUse(
        ...
        if (!StackUtil.isEmpty(stack) && player.canPlayerEdit(pos, side, stack) && world.mayPlace(
            ...
            TileImpSolarGenerator te = new TileImpSolarGenerator();

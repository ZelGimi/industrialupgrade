...
public class ItemsMolecular extends ItemMulti<ItemsMolecular.Types> implements IModelRegister {

    protected static final String NAME = "molecular_item";

    public ItemsMolecular() {
    ...
    public EnumActionResult onItemUse(
        ...
        if (!StackUtil.isEmpty(stack) && player.canPlayerEdit(pos, side, stack) && world.mayPlace(
            ...
            TileEntityMolecularTransformer te = new TileEntityMolecularTransformer();

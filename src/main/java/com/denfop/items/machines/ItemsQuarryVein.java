...
public class ItemsQuarryVein extends ItemMulti<ItemsQuarryVein.Types> implements IModelRegister {

    protected static final String NAME = "quarry_vein_item";

    public ItemsQuarryVein() {
    ...
    public EnumActionResult onItemUse(
        ...
        if (!StackUtil.isEmpty(stack) && player.canPlayerEdit(pos, side, stack) && world.mayPlace(
            ...
            TileEntityQuarryVein te = new TileEntityQuarryVein();

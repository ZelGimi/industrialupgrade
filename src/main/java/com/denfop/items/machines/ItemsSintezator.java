...
public class ItemsSintezator extends ItemMulti<ItemsSintezator.Types> implements IModelRegister {

    protected static final String NAME = "sintezator_item";
    ...
    public EnumActionResult onItemUse(
        ...
        if (!StackUtil.isEmpty(stack) && player.canPlayerEdit(pos, side, stack) && world.mayPlace(
            ...
            TileEntitySintezator te = new TileEntitySintezator();

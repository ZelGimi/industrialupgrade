...
public class ItemsDoubleMolecular extends ItemMulti<ItemsDoubleMolecular.Types> implements IModelRegister {

    protected static final String NAME = "double_molecular";

    public ItemsDoubleMolecular() {
    ...
    public EnumActionResult onItemUse(
        ...
        if (!StackUtil.isEmpty(stack) && player.canPlayerEdit(pos, side, stack) && world.mayPlace(
            ...
            TileEntityDoubleMolecular te = new TileEntityDoubleMolecular();

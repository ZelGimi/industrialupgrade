...
public class ItemsSunnariumPanelMaker extends ItemMulti<ItemsSunnariumPanelMaker.Types> implements IModelRegister {

    protected static final String NAME = "sunnarium_maker_plate_item";

    public ItemsSunnariumPanelMaker() {
    ...
    public EnumActionResult onItemUse(
        ...
        if (!StackUtil.isEmpty(stack) && player.canPlayerEdit(pos, side, stack) && world.mayPlace(
            ...
            TileEntitySunnariumPanelMaker te = new TileEntitySunnariumPanelMaker();

...
public class ItemsCoverterMatter extends ItemMulti<ItemsCoverterMatter.Types> implements IModelRegister {

    protected static final String NAME = "converter_solid";

    public ItemsCoverterMatter() {
    ...
    public EnumActionResult onItemUse(
        ...
        if (!StackUtil.isEmpty(stack) && player.canPlayerEdit(pos, side, stack) && world.mayPlace(
            ...
            TileEntityConverterSolidMatter te = new TileEntityConverterSolidMatter();

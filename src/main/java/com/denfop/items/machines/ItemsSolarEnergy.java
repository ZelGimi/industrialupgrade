...
public class ItemsSolarEnergy extends ItemMulti<ItemsSolarEnergy.Types> implements IModelRegister {

    protected static final String NAME = "solar_energy";

    public ItemsSolarEnergy() {
    ...
    public EnumActionResult onItemUse(
        ...
        if (!StackUtil.isEmpty(stack) && player.canPlayerEdit(pos, side, stack) && world.mayPlace(
            ...
            TileSolarGenerator te = new TileSolarGenerator();

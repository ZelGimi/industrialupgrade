...
public class ItemsCombinerSolid extends ItemMulti<ItemsCombinerSolid.Types> implements IModelRegister {

    protected static final String NAME = "combiner_solidmatter";

    public ItemsCombinerSolid() {
    ...
    public EnumActionResult onItemUse(
        ...
        if (!StackUtil.isEmpty(stack) && player.canPlayerEdit(pos, side, stack) && world.mayPlace(
            ...
            TileEntityCombinerSolidMatter te = new TileEntityCombinerSolidMatter();

...
public class ItemsAdvSolarEnergy extends ItemMulti<ItemsAdvSolarEnergy.Types> implements IModelRegister {

    protected static final String NAME = "adv_solar_energy";

    public ItemsAdvSolarEnergy() {
    ...
    public EnumActionResult onItemUse(
        ...
        if (!StackUtil.isEmpty(stack) && player.canPlayerEdit(pos, side, stack) && world.mayPlace(
            ...
            TileAdvSolarGenerator te = new TileAdvSolarGenerator();

...
public class ItemAlloysCasing extends ItemSubTypes<ItemAlloysCasing.Types> implements IModelRegister {
    ...
    public String getUnlocalizedName() {
        return super.getUnlocalizedName().replace("alloy", "alloys");
    }

...
public class ItemBeeAnalyzer extends Item implements IItemStackInventory {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        ...
        pTooltipComponents.add(Component.literal(Localization.translate("iu.bee_analyzer.info")));
    }
    ...
    public InteractionResultHolder<ItemStack> use(@Nonnull Level world, @Nonnull Player player, @Nonnull InteractionHand hand) {
        ...
        if (!player.getLevel().isClientSide && world.getBlockEntity(blockhitresult.getBlockPos()) == null) {
            save(stack, player);

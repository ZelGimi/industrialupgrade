...
@OnlyIn(Dist.CLIENT)
public class ScreenFacadeItem<T extends ContainerMenuFacadeItem> extends ScreenMain<ContainerMenuFacadeItem> {
    ...
    public ScreenFacadeItem(ContainerMenuFacadeItem container, final ItemStack itemStack1) {
        super(container);

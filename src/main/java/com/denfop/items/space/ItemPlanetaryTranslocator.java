...
public class ItemPlanetaryTranslocator extends BaseEnergyItem {
    ...
    public void appendHoverText(final ItemStack stack, @Nullable final Level level, final List<Component> tooltip, final TooltipFlag flag) {
        ...
        tooltip.add(Component.literal(Localization.translate("iu.space.tp.item.info1")));
        tooltip.add(Component.literal(Localization.translate("iu.space.tp.item.info2")));
        tooltip.add(Component.literal(Localization.translate("iu.space.tp.item.info3")));
    }

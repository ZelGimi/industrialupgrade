...
public final class SpaceTeleportEnergyLogic {
    ...
    private static final double MOON_MAX_STAY_SECONDS = 2.5D * 60D * 60D;     // 2:30
    private static final double MARS_MAX_STAY_SECONDS = 2.0D * 60D * 60D;     // 2:00
    private static final double FAR_SOLAR_MAX_STAY_SECONDS = 15D * 60D;        // 0:15
    private static final double DEEP_SYSTEM_MIN_STAY_SECONDS = 5D * 60D;       // 0:05

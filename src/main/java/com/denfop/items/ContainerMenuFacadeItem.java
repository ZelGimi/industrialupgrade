...
public class ContainerMenuFacadeItem extends ContainerMenuHandHeldInventory<FacadeItemInventory> {


    private final int current;

    public ContainerMenuFacadeItem(Player player, FacadeItemInventory facadeItemInventory) {

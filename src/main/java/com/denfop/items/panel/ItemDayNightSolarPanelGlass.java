...
public class ItemDayNightSolarPanelGlass extends ItemSubTypes<ItemDayNightSolarPanelGlass.Types> implements ISolarItem,
        IModelRegister {
    ...
    public EnumSolarType getType() {
        return EnumSolarType.DAY_NIGHT;
    }
    ...
    public void addInformation(
        ...
        tooltip.add(Localization.translate("iu.minipanel.generating") + this.getGenerationValue(stack.getItemDamage()) + " EF/t");
    ...
    public ResourceLocation getResourceLocation(int meta) {
        return new ResourceLocation(Constants.MOD_ID, "textures/items/daynight/" + Types.getFromID(meta).getName() + ".png");
    }

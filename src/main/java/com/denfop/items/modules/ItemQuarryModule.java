...
public class ItemQuarryModule<T extends Enum<T> & ISubEnum> extends ItemMain<T> {
    public ItemQuarryModule(T element) {
        super(new Properties().tab(IUCore.ModuleTab), element);
    }
        ...
        switch (meta) {
            ...
            case 12:
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    ItemStack stack = new ItemStack(Registry.ITEM.getTagOrEmpty(ItemTags.create(new ResourceLocation(ore))).iterator().next().get());

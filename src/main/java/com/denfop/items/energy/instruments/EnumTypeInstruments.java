...
public enum EnumTypeInstruments {
    SHOVEL(
            ...
            Sets.newHashSet(Material.GRASS, Material.DIRT,
                    Material.SAND, Material.SNOW, Material.POWDER_SNOW, Material.CLAY, Material.GLASS
            ),
    ...
    ), Sets.newHashSet(Material.METAL, Material.HEAVY_METAL,
            Material.STONE, Material.GRASS, Material.ICE, Material.ICE_SOLID, Material.GLASS
    ...
    DRILL(Sets.newHashSet(
            ...
            Material.STONE, Material.GRASS, Material.ICE, Material.ICE_SOLID, Material.GRASS, Material.DIRT,
            Material.SAND, Material.SNOW, Material.POWDER_SNOW, Material.CLAY
    ...
    AXE(
            ...
            Sets.newHashSet(Material.WOOD, Material.LEAVES,
                    Material.MOSS, Material.CACTUS, Material.PLANT, Material.VEGETABLE
            ),
            ImmutableSet.of("axe"),
    ...
    PERFECT_DRILL(
            ...
            Sets.newHashSet(Material.WOOD, Material.LEAVES,
                    Material.MOSS, Material.CACTUS, Material.PLANT, Material.VEGETABLE, Material.METAL, Material.HEAVY_METAL,
                    Material.STONE, Material.GRASS, Material.ICE, Material.ICE_SOLID, Material.GRASS, Material.DIRT,
                    Material.SAND, Material.SNOW, Material.POWDER_SNOW, Material.CLAY
            ),
    ...
    EnumTypeInstruments(
            Set<BlockState> mineableBlocks, Set<Material> materials, Set<String> toolType, List<TagKey<Block>> listItems,

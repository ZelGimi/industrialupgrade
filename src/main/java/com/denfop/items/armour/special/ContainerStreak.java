...
public class ContainerStreak extends ContainerHandHeldInventory<ItemStackStreakSettings> {


    private final ItemStackStreakSettings Toolbox1;
    private final int current;

    public ContainerStreak(Player player, ItemStackStreakSettings Toolbox1) {

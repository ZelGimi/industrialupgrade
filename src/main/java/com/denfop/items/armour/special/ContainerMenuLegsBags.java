...
public class ContainerMenuLegsBags extends ContainerMenuHandHeldInventory<ItemStackLegsBags> {
    ...
    public ContainerMenuLegsBags(Player player, ItemStackLegsBags Toolbox1) {

...
public class HsvColorPaletteWidget extends AbstractWidget {
    ...
    public void renderButton(PoseStack poseStack, int mouseX, int mouseY, float partialTick) {
        ...
        fill(poseStack, innerX, innerY, innerX + innerW, innerY + innerH, baseColor);
        ...
        fill(poseStack, knobX - 2, knobY - 2, knobX + 3, knobY + 3, 0xFF000000);
        fill(poseStack, knobX - 1, knobY - 1, knobX + 2, knobY + 2, 0xFFFFFFFF);
    }
    ...
    private void updateFromMouse(double mouseX, double mouseY) {
        float localX = (float) ((mouseX - (this.x + 1)) / (double) (this.width - 2));

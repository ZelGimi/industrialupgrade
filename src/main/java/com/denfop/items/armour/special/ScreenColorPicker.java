...
@OnlyIn(Dist.CLIENT)
public class ScreenColorPicker<T extends ContainerMenuBase<?>> extends ScreenMain<ContainerMenuStreak> implements ButtonListSliderWidget.GuiResponder, SliderWidget.FormatHelper {
    ...
    public ScreenColorPicker(ContainerMenuStreak container, final ItemStack itemStack1) {
        super(container);

...
public class ItemArmorImprovemedNano extends ItemArmorEnergy
        implements IModelRegister, ISpecialArmor, IUpgradeItem, IEnergyItem {
    ...
    public void onArmorTick(@Nonnull World world, @Nonnull EntityPlayer player, @Nonnull ItemStack itemStack) {
        ...
        switch (this.armorType.getIndex()) {
            ...
            case 2:
                ...
                if (IUCore.keyboard.isJumpKeyDown(player) && IUCore.keyboard.isChangeKeyDown(player) && toggleTimer == 0) {
                    ...
                    if (IUCore.proxy.isSimulating()) {
                        ...
                        if (hoverMode) {
                            IUCore.proxy.messagePlayer(player, "Quantum Hover Mode enabled.");
                        } else {
                            IUCore.proxy.messagePlayer(player, "Quantum Hover Mode disabled.");
                        }
                    }
                }

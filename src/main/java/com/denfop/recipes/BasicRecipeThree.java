...
public class BasicRecipeThree {
    ...
    public static void recipe() {
        ...
        Recipes.recipe.addRecipe(getBlockStack(BlockMiniSmeltery.mini_smeltery), "ACA", "EDE", "BBB",

                'A', "gearFerromanganese",'B',getBlockStack(BlockSmeltery.smeltery_casing), 'C', new ItemStack(IUItem.crafting_elements, 1,
                        496),
                'D',
                getBlockStack(BlockBaseMachine3.oak_tank),'E',"plateIridium"
        );
        ...
        Recipes.recipe.addRecipe(getBlockStack(BlockBaseMachine3.steam_crystal_charge), "AED", " B ", " C ",
                ...
                'A',new ItemStack(IUItem.crafting_elements, 1,
                        123),'D',new ItemStack(IUItem.crafting_elements, 1,
                        32),'B', new ItemStack(IUItem.crafting_elements, 1,
                        601),'C', new ItemStack(IUItem.blockResource,1,12),'E', IUItem.charged_redstone
        );
        Recipes.recipe.addRecipe(getBlockStack(BlockBaseMachine3.steam_fluid_heater), "AED", " B ", " C ",
                ...
                'A',new ItemStack(IUItem.crafting_elements, 1,
                        123),'D',new ItemStack(IUItem.crafting_elements, 1,
                        32),'B', new ItemStack(IUItem.crafting_elements, 1,
                        601),'C', new ItemStack(IUItem.blockResource,1,12),'E', IUItem.primalFluidHeater
        );
        Recipes.recipe.addRecipe(getBlockStack(BlockBaseMachine3.steam_wire_insulator), "AED", " B ", " C ",

                'A',new ItemStack(IUItem.crafting_elements, 1,
                        123),'D',new ItemStack(IUItem.crafting_elements, 1,
                        32),'B', getBlockStack(BlockPrimalWireInsulator.primal_wire_insulator),'C', new ItemStack(IUItem.blockResource,1,12),'E',
        ...
        Recipes.recipe.addRecipe(getBlockStack(BlockBaseMachine3.steam_rolling), "AED", " B ", " C ",
                ...
                'A',new ItemStack(IUItem.crafting_elements, 1,
                        123),'D',new ItemStack(IUItem.crafting_elements, 1,
                        32),'B', getBlockStack(BlockStrongAnvil.block_strong_anvil),'C', new ItemStack(IUItem.blockResource,1,12),'E',
                new ItemStack(IUItem.crafting_elements, 1,
                        165)
        );
        ...
        Recipes.recipe.addRecipe(getBlockStack(BlockBaseMachine3.steam_quarry), "AED", "BCB", "   ",
                ...
                'A',new ItemStack(IUItem.crafting_elements, 1,
                        123),'D',new ItemStack(IUItem.crafting_elements, 1,
                        32),'B', getBlockStack(BlockBaseMachine3.quarry_pipe),'C', new ItemStack(IUItem.blockResource,1,12),'E',
                new ItemStack(IUItem.crafting_elements, 1,
                        158)
        );
        ...
        Recipes.recipe.addRecipe(getBlockStack(BlockBaseMachine3.adv_steam_quarry), "ACA", " B ", "A A",
                'B', getBlockStack(BlockBaseMachine3.steam_quarry),'A',new ItemStack(IUItem.crafting_elements, 1,
                        138),'C',  new ItemStack(IUItem.crafting_elements, 1,
                        256)
        ...
        Recipes.recipe.addRecipe(ModUtils.setSize(getBlockStack(BlockSteamBoiler.steam_boiler_tank),1), " B ", " A ", " C ",
                'A',getBlockStack(BlockSteamBoiler.steam_boiler_casing),'B', new ItemStack(IUItem.crafting_elements, 1,
                        601),'C',  new ItemStack(IUItem.crafting_elements, 1,
                        154)
        );
        ...
        Recipes.recipe.addRecipe(ModUtils.setSize(getBlockStack(BlockSteamBoiler.steam_boiler_heat_exchanger),1), " B ", "CAC", " B ",
                'A',getBlockStack(BlockSteamBoiler.steam_boiler_casing),'B',
                new ItemStack(IUItem.crafting_elements, 1,
                        356),'C',"gearInvar"
        );
        Recipes.recipe.addRecipe(ModUtils.setSize(getBlockStack(BlockSteamBoiler.steam_boiler_controller),1), "CBC", "DAD", "   ",
                'A',getBlockStack(BlockSteamBoiler.steam_boiler_casing),'B',
                TileGenerationMicrochip.getLevelCircuit(IUItem.electronicCircuit, 1),'C',"plateOsmium",'D',"casingBismuth"
        );
        ...
        Recipes.recipe.addRecipe(new ItemStack(IUItem.crafting_elements,1,745), "BDD", "CAE", "BCC",
                'A',TileGenerationMicrochip.getLevelCircuit(IUItem.electronicCircuit,2),'B',new ItemStack(IUItem.cable,1,11),
                'C',new ItemStack(IUItem.graphene_wire),'D',"plateZinc",'E',"plateTin"
        ...
        Recipes.recipe.addRecipe(new ItemStack(IUItem.crafting_elements,1,757), "BDD", "CAE", "BCC",
                'A',TileGenerationMicrochip.getLevelCircuit(IUItem.cirsuitQuantum,8),'B',new ItemStack(IUItem.cable,1,11),
                'C',new ItemStack(IUItem.graphene_wire),'D',new ItemStack(IUItem.plate,1,51),'E',"plateYttriumAluminiumGarnet"
        ...
        Recipes.recipe.addRecipe(ModUtils.setSize(getBlockStack(BlockHydroTurbine.hydro_turbine_casing_2),4), "A  ", "AA ", "AAA",
                'A',getBlockStack(BlockHydroTurbine.hydro_turbine_casing_1)
        );
        ...
        Recipes.recipe.addRecipe(new ItemStack(IUItem.spaceupgrademodule,1,3), " B ", "CAC", " E ",
              'A', new ItemStack(IUItem.spaceupgrademodule_schedule,1),'B',"plateMolybdenum",'C',"plateCadmium",'E',"plateLapis"
        );
        ...
        Recipes.recipe.addRecipe(new ItemStack(IUItem.spaceupgrademodule,1,2), " B ", "CAC", " E ",
                'A', new ItemStack(IUItem.spaceupgrademodule_schedule,1),'B',"plateHafniumCarbide",'C',"plateOsmiridium",'E',"plateNiobiumTitanium"
        );
        Recipes.recipe.addRecipe(new ItemStack(IUItem.spaceupgrademodule,1,0), " B ", "CAC", " E ",
                'A', new ItemStack(IUItem.spaceupgrademodule_schedule,1),'B',"plateWoods",'C',"plateBerylliumBronze",'E',"plateNitenol"
        );
        ...
        Recipes.recipe.addRecipe(new ItemStack(IUItem.spaceupgrademodule,1,4), " B ", "CAC", " E ",
                'A', new ItemStack(IUItem.spaceupgrademodule_schedule,1),'B',"plateObsidian",'C',"plateMuntsa",'E',"plateGermanium"
        );
        Recipes.recipe.addRecipe(new ItemStack(IUItem.spaceupgrademodule,1,6), " B ", "CAC", " E ",
                'A', new ItemStack(IUItem.spaceupgrademodule_schedule,1),'B',"plateAlcled",'C',"plateInconel",'E',new ItemStack(IUItem.plate,1,47)
        );
        ...
        Recipes.recipe.addRecipe(new ItemStack(IUItem.crafting_elements,1,658), "BEB", "CAC", "DHD",
                'A', DEFAULT_SENSOR,'C',Items.BLAZE_ROD,'B',Items.SUGAR,'E',Items.GLASS_BOTTLE,'D',Items.NETHER_WART,'H',Items.ENDER_PEARL
        );
        ...
        Recipes.recipe.addRecipe(new ItemStack(IUItem.crafting_elements,1,662), "BBB", "CAC", " D ",
                ...
                new ItemStack(IUItem.crafting_elements,1,320),'B',new ItemStack(IUItem.crafting_elements,1,597)
        );
        ...
        Recipes.recipe.addRecipe(new ItemStack(IUItem.crafting_elements,1,683), "CBC", "DAD", "EBE",
                'A', DEFAULT_SENSOR,  'C', "plateBerylliumBronze",'B',"plateZeliber",'D',"plateNichrome",'E',"plateAluminumbronze"
        );
        ...
        Recipes.recipe.addRecipe(new ItemStack(IUItem.crafting_elements,1,684), "CBC", "DAD", "EBE",
                'A', DEFAULT_SENSOR,  'C', "plateAluminiumSilicon",'B',"plateFerromanganese",'D',"plateTitanium",'E',"plateMolybdenum"
        );

...
public class BaseRecipes {
    ...
    public static void init() {
        ...
        Recipes.recipe.addRecipe(ItemStackHelper.fromData(IUItem.quantumSaber), "AB ", "AC ", "DEB",
                ...
                ('B'),
                "forge:plates/adamantium", ('A'), ItemStackHelper.fromData(IUItem.compresscarbon)
        );
        ...
        Recipes.recipe.addRecipe(ItemStackHelper.fromData(IUItem.module9), "BCA", "DED", "BHA",
                ...
                ("forge:doubleplate/Redbrass"),
                ('A'),
                ("forge:doubleplate/Alcled"), 'H', ItemStackHelper.fromData(IUItem.module_schedule, 1)
        );
        Recipes.recipe.addRecipe(ItemStackHelper.fromData(IUItem.module9, 1, 1), "ABA", "DED", "ACA",
                ...
                ("forge:doubleplate/Vanadoalumite"),
                ('A'),
                ("forge:doubleplate/Alcled"), 'C', ItemStackHelper.fromData(IUItem.module_schedule, 1)
        );
        ...
        Recipes.recipe.addRecipe(ItemStackHelper.fromData(IUItem.per_lappack), "ACA", "BEB", "ADA",
                ...
                ('A'),
                ("forge:doubleplate/Vitalium"), 'D', ItemStackHelper.fromData(IUItem.AdvlapotronCrystal, 1)
        );
        ...
        Recipes.recipe.addRecipe(ItemStackHelper.fromData(IUItem.spawnermodules, 1, 0), "CBC", "BAB", "CBC",
                ...
                ('B'),
                ("forge:doubleplate/tantalum"), ('C'),
                ("forge:doubleplate/thallium")
        );
        ...
        Recipes.recipe.addRecipe(ItemStackHelper.fromData(IUItem.module_quickly), "CCC", "ABA", "   ",
                ...
                ('B'), ItemStackHelper.fromData(IUItem.module_schedule), 'C', "forge:plates/draconid"
        );
        ...
        Recipes.recipe.addRecipe(ItemStackHelper.fromData(IUItem.coolupgrade, 1, 0), "ACA", "DBD", "ACA",
                ...
                ('B'), ItemStackHelper.fromData(IUItem.module_schedule), 'C', "forge:plates/Adamantium", 'D', "forge:plates/nitenol"
        );
        Recipes.recipe.addRecipe(ItemStackHelper.fromData(IUItem.coolupgrade, 1, 1), "ACA", "DBD", "ACA",
                ...
                ('B'), ItemStackHelper.fromData(IUItem.module_schedule), 'C', "forge:plates/Adamantium", 'D', "forge:plates/berylliumbronze"
        );
        ...
        Recipes.recipe.addRecipe(ItemStackHelper.fromData(IUItem.rotors_upgrade, 1, 10), " D ", "CBC", "ADA",
        ...
        Recipes.recipe.addRecipe(ItemStackHelper.fromData(IUItem.rotors_upgrade, 1, 14), "ADA", "CBC", "DED",
                ...
                ('A'), ItemStackHelper.fromData(IUItem.advnanobox),
                ('B'), ItemStackHelper.fromData(IUItem.rotorupgrade_schemes), ('C'), IUItem.iridiumPlate, ('D'),
                "forge:doubleplate/Vitalium", ('E'), ItemStackHelper.fromData(IUItem.core, 1, 3)
        );
    ...
    public static void recipe_machines() {
        ...
        Recipes.recipe.addRecipe(ItemStackHelper.fromData(IUItem.anvil),
                "AAA", "ABA", "   ", 'A', "forge:ingots/Titanium", 'B', Blocks.ANVIL
        );
        ...
        Recipes.recipe.addRecipe(ItemStackHelper.fromData(IUItem.reactorData), "DCD", "BAB", "  ",
                'A', BlockEntityGenerationMicrochip.getLevelCircuit(IUItem.circuitNano, 5), 'B', "forge:plates/Nimonic", 'C', "forge:plates/Woods",

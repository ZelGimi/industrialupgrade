...
public class BaseRecipeFour {
    ...
    public static void init() {
        ...
        Recipes.recipe.addShapelessRecipe(ModUtils.setSize(  new ItemStack(IUItem.iuingot, 1, 43 + i),9),
        ...
        Recipes.recipe.addRecipe(new ItemStack(IUItem.lightning_rod,1,0), "", "ACA",
                "DBD",

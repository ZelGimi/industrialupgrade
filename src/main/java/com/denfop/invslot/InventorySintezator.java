...
public class InventorySintezator extends Inventory {


    public final int type;
    public final TileSintezator tile;

    public InventorySintezator(TileSintezator base1, String name, int type, int count) {
        super(base1, TypeItemSlot.INPUT_OUTPUT, count);
        this.type = type;
        if (type == 0) {
            this.setInventoryStackLimit(Config.limit);
        } else {

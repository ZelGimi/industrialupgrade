...
public class PressureComponent extends AbstractComponent {
    ...
    public void setDirections(Set<Direction> sinkDirections, Set<Direction> sourceDirections) {
        ...
        if (this.delegate != null) {
            ...
            NeoForge.EVENT_BUS.post(new PressureTileUnloadEvent(this.delegate, parent.getLevel()));
        }
        ...
        if (this.delegate != null) {
            ...
            NeoForge.EVENT_BUS.post(new PressureTileLoadEvent(this.delegate, parent.getLevel()));
        }

            ...
            if (pEntity.isAngry()) {
                if ( pEntity.hasNectar()){
                    if (angry_texture_nectar == null){
                        angry_texture_nectar = new ResourceLocation(Constants.MOD_ID,"textures/entity/bee/"+name+"_angry_nectar_bee.png");
                        ANGRY_NECTAR_BEE_TEXTURES[id] = angry_texture_nectar;
                    }
                    return angry_texture_nectar;
                }else{
                    if (angry_texture == null){
                        angry_texture = new ResourceLocation(Constants.MOD_ID,"textures/entity/bee/"+name+"_angry_bee.png");
                ...
                if (pEntity.hasNectar()){
                    if (texture_nectar == null){
                        texture_nectar = new ResourceLocation(Constants.MOD_ID,"textures/entity/bee/"+name+"_nectar_bee.png");
                        NECTAR_BEE_TEXTURES[id] = texture_nectar;
                    }
                    return texture_nectar;
                }else{
                    if (texture == null){
                        texture = new ResourceLocation(Constants.MOD_ID,"textures/entity/bee/"+name+"_bee.png");

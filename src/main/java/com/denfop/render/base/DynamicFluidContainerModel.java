...
public class DynamicFluidContainerModel implements IUnbakedGeometry<DynamicFluidContainerModel> {
    ...
    private static final class ContainedFluidOverrideHandler extends ItemOverrides {
        ...
        public BakedModel resolve(BakedModel originalModel, ItemStack stack, @Nullable ClientLevel level, @Nullable LivingEntity entity, int seed) {
            ...
            IFluidHandlerItem fs = stack.getCapability(ForgeCapabilities.FLUID_HANDLER_ITEM, null).orElse((IFluidHandlerItem) stack.getItem().initCapabilities(stack, stack.getTag()));

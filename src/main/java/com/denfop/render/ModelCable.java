...
import com.denfop.tiles.mechanism.TileEntityCable.CableRenderState;
...
public class ModelCable extends AbstractModel implements ISpecialParticleModel {
    ...
    private static ResourceLocation getTextureLocation(CableType type, int insulation, boolean active) {

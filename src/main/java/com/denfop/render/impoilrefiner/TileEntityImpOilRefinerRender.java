package com.denfop.render.impoilrefiner;
...
public class TileEntityImpOilRefinerRender extends TileEntitySpecialRenderer<TileImpOilRefiner> {


    public void render(
            TileImpOilRefiner tile,
            double x,
            double y,
            double z,
            float partialTicks,

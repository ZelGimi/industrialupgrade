...
public class WindGeneratorRenderer extends TileEntitySpecialRenderer<TileWindGenerator> {

    public static final Map<Integer, ModelBase> rotorModels = new HashMap<>();

    public WindGeneratorRenderer() {
    }

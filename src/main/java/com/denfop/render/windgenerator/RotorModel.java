...
public class RotorModel<T extends Entity> extends EntityModel<T> {
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer buffer, int packedLight, int packedOverlay, int color) {
        ...
        rotor2.render(poseStack, buffer, packedLight, packedOverlay, color);
        rotor3.render(poseStack, buffer, packedLight, packedOverlay, color);
        rotor4.render(poseStack, buffer, packedLight, packedOverlay, color);
    }
}

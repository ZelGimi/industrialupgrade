...
import com.denfop.tiles.transport.tiles.TileEntityCoolPipes.CableRenderState;
...
public class ModelCoolPipes extends AbstractModel implements ISpecialParticleModel {
    ...
    private static ResourceLocation getTextureLocation(CoolType type) {
        String loc = "blocks/wiring/cool/" + type.getName();

...
public class PatternItemRenderer extends BlockEntityWithoutLevelRenderer {
    ...
    private void renderFluidInGui(FluidStack fluidStack,
        ...
        BufferBuilder buffer1 = Tesselator.getInstance().getBuilder();
        buffer1.begin(VertexFormat.Mode.QUADS, DefaultVertexFormat.POSITION_TEX_COLOR);
        ...
        BufferUploader.drawWithShader(buffer1.end());
    }

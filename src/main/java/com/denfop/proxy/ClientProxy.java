...
import com.denfop.render.steam.TileEntityRenderSteamCreativeStorage;
...
public class ClientProxy extends CommonProxy {
    ...
    public void preInit() {
        ...
        BlockEntityRenderers.register((BlockEntityType<? extends BlockEntityCreativeSteamStorage>) IUItem.creativeBlock.getBlock(BlockCreativeBlocksEntity.creative_steam_storage).getValue().getBlockType(), TileEntityRenderSteamCreativeStorage::new);

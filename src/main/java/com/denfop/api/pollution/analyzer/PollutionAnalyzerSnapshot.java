...
public class PollutionAnalyzerSnapshot {
    ...
    public static PollutionAnalyzerSnapshot fromTag(CompoundTag tag) {
        ...
        for (int i = 0; i < sourcesTag.size(); i++) {
            sources.add(PollutionAnalyzerSourceSnapshot.fromTag(sourcesTag.getCompound(i)));
        }
        ...
        return new PollutionAnalyzerSnapshot(
                ...
                PollutionAnalyzerCleanerOption.fromTag(tag.getCompound("airCleaner")),
                PollutionAnalyzerCleanerOption.fromTag(tag.getCompound("soilCleaner")),
                chunks,
                sources,
                recommendations
        );
    ...
    public CompoundTag toTag() {
        ...
        tag.put("airCleaner", airCleaner.toTag());
        tag.put("soilCleaner", soilCleaner.toTag());

...
public final class PollutionAnalyzerCleanerResolver {
    ...
    private static final ResourceLocation[] AIR_CANDIDATES = new ResourceLocation[]{
            new ResourceLocation("industrialupgrade", "aircollector"),
            new ResourceLocation("industrialupgrade", "air_collector"),
            new ResourceLocation("industrialupgrade", "air_purifier"),
            new ResourceLocation("industrialupgrade", "air_cleaner"),
            new ResourceLocation("industrialupgrade", "pollution_air_cleaner")
    };

    private static final ResourceLocation[] SOIL_CANDIDATES = new ResourceLocation[]{
            new ResourceLocation("industrialupgrade", "purifier_soil"),
            new ResourceLocation("industrialupgrade", "soil_purifier"),
            new ResourceLocation("industrialupgrade", "soil_cleaner"),
            new ResourceLocation("industrialupgrade", "pollution_soil_cleaner")
    };

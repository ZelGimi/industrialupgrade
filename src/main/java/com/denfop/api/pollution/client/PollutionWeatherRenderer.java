...
public final class PollutionWeatherRenderer {
    ...
    private static void renderToxicRain(
        ...
        float thunder = minecraft.level.getThunderLevel(event.getPartialTick());
    ...
    private static void addCrossRibbon(
        ...
        builder.vertex(matrix, startX - halfWidth, startY, startZ).color(r, g, b, aTop).endVertex();
        builder.vertex(matrix, startX + halfWidth, startY, startZ).color(r, g, b, aTop).endVertex();
        builder.vertex(matrix, endX + halfWidth, endY, endZ).color(r, g, b, aBottom).endVertex();
        builder.vertex(matrix, endX - halfWidth, endY, endZ).color(r, g, b, aBottom).endVertex();

        builder.vertex(matrix, startX, startY, startZ - halfWidth).color(r, g, b, aTop).endVertex();
        builder.vertex(matrix, startX, startY, startZ + halfWidth).color(r, g, b, aTop).endVertex();
        builder.vertex(matrix, endX, endY, endZ + halfWidth).color(r, g, b, aBottom).endVertex();
        builder.vertex(matrix, endX, endY, endZ - halfWidth).color(r, g, b, aBottom).endVertex();
    }
    ...
    private static void addCrossFlake(
        ...
        builder.vertex(matrix, centerX - halfSize, centerY + halfSize, centerZ).color(r, g, b, a).endVertex();
        builder.vertex(matrix, centerX + halfSize, centerY + halfSize, centerZ).color(r, g, b, a).endVertex();
        builder.vertex(matrix, centerX + halfSize, centerY - halfSize, centerZ).color(r, g, b, a).endVertex();
        builder.vertex(matrix, centerX - halfSize, centerY - halfSize, centerZ).color(r, g, b, a).endVertex();

        builder.vertex(matrix, centerX, centerY + halfSize, centerZ - halfSize).color(r, g, b, a).endVertex();
        builder.vertex(matrix, centerX, centerY + halfSize, centerZ + halfSize).color(r, g, b, a).endVertex();
        builder.vertex(matrix, centerX, centerY - halfSize, centerZ + halfSize).color(r, g, b, a).endVertex();
        builder.vertex(matrix, centerX, centerY - halfSize, centerZ - halfSize).color(r, g, b, a).endVertex();
    }

...
public class CropBase implements Crop {
    ...
    private final List<Crop> unCompatibleCrops;
    private final byte render;
    private final boolean isCombine;
    private final List<Crop> cropCombine;
    private final int maxTick;
    private final List<ResourceKey<Biome>> biomes;
    private final List<Crop> compatibleCrops;
    ...
    public CropBase(
            ...
            double growthSpeed,
            int pestResistance,
            int maxStage, int sizeSeed, ResourceLocation texture, boolean isCombine, List<Crop> cropCombine, int chance,
            boolean isBeeCombine
            , int tick, int chanceWeed, boolean sun, boolean night, List<ItemStack> drop, int lightLevel,
            List<Crop> unCompatibleCrops, int render
    ) {
    ...
    public List<Crop> getCropCombine() {
        return cropCombine;
    }
    ...
    @Override
    public boolean isCombineWithCrops(final List<Crop> crops) {
        ...
        cycle1:
        for (Crop crop : crops) {
            for (Crop crop1 : compatibleCrops) {
    ...
    @Override
    public boolean compatibilityWithCrop(Crop crop) {

...
public class CropInit {
    ...
    public static void init() {
        ...
        wheat_seed = new CropBase("wheat", 0, EnumSoil.FARMLAND, 1, 0, 4, 1, 90, 8, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/wheat_stage"), false, Collections.emptyList(), 2, false, 4800, 90,
        ...
        reed_seed = new CropBase("reed", 1, EnumSoil.SAND, 1, 1, 1, 1, 60, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/stickreed"), false, Collections.emptyList(), 5, false, 5000, 80,
        ...
        weed_seed = new CropBase("weed_seed", 3, EnumSoil.SAND, 1, 2, 0, 1, 0, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/weed_seed"), false, Collections.emptyList(), 0,
                false, 400, 0,
        ...
        tulip_pink = new CropBase("tulip_pink", 4, EnumSoil.FARMLAND, 1, 2, 5, 1, 60, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/tulip_pink"), false, Collections.emptyList(), 5,
                false, 3000, 60,
        ...
        haustonia_gray = new CropBase("haustonia_gray", 5, EnumSoil.FARMLAND, 1, 2, 5, 1, 60, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/haustonia_gray"), false, Collections.emptyList(), 5,
                false, 3000, 60,
        ...
        poppy = new CropBase("poppy", 6, EnumSoil.FARMLAND, 1, 2, 5, 1, 60, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/poppy"), false, Collections.emptyList(), 5,
                false, 3000, 60,
        ...
        onion = new CropBase("onion", 7, EnumSoil.FARMLAND, 1, 2, 5, 1, 60, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/onion"), false, Collections.emptyList(), 5,
                false, 3000, 60,
        ...
        brown_mushroom = new CropBase("brown_mushroom", 8, EnumSoil.MYCELIUM, 1, 2, 5, 1, 40, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/brown_mushroom"), false, Collections.emptyList(), 4,
                false, 7000, 90,
        ...
        tulip_orange = new CropBase("tulip_orange", 9, EnumSoil.FARMLAND, 1, 2, 5, 1, 60, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/tulip_orange"), false, Collections.emptyList(), 5,
                false, 3000, 60,
        ...
        chamomile = new CropBase("chamomile", 10, EnumSoil.FARMLAND, 1, 2, 5, 1, 60, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/chamomile"), false, Collections.emptyList(), 5,
                false, 3000, 60,
        ...
        tulip_white = new CropBase("tulip_white", 11, EnumSoil.FARMLAND, 1, 2, 5, 1, 60, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/tulip_white"), false, Collections.emptyList(), 5,
                false, 3000, 60,
        ...
        dandelion = new CropBase("dandelion", 12, EnumSoil.FARMLAND, 1, 2, 5, 1, 60, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/dandelion"), false, Collections.emptyList(), 5,
                false, 3000, 60,
        ...
        tulip_red = new CropBase("tulip_red", 13, EnumSoil.FARMLAND, 1, 2, 5, 1, 60, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/tulip_red"), false, Collections.emptyList(), 5,
                false, 3000, 60,
        ...
        red_mushroom = new CropBase("red_mushroom", 14, EnumSoil.MYCELIUM, 1, 2, 0, 1, 40, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/red_mushroom"), false, Collections.emptyList(), 4,
                false, 7000, 90,
        ...
        blue_orchid = new CropBase("blue_orchid", 15, EnumSoil.FARMLAND, 1, 2, 5, 1, 60, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/blue_orchid"), false, Collections.emptyList(), 5,
                false, 3000, 60,
        ...
        corn = new CropBase("corn", 16, EnumSoil.FARMLAND, 2, 1, 6, 1, 75, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/corn"), true, Arrays.asList(dandelion, brown_mushroom), 5,
                false, 5000, 100,
        ...
        rubber_reed_seed = new CropBase("rubber_reed", 2, EnumSoil.SAND, 1, 1, 1, 1, 60, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/stickreed_rubber"), true, Arrays.asList(reed_seed, corn), 3,
                false, 5000, 80,
        ...
        beet = new CropBase("beet", 17, EnumSoil.FARMLAND, 1, 1, 4, 1, 70, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/beetroots_stage"), false, Collections.emptyList(), 5,
                false, 5000, 70,
        ...
        carrot = new CropBase("carrot", 18, EnumSoil.FARMLAND, 1, 0, 4, 1, 60, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/carrots_stage"), false, Collections.emptyList(), 5,
                false, 4000, 60,
        ...
        potato = new CropBase("potato", 19, EnumSoil.FARMLAND, 1, 0, 4, 1, 60, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/potatoes_stage"), false, Collections.emptyList(), 5,
                false, 4000, 60,
        ...
        tomato = new CropBase("tomato", 22, EnumSoil.FARMLAND, 1, 0, 4, 1, 60, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/tomato"), true, Arrays.asList(potato, carrot, red_mushroom), 4,
                false, 4000, 60,
        ...
        raspberry = new CropBase("raspberry", 20, EnumSoil.FARMLAND, 2, 0, 4, 1, 40, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/raspberry"), true, Arrays.asList(tulip_red, tomato), 3,
                false, 4000, 50,
        ...
        hops = new CropBase("hops", 21, EnumSoil.FARMLAND, 1, 1, 4, 1, 20, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/hops"), true, Arrays.asList(wheat_seed, tomato, corn), 1,
                false, 8000, 70,
        ...
        melon = new CropBase("melon", 23, EnumSoil.FARMLAND, 1, 0, 4, 1, 60, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/melon"), false, Arrays.asList(), 4,
                false, 5000, 60,
        ...
        pumpkin = new CropBase("pumpkin", 24, EnumSoil.FARMLAND, 1, 0, 4, 1, 60, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/pumpkin"), false, Arrays.asList(), 4,
                false, 5000, 60,
        ...
        copper_heart = new CropBase("copper_heart", 44, EnumSoil.COPPER, 1, 0, 1, 1, 50, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/copper_heart"), true, Arrays.asList(potato
                , tulip_orange), 4,
        ...
        iron_crimson = new CropBase("iron_crimson", 46, EnumSoil.IRON, 1, 0, 1, 1, 70, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/iron_crimson"), true, Arrays.asList(tulip_white
                , wheat_seed), 5,
        ...
        gold_astral = new CropBase("gold_astral", 45, EnumSoil.GOLD, 1, 0, 1, 1, 60, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/gold_astral"), true, Arrays.asList(iron_crimson
        ...
        diamond_island = new CropBase("diamond_island", 47, EnumSoil.DIAMOND, 1, 0, 1, 1, 65, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/diamond_island"), true, Arrays.asList(gold_astral, blue_orchid, carrot), 4,
        ...
        emerald_heart = new CropBase("emerald_heart", 48, EnumSoil.EMERALD, 1, 0, 1, 1, 55, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/emerald_heart"), true, Arrays.asList(diamond_island, melon), 3,
        ...
        quartz_storm = new CropBase("quartz_storm", 49, EnumSoil.QUARTZ, 1, 0, 1, 1, 50, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/quartz_storm"), true, Arrays.asList(iron_crimson
                , haustonia_gray), 4,
        ...
        lead_stream = new CropBase("lead_stream", 51, EnumSoil.LEAD, 1, 0, 1, 1, 70, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/lead_stream"), true, Arrays.asList(haustonia_gray,
                brown_mushroom), 5,
        ...
        tin_ghost = new CropBase("tin_ghost", 52, EnumSoil.TIN, 1, 0, 1, 1, 65, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/tin_ghost"), true, Arrays.asList(iron_crimson,
                quartz_storm), 4,
        ...
        red_fury = new CropBase("red_fury", 73, EnumSoil.REDSTONE, 1, 0, 1, 1, 55, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/red_fury"), true, Arrays.asList(poppy, red_mushroom, tulip_red), 3,
        ...
        silicon_avalanche = new CropBase("silicon_avalanche", 74, EnumSoil.GRAVEL, 1, 0, 1, 1, 50, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/silicon_avalanche"), true, Arrays.asList(tin_ghost, iron_crimson), 4,
        ...
        mikhailovskaya_lavra = new CropBase("mikhailovskaya_lavra", 25, EnumSoil.MICHALOV, 1, 0, 1, 1, 50, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/mikhailovskaya_lavra"), false, Arrays.asList(lead_stream,
                blue_orchid), 3,
        ...
        aluminum_plutonka = new CropBase("aluminum_plutonka", 26, EnumSoil.ALUMINUM, 1, 0, 1, 1, 60, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/aluminum_plutonka"), false, Arrays.asList(tulip_pink,
        ...
        tungsten_moon_flower = new CropBase("tungsten_moon_flower", 28, EnumSoil.TUNGSTEN, 1, 0, 1, 1, 65, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/tungsten_moon_flower"), false, Arrays.asList(iron_crimson,
                tin_ghost, onion), 3,
        ...
        silver_melody = new CropBase("silver_melody", 39, EnumSoil.SILVER, 1, 0, 1, 1, 50, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/silver_melody"), false, Arrays.asList(iron_crimson,
        ...
        nickel_firework = new CropBase("nickel_firework", 33, EnumSoil.NICKEL, 1, 0, 1, 1, 65, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/nickel_firework"), false, Arrays.asList(lead_stream,
                tin_ghost), 4,
        ...
        invar_crystal = new CropBase("invar_crystal", 29, EnumSoil.IRON, 1, 0, 1, 1, 55, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/invar_crystal"), false, Arrays.asList(nickel_firework,
                iron_crimson), 4,
        ...
        cobalt_grapefruit = new CropBase("cobalt_grapefruit", 31, EnumSoil.COBALT, 1, 0, 1, 1, 60, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/cobalt_grapefruit"), false, Arrays.asList(mikhailovskaya_lavra,
                gold_astral), 2,
        ...
        magnesium_diamond = new CropBase("magnesium_diamond", 32, EnumSoil.MAGNESIUM, 1, 0, 1, 1, 70, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/magnesium_diamond"), false, Arrays.asList(diamond_island,
                tulip_pink, beet), 5,
        ...
        platinum_turner = new CropBase("platinum_turner", 34, EnumSoil.PLATINUM, 1, 0, 1, 1, 55, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/platinum_turner"), false, Arrays.asList(cobalt_grapefruit,
                magnesium_diamond), 3,
        ...
        spinel_zenith = new CropBase("spinel_zenith", 37, EnumSoil.SPINEL, 1, 0, 1, 1, 65, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/spinel_zenith"), false, Arrays.asList(diamond_island,
                reed_seed, corn), 3,
        ...
        iridium_snowflake = new CropBase("iridium_snowflake", 42, EnumSoil.IRIDIUM, 1, 0, 1, 1, 65, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/iridium_snowflake"), false, Arrays.asList(platinum_turner,
                spinel_zenith), 4,
        ...
        karav_green = new CropBase("karav_green", 30, EnumSoil.SPINEL, 1, 0, 1, 1, 50, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/karav_green"), false, Arrays.asList(spinel_zenith,
        ...
        titanium_fantasy = new CropBase("titanium_fantasy", 35, EnumSoil.TITANIUM, 1, 0, 1, 1, 50, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/titanium_fantasy"), false, Arrays.asList(tungsten_moon_flower,
                invar_crystal), 4,
        ...
        chromium_gentleness = new CropBase("chromium_gentleness", 36, EnumSoil.CHROMIUM, 1, 0, 1, 1, 70, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/chromium_gentleness"), false, Arrays.asList(reed_seed,
        ...
        electrum_symphony = new CropBase("electrum_symphony", 38, EnumSoil.GOLD, 1, 0, 1, 1, 55, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/electrum_symphony"), false, Arrays.asList(silver_melody,
        ...
        zinc_storm = new CropBase("zinc_storm", 40, EnumSoil.ZINC, 1, 0, 1, 1, 60, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/zinc_storm"), false, Arrays.asList(lead_stream,
                onion, tin_ghost), 2,
        ...
        manganese_lotus = new CropBase("manganese_lotus", 41, EnumSoil.MANGANESE, 1, 0, 1, 1, 70, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/manganese_lotus"), false, Arrays.asList(magnesium_diamond,
                raspberry), 5,
        ...
        germanite_wonders = new CropBase("germanite_wonders", 43, EnumSoil.GERMANIUM, 1, 0, 1, 1, 55, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/germanite_wonders"), false, Arrays.asList(iridium_snowflake,
        ...
        uranium_fairy = new CropBase("uranium_fairy", 50, EnumSoil.URANIUM, 1, 0, 1, 1, 60, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/uranium_fairy"), false, Arrays.asList(chromium_gentleness,
        ...
        vanadium_dawn = new CropBase("vanadium_dawn", 27, EnumSoil.VANADIUM, 1, 0, 1, 1, 70, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/vanadium_dawn"), false, Arrays.asList(chromium_gentleness,
                manganese_lotus
        ), 2,
        ...
        arsenite_flower = new CropBase("arsenite_flower", 53, EnumSoil.ARSENIC, 1, 0, 1, 1, 55, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/arsenite_flower"), false, Arrays.asList(chromium_gentleness,
                hops), 3,
        ...
        barium_star = new CropBase("barium_star", 54, EnumSoil.BARIUM, 1, 0, 1, 1, 50, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/barium_star"), false, Arrays.asList(electrum_symphony,
                vanadium_dawn), 4,
        ...
        bismuth_garden = new CropBase("bismuth_garden", 55, EnumSoil.BISMUTH, 1, 0, 1, 1, 60, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/bismuth_garden"), false, Arrays.asList(vanadium_dawn,
                cobalt_grapefruit), 2,
        ...
        gadolinium_lotus = new CropBase("gadolinium_lotus", 56, EnumSoil.GADOLINIUM, 1, 0, 1, 1, 70, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/gadolinium_lotus"), false, Arrays.asList(copper_heart,
                electrum_symphony), 5,
        ...
        gallium_song = new CropBase("gallium_song", 57, EnumSoil.GALLIUM, 1, 0, 1, 1, 65, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/gallium_song"), false, Arrays.asList(copper_heart,
                invar_crystal), 4,
        ...
        hafnium_leaf = new CropBase("hafnium_leaf", 58, EnumSoil.HAFNIUM, 1, 0, 1, 1, 55, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/hafnium_leaf"), false, Arrays.asList(mikhailovskaya_lavra,
                platinum_turner), 3,
        ...
        ytterbium_bright = new CropBase("ytterbium_bright", 59, EnumSoil.YTTRIUM, 1, 0, 1, 1, 50, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/ytterbium_bright"), false, Arrays.asList(magnesium_diamond,
                spinel_zenith), 4,
        ...
        molybdenum_whirlwind = new CropBase("molybdenum_whirlwind", 60, EnumSoil.MOLYBDENUM, 1, 0, 1, 1, 60, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/molybdenum_whirlwind"), false, Arrays.asList(vanadium_dawn,
                bismuth_garden), 2,
        ...
        neodymium_glow = new CropBase("neodymium_glow", 61, EnumSoil.NEODYMIUM, 1, 0, 1, 1, 70, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/neodymium_glow"), false, Arrays.asList(magnesium_diamond,
                platinum_turner), 5,
        ...
        niobium_obelisk = new CropBase("niobium_obelisk", 62, EnumSoil.NIOBIUM, 1, 0, 1, 1, 65, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/niobium_obelisk"), false, Arrays.asList(platinum_turner,
        ...
        palladium_gentleness = new CropBase("palladium_gentleness", 63, EnumSoil.PALLADIUM, 1, 0, 1, 1, 55, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/palladium_gentleness"), false, Arrays.asList(gadolinium_lotus,
                gallium_song), 3,
        ...
        polonium_crystal = new CropBase("polonium_crystal", 64, EnumSoil.POLONIUM, 1, 0, 1, 1, 50, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/polonium_crystal"), false, Arrays.asList(neodymium_glow,
                niobium_obelisk), 4,
        ...
        strontium_storm = new CropBase("strontium_storm", 65, EnumSoil.STRONTIUM, 1, 0, 1, 1, 60, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/strontium_storm"), false, Arrays.asList(karav_green,
                germanite_wonders), 2,
        ...
        thallium_sunlight = new CropBase("thallium_sunlight", 66, EnumSoil.THALLIUM, 1, 0, 1, 1, 70, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/thallium_sunlight"), false, Arrays.asList(arsenite_flower,
                barium_star), 5,
        ...
        zirconium_dragon = new CropBase("zirconium_dragon", 67, EnumSoil.ZIRCONIUM, 1, 0, 1, 1, 65, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/zirconium_dragon"), false, Arrays.asList(ytterbium_bright,
        ...
        osmium_silk = new CropBase("osmium_silk", 68, EnumSoil.OSMIUM, 1, 0, 1, 1, 55, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/osmium_silk"), false, Arrays.asList(iridium_snowflake,
        ...
        tantalum_moon = new CropBase("tantalum_moon", 69, EnumSoil.TANTALUM, 1, 0, 1, 1, 50, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/tantalum_moon"), false, Arrays.asList(thallium_sunlight,
                arsenite_flower), 4,
        ...
        cadmium_gentleness = new CropBase("cadmium_gentleness", 70, EnumSoil.CADMIUM, 1, 0, 1, 1, 60, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/cadmium_gentleness"), false, Arrays.asList(molybdenum_whirlwind,
        ...
        nether_wart = new CropBase("nether_wart", 81, EnumSoil.SOULSAND, 1, 2, 1, 1, 60, 3, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/nether_wart_stage"), false, Collections.emptyList(), 3,
        ...
        ender_lily = new CropBase("ender_lily", 71, EnumSoil.ENDER, 1, 0, 1, 1, 70, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/ender_lily"), false, Arrays.asList(nether_wart,
        ...
        blaze_storm = new CropBase("blaze_storm", 72, EnumSoil.SOULSAND, 1, 0, 1, 1, 65, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/blaze_storm"), false, Arrays.asList(nether_wart,
        ...
        ghast_dew = new CropBase("ghast_dew", 75, EnumSoil.SOULSAND, 1, 0, 1, 1, 60, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/ghast_dew"), false, Arrays.asList(blaze_storm,
        ...
        bone_leaf = new CropBase("bone_leaf", 76, EnumSoil.SOULSAND, 1, 0, 1, 1, 70, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/bone_leaf"), false, Arrays.asList(nether_wart,
        ...
        americium_moss = new CropBase("americium_moss", 79, EnumSoil.URANIUM, 1, 0, 1, 1, 50, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/americium_moss"), false, Arrays.asList(uranium_fairy,
        ...
        neptunium_wisdom = new CropBase("neptunium_wisdom", 78, EnumSoil.URANIUM, 1, 0, 1, 1, 55, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/neptunium_wisdom"), false, Arrays.asList(americium_moss,
        ...
        curie_berry = new CropBase("curie_berry", 77, EnumSoil.URANIUM, 1, 0, 1, 1, 65, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/curie_berry"), false, Arrays.asList(polonium_crystal,
        ...
        thorium_fist = new CropBase("thorium_fist", 80, EnumSoil.URANIUM, 1, 0, 1, 1, 60, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/thorium_fist"), false, Arrays.asList(uranium_fairy,
        ...
        terra_wart = new CropBase("terra_wart", 82, EnumSoil.SOULSAND, 1, 0, 1, 1, 60, 4, 1,
                ResourceLocation.tryBuild(Constants.MOD_ID, "blocks/crop/terra_wart"), false, Arrays.asList(ender_lily,
    ...
    public static void initBiomes(Registry<Biome> biomeRegistry) {
        if (geneticBiomes.isEmpty()) {
            Genome.init(biomeRegistry);

...
public class GeneticsManager {
    ...
    public void loadGenomeToCrop(Genome genome, Crop crop) {
        genome.loadCrop(crop);
    }

    public void deleteGenomeCrop(Crop crop, final GeneticTraits geneticTraits) {
    ...
    public void addGenomeCrop(Crop crop, GeneticTraits geneticTraits) {
        switch (geneticTraits) {
            case SUN:
                crop.setSun(true);
                break;

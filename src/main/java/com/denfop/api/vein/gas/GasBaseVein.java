...
public class GasBaseVein implements GasVein {
    ...
    public GasBaseVein(TypeGas type, ChunkPos chunk) {
        this.type = type;
        this.chunk = chunk;
        this.col = 0;
        this.maxcol = 0;
    ...
    public GasBaseVein(CompoundTag tagCompound) {
    ...
    public GasBaseVein(CustomPacketBuffer is) {
    ...
    public boolean equals(final Object o) {
        ...
        GasBaseVein vein = (GasBaseVein) o;

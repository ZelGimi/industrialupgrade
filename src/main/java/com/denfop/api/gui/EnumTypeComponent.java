...
public enum EnumTypeComponent {
    ...
    FLUID_PART2(142, 61, 132, 24, 25, 13, EnumTypeRender.WEIGHT, 0, 0, false),
    FLUID_PART3(25, 102, 132, 24, 36, 13, EnumTypeRender.WEIGHT, 0, 0, false),
    FLUID_PART4(58, 118, 132, 24, 13, 36, EnumTypeRender.WEIGHT, 0, 0, false),
    FLUID_PART5(80, 114, 132, 24, 13, 135 - 113, EnumTypeRender.WEIGHT, 0, 0, false),
    FLUID_PART6(87, 141, 132, 24, 13, 17, EnumTypeRender.WEIGHT, 0, 0, false),
    FLUID_PART7(0, 163, 132, 24, 0, 3, EnumTypeRender.WEIGHT, 0, 0, false),
    FLUID_PART9(122, 193, 132, 24, 3, 0, EnumTypeRender.HEIGHT, 0, 0, false),
    FLUID_PART8(218, 148, 132, 24, 36, 14, EnumTypeRender.WEIGHT, 0, 0, false),

    EMPTY(2, 103, 132, 24, 16, 16, EnumTypeRender.WEIGHT, 0, 0, false),
    HYDRO(2, 122, 132, 24, 16, 16, EnumTypeRender.WEIGHT, 0, 0, false),
    WIND(2, 141, 132, 24, 19, 16, EnumTypeRender.WEIGHT, 0, 0, false),
    CHANGEMODE(146, 79, 132, 24, 163 - 145, 96 - 78, EnumTypeRender.WEIGHT, 0, 0, false),
    ...
    SOUND_BUTTON(48, 58, 64, 58, 15, 15, EnumTypeRender.WEIGHT, 0, 0, true),
    WORK_BUTTON(0, 79, 0, 57, 21, 21, EnumTypeRender.WEIGHT, 0, 0, true),
    PLUS_BUTTON(22, 61, 0, 57, 12, 12, EnumTypeRender.WEIGHT, 0, 0, true),
    MINUS_BUTTON(35, 61, 0, 57, 12, 12, EnumTypeRender.WEIGHT, 0, 0, true),
    PROCESS(104, 17, 104, 35, 22, 16, EnumTypeRender.WEIGHT, 0, 0, true),
    STEAM_PROCESS(48, 1, 71, 1, 22, 16, EnumTypeRender.WEIGHT, 0, 0, true, false, true),
    STEAM_PROCESS2(42, 87, 65, 87, 22, 16, EnumTypeRender.WEIGHT, 0, 0, true, false, true),
    PROCESS1(103, 108, 121, 108, 16, 22, EnumTypeRender.HEIGHT, 0, 0, true),
    PROCESS2(29, 135, 29, 119, 22, 16, EnumTypeRender.WEIGHT, 0, 0, true),
    OIL(24, 78, 34, 78, 10, 15, EnumTypeRender.HEIGHT, 0, 0, true),
    UPGRADE(82, 91, 34, 78, 11, 14, EnumTypeRender.WEIGHT, 0, 0, true),
    ANTIUPGRADE(82, 75, 34, 78, 11, 14, EnumTypeRender.WEIGHT, 0, 0, true),
    NO(85, 60, 34, 78, 11, 11, EnumTypeRender.WEIGHT, 0, 0, true),


    LEFT(84, 172, 239, 98, 9, 18, EnumTypeRender.WEIGHT, 0, 0, true),
    RIGHT(95, 172, 239, 98, 9, 18, EnumTypeRender.WEIGHT, 0, 0, true),
    TOP(108, 171, 239, 98, 18, 9, EnumTypeRender.WEIGHT, 0, 0, true),
    DOWN(108, 182, 239, 98, 18, 9, EnumTypeRender.WEIGHT, 0, 0, true),
    ACCEPT(128, 240, 239, 98, 16, 16, EnumTypeRender.WEIGHT, 0, 0, true, true),
    CANCEL(145, 240, 239, 98, 16, 16, EnumTypeRender.WEIGHT, 0, 0, true, true),
    SCROLL_UP(189, 221, 239, 98, 16, 16, EnumTypeRender.WEIGHT, 0, 0, true, true),
    SCROLL_DOWN(206, 221, 239, 98, 16, 16, EnumTypeRender.WEIGHT, 0, 0, true, true),

    BLACK(128, 222, 239, 98, 16, 16, EnumTypeRender.WEIGHT, 0, 0, true, true),
    WHITE(145, 222, 239, 98, 16, 16, EnumTypeRender.WEIGHT, 0, 0, true, true),
    REDSTONE(170, 221, 239, 98, 17, 17, EnumTypeRender.WEIGHT, 0, 0, true, true),

    RAD(170, 17, 213, 17, 43, 16, EnumTypeRender.WEIGHT, 0, 0, true),
    ...
    BUTTON(1, 75, 1, 97, 200, 20, EnumTypeRender.WEIGHT, 0, 0, true, true),
    FIRE(177, 159, 196, 159, 15, 174 - 159, EnumTypeRender.HEIGHT, 0, 0, true),
    GAS(65, 74, 65, 91, 16, 174 - 159, EnumTypeRender.HEIGHT, 0, 0, true),

    BUTTON1(45, 1, 1, 97, 16, 16, EnumTypeRender.WEIGHT, 0, 0, true, true),
    FRAME(63, 1, 1, 97, 24, 24, EnumTypeRender.WEIGHT, 0, 0, true, true),
    EXP_BUTTON(183, 1, 1, 97, 17, 16, EnumTypeRender.WEIGHT, 0, 0, true, true),
    BIG_FRAME(97, 1, 1, 97, 55, 54, EnumTypeRender.WEIGHT, 0, 0, true, true),
    ...
    BIGGEST_FRAME(205, 2, 1, 97, 252 - 205, 75, EnumTypeRender.WEIGHT, 0, 0, true, true),
    INFO(67, 30, 1, 97, 18, 18, EnumTypeRender.WEIGHT, 0, 0, true, true),
    LASER_PROCESS(0, 183, 0, 199, 29, 16, EnumTypeRender.WEIGHT, 0, 0, true, true),
    FACTORY_PROCESS(0, 142, 0, 154, 24, 12, EnumTypeRender.WEIGHT, 0, 0, true, true),
    STAMP_PROCESS(1, 239, 33, 239, 32, 15, EnumTypeRender.WEIGHT, 0, 0, true, true),
    ...
    ENCHANT_PROCESS(67, 236, 95, 236, 93 - 67, 253 - 236, EnumTypeRender.WEIGHT, 0, 0, true, true),

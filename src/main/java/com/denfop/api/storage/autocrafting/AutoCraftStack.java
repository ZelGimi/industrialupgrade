...
public class AutoCraftStack {
    ...
    public static AutoCraftStack readFromNBT(CompoundTag nbt) {
        PatternStack patternStack = PatternStack.readFromNBT(nbt.getCompound("PatternStack"));
        SameStack sameStack = SameStack.readFromNBT(nbt.getCompound("SameStack"));
    ...
    public CompoundTag writeToNBT() {
        ...
        nbt.put("PatternStack", patternStack.getA().writeToNBT());
        nbt.put("SameStack", patternStack.getB().writeToNBT());
        nbt.putInt("All", all);

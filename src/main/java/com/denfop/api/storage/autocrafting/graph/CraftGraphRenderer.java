...
public class CraftGraphRenderer {
    ...
    public void render(GuiGraphics graphics, CraftGraph graph, int panelX, int panelY, int panelWidth, int panelHeight,
        ...
        renderNodes(graphics, graph, panelX, panelY, panelWidth, panelHeight, cameraX, cameraY, zoom,
                hoveredNodeId, selectedNodeId, highlightedNodes);
    }

    private void renderEdges(GuiGraphics graphics, CraftGraph graph, int panelX, int panelY, int panelWidth, int panelHeight,
    ...
    private void renderNodes(GuiGraphics graphics, CraftGraph graph, int panelX, int panelY, int panelWidth, int panelHeight,
    ...
    private void renderNode(GuiGraphics graphics, CraftNode node, Rect rect, double zoom,

...
public class GuideBookCore {
    ...
    public static void init() {
        ...
        Quest.Builder.create().name("reactor_logic").tab(guideTab).icon(ItemStackHelper.fromData(IUItem.quad_mox_fuel_rod)).shape(Shape.DEFAULT).description(
                ...
                70).build();
        Quest.Builder.create().name("fluid_reactor").tab(guideTab).icon(getBlockStack(BlockWaterReactorsEntity.water_controller)).shape(Shape.DEFAULT).description(
        ...
        Quest.Builder.create().name("graphite_reactor").tab(guideTab).icon(getBlockStack(BlocksGraphiteReactors.graphite_adv_controller)).shape(Shape.DEFAULT).description(
                ...
                35).build();
        Quest.Builder.create().name("gas_reactor").tab(guideTab).icon(getBlockStack(BlockGasReactorEntity.gas_controller)).shape(Shape.DEFAULT).description(
                "gas_reactor").position(105,
                70).build();
        Quest.Builder.create().name("heat_reactor").tab(guideTab).icon(getBlockStack(BlockHeatReactorEntity.heat_controller)).shape(Shape.DEFAULT).description(
        ...
        Quest.Builder.create().name("electronics_assembler").itemStack(getBlockStack(BlockElectronicsAssemblerEntity.electronics_assembler)).useItemInform().prev(
        ...
        Quest.Builder.create().name("liqued_heater").itemStack(getBlockStack(BlockBaseMachine3Entity.fluid_heat)).localizationItem().useItemInform().tab(baseElectricTab).prev("elemotor").position(40, 0).build();
        Quest.Builder.create().name("generator").itemStack(getBlockStack(BlockBaseMachine3Entity.generator_iu)).localizationItem().useItemInform().tab(baseElectricTab).prev("liqued_heater").position(80, 0).build();
        Quest.Builder.create().name("redstone_generator").itemStack(getBlockStack(BlockBaseMachine3Entity.redstone_generator)).localizationItem().useItemInform().tab(baseElectricTab).prev("generator").position(80, -40).build();
        Quest.Builder.create().name("geogenerator").itemStack(getBlockStack(BlockBaseMachine3Entity.geogenerator_iu)).localizationItem().useItemInform().tab(baseElectricTab).prev("generator").position(120, 0).build();
        Quest.Builder.create().name("solid_refrigerator").itemStack(getBlockStack(BlockBaseMachine3Entity.solid_cooling)).localizationItem().useItemInform().tab(baseElectricTab).prev("geogenerator").position(160, 0).build();
        Quest.Builder.create().name("base_machines").itemStack(getBlockStack(BlockSimpleMachineEntity.macerator_iu),
                ...
                getBlockStack(BlockMoreMachine2Entity.cutting), getBlockStack(BlockMoreMachine2Entity.extruder)).localizationItem().useItemInform().tab(baseElectricTab).prev(
                "solid_refrigerator").position(200, 0).build();
        Quest.Builder.create().name("generator_microchip").itemStack(getBlockStack(BlockBaseMachineEntity.generator_microchip)).localizationItem().useItemInform().tab(baseElectricTab).prev("base_machines").position(240, 0).build();
        Quest.Builder.create().name("alloy_smelter").itemStack(getBlockStack(BlockBaseMachineEntity.alloy_smelter)).localizationItem().useItemInform().tab(baseElectricTab).prev("generator_microchip").position(280, 0).build();
        Quest.Builder.create().name("gearing").itemStack(getBlockStack(BlockMoreMachine3Entity.gearing)).localizationItem().useItemInform().tab(baseElectricTab).prev("alloy_smelter").position(320, 0).build();
        Quest.Builder.create().name("electronic_assembler").itemStack(getBlockStack(BlockBaseMachine3Entity.electronic_assembler)).localizationItem().useItemInform().tab(baseElectricTab).prev("gearing").position(360, 0).build();
        Quest.Builder.create().name("plastic_creator").itemStack(getBlockStack(BlockBaseMachine2Entity.plastic_creator)).localizationItem().useItemInform().tab(baseElectricTab).prev("electronic_assembler").position(360, 40).build();
        Quest.Builder.create().name("plastic_plate_creator").itemStack(getBlockStack(BlockBaseMachine2Entity.plastic_plate_creator)).localizationItem().useItemInform().tab(baseElectricTab).prev("plastic_creator").position(320, 40).build();
        Quest.Builder.create().name("welding").itemStack(getBlockStack(BlockBaseMachine3Entity.welding)).localizationItem().useItemInform().tab(baseElectricTab).prev("plastic_plate_creator").position(280, 40).build();
        Quest.Builder.create().name("orewashing").itemStack(getBlockStack(BlockMoreMachine3Entity.orewashing)).localizationItem().useItemInform().tab(baseElectricTab).prev("welding").position(240, 40).build();
        ...
        Quest.Builder.create().name("item_divider").itemStack(getBlockStack(BlockBaseMachine3Entity.item_divider)).localizationItem().useItemInform().tab(baseElectricTab).prev("nitrate_dust").position(160, 40).build();
        Quest.Builder.create().name("nitrogen").fluidStack(new FluidStack(FluidName.fluidnitrogen.getInstance().get(), 1000)).localizationItem().useItemInform().tab(baseElectricTab).prev(
        ...
        Quest.Builder.create().name("triple_solid_mixer").itemStack(getBlockStack(BlockBaseMachine3Entity.triple_solid_mixer)).localizationItem().useItemInform().tab(baseElectricTab).prev("gas").position(240, 80).build();
        Quest.Builder.create().name("gas_combiner").itemStack(getBlockStack(BlockBaseMachine3Entity.gas_combiner)).localizationItem().useItemInform().tab(baseElectricTab).prev("triple_solid_mixer").position(280, 80).build();
        ...
        Quest.Builder.create().name("fluid_integrator").itemStack(getBlockStack(BlockBaseMachine3Entity.fluid_integrator)).localizationItem().useItemInform().tab(baseElectricTab)
        ...
        Quest.Builder.create().name("radioactive_handler_ore").itemStack(getBlockStack(BlockBaseMachine3Entity.radioactive_handler_ore)).localizationItem().useItemInform().tab(baseElectricTab)
                .prev("crushed_uranium_ore").position(240, 120).build();
        Quest.Builder.create().name("industrial_ore_purifier").itemStack(getBlockStack(BlockBaseMachine3Entity.industrial_ore_purifier)).localizationItem().useItemInform().tab(baseElectricTab)
        ...
        Quest.Builder.create().name("se_gen").itemStack(getBlockStack(BlockSolarEnergyEntity.se_gen)).localizationItem().useItemInform().tab(baseElectricTab)
                .prev("se_sensor").position(120, 120).build();
        Quest.Builder.create().name("gen_sunnarium_plate").itemStack(getBlockStack(BlockSunnariumMakerEntity.gen_sunnarium_plate)).localizationItem().useItemInform().tab(baseElectricTab)
                .prev("se_gen").position(80, 120).build();
        Quest.Builder.create().name("gen_sunnarium").itemStack(getBlockStack(BlockSunnariumPanelMakerEntity.gen_sunnarium)).localizationItem().useItemInform().tab(baseElectricTab)
        ...
        Quest.Builder.create().name("polymerizer").itemStack(getBlockStack(BlockBaseMachine3Entity.polymerizer)).localizationItem().useItemInform().tab(baseElectricTab)
                .prev("acetylene").position(40, 160).build();
        Quest.Builder.create().name("solid_fluid_integrator").itemStack(getBlockStack(BlockBaseMachine3Entity.solid_fluid_integrator)).localizationItem().useItemInform().tab(baseElectricTab)
        ...
        Quest.Builder.create().name("fluid_separator").itemStack(getBlockStack(BlockBaseMachine3Entity.fluid_separator)).localizationItem().useItemInform().tab(baseElectricTab)
        ...
        Quest.Builder.create().name("handler_ho").itemStack(getBlockStack(BlockBaseMachine1Entity.handler_ho)).localizationItem().useItemInform().tab(baseElectricTab)
                .prev("plastic_plate").position(400, 160).build();
        Quest.Builder.create().name("refiner").itemStack(getBlockStack(BlockRefinerEntity.refiner)).localizationItem().useItemInform().tab(baseElectricTab)
                .prev("handler_ho").position(440, 160).build();
        Quest.Builder.create().name("gen_disel").itemStack(getBlockStack(BlockBaseMachine2Entity.gen_disel)).localizationItem().useItemInform().tab(baseElectricTab)
                .prev("refiner").position(480, 160).build();
        Quest.Builder.create().name("gen_pet").itemStack(getBlockStack(BlockBaseMachine2Entity.gen_pet)).localizationItem().useItemInform().tab(baseElectricTab)
                .prev("refiner").position(480, 200).build();
        Quest.Builder.create().name("fluid_cooling").itemStack(getBlockStack(BlockBaseMachine3Entity.fluid_cooling)).localizationItem().useItemInform().tab(baseElectricTab)
                .prev("refiner").position(440, 240).build();
        Quest.Builder.create().name("simple_wind_generator").itemStack(getBlockStack(BlockBaseMachine3Entity.simple_wind_generator)).localizationItem().useItemInform().tab(baseElectricTab)
                .prev("fluid_cooling").position(480, 240).build();
        Quest.Builder.create().name("simple_water_generator").itemStack(getBlockStack(BlockBaseMachine3Entity.simple_water_generator)).localizationItem().useItemInform().tab(baseElectricTab)
                .prev("fluid_cooling").position(440, 280).build();
        Quest.Builder.create().name("adv_alloy_smelter").itemStack(getBlockStack(BlockBaseMachine1Entity.adv_alloy_smelter)).localizationItem().useItemInform().tab(baseElectricTab)
                .prev("fluid_cooling").position(400, 240).build();
        Quest.Builder.create().name("centrifuge").itemStack(getBlockStack(BlockMoreMachine3Entity.centrifuge_iu)).localizationItem().useItemInform().tab(baseElectricTab)
                .prev("adv_alloy_smelter").position(360, 240).build();
        Quest.Builder.create().name("enrichment").itemStack(getBlockStack(BlockBaseMachine1Entity.enrichment)).localizationItem().useItemInform().tab(baseElectricTab)
                .prev("centrifuge").position(320, 240).build();
        Quest.Builder.create().name("nuclear_waste_recycler").itemStack(getBlockStack(BlockBaseMachine3Entity.nuclear_waste_recycler)).localizationItem().useItemInform().tab(baseElectricTab)
        ...
        GuideTab improvedElectricTab = new GuideTab("improvedElectricTab", getBlockStack(BlockBaseMachine3Entity.research_table_space),
                "improvedElectricTab");
        Quest.Builder.create().name("laser_polisher").itemStack(getBlockStack(BlockBaseMachine3Entity.laser_polisher)).localizationItem().noDescription().tab(improvedElectricTab)
                .position(0, 0).build();
        Quest.Builder.create().name("farmer").itemStack(getBlockStack(BlockMoreMachine3Entity.farmer)).localizationItem().noDescription().tab(improvedElectricTab)
        ...
        Quest.Builder.create().name("single_multi_crop").itemStack(getBlockStack(BlockBaseMachine3Entity.single_multi_crop)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("fertilizer").position(120, -40).build();
        Quest.Builder.create().name("alkalineearthquarry").itemStack(getBlockStack(BlockBaseMachine3Entity.alkalineearthquarry)).localizationItem().noDescription().tab(improvedElectricTab)
        ...
        Quest.Builder.create().name("reactor_rod_factory").itemStack(getBlockStack(BlockBaseMachine3Entity.reactor_rod_factory)).localizationItem().noDescription().tab(improvedElectricTab)
        ...
        Quest.Builder.create().name("pallet_generator").itemStack(getBlockStack(BlockBaseMachine3Entity.pallet_generator)).localizationItem().noDescription().tab(improvedElectricTab)
        ...
        Quest.Builder.create().name("reactor_safety_doom").itemStack(getBlockStack(BlockBaseMachine3Entity.reactor_safety_doom)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("radcable").position(400, 40).build();
        Quest.Builder.create().name("water_controller").itemStack(getBlockStack(BlockWaterReactorsEntity.water_controller)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("reactor_safety_doom").position(440, 40).build();
        Quest.Builder.create().name("water_controller").itemStack(getBlockStack(BlockGasReactorEntity.gas_controller)).localizationItem().noDescription().tab(improvedElectricTab)
        ...
        Quest.Builder.create().name("solardestiller").itemStack(getBlockStack(BlockBaseMachine3Entity.solardestiller)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("motoroil").position(440, 0).build();
        Quest.Builder.create().name("single_fluid_adapter").itemStack(getBlockStack(BlockBaseMachine3Entity.single_fluid_adapter)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("solardestiller").position(480, 0).build();
        Quest.Builder.create().name("gen_obsidian").itemStack(getBlockStack(BlockBaseMachine2Entity.gen_obsidian)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("single_fluid_adapter").position(520, -40).build();
        Quest.Builder.create().name("fisher").itemStack(getBlockStack(BlockBaseMachine2Entity.fisher)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("gen_obsidian").position(560, -40).build();
        Quest.Builder.create().name("gen_wither").itemStack(getBlockStack(BlockBaseMachine1Entity.gen_wither)).localizationItem().noDescription().tab(improvedElectricTab)
        ...
        Quest.Builder.create().name("generator_fluid_matter").itemStack(getBlockStack(BlockSimpleMachineEntity.generator_matter)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("reinforcedstone").position(600, 80).build();
        Quest.Builder.create().name("scanner_iu").itemStack(getBlockStack(BlockBaseMachine3Entity.scanner_iu)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("generator_fluid_matter").position(640, 80).build();
        Quest.Builder.create().name("pattern_storage_iu").itemStack(getBlockStack(BlockBaseMachine3Entity.pattern_storage_iu)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("scanner_iu").position(680, 80).build();
        Quest.Builder.create().name("replicator_iu").itemStack(getBlockStack(BlockBaseMachine3Entity.replicator_iu)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("pattern_storage_iu").position(720, 80).build();
        Quest.Builder.create().name("matter_collector").itemStack(getBlockStack(BlockBaseMachine3Entity.matter_collector)).localizationItem().noDescription().tab(improvedElectricTab)
        ...
        Quest.Builder.create().name("assamplerscrap").itemStack(getBlockStack(BlockMoreMachine3Entity.assamplerscrap)).localizationItem().noDescription().tab(improvedElectricTab)
        ...
        Quest.Builder.create().name("mfe_iu").itemStack(getBlockStack(BlockEnergyStorageEntity.mfe_iu)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("transformerUpgrade").position(440, 100).build();
        Quest.Builder.create().name("fluid_trash").itemStack(getBlockStack(BlockBaseMachine3Entity.fluid_trash)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("mfe_iu").position(400, 140).build();
        Quest.Builder.create().name("energy_trash").itemStack(getBlockStack(BlockBaseMachine3Entity.energy_trash)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("mfe_iu").position(480, 140).build();
        Quest.Builder.create().name("item_trash").itemStack(getBlockStack(BlockBaseMachine3Entity.item_trash)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("mfe_iu").position(440, 140).build();
        Quest.Builder.create().name("electrolyzer_iu").itemStack(getBlockStack(BlockBaseMachine2Entity.electrolyzer_iu)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("mfe_iu").position(400, 100).build();
        Quest.Builder.create().name("enchanter_books").itemStack(getBlockStack(BlockBaseMachine3Entity.enchanter_books)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("electrolyzer_iu").position(360, 70).build();
        Quest.Builder.create().name("molecular").itemStack(getBlockStack(BlockMolecularEntity.molecular)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("electrolyzer_iu").position(360, 100).build();
        Quest.Builder.create().name("advanced_solar_paneliu").itemStack(getBlockStack(BlockSolarPanelsEntity.advanced_solar_paneliu)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("molecular").position(280, 120).build();
        Quest.Builder.create().name("minipanel").itemStack(getBlockStack(BlockBaseMachine3Entity.minipanel)).localizationItem().noDescription().tab(improvedElectricTab)
        ...
        Quest.Builder.create().name("matter_factory").itemStack(getBlockStack(BlockBaseMachine3Entity.matter_factory)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("minipanel").position(200, 120).build();
        Quest.Builder.create().name("battery_factory").itemStack(getBlockStack(BlockBaseMachine3Entity.battery_factory)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("matter_factory").position(160, 120).build();
        Quest.Builder.create().name("socket_factory").itemStack(getBlockStack(BlockBaseMachine3Entity.socket_factory)).localizationItem().noDescription().tab(improvedElectricTab)
        ...
        Quest.Builder.create().name("aircollector").itemStack(getBlockStack(BlockBaseMachine3Entity.aircollector)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("photoniy_ingot").position(280, 180).build();
        Quest.Builder.create().name("soil_analyzer").itemStack(getBlockStack(BlockBaseMachine3Entity.soil_analyzer)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("photoniy_ingot").position(360, 180).build();
        Quest.Builder.create().name("radiation_purifier").itemStack(getBlockStack(BlockBaseMachine3Entity.radiation_purifier)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("soil_analyzer").position(400, 180).build();
        Quest.Builder.create().name("synthesis").itemStack(getBlockStack(BlockBaseMachine1Entity.synthesis)).localizationItem().noDescription().tab(improvedElectricTab)
        ...
        Quest.Builder.create().name("steam_turbine_controller").itemStack(getBlockStack(BlockSteamTurbineEntity.steam_turbine_controller)).localizationItem().noDescription().tab(improvedElectricTab)
        ...
        Quest.Builder.create().name("research_table_space").itemStack(getBlockStack(BlockBaseMachine3Entity.research_table_space)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("research_lens").position(160, 180).build();
        Quest.Builder.create().name("rocket_launch_pad").itemStack(getBlockStack(BlockBaseMachine3Entity.rocket_launch_pad)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("research_table_space").position(120, 180).build();
        Quest.Builder.create().name("rover_assembler").itemStack(getBlockStack(BlockBaseMachine3Entity.rover_assembler)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("rocket_launch_pad").position(80, 180).build();
        Quest.Builder.create().name("probe_assembler").itemStack(getBlockStack(BlockBaseMachine3Entity.probe_assembler)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("rover_assembler").position(40, 140).build();
        Quest.Builder.create().name("satellite_assembler").itemStack(getBlockStack(BlockBaseMachine3Entity.satellite_assembler)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("probe_assembler").position(0, 100).build();
        Quest.Builder.create().name("rocket_assembler").itemStack(getBlockStack(BlockBaseMachine3Entity.rocket_assembler)).localizationItem().noDescription().tab(improvedElectricTab)
        ...
        Quest.Builder.create().name("purifier_soil").itemStack(getBlockStack(BlockBaseMachine3Entity.purifier_soil)).localizationItem().noDescription().tab(improvedElectricTab)
        ...
        Quest.Builder.create().name("upgrade_rover").itemStack(getBlockStack(BlockBaseMachine3Entity.upgrade_rover)).localizationItem().noDescription().tab(improvedElectricTab)
        ...
        Quest.Builder.create().name("double_transformer").itemStack(getBlockStack(BlockDoubleMolecularTransfomerEntity.double_transformer)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("advanced_hull_machine").position(160, 300).build();
        Quest.Builder.create().name("analyzer").itemStack(getBlockStack(BlockBaseMachine2Entity.analyzer)).localizationItem().noDescription().tab(improvedElectricTab)
        ...
        GuideTab advancedElectricTab = new GuideTab("advancedElectricTab", getBlockStack(BlockBaseMachine3Entity.imp_alloy_smelter),
                "advancedElectricTab");
        Quest.Builder.create().name("imp_alloy_smelter").itemStack(getBlockStack(BlockBaseMachine3Entity.imp_alloy_smelter)).localizationItem().noDescription().tab(advancedElectricTab)
                .position(0, 0).build();
        ...
        Quest.Builder.create().name("cooling").itemStack(getBlockStack(BlockBaseMachine3Entity.cooling)).localizationItem().noDescription().tab(advancedElectricTab)
        ...
        Quest.Builder.create().name("substitute").itemStack(getBlockStack(BlockBaseMachine3Entity.substitute)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("cooling").position(80, 0).build();
        Quest.Builder.create().name("energy_remover").itemStack(getBlockStack(BlockBaseMachine3Entity.energy_remover)).localizationItem().noDescription().tab(advancedElectricTab)
        ...
        Quest.Builder.create().name("imp_refiner").itemStack(getBlockStack(BlockBaseMachine3Entity.imp_refiner)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("autoheater").position(240, 0).build();
        Quest.Builder.create().name("adv_coke_oven_main").itemStack(getBlockStack(BlockAdvCokeOvenEntity.adv_coke_oven_main)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("imp_refiner").position(280, 0).build();
        Quest.Builder.create().name("wireless_oil_pump").itemStack(getBlockStack(BlockBaseMachine3Entity.wireless_oil_pump)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("adv_coke_oven_main").position(280, -40).build();
        Quest.Builder.create().name("wireless_mineral_quarry").itemStack(getBlockStack(BlockBaseMachine3Entity.wireless_mineral_quarry)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("wireless_oil_pump").position(320, -40).build();
        Quest.Builder.create().name("wireless_gas_pump").itemStack(getBlockStack(BlockBaseMachine3Entity.wireless_gas_pump)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("wireless_mineral_quarry").position(360, -40).build();
        Quest.Builder.create().name("radiation_storage").itemStack(getBlockStack(BlockBaseMachine3Entity.radiation_storage)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("adv_coke_oven_main").position(320, 0).build();
        Quest.Builder.create().name("automatic_mechanism").itemStack(getBlockStack(BlockBaseMachine3Entity.automatic_mechanism)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("radiation_storage").position(360, 0).build();
        Quest.Builder.create().name("wireless_controller_reactors").itemStack(getBlockStack(BlockBaseMachine3Entity.wireless_controller_reactors)).localizationItem().noDescription().tab(advancedElectricTab)
        ...
        Quest.Builder.create().name("spawner").itemStack(getBlockStack(BlockBaseMachine3Entity.spawner)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("entitymodules").position(440, -40).build();
        Quest.Builder.create().name("auto_open_box").itemStack(getBlockStack(BlockBaseMachine3Entity.auto_open_box)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("entitymodules").position(480, 0).build();
        Quest.Builder.create().name("refrigerator_coolant").itemStack(getBlockStack(BlockBaseMachine3Entity.refrigerator_coolant)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("auto_open_box").position(480, 100).build();
        Quest.Builder.create().name("autocrafter").itemStack(getBlockStack(BlockBaseMachine3Entity.autocrafter)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("refrigerator_coolant").position(520, 100).build();
        Quest.Builder.create().name("autofuse").itemStack(getBlockStack(BlockBaseMachine3Entity.autofuse)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("refrigerator_coolant").position(440, 100).build();
        Quest.Builder.create().name("graphite_handler").itemStack(getBlockStack(BlockBaseMachine3Entity.graphite_handler)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("autofuse").position(400, 100).build();
        Quest.Builder.create().name("tesseract").itemStack(getBlockStack(BlockBaseMachine3Entity.tesseract)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("graphite_handler").position(360, 100).build();
        Quest.Builder.create().name("imp_se_gen").itemStack(getBlockStack(BlockImpSolarEnergyEntity.imp_se_gen)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("tesseract").position(320, 100).build();
        Quest.Builder.create().name("combiner_se_generators").itemStack(getBlockStack(BlockBaseMachine3Entity.combiner_se_generators)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("imp_se_gen").position(280, 100).build();
        Quest.Builder.create().name("combiner_matter").itemStack(getBlockStack(BlockBaseMachine2Entity.combiner_matter)).localizationItem().noDescription().noDescription().tab(advancedElectricTab)
                .prev("combiner_se_generators").position(240, 100).build();
        Quest.Builder.create().name("quantum_quarry").itemStack(getBlockStack(BlockBaseMachineEntity.quantum_quarry)).localizationItem().noDescription().tab(advancedElectricTab)
        ...
        Quest.Builder.create().name("heat_controller").itemStack(getBlockStack(BlockHeatReactorEntity.heat_controller)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("quantum_quarry").position(200, 140).build();
        Quest.Builder.create().name("neutron_generator").itemStack(getBlockStack(BlockBaseMachineEntity.neutron_generator)).localizationItem().noDescription().tab(advancedElectricTab)
        ...
        Quest.Builder.create().name("upgrade_block").itemStack(getBlockStack(BlockUpgradeBlockEntity.upgrade_block)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("neutroniumingot").position(80, 100).build();
        Quest.Builder.create().name("antiupgradeblock").itemStack(getBlockStack(BlockBaseMachine3Entity.antiupgradeblock)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("upgrade_block").position(80, 140).build();
        Quest.Builder.create().name("rotor_modifier").itemStack(getBlockStack(BlockBaseMachine3Entity.rotor_modifier)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("antiupgradeblock").position(120, 140).build();
        Quest.Builder.create().name("water_modifier").itemStack(getBlockStack(BlockBaseMachine3Entity.water_modifier)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("rotor_modifier").position(160, 140).build();
        Quest.Builder.create().name("earth_controller").itemStack(getBlockStack(BlockEarthQuarryEntity.earth_controller)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("upgrade_block").position(40, 100).build();
        Quest.Builder.create().name("gas_turbine_controller").itemStack(getBlockStack(BlockGasTurbineEntity.gas_turbine_controller)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("earth_controller").position(0, 100).build();
        Quest.Builder.create().name("gas_well_controller").itemStack(getBlockStack(BlockGasWellEntity.gas_well_controller)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("gas_turbine_controller").position(0, 180).build();
        Quest.Builder.create().name("night_transformer").itemStack(getBlockStack(BlockBaseMachine3Entity.night_transformer)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("gas_well_controller").position(40, 180).build();
        Quest.Builder.create().name("night_converter").itemStack(getBlockStack(BlockBaseMachine3Entity.night_converter)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("night_transformer").position(40, 220).build();
        Quest.Builder.create().name("incubator").itemStack(getBlockStack(BlockBaseMachine3Entity.incubator)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("night_transformer").position(80, 180).build();
        Quest.Builder.create().name("insulator").itemStack(getBlockStack(BlockBaseMachine3Entity.insulator)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("incubator").position(120, 180).build();
        Quest.Builder.create().name("rna_collector").itemStack(getBlockStack(BlockBaseMachine3Entity.rna_collector)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("insulator").position(160, 180).build();
        Quest.Builder.create().name("mutatron").itemStack(getBlockStack(BlockBaseMachine3Entity.mutatron)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("rna_collector").position(200, 180).build();
        Quest.Builder.create().name("genetic_stabilizer").itemStack(getBlockStack(BlockBaseMachine3Entity.genetic_stabilizer)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("mutatron").position(240, 180).build();
        Quest.Builder.create().name("reverse_transcriptor").itemStack(getBlockStack(BlockBaseMachine3Entity.reverse_transcriptor)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("genetic_stabilizer").position(280, 180).build();
        Quest.Builder.create().name("genetic_replicator").itemStack(getBlockStack(BlockBaseMachine3Entity.genetic_replicator)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("reverse_transcriptor").position(320, 180).build();
        Quest.Builder.create().name("genetic_transposer").itemStack(getBlockStack(BlockBaseMachine3Entity.genetic_transposer)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("genetic_replicator").position(360, 180).build();
        Quest.Builder.create().name("genetic_polymerizer").itemStack(getBlockStack(BlockBaseMachine3Entity.genetic_polymerizer)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("genetic_transposer").position(400, 180).build();
        Quest.Builder.create().name("inoculator").itemStack(getBlockStack(BlockBaseMachine3Entity.inoculator)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("genetic_polymerizer").position(440, 180).build();
        Quest.Builder.create().name("genome_extractor").itemStack(getBlockStack(BlockBaseMachine3Entity.genome_extractor)).localizationItem().noDescription().tab(advancedElectricTab)
                .prev("inoculator").position(480, 180).build();
        Quest.Builder.create().name("geothermal_controller").itemStack(getBlockStack(BlockGeothermalPumpEntity.geothermal_controller)).localizationItem().noDescription().tab(advancedElectricTab)
        ...
        Quest.Builder.create().name("chemical_plant_controller").itemStack(getBlockStack(BlockChemicalPlantEntity.chemical_plant_controller)).localizationItem().noDescription().tab(advancedElectricTab)
        ...
        Quest.Builder.create().name("recipe_tuner").itemStack(getBlockStack(BlockBaseMachine3Entity.recipe_tuner)).localizationItem().useItemInform().tab(baseElectricTab)
        ...
        Quest.Builder.create().name("tuner").itemStack(getBlockStack(BlockBaseMachine3Entity.tuner)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("purifier_soil").position(-80, 180).build();
        Quest.Builder.create().name("privatizer").itemStack(getBlockStack(BlockBaseMachine3Entity.privatizer)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("tuner").position(-120, 180).build();
        Quest.Builder.create().name("hologram_space").itemStack(getBlockStack(BlockBaseMachine3Entity.hologram_space)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("rocket_launch_pad").position(120, 220).build();
        Quest.Builder.create().name("weeder").itemStack(getBlockStack(BlockBaseMachine3Entity.weeder)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("single_multi_crop").position(160, -40).build();
        Quest.Builder.create().name("plant_fertilizer").itemStack(getBlockStack(BlockBaseMachine3Entity.plant_fertilizer)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("weeder").position(200, -40).build();
        Quest.Builder.create().name("field_cleaner").itemStack(getBlockStack(BlockBaseMachine3Entity.field_cleaner)).localizationItem().noDescription().tab(improvedElectricTab)
        ...
        Quest.Builder.create().name("collector_product_bee").itemStack(getBlockStack(BlockBaseMachine3Entity.collector_product_bee)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("steelMesh").position(80, 40).build();
        Quest.Builder.create().name("shield").itemStack(getBlockStack(BlockBaseMachine3Entity.shield)).localizationItem().noDescription().tab(improvedElectricTab)
                .prev("gen_wither").position(640, -40).build();
        Quest.Builder.create().name("steam_generator").itemStack(getBlockStack(BlockBaseMachine3Entity.steam_generator)).localizationItem().noDescription().tab(baseElectricTab).prev("redstone_generator").position(120, -40).build();
        Quest.Builder.create().name("bio_generator").itemStack(getBlockStack(BlockBaseMachine3Entity.bio_generator)).localizationItem().noDescription().tab(baseElectricTab).prev("steam_generator").position(160, -40).build();
        Quest.Builder.create().name("peat_generator").itemStack(getBlockStack(BlockBaseMachine3Entity.peat_generator)).localizationItem().noDescription().tab(baseElectricTab).prev("bio_generator").position(200, -40).build();

        Quest.Builder.create().name("gen_hyd").itemStack(getBlockStack(BlockBaseMachine2Entity.gen_hyd)).localizationItem().noDescription().tab(baseElectricTab).prev("peat_generator").position(240, -40).build();

        Quest.Builder.create().name("electric_refractory_furnace").itemStack(getBlockStack(BlockBaseMachine3Entity.electric_refractory_furnace)).localizationItem().noDescription().tab(baseElectricTab)
                .prev("gen_sunnarium").position(0, 80).build();

        Quest.Builder.create().name("electric_brewing").itemStack(getBlockStack(BlockBaseMachine3Entity.electric_brewing)).localizationItem().noDescription().tab(baseElectricTab).prev("generator").position(80, 40).build();
        Quest.Builder.create().name("watergenerator").itemStack(getBlockStack(BlockBaseMachine3Entity.watergenerator)).localizationItem().noDescription().tab(baseElectricTab)
                .prev("adv_alloy_smelter").position(360, 200).build();
        Quest.Builder.create().name("apothecary_bee").itemStack(getBlockStack(BlockBaseMachine3Entity.apothecary_bee)).localizationItem().noDescription().tab(baseElectricTab)
                .prev("watergenerator").position(320, 200).build();
        Quest.Builder.create().name("lava_gen").itemStack(getBlockStack(BlockBaseMachine2Entity.lava_gen)).localizationItem().noDescription().tab(baseElectricTab).prev("electronic_assembler").position(400, 0).build();
        Quest.Builder.create().name("helium_generator").itemStack(getBlockStack(BlockBaseMachine2Entity.helium_generator)).localizationItem().noDescription().tab(baseElectricTab).prev("lava_gen").position(440, 0).build();
        Quest.Builder.create().name("gen_stone").itemStack(getBlockStack(BlockBaseMachineEntity.gen_stone)).localizationItem().noDescription().tab(baseElectricTab).prev("gearing").position(360, -40).build();
        Quest.Builder.create().name("gen_addition_stone").itemStack(getBlockStack(BlockBaseMachine3Entity.gen_addition_stone)).localizationItem().noDescription().tab(baseElectricTab).prev("gen_stone").position(400, -40).build();
        Quest.Builder.create().name("fluid_heater").itemStack(getBlockStack(BlockBaseMachine3Entity.fluid_heater)).localizationItem().useItemInform().tab(baseElectricTab).prev("liqued_heater").position(40, -40).build();
        ...
        Quest.Builder.create().name("per_alloy_smelter").itemStack(getBlockStack(BlockBaseMachine3Entity.per_alloy_smelter)).localizationItem().noDescription().tab(perElectricTab).position(0, 0).build();

...
public class VerticalSliderWidget extends AbstractWidget {
    ...
    public VerticalSliderWidget(ButtonListSliderWidget.GuiResponder p_i45541_1_, int p_i45541_2_, int x, int y, String name, int min, int max, int def, FormatHelper p_i45541_9_, int height) {

...
public class VerticalSliderListWidget extends AbstractWidget {
    ...
    private final ButtonListSliderWidget.GuiResponder responder;
    ...
    public VerticalSliderListWidget(ButtonListSliderWidget.GuiResponder p_i45541_1_, int p_i45541_2_, int x, int y, String name, int min, int max, int def, FormatHelper p_i45541_9_, int height) {
    ...
    protected void renderWidget(GuiGraphics guiGraphics, int i, int i1, float v) {
        ...
        guiGraphics.blit(ScreenIndustrialUpgrade.currentTexture, this.getX(), this.getY() - 1, 255, 0, 4, this.height - 2);

        int sliderY = (int) (this.getY() + (this.height - this.sizeRender) * this.sliderPosition);
        guiGraphics.blit(ScreenIndustrialUpgrade.currentTexture, this.getX() - 1, sliderY, 12, 13, 4, this.sizeRender);

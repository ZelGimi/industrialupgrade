...
public class ScreenWidget extends AbstractWidget {
    ...
    public static final ResourceLocation space_progress = ResourceLocation.tryBuild(
            Constants.MOD_ID,
    ...
    protected void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float v) {
        drawBackground(guiGraphics, mouseX, mouseY);
    }
    ...
    public void drawBackground(GuiGraphics poseStack, int mouseX, int mouseY) {
        ...
        if (this.widgetDefault.getComponent() instanceof ComponentCustomizeSize) {
            ComponentCustomizeSize componentSoundButton = (ComponentCustomizeSize) this.widgetDefault.getComponent();
            this.gui.drawTexturedModalRect(
                    poseStack, mouseX + this.x,
                    mouseY + this.y,
                    type.getX(),

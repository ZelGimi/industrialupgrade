...
public class SteamInterfaceWidget extends ScreenWidget {


    public SteamInterfaceWidget(ScreenIndustrialUpgrade<?> gui, int x, int y, int width, int height) {
    ...
    public void drawBackground(GuiGraphics poseStack, int mouseX, int mouseY) {
        mouseX = gui.guiLeft();
        mouseY = gui.guiTop();
        ScreenIndustrialUpgrade.bindTexture(ResourceLocation.tryBuild("industrialupgrade", "textures/gui/common4.png"));

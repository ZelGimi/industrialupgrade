...
public class SpaceMainRedInterfaceWidget extends ScreenWidget {


    public SpaceMainRedInterfaceWidget(ScreenIndustrialUpgrade<?> gui, int x, int y, int width, int height) {
        super(gui, x, y, width, height);
    }

    public void drawBackground(GuiGraphics poseStack, int mouseX, int mouseY) {

        ScreenIndustrialUpgrade.bindTexture(ResourceLocation.tryBuild("industrialupgrade", "textures/gui/gui_space_main_red.png"));

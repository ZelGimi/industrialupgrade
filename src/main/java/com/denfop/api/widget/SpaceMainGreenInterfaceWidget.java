...
public class SpaceMainGreenInterfaceWidget extends ScreenWidget {


    public SpaceMainGreenInterfaceWidget(ScreenIndustrialUpgrade<?> gui, int x, int y, int width, int height) {
    ...
    public void drawBackground(GuiGraphics poseStack, int mouseX, int mouseY) {
        mouseX = gui.guiLeft();
        mouseY = gui.guiTop();
        ScreenIndustrialUpgrade.bindTexture(ResourceLocation.tryBuild("industrialupgrade", "textures/gui/gui_space_main_green.png"));

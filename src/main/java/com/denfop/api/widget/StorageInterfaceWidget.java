...
public class StorageInterfaceWidget extends ScreenWidget {


    public StorageInterfaceWidget(ScreenIndustrialUpgrade<?> gui, int x, int y, int width, int height) {
    ...
    public void drawBackground(GuiGraphics poseStack, int mouseX, int mouseY) {
        ...
        mouseX = gui.guiLeft();
        mouseY = gui.guiTop();
        ScreenIndustrialUpgrade.bindTexture(ResourceLocation.tryBuild("industrialupgrade", "textures/gui/storageinterface.png"));

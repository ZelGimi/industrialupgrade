...
public class SliderWidget extends AbstractWidget {
    ...
    public SliderWidget(
            ButtonListSliderWidget.WidgetResponder p_i45541_1_,
            int p_i45541_2_,
            int p_i45541_3_,
            int p_i45541_4_,
            String p_i45541_5_,
    ...
    public SliderWidget(
            ButtonListSliderWidget.WidgetResponder p_i45541_1_, int p_i45541_2_, int p_i45541_3_, int p_i45541_4_,
    ...
    protected void renderWidget(GuiGraphics guiGraphics, int i, int i1, float v) {
        ...
        guiGraphics.blit(ScreenIndustrialUpgrade.currentTexture, this.getX(),
                this.getY(), 0, 255
                , this.width, 1
        );
        guiGraphics.blit(ScreenIndustrialUpgrade.currentTexture, this.getX(),
        ...
        guiGraphics.blit(ScreenIndustrialUpgrade.currentTexture, this.getX() + this.width - 1,
                this.getY() - 2, 6, 13
                , 1, 4
        );
        guiGraphics.blit(ScreenIndustrialUpgrade.currentTexture, this.getX() + (this.width) / 2,
                this.getY() - 2, 6, 13
                , 1, 4
        );
        for (int x = this.getX() + this.width / 4; x < this.getX() + this.width - 1; x += this.width / 4) {
            guiGraphics.blit(ScreenIndustrialUpgrade.currentTexture, x + 1,
                    this.getY() - 1, 9, 14
                    , 1, 3
            );
        }
        ...
        guiGraphics.blit(ScreenIndustrialUpgrade.currentTexture, (this.getX() + (int) (this.sliderPosition * (float) (this.width - 3))),

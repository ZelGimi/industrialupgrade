...
public class WidgetDefault<T> {
    ...
    public void drawBackground(GuiGraphics poseStack, int mouseX, int mouseY, final ScreenWidget screenWidget) {
        if (visible()) {
    ...
    public String getText(final ScreenWidget screenWidget) {
        ...
        if (this.component instanceof ComponentButton) {
            ...
            FluidTank component = (FluidTank) this.component;
            String text1;
            text1 = Localization.translate(component.getFluid().getDescriptionId());

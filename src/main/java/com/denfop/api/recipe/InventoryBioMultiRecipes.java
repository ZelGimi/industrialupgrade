...
public class InventoryBioMultiRecipes extends Inventory {

    private final IMultiUpdateTick tile;
    private final BioProcessMultiComponent processMultiComponent;
    ...
    public InventoryBioMultiRecipes(
            ...
            FluidTank tank,
            int size, BioProcessMultiComponent processMultiComponent
    ) {
        this(base, Recipes.recipes.getRecipe(baseRecipe), tile, size, processMultiComponent);
        this.tank = tank;
    }
    ...
    public boolean canPlaceItem(final int index, final ItemStack itemStack) {
        ...
        return !itemStack.isEmpty() && !(itemStack.getItem() instanceof UpgradeItem) && (recipe
                .getName()

...
public class RecipesFluidCore implements IFluidRecipes {
    ...
    public final List<String> registeredRecipes = new ArrayList<>();
    ...
    public void addRecipe(String name, BaseFluidMachineRecipe recipe) {
        if (!this.map_recipes_fluid.containsKey(name)) {
            ...
            if (iRecipeInputList == null) {
                iRecipeInputList = new ArrayList<>();
            }
    ...
    public void removeAllRecipe(String name, boolean removeAll, ItemStack output) {
        ...
        for (BaseFluidMachineRecipe recipe : recipes) {
            if (recipe == null || recipe.getOutput() == null || recipe.getOutput().items == null || recipe.getOutput().items.isEmpty()) {
                continue;
            }

...
public final class SpaceWorldgenContent {
    ...
    public static final RegistryObject<Feature<SpaceBodyFeatureConfig>> SPACE_CRATER = FEATURES.register("space_crater", () -> new com.denfop.api.space.dimension.worldgen.feature.SpaceCraterFeature(SpaceBodyFeatureConfig.CODEC));    public static final RegistryObject<BlockEntityType<SpaceGeyserBlockEntity>> SPACE_GEYSER_BE = BLOCK_ENTITIES.register(
            "space_geyser",
            () -> BlockEntityType.Builder.of(SpaceGeyserBlockEntity::new, SPACE_GEYSER.get()).build(null)
    );
    public static final RegistryObject<Feature<SpaceBodyFeatureConfig>> SPACE_VOLCANO = FEATURES.register("space_volcano", () -> new SpaceVolcanoFeature(SpaceBodyFeatureConfig.CODEC));

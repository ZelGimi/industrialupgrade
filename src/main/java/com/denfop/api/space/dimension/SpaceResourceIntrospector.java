...
public final class SpaceResourceIntrospector {
    ...
    private static BlockState resolveBlockState(final Item item, final ResourceLocation itemId, final SolidKind kind) {
        ...
        candidates.add(new ResourceLocation(namespace, path));

        switch (kind) {
            case STONE -> {
                candidates.add(new ResourceLocation(namespace, path + "_stone"));
                candidates.add(new ResourceLocation(namespace, path.replace("_dust", "_stone")));
                candidates.add(new ResourceLocation(namespace, path.replace("_fragment", "_stone")));
                candidates.add(new ResourceLocation(namespace, path.replace("_chunk", "_stone")));
                candidates.add(new ResourceLocation(IUCore.MODID, path));
                candidates.add(new ResourceLocation(IUCore.MODID, path + "_stone"));
            }
            case COBBLE -> {
                candidates.add(new ResourceLocation(namespace, path + "_cobblestone"));
                candidates.add(new ResourceLocation(namespace, path.replace("_stone", "_cobblestone")));
                candidates.add(new ResourceLocation(namespace, path.replace("_stone", "_regolith")));
                candidates.add(new ResourceLocation(IUCore.MODID, path));
                candidates.add(new ResourceLocation(IUCore.MODID, path + "_cobblestone"));
            }
            case ORE -> {
                candidates.add(new ResourceLocation(namespace, path + "_ore"));
                candidates.add(new ResourceLocation(namespace, path.replace("raw_", "") + "_ore"));
                candidates.add(new ResourceLocation(namespace, path.replace("_ingot", "_ore")));
                candidates.add(new ResourceLocation(namespace, path.replace("_dust", "_ore")));
                candidates.add(new ResourceLocation(namespace, path.replace("_gem", "_ore")));
                candidates.add(new ResourceLocation(IUCore.MODID, path));
                candidates.add(new ResourceLocation(IUCore.MODID, path + "_ore"));
            }
        }

        for (ResourceLocation id : candidates) {
            Optional<Block> block = Registry.BLOCK.getOptional(id);

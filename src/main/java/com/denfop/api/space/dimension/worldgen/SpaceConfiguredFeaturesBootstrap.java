...
public final class SpaceConfiguredFeaturesBootstrap {
    ...
    private static void registerCave(
            final BootstapContext<ConfiguredFeature<?, ?>> context,
    ...
    private static void registerBodyOres(final BootstapContext<ConfiguredFeature<?, ?>> context, final SpaceDimensionProfile body, int oreIndex) {

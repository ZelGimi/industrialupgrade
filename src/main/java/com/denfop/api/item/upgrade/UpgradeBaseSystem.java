...
public interface UpgradeBaseSystem {
    ...
    void updateListFromNBT(UpgradeItem item, ItemStack stack);

    void setInformation(UpgradeItem item, List<EnumInfoUpgradeModules> lst, ItemStack stack);

    void write(UpgradeItem item, List<EnumInfoUpgradeModules> lst, ItemStack stack);

    void updateBlackListFromNBT(UpgradeWithBlackList item, ItemStack stack, CompoundTag nbt);

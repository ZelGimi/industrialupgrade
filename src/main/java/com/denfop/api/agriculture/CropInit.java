...
import static com.denfop.api.bee.BeeInit.FOREST_BEE;
import static com.denfop.api.bee.BeeInit.PLAINS_BEE;
import static com.denfop.api.bee.BeeInit.SWAMP_BEE;
import static com.denfop.api.bee.BeeInit.TROPICAL_BEE;
import static com.denfop.api.bee.BeeInit.WINTER_BEE;
...
public class CropInit {
    ...
    public static void init() {
        ...
        wheat_seed = new CropBase("wheat",
                ...
                8,
                1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/wheat_stage"),
                false,
                ...
                true,
                false,
                Arrays.asList(new ItemStack(Items.WHEAT)),
                10,
                Collections.emptyList(),
                0
        );
        reed_seed = new CropBase("reed",
                1,
                EnumSoil.SAND,
                1,
                1,
                ...
                4,
                1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/stickreed"),
                false,
                Collections.emptyList(),
                5,
                false,
                ...
                true,
                true,
                Arrays.asList(new ItemStack(Items.REEDS)),
                10,
                Collections.emptyList(),
                1
        );
        ...
        tulip_pink = new CropBase("tulip_pink", 4, EnumSoil.FARMLAND, 1, 2, 5, 1, 60, 4, 1,
                ...
                false, 3000, 60,
                true, false, Arrays.asList(new ItemStack(Blocks.RED_FLOWER, 1, 7)), 10, Collections.emptyList(), 1
        );
        haustonia_gray = new CropBase("haustonia_gray", 5, EnumSoil.FARMLAND, 1, 2, 5, 1, 60, 4, 1,
                ...
                false, 3000, 60,
                true, false, Arrays.asList(new ItemStack(Blocks.RED_FLOWER, 1, 3)), 10, Collections.emptyList(), 1
        );
        ...
        onion = new CropBase("onion", 7, EnumSoil.FARMLAND, 1, 2, 5, 1, 60, 4, 1,
                ...
                false, 3000, 60,
                true, false, Arrays.asList(new ItemStack(Blocks.RED_FLOWER, 1, 2)), 10, Collections.emptyList(), 1
        );
        ...
        chamomile = new CropBase("chamomile", 10, EnumSoil.FARMLAND, 1, 2, 5, 1, 60, 4, 1,
                ...
                false, 3000, 60,
                true, false, Arrays.asList(new ItemStack(Blocks.RED_FLOWER, 1, 8)), 10, Collections.emptyList(), 1
        );
        tulip_white = new CropBase("tulip_white", 11, EnumSoil.FARMLAND, 1, 2, 5, 1, 60, 4, 1,
                ...
                false, 3000, 60,
                true, false, Arrays.asList(new ItemStack(Blocks.RED_FLOWER, 1, 6)), 10, Collections.emptyList(), 1
        );
        dandelion = new CropBase("dandelion", 12, EnumSoil.FARMLAND, 1, 2, 5, 1, 60, 4, 1,
                ...
                false, 3000, 60,
                true, false, Arrays.asList(new ItemStack(Blocks.YELLOW_FLOWER)), 10, Collections.emptyList(), 1
        );
        tulip_red = new CropBase("tulip_red", 13, EnumSoil.FARMLAND, 1, 2, 5, 1, 60, 4, 1,
                ...
                false, 3000, 60,
                true, false, Arrays.asList(new ItemStack(Blocks.RED_FLOWER, 1, 4)), 10, Collections.emptyList(), 1
        );
        ...
        tomato = new CropBase("tomato",
                ...
                4,
                1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/tomato"),
                true,
                Arrays.asList(potato, carrot, red_mushroom),
                4,
                false,
                4000,
                60,
                true,
                false,
                Arrays.asList(new ItemStack(IUItem.tomato)),
                5,
                Collections.emptyList(),
                0
        );
        ...
        diamond_island = new CropBase("diamond_island",
                47,
                EnumSoil.DIAMOND,
                1,
                0,
                ...
                4,
                1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/diamond_island"),
                true,
                Arrays.asList(gold_astral, blue_orchid, carrot),
                4,
                false,
                4800,
                50,
                true,
                false,
                Arrays.asList(new ItemStack(IUItem.smalldust, 1, 28)),
                10,
                Arrays.asList(),
                1
        );

        emerald_heart = new CropBase("emerald_heart",
                48,
                EnumSoil.EMERALD,
                1,
                0,
                ...
                4,
                1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/emerald_heart"),
                true,
                Arrays.asList(diamond_island, melon),
                3,
                false,
                4000,
                45,
                true,
                false,
                Arrays.asList(new ItemStack(IUItem.smalldust, 1, 47)),
                10,
                Collections.emptyList(),
                1
        );
        ...
        lead_stream = new CropBase("lead_stream",
                51,
                EnumSoil.LEAD,
                1,
                0,
                ...
                4,
                1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/lead_stream"),
                true,
                Arrays.asList(
                        haustonia_gray,
                        brown_mushroom
                ...
                true,
                false,
                Arrays.asList(new ItemStack(IUItem.smalldust, 1, 24)),
                10,
                Collections.emptyList(),
                1
        );

        tin_ghost = new CropBase("tin_ghost",
                52,
                EnumSoil.TIN,
                1,
                0,
                ...
                4,
                1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/tin_ghost"),
                true,
                Arrays.asList(
                        iron_crimson,
                        quartz_storm
                ...
                true,
                false,
                Arrays.asList(new ItemStack(IUItem.smalldust, 1, 27)),
                10,
                Collections.emptyList(),
                1
        );

        red_fury = new CropBase("red_fury",
                73,
                EnumSoil.REDSTONE,
                1,
                0,
                ...
                4,
                1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/red_fury"),
                true,
                Arrays.asList(poppy, red_mushroom, tulip_red),
                3,
                false,
                4000,
                40,
                true,
                false,
                Arrays.asList(new ItemStack(Items.REDSTONE)),
                10,
                Collections.emptyList(),
                1
        );
        silicon_avalanche = new CropBase("silicon_avalanche",
                74,
                EnumSoil.GRAVEL,
                1,
                0,
                ...
                4,
                1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/silicon_avalanche"),
                true,
                Arrays.asList(tin_ghost, iron_crimson),
                4,
                false,
                5000,
                40,
                true,
                false,
                Arrays.asList(new ItemStack(Items.FLINT)),
                10,
                Collections.emptyList(),
                1
        );
        ...
        mikhailovskaya_lavra = new CropBase("mikhailovskaya_lavra", 25, EnumSoil.MICHALOV, 1, 0, 1, 1, 50, 4, 1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/mikhailovskaya_lavra"), false, Arrays.asList(
                lead_stream,
                blue_orchid
        ), 3,
        ...
        silver_melody = new CropBase("silver_melody",
                39,
                EnumSoil.SILVER,
                1,
                0,
                ...
                4,
                1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/silver_melody"),
                false,
                Arrays.asList(iron_crimson,
                        tin_ghost, chamomile
                ),
                3,
                false,
                ...
                true,
                false,
                Arrays.asList(new ItemStack(IUItem.smalldust, 1, 14)),
                10,
                Collections.emptyList(),
                1
        );
        nickel_firework = new CropBase("nickel_firework", 33, EnumSoil.NICKEL, 1, 0, 1, 1, 65, 4, 1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/nickel_firework"), false, Arrays.asList(
                lead_stream,
                tin_ghost
        ), 4,
        ...
        invar_crystal = new CropBase("invar_crystal", 29, EnumSoil.IRON, 1, 0, 1, 1, 55, 4, 1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/invar_crystal"), false, Arrays.asList(
                nickel_firework,
                iron_crimson
        ), 4,
        ...
        cobalt_grapefruit = new CropBase("cobalt_grapefruit", 31, EnumSoil.COBALT, 1, 0, 1, 1, 60, 4, 1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/cobalt_grapefruit"), false, Arrays.asList(
                mikhailovskaya_lavra,
                gold_astral
        ), 2,
        ...
        platinum_turner = new CropBase("platinum_turner", 34, EnumSoil.PLATINUM, 1, 0, 1, 1, 55, 4, 1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/platinum_turner"), false, Arrays.asList(
                cobalt_grapefruit,
                magnesium_diamond
        ), 3,
        ...
        iridium_snowflake = new CropBase("iridium_snowflake", 42, EnumSoil.IRIDIUM, 1, 0, 1, 1, 65, 4, 1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/iridium_snowflake"), false, Arrays.asList(
                platinum_turner,
                spinel_zenith
        ), 4,
        ...
        titanium_fantasy = new CropBase("titanium_fantasy",
                ...
                4,
                1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/titanium_fantasy"),
                false,
                Arrays.asList(
                        tungsten_moon_flower,
                        invar_crystal
                ),
                4,
                false,
                ...
                true,
                false,
                Arrays.asList(new ItemStack(IUItem.smalldust, 1, 10)),
                10,
                Collections.emptyList(),
                1
        );

        chromium_gentleness = new CropBase("chromium_gentleness",
                36,
                EnumSoil.CHROMIUM,
                1,
                0,
                ...
                4,
                1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/chromium_gentleness"),
                false,
                Arrays.asList(reed_seed,
                        quartz_storm, titanium_fantasy
                ),
                2,
                false,
                4500,
                ...
                true,
                false,
                Arrays.asList(new ItemStack(IUItem.smalldust, 1, 11)),
                10,
                Collections.emptyList(),
                1
        );
        ...
        manganese_lotus = new CropBase("manganese_lotus", 41, EnumSoil.MANGANESE, 1, 0, 1, 1, 70, 4, 1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/manganese_lotus"), false, Arrays.asList(
                magnesium_diamond,
                raspberry
        ), 5,
        ...
        uranium_fairy = new CropBase("uranium_fairy",
                50,
                EnumSoil.URANIUM,
                1,
                0,
                ...
                4,
                1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/uranium_fairy"),
                false,
                Arrays.asList(chromium_gentleness,
                        hops, brown_mushroom
                ),
                2,
                false,
                ...
                true,
                false,
                Arrays.asList(new ItemStack(IUItem.nuclear_res, 1, 21)),
                10,
                Collections.emptyList(),
                1
        );
        ...
        arsenite_flower = new CropBase("arsenite_flower", 53, EnumSoil.ARSENIC, 1, 0, 1, 1, 55, 4, 1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/arsenite_flower"), false, Arrays.asList(
                chromium_gentleness,
                hops
        ), 3,
        ...
        barium_star = new CropBase("barium_star", 54, EnumSoil.BARIUM, 1, 0, 1, 1, 50, 4, 1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/barium_star"), false, Arrays.asList(
                electrum_symphony,
                vanadium_dawn
        ), 4,
        ...
        bismuth_garden = new CropBase("bismuth_garden", 55, EnumSoil.BISMUTH, 1, 0, 1, 1, 60, 4, 1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/bismuth_garden"), false, Arrays.asList(
                vanadium_dawn,
                cobalt_grapefruit
        ), 2,
        ...
        gadolinium_lotus = new CropBase("gadolinium_lotus", 56, EnumSoil.GADOLINIUM, 1, 0, 1, 1, 70, 4, 1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/gadolinium_lotus"), false, Arrays.asList(
                copper_heart,
                electrum_symphony
        ), 5,
        ...
        gallium_song = new CropBase("gallium_song", 57, EnumSoil.GALLIUM, 1, 0, 1, 1, 65, 4, 1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/gallium_song"), false, Arrays.asList(
                copper_heart,
                invar_crystal
        ), 4,
        ...
        hafnium_leaf = new CropBase("hafnium_leaf", 58, EnumSoil.HAFNIUM, 1, 0, 1, 1, 55, 4, 1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/hafnium_leaf"), false, Arrays.asList(
                mikhailovskaya_lavra,
                platinum_turner
        ), 3,
        ...
        ytterbium_bright = new CropBase("ytterbium_bright", 59, EnumSoil.YTTRIUM, 1, 0, 1, 1, 50, 4, 1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/ytterbium_bright"), false, Arrays.asList(
                magnesium_diamond,
                spinel_zenith
        ), 4,
        ...
        molybdenum_whirlwind = new CropBase("molybdenum_whirlwind", 60, EnumSoil.MOLYBDENUM, 1, 0, 1, 1, 60, 4, 1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/molybdenum_whirlwind"), false, Arrays.asList(
                vanadium_dawn,
                bismuth_garden
        ), 2,
        ...
        neodymium_glow = new CropBase("neodymium_glow", 61, EnumSoil.NEODYMIUM, 1, 0, 1, 1, 70, 4, 1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/neodymium_glow"), false, Arrays.asList(
                magnesium_diamond,
                platinum_turner
        ), 5,
        ...
        niobium_obelisk = new CropBase("niobium_obelisk", 62, EnumSoil.NIOBIUM, 1, 0, 1, 1, 65, 4, 1,
                ...
                cobalt_grapefruit, mikhailovskaya_lavra
        ), 4,
        ...
        palladium_gentleness = new CropBase("palladium_gentleness", 63, EnumSoil.PALLADIUM, 1, 0, 1, 1, 55, 4, 1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/palladium_gentleness"), false, Arrays.asList(
                gadolinium_lotus,
                gallium_song
        ), 3,
        ...
        polonium_crystal = new CropBase("polonium_crystal", 64, EnumSoil.POLONIUM, 1, 0, 1, 1, 50, 4, 1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/polonium_crystal"), false, Arrays.asList(
                neodymium_glow,
                niobium_obelisk
        ), 4,
        ...
        strontium_storm = new CropBase("strontium_storm", 65, EnumSoil.STRONTIUM, 1, 0, 1, 1, 60, 4, 1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/strontium_storm"), false, Arrays.asList(
                karav_green,
                germanite_wonders
        ), 2,
        ...
        thallium_sunlight = new CropBase("thallium_sunlight", 66, EnumSoil.THALLIUM, 1, 0, 1, 1, 70, 4, 1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/thallium_sunlight"), false, Arrays.asList(
                arsenite_flower,
                barium_star
        ), 5,
        ...
        zirconium_dragon = new CropBase("zirconium_dragon", 67, EnumSoil.ZIRCONIUM, 1, 0, 1, 1, 65, 4, 1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/zirconium_dragon"), false, Arrays.asList(
                ytterbium_bright,
        ...
        tantalum_moon = new CropBase("tantalum_moon", 69, EnumSoil.TANTALUM, 1, 0, 1, 1, 50, 4, 1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/tantalum_moon"), false, Arrays.asList(
                thallium_sunlight,
                arsenite_flower
        ), 4,
        ...
        cadmium_gentleness = new CropBase("cadmium_gentleness",
                70,
                EnumSoil.CADMIUM,
                1,
                0,
                ...
                4,
                1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/cadmium_gentleness"),
                false,
                Arrays.asList(molybdenum_whirlwind,
                        silver_melody, silicon_avalanche
                ),
                2,
                false,
                4500,
                ...
                true,
                false,
                Arrays.asList(new ItemStack(IUItem.smalldust, 1, 31)),
                10,
                Collections.emptyList(),
                1
        );
        ...
        blaze_storm = new CropBase("blaze_storm", 72, EnumSoil.SOULSAND, 1, 0, 1, 1, 65, 4, 1,
                ...
                germanite_wonders, wheat_seed, red_fury
        ), 4,
        ...
        ghast_dew = new CropBase("ghast_dew", 75, EnumSoil.SOULSAND, 1, 0, 1, 1, 60, 4, 1,
                ...
                silver_melody, silicon_avalanche, zinc_storm
        ), 2,
        ...
        americium_moss = new CropBase("americium_moss",
                ...
                4,
                1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/americium_moss"),
                false,
                Arrays.asList(uranium_fairy,
                        nether_wart, zirconium_dragon
                ),
                4,
                false,
                5000,
                ...
                true,
                false,
                Arrays.asList(new ItemStack(IUItem.nuclear_res, 1, 13)),
                10,
                Collections.emptyList(),
                1
        );
        neptunium_wisdom = new CropBase("neptunium_wisdom",
                78,
                EnumSoil.URANIUM,
                1,
                0,
                ...
                4,
                1,
                new ResourceLocation(Constants.MOD_ID, "blocks/crop/neptunium_wisdom"),
                false,
                Arrays.asList(americium_moss,
                        arsenite_flower, bismuth_garden, red_mushroom
                ),
                3,
                false,
                4000,
                ...
                true,
                false,
                Arrays.asList(new ItemStack(IUItem.nuclear_res, 1, 14)),
                10,
                Collections.emptyList(),
                1
        );
        curie_berry = new CropBase("curie_berry", 77, EnumSoil.URANIUM, 1, 0, 1, 1, 65, 4, 1,
                ...
                raspberry, uranium_fairy, neptunium_wisdom
        ), 4,
        ...
        thorium_fist = new CropBase("thorium_fist", 80, EnumSoil.URANIUM, 1, 0, 1, 1, 60, 4, 1,
                ...
                titanium_fantasy, tungsten_moon_flower
        ), 2,

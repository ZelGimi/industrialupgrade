...
public class ModConfig {
    ...
    private static final DoubleEntry[] ITEM_DOUBLE_ENTRIES = new DoubleEntry[]{
            new DoubleEntry("net_durability", 0.0D, 0.0D, Double.MAX_VALUE, "Net: durability (old value 0)"),
            new DoubleEntry("hammer_durability", 2.0D, 0.0D, Double.MAX_VALUE, "Hammer: durability (old value 2)"),
    ...
    public static class Common {
        ...
        public final Map<String, ForgeConfigSpec.IntValue> mechanismInts = new LinkedHashMap<>();
        public final Map<String, ForgeConfigSpec.DoubleValue> mechanismDoubles = new LinkedHashMap<>();
        public final Map<String, ForgeConfigSpec.IntValue> itemInts = new LinkedHashMap<>();
        public final Map<String, ForgeConfigSpec.DoubleValue> itemDoubles = new LinkedHashMap<>();
        public final Map<String, ForgeConfigSpec.IntValue> mechanicInts = new LinkedHashMap<>();
        public final Map<String, ForgeConfigSpec.DoubleValue> mechanicDoubles = new LinkedHashMap<>();

        private int getInt(Map<String, ForgeConfigSpec.IntValue> values, String key, int fallback) {
            ForgeConfigSpec.IntValue value = values.get(key);
            if (value == null) {
                return fallback;
            }
        ...
        private double getDouble(Map<String, ForgeConfigSpec.DoubleValue> values, String key, double fallback) {
            ForgeConfigSpec.DoubleValue value = values.get(key);
            if (value == null) {
                return fallback;
            }
        ...
        private void defineIntEntries(ForgeConfigSpec.Builder builder, Map<String, ForgeConfigSpec.IntValue> out, IntEntry[] entries) {
        ...
        private void defineDoubleEntries(ForgeConfigSpec.Builder builder, Map<String, ForgeConfigSpec.DoubleValue> out, DoubleEntry[] entries) {
